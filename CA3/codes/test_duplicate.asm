 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4b4:	ff 24 85 a8 07 00 00 	jmp    *0x7a8(,%eax,4)
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb a0 07 00 00       	mov    $0x7a0,%ebx
 ...
 5d1:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ab:	3b 05 9c 0a 00 00    	cmp    0xa9c,%eax
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 a0 0a 00 00       	mov    $0xaa0,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 730:	00 00 00 
    if(p->s.size >= nunits){
