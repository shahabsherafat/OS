    ...
    39d8:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a46:	50                   	push   %eax
    3a47:	56                   	push   %esi
    3a48:	e8 b6 fe ff ff       	call   3903 <write>
  while(--i >= 0)
    ...
    3a79:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    3ab0:	50                   	push   %eax
    3ab1:	57                   	push   %edi
    3ab2:	e8 4c fe ff ff       	call   3903 <write>
  ...
  write(fd, &c, 1);
    ...
    3b10:	57                   	push   %edi
    3b11:	e8 ed fd ff ff       	call   3903 <write>
    ...
    3b21:	52                   	push   %edx
    3b22:	57                   	push   %edi
    3b23:	e8 db fd ff ff       	call   3903 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b8b:	53                   	push   %ebx
    3b8c:	57                   	push   %edi
    3b8d:	e8 71 fd ff ff       	call   3903 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3bca:	52                   	push   %edx
    3bcb:	57                   	push   %edi
    3bcc:	e8 32 fd ff ff       	call   3903 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3ce6:	56                   	push   %esi
    3ce7:	e8 7f fc ff ff       	call   396b <sbrk>
  if(p == (char*)-1)
