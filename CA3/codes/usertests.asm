    ...
    39c8:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a36:	50                   	push   %eax
    3a37:	56                   	push   %esi
    3a38:	e8 c6 fe ff ff       	call   3903 <write>
  while(--i >= 0)
    ...
    3a69:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    3aa0:	50                   	push   %eax
    3aa1:	57                   	push   %edi
    3aa2:	e8 5c fe ff ff       	call   3903 <write>
  ...
  write(fd, &c, 1);
    ...
    3b00:	57                   	push   %edi
    3b01:	e8 fd fd ff ff       	call   3903 <write>
    ...
    3b11:	52                   	push   %edx
    3b12:	57                   	push   %edi
    3b13:	e8 eb fd ff ff       	call   3903 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b7b:	53                   	push   %ebx
    3b7c:	57                   	push   %edi
    3b7d:	e8 81 fd ff ff       	call   3903 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3bba:	52                   	push   %edx
    3bbb:	57                   	push   %edi
    3bbc:	e8 42 fd ff ff       	call   3903 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cd6:	56                   	push   %esi
    3cd7:	e8 8f fc ff ff       	call   396b <sbrk>
  if(p == (char*)-1)
