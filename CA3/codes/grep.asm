 ...
 6d8:	89 d1                	mov    %edx,%ecx
{
 ...
 746:	50                   	push   %eax
 747:	56                   	push   %esi
 748:	e8 c6 fe ff ff       	call   613 <write>
  while(--i >= 0)
 ...
 779:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 7b0:	50                   	push   %eax
 7b1:	57                   	push   %edi
 7b2:	e8 5c fe ff ff       	call   613 <write>
 ...
 821:	52                   	push   %edx
 822:	57                   	push   %edi
 823:	e8 eb fd ff ff       	call   613 <write>
        putc(fd, c);
 ...
 88b:	53                   	push   %ebx
 88c:	57                   	push   %edi
 88d:	e8 81 fd ff ff       	call   613 <write>
        while(*s != 0){
 ...
 8ca:	52                   	push   %edx
 8cb:	57                   	push   %edi
 8cc:	e8 42 fd ff ff       	call   613 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9e6:	56                   	push   %esi
 9e7:	e8 8f fc ff ff       	call   67b <sbrk>
  if(p == (char*)-1)
