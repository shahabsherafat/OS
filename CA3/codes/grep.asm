 ...
 6e8:	89 d1                	mov    %edx,%ecx
{
 ...
 756:	50                   	push   %eax
 757:	56                   	push   %esi
 758:	e8 b6 fe ff ff       	call   613 <write>
  while(--i >= 0)
 ...
 789:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 7c0:	50                   	push   %eax
 7c1:	57                   	push   %edi
 7c2:	e8 4c fe ff ff       	call   613 <write>
 ...
 820:	57                   	push   %edi
 821:	e8 ed fd ff ff       	call   613 <write>
 ...
 831:	52                   	push   %edx
 832:	57                   	push   %edi
 833:	e8 db fd ff ff       	call   613 <write>
        putc(fd, c);
 ...
 8da:	52                   	push   %edx
 8db:	57                   	push   %edi
 8dc:	e8 32 fd ff ff       	call   613 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9f6:	56                   	push   %esi
 9f7:	e8 7f fc ff ff       	call   67b <sbrk>
  if(p == (char*)-1)
