...
_rr_test:     file format elf32-i386
...
int main(void)
{
  ...
  11:	68 08 08 00 00       	push   $0x808
  16:	6a 01                	push   $0x1
  18:	e8 c3 04 00 00       	call   4e0 <printf>
  start_throughput();
  1d:	e8 f9 03 00 00       	call   41b <start_throughput>

  for(i = 0; i < NCHILD; i++){
    pid = fork();
  22:	e8 24 03 00 00       	call   34b <fork>
    if(pid == 0){
  ...
  35:	74 2c                	je     63 <main+0x63>
    pid = fork();
  37:	e8 0f 03 00 00       	call   34b <fork>
    if(pid == 0){
  3c:	85 c0                	test   %eax,%eax
  3e:	74 3c                	je     7c <main+0x7c>
      busy('A' + i);
      exit();
    }
  }
  ...
  while(wait() > 0)
  40:	e8 16 03 00 00       	call   35b <wait>
  45:	85 c0                	test   %eax,%eax
  47:	7f f7                	jg     40 <main+0x40>
    ;

  int th = end_throughput();
  49:	e8 d5 03 00 00       	call   423 <end_throughput>
  printf(1, "\nThroughput = %d\n", th);
  4e:	83 ec 04             	sub    $0x4,%esp
  51:	50                   	push   %eax
  52:	68 ec 07 00 00       	push   $0x7ec
  57:	6a 01                	push   $0x1
  59:	e8 82 04 00 00       	call   4e0 <printf>

  exit();
  5e:	e8 f0 02 00 00       	call   353 <exit>
  for(i = 0; i < NCHILD; i++){
  63:	b8 01 00 00 00       	mov    $0x1,%eax
      busy('A' + i);
  68:	83 c0 41             	add    $0x41,%eax
  6b:	83 ec 0c             	sub    $0xc,%esp
  6e:	0f b6 c0             	movzbl %al,%eax
  71:	50                   	push   %eax
  72:	e8 19 00 00 00       	call   90 <busy>
      exit();
  77:	e8 d7 02 00 00       	call   353 <exit>
  7c:	b8 02 00 00 00       	mov    $0x2,%eax
  81:	eb e5                	jmp    68 <main+0x68>
  83:	66 90                	xchg   %ax,%ax
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
...
{
  a1:	0f be 5d 08          	movsbl 0x8(%ebp),%ebx
  for(i = 0; i < WORK; i++){
  a5:	3d 7f f0 fa 02       	cmp    $0x2faf07f,%eax
  aa:	7e 17                	jle    c3 <busy+0x33>
  ac:	eb 4a                	jmp    f8 <busy+0x68>
  ae:	66 90                	xchg   %ax,%ax
  b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  b3:	83 c0 01             	add    $0x1,%eax
  b6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  bc:	3d 7f f0 fa 02       	cmp    $0x2faf07f,%eax
  c1:	7f 35                	jg     f8 <busy+0x68>
    if(i % 8000000 == 0){
  c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  c6:	69 c0 39 61 c2 68    	imul   $0x68c26139,%eax,%eax
  cc:	05 00 18 02 00       	add    $0x21800,%eax
  d1:	c1 c8 09             	ror    $0x9,%eax
  d4:	3d 18 02 00 00       	cmp    $0x218,%eax
  d9:	77 d5                	ja     b0 <busy+0x20>
      print_process_info();  
  db:	e8 4b 03 00 00       	call   42b <print_process_info>
      printf(1, "%c ", tag);
  e0:	83 ec 04             	sub    $0x4,%esp
  e3:	53                   	push   %ebx
  e4:	68 e8 07 00 00       	push   $0x7e8
  e9:	6a 01                	push   $0x1
  eb:	e8 f0 03 00 00       	call   4e0 <printf>
  f0:	83 c4 10             	add    $0x10,%esp
  f3:	eb bb                	jmp    b0 <busy+0x20>
 ...
 4e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 660:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 665:	bb fe 07 00 00       	mov    $0x7fe,%ebx
...
malloc(uint nbytes)
{
 ...
 74b:	3b 05 40 0b 00 00    	cmp    0xb40,%eax
 ...
 76e:	e8 fd fe ff ff       	call   670 <free>
  return freep;
 773:	8b 15 40 0b 00 00    	mov    0xb40,%edx
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	b8 44 0b 00 00       	mov    $0xb44,%eax
    base.s.ptr = freep = prevp = &base;
