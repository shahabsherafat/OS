 ...
 4c8:	89 d1                	mov    %edx,%ecx
{
 ...
 536:	50                   	push   %eax
 537:	56                   	push   %esi
 538:	e8 b6 fe ff ff       	call   3f3 <write>
  while(--i >= 0)
 ...
 569:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	50                   	push   %eax
 5a1:	57                   	push   %edi
 5a2:	e8 4c fe ff ff       	call   3f3 <write>
 ...
 611:	52                   	push   %edx
 612:	57                   	push   %edi
 613:	e8 db fd ff ff       	call   3f3 <write>
        putc(fd, c);
 ...
 6ba:	52                   	push   %edx
 6bb:	57                   	push   %edi
 6bc:	e8 32 fd ff ff       	call   3f3 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7d6:	56                   	push   %esi
 7d7:	e8 7f fc ff ff       	call   45b <sbrk>
  if(p == (char*)-1)
