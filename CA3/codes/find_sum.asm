 ...
 5a8:	89 d1                	mov    %edx,%ecx
{
 ...
 5db:	0f b6 92 b4 09 00 00 	movzbl 0x9b4(%edx),%edx
 ...
 616:	50                   	push   %eax
 617:	56                   	push   %esi
 618:	e8 c6 fe ff ff       	call   4e3 <write>
  while(--i >= 0)
 ...
 649:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 680:	50                   	push   %eax
 681:	57                   	push   %edi
 682:	e8 5c fe ff ff       	call   4e3 <write>
 ...
 6b4:	ff 24 85 5c 09 00 00 	jmp    *0x95c(,%eax,4)
 ...
 6f1:	52                   	push   %edx
 6f2:	57                   	push   %edi
 6f3:	e8 eb fd ff ff       	call   4e3 <write>
        putc(fd, c);
 ...
 79a:	52                   	push   %edx
 79b:	57                   	push   %edi
 79c:	e8 42 fd ff ff       	call   4e3 <write>
        ap++;
 ...
 7c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 7c5:	bb 53 09 00 00       	mov    $0x953,%ebx
...
free(void *ap)
{
 ...
 7d1:	a1 5c 0c 00 00       	mov    0xc5c,%eax
{
 ...
 80f:	5b                   	pop    %ebx
  freep = p;
 810:	a3 5c 0c 00 00       	mov    %eax,0xc5c
}
 815:	5e                   	pop    %esi
 816:	5f                   	pop    %edi
 817:	5d                   	pop    %ebp
 ...
 826:	72 ce                	jb     7f6 <free+0x26>
{
 ...
 847:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 84a:	a3 5c 0c 00 00       	mov    %eax,0xc5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 869:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 86c:	8b 15 5c 0c 00 00    	mov    0xc5c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8ab:	3b 05 5c 0c 00 00    	cmp    0xc5c,%eax
 8b1:	75 ed                	jne    8a0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 8b3:	83 ec 0c             	sub    $0xc,%esp
 8b6:	56                   	push   %esi
 8b7:	e8 8f fc ff ff       	call   54b <sbrk>
  if(p == (char*)-1)
 ...
 8ce:	e8 fd fe ff ff       	call   7d0 <free>
  return freep;
 8d3:	8b 15 5c 0c 00 00    	mov    0xc5c,%edx
 ...
 8fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 8ff:	89 15 5c 0c 00 00    	mov    %edx,0xc5c
}
 ...
 90f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 910:	c7 05 5c 0c 00 00 60 	movl   $0xc60,0xc5c
 917:	0c 00 00 
    base.s.size = 0;
 91a:	b8 60 0c 00 00       	mov    $0xc60,%eax
    base.s.ptr = freep = prevp = &base;
 91f:	c7 05 60 0c 00 00 60 	movl   $0xc60,0xc60
 926:	0c 00 00 
    base.s.size = 0;
 929:	c7 05 64 0c 00 00 00 	movl   $0x0,0xc64
 930:	00 00 00 
    if(p->s.size >= nunits){
