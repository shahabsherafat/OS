...
fork1(void)
{
  ...
  if (pid == -1)
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
      88:	80 3d c1 1f 00 00 64 	cmpb   $0x64,0x1fc1
      8f:	75 d2                	jne    63 <main+0x63>
      91:	80 3d c2 1f 00 00 20 	cmpb   $0x20,0x1fc2
      98:	75 c9                	jne    63 <main+0x63>
      buf[strlen(buf) - 1] = 0; // chop \n
      9a:	83 ec 0c             	sub    $0xc,%esp
      9d:	68 c0 1f 00 00       	push   $0x1fc0
      a2:	e8 a9 10 00 00       	call   1150 <strlen>
      if (chdir(buf + 3) < 0)
      a7:	c7 04 24 c3 1f 00 00 	movl   $0x1fc3,(%esp)
      buf[strlen(buf) - 1] = 0; // chop \n
      ae:	c6 80 bf 1f 00 00 00 	movb   $0x0,0x1fbf(%eax)
      if (chdir(buf + 3) < 0)
      ...
      bf:	0f 89 7b ff ff ff    	jns    40 <main+0x40>
        printf(2, "cannot cd %s\n", buf + 3);
      c5:	50                   	push   %eax
      c6:	68 c3 1f 00 00       	push   $0x1fc3
      cb:	68 5c 18 00 00       	push   $0x185c
      d0:	6a 02                	push   $0x2
      d2:	e8 c9 13 00 00       	call   14a0 <printf>
...
00000120 <auto_complete>:
{
  ...
  printf(2, "%s\t", instruction + buf_len);
     ...
     173:	51                   	push   %ecx
     174:	68 a8 17 00 00       	push   $0x17a8
     179:	6a 02                	push   $0x2
     17b:	e8 20 13 00 00       	call   14a0 <printf>
}
...
00000190 <print_instructions>:
{
  ...
  printf(2, "\n");
     1a5:	68 d0 17 00 00       	push   $0x17d0
     1aa:	6a 02                	push   $0x2
     1ac:	e8 ef 12 00 00       	call   14a0 <printf>
  for (int i = 0; i < count; i++) {
    ...
    if (instructions[i])
     ...
     1ca:	52                   	push   %edx
     1cb:	68 50 18 00 00       	push   $0x1850
     1d0:	6a 02                	push   $0x2
     1d2:	e8 c9 12 00 00       	call   14a0 <printf>
  ...
  printf(2, "\t");
     ...
     1e4:	68 aa 17 00 00       	push   $0x17aa
     1e9:	6a 02                	push   $0x2
     1eb:	e8 b0 12 00 00       	call   14a0 <printf>
  printf(2, "$ %s", prefix);
     1f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     1f3:	83 c4 10             	add    $0x10,%esp
     1f6:	c7 45 0c ac 17 00 00 	movl   $0x17ac,0xc(%ebp)
     ...
     20d:	5d                   	pop    %ebp
  printf(2, "$ %s", prefix);
     20e:	e9 8d 12 00 00       	jmp    14a0 <printf>
...
00000290 <get_matching_instructions>:
{
  ...
  char **instructions = malloc(sizeof(char *) * 16);
     ...
     2b2:	e8 09 14 00 00       	call   16c0 <malloc>
  ...
  while (read(fd, &de, sizeof(de)) == sizeof(de)) {
    ...
    for (int i = 0; i < prefix_len; i++) {
     ...
     340:	6a 0f                	push   $0xf
     342:	e8 79 13 00 00       	call   16c0 <malloc>
  ...
  for (int i = 0; i < prefix_len; i++) {
    ...
    instructions[counter] = malloc(3);
     ...
     3fe:	6a 03                	push   $0x3
     400:	e8 bb 12 00 00       	call   16c0 <malloc>
...
00000440 <getcmd>:
{
  ...
  if (!temp_buf) {
     448:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
{
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     45b:	a1 ac 1f 00 00       	mov    0x1fac,%eax
     460:	0b 05 a8 1f 00 00    	or     0x1fa8,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     48e:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
    ...
    TAPPRESS = 0;
     4a4:	c7 05 ac 1f 00 00 00 	movl   $0x0,0x1fac
     4ab:	00 00 00 
    has_multiple_choice = 0;
     4ae:	c7 05 a8 1f 00 00 00 	movl   $0x0,0x1fa8
     4b5:	00 00 00 
  if (buf[0] == 0)
     4b8:	80 3b 00             	cmpb   $0x0,(%ebx)
     4bb:	0f 84 89 01 00 00    	je     64a <getcmd+0x20a>
  if (temp_buf)
     4c1:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     4eb:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
    ...
    has_multiple_choice = 0;
     505:	c7 05 a8 1f 00 00 00 	movl   $0x0,0x1fa8
     50c:	00 00 00 
    TAPPRESS = 0;
     50f:	c7 05 ac 1f 00 00 00 	movl   $0x0,0x1fac
     516:	00 00 00 
    ...
    if (instruction_num == 0) {
     ...
     540:	8b 0d a8 1f 00 00    	mov    0x1fa8,%ecx
     546:	85 c9                	test   %ecx,%ecx
     548:	0f 85 a2 00 00 00    	jne    5f0 <getcmd+0x1b0>
        if (temp_buf)
     54e:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
        has_multiple_choice = 1; 
     553:	c7 05 a8 1f 00 00 01 	movl   $0x1,0x1fa8
     55a:	00 00 00 
        if (temp_buf)
     ...
     57b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      if (temp_buf)
     580:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
      TAPPRESS = 1;
     585:	c7 05 ac 1f 00 00 01 	movl   $0x1,0x1fac
     58c:	00 00 00 
      if (temp_buf)
    ...
    temp_buf = malloc(nbuf);
     ...
     59b:	56                   	push   %esi
     59c:	e8 1f 11 00 00       	call   16c0 <malloc>
    if (temp_buf)
     5a1:	83 c4 10             	add    $0x10,%esp
    temp_buf = malloc(nbuf);
     5a4:	a3 a0 1f 00 00       	mov    %eax,0x1fa0
    if (temp_buf)
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     5b4:	a1 ac 1f 00 00       	mov    0x1fac,%eax
     5b9:	0b 05 a8 1f 00 00    	or     0x1fa8,%eax
     5bf:	0f 85 a7 fe ff ff    	jne    46c <getcmd+0x2c>
     5c5:	8d 76 00             	lea    0x0(%esi),%esi
    printf(2, "$ ");
     5c8:	83 ec 08             	sub    $0x8,%esp
     5cb:	68 b3 17 00 00       	push   $0x17b3
     5d0:	6a 02                	push   $0x2
     5d2:	e8 c9 0e 00 00       	call   14a0 <printf>
    memset(buf, 0, nbuf);
     ...
     5f6:	e8 95 fb ff ff       	call   190 <print_instructions>
        if (temp_buf)
     5fb:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
     600:	83 c4 10             	add    $0x10,%esp
        done_printing = 1;
     603:	c7 05 a4 1f 00 00 01 	movl   $0x1,0x1fa4
     60a:	00 00 00 
        if (temp_buf)
     ...
     626:	e8 f5 fa ff ff       	call   120 <auto_complete>
      if (temp_buf)
     62b:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
     630:	83 c4 10             	add    $0x10,%esp
      TAPPRESS = 1;
     633:	c7 05 ac 1f 00 00 01 	movl   $0x1,0x1fac
     63a:	00 00 00 
      if (temp_buf)
...
00000660 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     669:	68 50 18 00 00       	push   $0x1850
     66e:	6a 02                	push   $0x2
     670:	e8 2b 0e 00 00       	call   14a0 <printf>
  exit();
...
00000680 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     695:	68 b6 17 00 00       	push   $0x17b6
...
000006a0 <runcmd>:
{
  ...
  switch (cmd->type) {
     ...
     6b9:	ff 24 85 74 18 00 00 	jmp    *0x1874(,%eax,4)
    if (ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     6d9:	68 c2 17 00 00       	push   $0x17c2
     6de:	6a 02                	push   $0x2
     6e0:	e8 bb 0d 00 00       	call   14a0 <printf>
    break;
    ...
    panic("runcmd");
     ...
     79d:	68 bb 17 00 00       	push   $0x17bb
     7a2:	e8 b9 fe ff ff       	call   660 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     7a7:	51                   	push   %ecx
     7a8:	ff 73 08             	push   0x8(%ebx)
     7ab:	68 d2 17 00 00       	push   $0x17d2
     7b0:	6a 02                	push   $0x2
     7b2:	e8 e9 0c 00 00       	call   14a0 <printf>
      exit();
     7b7:	e8 57 0b 00 00       	call   1313 <exit>
      panic("pipe");
     7bc:	83 ec 0c             	sub    $0xc,%esp
     7bf:	68 e2 17 00 00       	push   $0x17e2
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     837:	6a 54                	push   $0x54
     839:	e8 82 0e 00 00       	call   16c0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     867:	6a 18                	push   $0x18
     869:	e8 52 0e 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8b7:	6a 0c                	push   $0xc
     8b9:	e8 02 0e 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8f7:	6a 0c                	push   $0xc
     8f9:	e8 c2 0d 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     937:	6a 08                	push   $0x8
     939:	e8 82 0d 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     969:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     98d:	50                   	push   %eax
     98e:	68 90 1f 00 00       	push   $0x1f90
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     9dd:	50                   	push   %eax
     9de:	68 90 1f 00 00       	push   $0x1f90
  ...
  *ps = s;
  ...
  switch (*s) {
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a36:	50                   	push   %eax
     a37:	68 88 1f 00 00       	push   $0x1f88
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a55:	50                   	push   %eax
     a56:	68 90 1f 00 00       	push   $0x1f90
...
peek(char **ps, char *es, char *toks)
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     afd:	50                   	push   %eax
     afe:	68 90 1f 00 00       	push   $0x1f90
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while (peek(ps, es, "<>")) {
     ...
     b63:	68 04 18 00 00       	push   $0x1804
     b68:	53                   	push   %ebx
     b69:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     bc0:	6a 18                	push   $0x18
     bc2:	e8 f9 0a 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     c1f:	6a 18                	push   $0x18
     c21:	e8 9a 0a 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     c7e:	68 e7 17 00 00       	push   $0x17e7
...
parseexec(char **ps, char *es)
{
  ...
  if (peek(ps, es, "("))
     c9f:	68 07 18 00 00       	push   $0x1807
     ca4:	56                   	push   %esi
     ca5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     cbb:	6a 54                	push   $0x54
     cbd:	e8 fe 09 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (!peek(ps, es, "|)&;")) {
     ...
     d06:	68 1e 18 00 00       	push   $0x181e
     d0b:	56                   	push   %esi
     d0c:	53                   	push   %ebx
    ...
    if (argc >= MAXARGS)
     ...
     d50:	68 10 18 00 00       	push   $0x1810
  ...
  cmd->eargv[argc] = 0;
     ...
     d99:	68 09 18 00 00       	push   $0x1809
...
00000db0 <parsepipe>:
{
  ...
  if (peek(ps, es, "|")) {
     ...
     dc9:	68 23 18 00 00       	push   $0x1823
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     e0d:	e8 ae 08 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000e40 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     e72:	e8 49 08 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (peek(ps, es, "&")) {
     ...
     e9b:	68 25 18 00 00       	push   $0x1825
     ea0:	57                   	push   %edi
     ea1:	56                   	push   %esi
  ...
  if (peek(ps, es, ";")) {
     ...
     eb1:	68 21 18 00 00       	push   $0x1821
     eb6:	57                   	push   %edi
     eb7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     eed:	e8 ce 07 00 00       	call   16c0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000f20 <parseblock>:
{
  ...
  if (!peek(ps, es, "("))
     f2f:	68 07 18 00 00       	push   $0x1807
     f34:	56                   	push   %esi
     f35:	53                   	push   %ebx
  ...
  if (!peek(ps, es, ")"))
     ...
     f59:	68 43 18 00 00       	push   $0x1843
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch (cmd->type) {
     ...
     fc5:	ff 24 85 8c 18 00 00 	jmp    *0x188c(,%eax,4)
    ...
    1055:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
    ...
    1073:	68 ab 17 00 00       	push   $0x17ab
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    109e:	52                   	push   %edx
    109f:	50                   	push   %eax
    10a0:	68 45 18 00 00       	push   $0x1845
    10a5:	6a 02                	push   $0x2
    10a7:	e8 f4 03 00 00       	call   14a0 <printf>
    panic("syntax");
    10ac:	c7 04 24 09 18 00 00 	movl   $0x1809,(%esp)
...
{
    140a:	83 ec 3c             	sub    $0x3c,%esp
    140d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    1410:	85 d2                	test   %edx,%edx
    1412:	0f 89 80 00 00 00    	jns    1498 <printint+0x98>
    1418:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    141c:	74 7a                	je     1498 <printint+0x98>
    x = -xx;
    141e:	f7 d9                	neg    %ecx
    neg = 1;
  ...
  i = 0;
    1425:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    1428:	31 f6                	xor    %esi,%esi
    142a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    1430:	89 c8                	mov    %ecx,%eax
    1432:	31 d2                	xor    %edx,%edx
    1434:	89 f7                	mov    %esi,%edi
    1436:	f7 f3                	div    %ebx
    1438:	8d 76 01             	lea    0x1(%esi),%esi
    143b:	0f b6 92 fc 18 00 00 	movzbl 0x18fc(%edx),%edx
    1442:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    1446:	89 ca                	mov    %ecx,%edx
    1448:	89 c1                	mov    %eax,%ecx
    144a:	39 da                	cmp    %ebx,%edx
    144c:	73 e2                	jae    1430 <printint+0x30>
  if(neg)
    144e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    1451:	85 c0                	test   %eax,%eax
    1453:	74 07                	je     145c <printint+0x5c>
    buf[i++] = '-';
    1455:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    145a:	89 f7                	mov    %esi,%edi
    145c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    145f:	8b 75 c0             	mov    -0x40(%ebp),%esi
    1462:	01 df                	add    %ebx,%edi
    1464:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    1468:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    146b:	83 ec 04             	sub    $0x4,%esp
    146e:	88 45 d7             	mov    %al,-0x29(%ebp)
    1471:	8d 45 d7             	lea    -0x29(%ebp),%eax
    1474:	6a 01                	push   $0x1
    1476:	50                   	push   %eax
    1477:	56                   	push   %esi
    1478:	e8 b6 fe ff ff       	call   1333 <write>
  while(--i >= 0)
    147d:	89 f8                	mov    %edi,%eax
    147f:	83 c4 10             	add    $0x10,%esp
    1482:	83 ef 01             	sub    $0x1,%edi
    1485:	39 c3                	cmp    %eax,%ebx
    1487:	75 df                	jne    1468 <printint+0x68>
}
  ...
  neg = 0;
    ...
    149a:	eb 89                	jmp    1425 <printint+0x25>
...
{
    14ac:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    14af:	0f b6 1e             	movzbl (%esi),%ebx
    14b2:	83 c6 01             	add    $0x1,%esi
    14b5:	84 db                	test   %bl,%bl
    14b7:	74 67                	je     1520 <printf+0x80>
    14b9:	8d 4d 10             	lea    0x10(%ebp),%ecx
    14bc:	31 d2                	xor    %edx,%edx
    14be:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    14c1:	eb 34                	jmp    14f7 <printf+0x57>
    14c3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    14c8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    14cb:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    14d0:	83 f8 25             	cmp    $0x25,%eax
    14d3:	74 18                	je     14ed <printf+0x4d>
  write(fd, &c, 1);
    14d5:	83 ec 04             	sub    $0x4,%esp
    14d8:	8d 45 e7             	lea    -0x19(%ebp),%eax
    14db:	88 5d e7             	mov    %bl,-0x19(%ebp)
    14de:	6a 01                	push   $0x1
    14e0:	50                   	push   %eax
    14e1:	57                   	push   %edi
    14e2:	e8 4c fe ff ff       	call   1333 <write>
    14e7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    14ea:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    14ed:	0f b6 1e             	movzbl (%esi),%ebx
    14f0:	83 c6 01             	add    $0x1,%esi
    14f3:	84 db                	test   %bl,%bl
    14f5:	74 29                	je     1520 <printf+0x80>
    c = fmt[i] & 0xff;
    14f7:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    14fa:	85 d2                	test   %edx,%edx
    14fc:	74 ca                	je     14c8 <printf+0x28>
      }
    } else if(state == '%'){
    14fe:	83 fa 25             	cmp    $0x25,%edx
    1501:	75 ea                	jne    14ed <printf+0x4d>
      if(c == 'd'){
    1503:	83 f8 25             	cmp    $0x25,%eax
    1506:	0f 84 04 01 00 00    	je     1610 <printf+0x170>
    150c:	83 e8 63             	sub    $0x63,%eax
    150f:	83 f8 15             	cmp    $0x15,%eax
    1512:	77 1c                	ja     1530 <printf+0x90>
    1514:	ff 24 85 a4 18 00 00 	jmp    *0x18a4(,%eax,4)
    151b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1533:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1536:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    153a:	6a 01                	push   $0x1
    153c:	52                   	push   %edx
    153d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    1540:	57                   	push   %edi
    1541:	e8 ed fd ff ff       	call   1333 <write>
    1546:	83 c4 0c             	add    $0xc,%esp
    1549:	88 5d e7             	mov    %bl,-0x19(%ebp)
    154c:	6a 01                	push   $0x1
    154e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    1551:	52                   	push   %edx
    1552:	57                   	push   %edi
    1553:	e8 db fd ff ff       	call   1333 <write>
        putc(fd, c);
    1558:	83 c4 10             	add    $0x10,%esp
      state = 0;
    155b:	31 d2                	xor    %edx,%edx
    155d:	eb 8e                	jmp    14ed <printf+0x4d>
    155f:	90                   	nop
        printint(fd, *ap, 16, 0);
    1560:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1563:	83 ec 0c             	sub    $0xc,%esp
    1566:	b9 10 00 00 00       	mov    $0x10,%ecx
    156b:	8b 13                	mov    (%ebx),%edx
    156d:	6a 00                	push   $0x0
    156f:	89 f8                	mov    %edi,%eax
        ap++;
    1571:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    1574:	e8 87 fe ff ff       	call   1400 <printint>
        ap++;
    1579:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    157c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    157f:	31 d2                	xor    %edx,%edx
    1581:	e9 67 ff ff ff       	jmp    14ed <printf+0x4d>
        s = (char*)*ap;
    1586:	8b 45 d0             	mov    -0x30(%ebp),%eax
    1589:	8b 18                	mov    (%eax),%ebx
        ap++;
    158b:	83 c0 04             	add    $0x4,%eax
    158e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    1591:	85 db                	test   %ebx,%ebx
    1593:	0f 84 87 00 00 00    	je     1620 <printf+0x180>
        while(*s != 0){
    1599:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    159c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    159e:	84 c0                	test   %al,%al
    15a0:	0f 84 47 ff ff ff    	je     14ed <printf+0x4d>
    15a6:	8d 55 e7             	lea    -0x19(%ebp),%edx
    15a9:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    15ac:	89 de                	mov    %ebx,%esi
    15ae:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
    15b0:	83 ec 04             	sub    $0x4,%esp
    15b3:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
    15b6:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
    15b9:	6a 01                	push   $0x1
    15bb:	53                   	push   %ebx
    15bc:	57                   	push   %edi
    15bd:	e8 71 fd ff ff       	call   1333 <write>
        while(*s != 0){
    ...
    15d1:	e9 17 ff ff ff       	jmp    14ed <printf+0x4d>
        printint(fd, *ap, 10, 1);
    15d6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    15d9:	83 ec 0c             	sub    $0xc,%esp
    15dc:	b9 0a 00 00 00       	mov    $0xa,%ecx
    15e1:	8b 13                	mov    (%ebx),%edx
    15e3:	6a 01                	push   $0x1
    15e5:	eb 88                	jmp    156f <printf+0xcf>
        putc(fd, *ap);
    15e7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    15ea:	83 ec 04             	sub    $0x4,%esp
    15ed:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    15f0:	8b 03                	mov    (%ebx),%eax
        ap++;
    15f2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    15f5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    15f8:	6a 01                	push   $0x1
    15fa:	52                   	push   %edx
    15fb:	57                   	push   %edi
    15fc:	e8 32 fd ff ff       	call   1333 <write>
        ap++;
    1601:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    1604:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1607:	31 d2                	xor    %edx,%edx
    1609:	e9 df fe ff ff       	jmp    14ed <printf+0x4d>
    160e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    1610:	83 ec 04             	sub    $0x4,%esp
    1613:	88 5d e7             	mov    %bl,-0x19(%ebp)
    1616:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1619:	6a 01                	push   $0x1
    161b:	e9 31 ff ff ff       	jmp    1551 <printf+0xb1>
    1620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1625:	bb 6a 18 00 00       	mov    $0x186a,%ebx
    162a:	e9 77 ff ff ff       	jmp    15a6 <printf+0x106>
    162f:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1631:	a1 24 20 00 00       	mov    0x2024,%eax
{
  ...
  freep = p;
    ...
    166f:	5b                   	pop    %ebx
  freep = p;
    1670:	a3 24 20 00 00       	mov    %eax,0x2024
}
    1675:	5e                   	pop    %esi
    1676:	5f                   	pop    %edi
    1677:	5d                   	pop    %ebp
    ...
    1686:	72 ce                	jb     1656 <free+0x26>
{
  ...
  freep = p;
    16aa:	a3 24 20 00 00       	mov    %eax,0x2024
    p->s.size += bp->s.size;
    16af:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    16b2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    16b5:	89 08                	mov    %ecx,(%eax)
}
    16b7:	5b                   	pop    %ebx
    16b8:	5e                   	pop    %esi
    16b9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16cc:	8b 15 24 20 00 00    	mov    0x2024,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    16dd:	0f 84 8d 00 00 00    	je     1770 <malloc+0xb0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16e8:	39 f9                	cmp    %edi,%ecx
    16ea:	73 64                	jae    1750 <malloc+0x90>
  if(nu < 4096)
    16ec:	bb 00 10 00 00       	mov    $0x1000,%ebx
    16f1:	39 df                	cmp    %ebx,%edi
    16f3:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    16f6:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    16fd:	eb 0a                	jmp    1709 <malloc+0x49>
    16ff:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1700:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1702:	8b 48 04             	mov    0x4(%eax),%ecx
    1705:	39 f9                	cmp    %edi,%ecx
    1707:	73 47                	jae    1750 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    170b:	3b 05 24 20 00 00    	cmp    0x2024,%eax
    1711:	75 ed                	jne    1700 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1713:	83 ec 0c             	sub    $0xc,%esp
    1716:	56                   	push   %esi
    1717:	e8 7f fc ff ff       	call   139b <sbrk>
  if(p == (char*)-1)
    171c:	83 c4 10             	add    $0x10,%esp
    171f:	83 f8 ff             	cmp    $0xffffffff,%eax
    1722:	74 1c                	je     1740 <malloc+0x80>
  hp->s.size = nu;
    1724:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1727:	83 ec 0c             	sub    $0xc,%esp
    172a:	83 c0 08             	add    $0x8,%eax
    172d:	50                   	push   %eax
    172e:	e8 fd fe ff ff       	call   1630 <free>
  return freep;
    1733:	8b 15 24 20 00 00    	mov    0x2024,%edx
      if((p = morecore(nunits)) == 0)
    1739:	83 c4 10             	add    $0x10,%esp
    173c:	85 d2                	test   %edx,%edx
    173e:	75 c0                	jne    1700 <malloc+0x40>
        return 0;
  }
}
    1740:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    1752:	74 4c                	je     17a0 <malloc+0xe0>
        p->s.size -= nunits;
    ...
    175c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    175f:	89 15 24 20 00 00    	mov    %edx,0x2024
}
    1765:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    ...
    176f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1770:	c7 05 24 20 00 00 28 	movl   $0x2028,0x2024
    1777:	20 00 00 
    base.s.size = 0;
    177a:	b8 28 20 00 00       	mov    $0x2028,%eax
    base.s.ptr = freep = prevp = &base;
    177f:	c7 05 28 20 00 00 28 	movl   $0x2028,0x2028
    1786:	20 00 00 
    base.s.size = 0;
    1789:	c7 05 2c 20 00 00 00 	movl   $0x0,0x202c
    1790:	00 00 00 
    if(p->s.size >= nunits){
    1793:	e9 54 ff ff ff       	jmp    16ec <malloc+0x2c>
    1798:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    179f:	00 
        prevp->s.ptr = p->s.ptr;
    17a0:	8b 08                	mov    (%eax),%ecx
    17a2:	89 0a                	mov    %ecx,(%edx)
    17a4:	eb b9                	jmp    175f <malloc+0x9f>
