...
fork1(void)
{
  ...
  if (pid == -1)
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
      ...
      cb:	68 4c 18 00 00       	push   $0x184c
      d0:	6a 02                	push   $0x2
      d2:	e8 b9 13 00 00       	call   1490 <printf>
  ...
  exit();
    ...
    panic("fork");
     ...
     10e:	68 a6 17 00 00       	push   $0x17a6
...
00000120 <auto_complete>:
{
  ...
  printf(2, "%s\t", instruction + buf_len);
     ...
     173:	51                   	push   %ecx
     174:	68 98 17 00 00       	push   $0x1798
     179:	6a 02                	push   $0x2
     17b:	e8 10 13 00 00       	call   1490 <printf>
}
...
00000190 <print_instructions>:
{
  ...
  printf(2, "\n");
     1a5:	68 c0 17 00 00       	push   $0x17c0
     1aa:	6a 02                	push   $0x2
     1ac:	e8 df 12 00 00       	call   1490 <printf>
  for (int i = 0; i < count; i++) {
    ...
    if (instructions[i])
     ...
     1ca:	52                   	push   %edx
     1cb:	68 40 18 00 00       	push   $0x1840
     1d0:	6a 02                	push   $0x2
     1d2:	e8 b9 12 00 00       	call   1490 <printf>
  ...
  printf(2, "\t");
     ...
     1e4:	68 9a 17 00 00       	push   $0x179a
     1e9:	6a 02                	push   $0x2
     1eb:	e8 a0 12 00 00       	call   1490 <printf>
  printf(2, "$ %s", prefix);
     1f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     1f3:	83 c4 10             	add    $0x10,%esp
     1f6:	c7 45 0c 9c 17 00 00 	movl   $0x179c,0xc(%ebp)
     ...
     20d:	5d                   	pop    %ebp
  printf(2, "$ %s", prefix);
     20e:	e9 7d 12 00 00       	jmp    1490 <printf>
...
00000290 <get_matching_instructions>:
{
  ...
  fd = open(path, 0);
     29c:	6a 00                	push   $0x0
     29e:	68 a1 17 00 00       	push   $0x17a1
  ...
  char **instructions = malloc(sizeof(char *) * 16);
     ...
     2b2:	e8 f9 13 00 00       	call   16b0 <malloc>
  ...
  while (read(fd, &de, sizeof(de)) == sizeof(de)) {
    ...
    for (int i = 0; i < prefix_len; i++) {
     ...
     340:	6a 0f                	push   $0xf
     342:	e8 69 13 00 00       	call   16b0 <malloc>
  ...
  for (int i = 0; i < prefix_len; i++) {
    ...
    instructions[counter] = malloc(3);
     ...
     3fe:	6a 03                	push   $0x3
     400:	e8 ab 12 00 00       	call   16b0 <malloc>
     ...
     448:	a1 a0 1f 00 00       	mov    0x1fa0,%eax
{
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
    ...
    temp_buf = malloc(nbuf);
     ...
     59b:	56                   	push   %esi
     59c:	e8 0f 11 00 00       	call   16b0 <malloc>
    if (temp_buf)
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
    ...
    printf(2, "$ ");
     ...
     5cb:	68 a3 17 00 00       	push   $0x17a3
     5d0:	6a 02                	push   $0x2
     5d2:	e8 b9 0e 00 00       	call   1490 <printf>
    memset(buf, 0, nbuf);
...
00000660 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     669:	68 40 18 00 00       	push   $0x1840
     66e:	6a 02                	push   $0x2
     670:	e8 1b 0e 00 00       	call   1490 <printf>
  exit();
...
00000680 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     695:	68 a6 17 00 00       	push   $0x17a6
...
000006a0 <runcmd>:
{
  ...
  switch (cmd->type) {
     ...
     6b9:	ff 24 85 64 18 00 00 	jmp    *0x1864(,%eax,4)
    if (ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     6d9:	68 b2 17 00 00       	push   $0x17b2
     6de:	6a 02                	push   $0x2
     6e0:	e8 ab 0d 00 00       	call   1490 <printf>
    break;
    ...
    panic("runcmd");
     ...
     79d:	68 ab 17 00 00       	push   $0x17ab
     7a2:	e8 b9 fe ff ff       	call   660 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     7a7:	51                   	push   %ecx
     7a8:	ff 73 08             	push   0x8(%ebx)
     7ab:	68 c2 17 00 00       	push   $0x17c2
     7b0:	6a 02                	push   $0x2
     7b2:	e8 d9 0c 00 00       	call   1490 <printf>
      exit();
     7b7:	e8 57 0b 00 00       	call   1313 <exit>
      panic("pipe");
     7bc:	83 ec 0c             	sub    $0xc,%esp
     7bf:	68 d2 17 00 00       	push   $0x17d2
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     837:	6a 54                	push   $0x54
     839:	e8 72 0e 00 00       	call   16b0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     867:	6a 18                	push   $0x18
     869:	e8 42 0e 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8b7:	6a 0c                	push   $0xc
     8b9:	e8 f2 0d 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8f7:	6a 0c                	push   $0xc
     8f9:	e8 b2 0d 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     937:	6a 08                	push   $0x8
     939:	e8 72 0d 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     969:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     98d:	50                   	push   %eax
     98e:	68 80 1f 00 00       	push   $0x1f80
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     9dd:	50                   	push   %eax
     9de:	68 80 1f 00 00       	push   $0x1f80
  ...
  *ps = s;
  ...
  switch (*s) {
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a36:	50                   	push   %eax
     a37:	68 78 1f 00 00       	push   $0x1f78
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a55:	50                   	push   %eax
     a56:	68 80 1f 00 00       	push   $0x1f80
...
peek(char **ps, char *es, char *toks)
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     afd:	50                   	push   %eax
     afe:	68 80 1f 00 00       	push   $0x1f80
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while (peek(ps, es, "<>")) {
     ...
     b63:	68 f4 17 00 00       	push   $0x17f4
     b68:	53                   	push   %ebx
     b69:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     bc0:	6a 18                	push   $0x18
     bc2:	e8 e9 0a 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     c1f:	6a 18                	push   $0x18
     c21:	e8 8a 0a 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     c7e:	68 d7 17 00 00       	push   $0x17d7
...
parseexec(char **ps, char *es)
{
  ...
  if (peek(ps, es, "("))
     c9f:	68 f7 17 00 00       	push   $0x17f7
     ca4:	56                   	push   %esi
     ca5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     cbb:	6a 54                	push   $0x54
     cbd:	e8 ee 09 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (!peek(ps, es, "|)&;")) {
     ...
     d06:	68 0e 18 00 00       	push   $0x180e
     d0b:	56                   	push   %esi
     d0c:	53                   	push   %ebx
    ...
    if (argc >= MAXARGS)
     ...
     d50:	68 00 18 00 00       	push   $0x1800
  ...
  cmd->eargv[argc] = 0;
     ...
     d99:	68 f9 17 00 00       	push   $0x17f9
...
00000db0 <parsepipe>:
{
  ...
  if (peek(ps, es, "|")) {
     ...
     dc9:	68 13 18 00 00       	push   $0x1813
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     e0d:	e8 9e 08 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000e40 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     e72:	e8 39 08 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (peek(ps, es, "&")) {
     ...
     e9b:	68 15 18 00 00       	push   $0x1815
     ea0:	57                   	push   %edi
     ea1:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     eed:	e8 be 07 00 00       	call   16b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000f20 <parseblock>:
{
  ...
  if (!peek(ps, es, "("))
     f2f:	68 f7 17 00 00       	push   $0x17f7
     f34:	56                   	push   %esi
     f35:	53                   	push   %ebx
  ...
  if (!peek(ps, es, ")"))
     ...
     f59:	68 33 18 00 00       	push   $0x1833
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch (cmd->type) {
     ...
     fc5:	ff 24 85 7c 18 00 00 	jmp    *0x187c(,%eax,4)
    ...
    1055:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
    ...
    1073:	68 9b 17 00 00       	push   $0x179b
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    109e:	52                   	push   %edx
    109f:	50                   	push   %eax
    10a0:	68 35 18 00 00       	push   $0x1835
    10a5:	6a 02                	push   $0x2
    10a7:	e8 e4 03 00 00       	call   1490 <printf>
    panic("syntax");
    10ac:	c7 04 24 f9 17 00 00 	movl   $0x17f9,(%esp)
...
{
    13fa:	83 ec 3c             	sub    $0x3c,%esp
    13fd:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    1400:	85 d2                	test   %edx,%edx
    1402:	0f 89 80 00 00 00    	jns    1488 <printint+0x98>
    1408:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    140c:	74 7a                	je     1488 <printint+0x98>
    x = -xx;
    140e:	f7 d9                	neg    %ecx
    neg = 1;
  ...
  i = 0;
    1415:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    1418:	31 f6                	xor    %esi,%esi
    141a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    1420:	89 c8                	mov    %ecx,%eax
    1422:	31 d2                	xor    %edx,%edx
    1424:	89 f7                	mov    %esi,%edi
    1426:	f7 f3                	div    %ebx
    1428:	8d 76 01             	lea    0x1(%esi),%esi
    142b:	0f b6 92 ec 18 00 00 	movzbl 0x18ec(%edx),%edx
    1432:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    1436:	89 ca                	mov    %ecx,%edx
    1438:	89 c1                	mov    %eax,%ecx
    143a:	39 da                	cmp    %ebx,%edx
    143c:	73 e2                	jae    1420 <printint+0x30>
  if(neg)
    143e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    1441:	85 c0                	test   %eax,%eax
    1443:	74 07                	je     144c <printint+0x5c>
    buf[i++] = '-';
    1445:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    144a:	89 f7                	mov    %esi,%edi
    144c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    144f:	8b 75 c0             	mov    -0x40(%ebp),%esi
    1452:	01 df                	add    %ebx,%edi
    1454:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    1458:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    145b:	83 ec 04             	sub    $0x4,%esp
    145e:	88 45 d7             	mov    %al,-0x29(%ebp)
    1461:	8d 45 d7             	lea    -0x29(%ebp),%eax
    1464:	6a 01                	push   $0x1
    1466:	50                   	push   %eax
    1467:	56                   	push   %esi
    1468:	e8 c6 fe ff ff       	call   1333 <write>
  while(--i >= 0)
    146d:	89 f8                	mov    %edi,%eax
    146f:	83 c4 10             	add    $0x10,%esp
    1472:	83 ef 01             	sub    $0x1,%edi
    1475:	39 c3                	cmp    %eax,%ebx
    1477:	75 df                	jne    1458 <printint+0x68>
}
    1479:	8d 65 f4             	lea    -0xc(%ebp),%esp
    147c:	5b                   	pop    %ebx
    147d:	5e                   	pop    %esi
    147e:	5f                   	pop    %edi
    147f:	5d                   	pop    %ebp
  ...
  neg = 0;
    ...
    148a:	eb 89                	jmp    1415 <printint+0x25>
...
{
    149c:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    149f:	0f b6 1e             	movzbl (%esi),%ebx
    14a2:	83 c6 01             	add    $0x1,%esi
    14a5:	84 db                	test   %bl,%bl
    14a7:	74 67                	je     1510 <printf+0x80>
    14a9:	8d 4d 10             	lea    0x10(%ebp),%ecx
    14ac:	31 d2                	xor    %edx,%edx
    14ae:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    14b1:	eb 34                	jmp    14e7 <printf+0x57>
    14b3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    14b8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    14bb:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    14c0:	83 f8 25             	cmp    $0x25,%eax
    14c3:	74 18                	je     14dd <printf+0x4d>
  write(fd, &c, 1);
    14c5:	83 ec 04             	sub    $0x4,%esp
    14c8:	8d 45 e7             	lea    -0x19(%ebp),%eax
    14cb:	88 5d e7             	mov    %bl,-0x19(%ebp)
    14ce:	6a 01                	push   $0x1
    14d0:	50                   	push   %eax
    14d1:	57                   	push   %edi
    14d2:	e8 5c fe ff ff       	call   1333 <write>
    14d7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    14da:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    14dd:	0f b6 1e             	movzbl (%esi),%ebx
    14e0:	83 c6 01             	add    $0x1,%esi
    14e3:	84 db                	test   %bl,%bl
    14e5:	74 29                	je     1510 <printf+0x80>
    c = fmt[i] & 0xff;
    14e7:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    14ea:	85 d2                	test   %edx,%edx
    14ec:	74 ca                	je     14b8 <printf+0x28>
      }
    } else if(state == '%'){
    14ee:	83 fa 25             	cmp    $0x25,%edx
    14f1:	75 ea                	jne    14dd <printf+0x4d>
      if(c == 'd'){
    14f3:	83 f8 25             	cmp    $0x25,%eax
    14f6:	0f 84 04 01 00 00    	je     1600 <printf+0x170>
    14fc:	83 e8 63             	sub    $0x63,%eax
    14ff:	83 f8 15             	cmp    $0x15,%eax
    1502:	77 1c                	ja     1520 <printf+0x90>
    1504:	ff 24 85 94 18 00 00 	jmp    *0x1894(,%eax,4)
    150b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
    ...
    1516:	5d                   	pop    %ebp
    1517:	c3                   	ret
    1518:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    151f:	00 
  write(fd, &c, 1);
    1520:	83 ec 04             	sub    $0x4,%esp
    1523:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1526:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    152a:	6a 01                	push   $0x1
    152c:	52                   	push   %edx
    152d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    1530:	57                   	push   %edi
    1531:	e8 fd fd ff ff       	call   1333 <write>
    1536:	83 c4 0c             	add    $0xc,%esp
    1539:	88 5d e7             	mov    %bl,-0x19(%ebp)
    153c:	6a 01                	push   $0x1
    153e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    1541:	52                   	push   %edx
    1542:	57                   	push   %edi
    1543:	e8 eb fd ff ff       	call   1333 <write>
        putc(fd, c);
    1548:	83 c4 10             	add    $0x10,%esp
      state = 0;
    154b:	31 d2                	xor    %edx,%edx
    154d:	eb 8e                	jmp    14dd <printf+0x4d>
    154f:	90                   	nop
        printint(fd, *ap, 16, 0);
    1550:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1553:	83 ec 0c             	sub    $0xc,%esp
    1556:	b9 10 00 00 00       	mov    $0x10,%ecx
    155b:	8b 13                	mov    (%ebx),%edx
    155d:	6a 00                	push   $0x0
    155f:	89 f8                	mov    %edi,%eax
        ap++;
    1561:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    1564:	e8 87 fe ff ff       	call   13f0 <printint>
        ap++;
    1569:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    156c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    156f:	31 d2                	xor    %edx,%edx
    1571:	e9 67 ff ff ff       	jmp    14dd <printf+0x4d>
        s = (char*)*ap;
    1576:	8b 45 d0             	mov    -0x30(%ebp),%eax
    1579:	8b 18                	mov    (%eax),%ebx
        ap++;
    157b:	83 c0 04             	add    $0x4,%eax
    157e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    1581:	85 db                	test   %ebx,%ebx
    1583:	0f 84 87 00 00 00    	je     1610 <printf+0x180>
        while(*s != 0){
    1589:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    158c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    158e:	84 c0                	test   %al,%al
    1590:	0f 84 47 ff ff ff    	je     14dd <printf+0x4d>
    1596:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1599:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    159c:	89 de                	mov    %ebx,%esi
    159e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
    15a0:	83 ec 04             	sub    $0x4,%esp
    15a3:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
  ...
  write(fd, &c, 1);
    ...
    15ab:	53                   	push   %ebx
    15ac:	57                   	push   %edi
    15ad:	e8 81 fd ff ff       	call   1333 <write>
        while(*s != 0){
    15b2:	0f b6 06             	movzbl (%esi),%eax
    15b5:	83 c4 10             	add    $0x10,%esp
    15b8:	84 c0                	test   %al,%al
    15ba:	75 e4                	jne    15a0 <printf+0x110>
      state = 0;
    15bc:	8b 75 d4             	mov    -0x2c(%ebp),%esi
    15bf:	31 d2                	xor    %edx,%edx
    15c1:	e9 17 ff ff ff       	jmp    14dd <printf+0x4d>
        printint(fd, *ap, 10, 1);
    15c6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    15c9:	83 ec 0c             	sub    $0xc,%esp
    15cc:	b9 0a 00 00 00       	mov    $0xa,%ecx
    15d1:	8b 13                	mov    (%ebx),%edx
    15d3:	6a 01                	push   $0x1
    15d5:	eb 88                	jmp    155f <printf+0xcf>
        putc(fd, *ap);
    15d7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    15da:	83 ec 04             	sub    $0x4,%esp
    15dd:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    15e0:	8b 03                	mov    (%ebx),%eax
        ap++;
    15e2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    15e5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    15e8:	6a 01                	push   $0x1
    15ea:	52                   	push   %edx
    15eb:	57                   	push   %edi
    15ec:	e8 42 fd ff ff       	call   1333 <write>
        ap++;
    15f1:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    15f4:	83 c4 10             	add    $0x10,%esp
      state = 0;
    15f7:	31 d2                	xor    %edx,%edx
    15f9:	e9 df fe ff ff       	jmp    14dd <printf+0x4d>
  ...
  write(fd, &c, 1);
    ...
    1609:	6a 01                	push   $0x1
    160b:	e9 31 ff ff ff       	jmp    1541 <printf+0xb1>
    1610:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1615:	bb 5a 18 00 00       	mov    $0x185a,%ebx
    161a:	e9 77 ff ff ff       	jmp    1596 <printf+0x106>
    161f:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1621:	a1 24 20 00 00       	mov    0x2024,%eax
{
  ...
  freep = p;
    ...
    165f:	5b                   	pop    %ebx
  freep = p;
    1660:	a3 24 20 00 00       	mov    %eax,0x2024
}
    1665:	5e                   	pop    %esi
    1666:	5f                   	pop    %edi
    1667:	5d                   	pop    %ebp
    ...
    1676:	72 ce                	jb     1646 <free+0x26>
{
  ...
  freep = p;
    169a:	a3 24 20 00 00       	mov    %eax,0x2024
    p->s.size += bp->s.size;
    169f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    16a2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    16a5:	89 08                	mov    %ecx,(%eax)
}
    16a7:	5b                   	pop    %ebx
    16a8:	5e                   	pop    %esi
    16a9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16bc:	8b 15 24 20 00 00    	mov    0x2024,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16fb:	3b 05 24 20 00 00    	cmp    0x2024,%eax
    1701:	75 ed                	jne    16f0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1703:	83 ec 0c             	sub    $0xc,%esp
    1706:	56                   	push   %esi
    1707:	e8 8f fc ff ff       	call   139b <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    1723:	8b 15 24 20 00 00    	mov    0x2024,%edx
    ...
    174c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    174f:	89 15 24 20 00 00    	mov    %edx,0x2024
}
    ...
    175f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1760:	c7 05 24 20 00 00 28 	movl   $0x2028,0x2024
    1767:	20 00 00 
    base.s.size = 0;
    176a:	b8 28 20 00 00       	mov    $0x2028,%eax
    base.s.ptr = freep = prevp = &base;
    176f:	c7 05 28 20 00 00 28 	movl   $0x2028,0x2028
    1776:	20 00 00 
    base.s.size = 0;
    1779:	c7 05 2c 20 00 00 00 	movl   $0x0,0x202c
    1780:	00 00 00 
    if(p->s.size >= nunits){
    1783:	e9 54 ff ff ff       	jmp    16dc <malloc+0x2c>
    1788:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    178f:	00 
        prevp->s.ptr = p->s.ptr;
