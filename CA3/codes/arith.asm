...
free(void *ap)
{
 ...
 5a1:	a1 18 0a 00 00       	mov    0xa18,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 18 0a 00 00       	mov    %eax,0xa18
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 18 0a 00 00       	mov    %eax,0xa18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 18 0a 00 00    	mov    0xa18,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	3b 05 18 0a 00 00    	cmp    0xa18,%eax
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 18 0a 00 00    	mov    0xa18,%edx
 ...
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 1c 0a 00 00       	mov    $0xa1c,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 1c 0a 00 00 1c 	movl   $0xa1c,0xa1c
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 20 0a 00 00 00 	movl   $0x0,0xa20
 700:	00 00 00 
    if(p->s.size >= nunits){
