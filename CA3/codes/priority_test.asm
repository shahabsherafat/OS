...
main(int argc, char **argv)
{
  ...
  1b:	75 0f                	jne    2c <main+0x2c>
    cpu_intensive("LOW");
  1d:	b8 db 07 00 00       	mov    $0x7db,%eax
  ...
  37:	75 0f                	jne    48 <main+0x48>
    cpu_intensive("HIGH");
  39:	b8 df 07 00 00       	mov    $0x7df,%eax
 ...
 4c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 640:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 645:	bb e4 07 00 00       	mov    $0x7e4,%ebx
 ...
 651:	a1 4c 0b 00 00       	mov    0xb4c,%eax
{
 ...
 68f:	5b                   	pop    %ebx
  freep = p;
 690:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 697:	5d                   	pop    %ebp
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 4c 0b 00 00       	mov    %eax,0xb4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	3b 05 4c 0b 00 00    	cmp    0xb4c,%eax
 ...
 74e:	e8 fd fe ff ff       	call   650 <free>
  return freep;
 753:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
 ...
 78f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 50 0b 00 00       	mov    $0xb50,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 7b0:	00 00 00 
    if(p->s.size >= nunits){
