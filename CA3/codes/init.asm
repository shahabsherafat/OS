 ...
 448:	89 d1                	mov    %edx,%ecx
{
 ...
 47b:	0f b6 92 e4 08 00 00 	movzbl 0x8e4(%edx),%edx
 ...
 4e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 554:	ff 24 85 8c 08 00 00 	jmp    *0x88c(,%eax,4)
...
free(void *ap)
{
 ...
 671:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 6af:	5b                   	pop    %ebx
  freep = p;
 6b0:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 6b7:	5d                   	pop    %ebp
 ...
 6c6:	72 ce                	jb     696 <free+0x26>
{
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 8c 0b 00 00    	mov    0xb8c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74b:	3b 05 8c 0b 00 00    	cmp    0xb8c,%eax
 ...
 76e:	e8 fd fe ff ff       	call   670 <free>
  return freep;
 773:	8b 15 8c 0b 00 00    	mov    0xb8c,%edx
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	b8 90 0b 00 00       	mov    $0xb90,%eax
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 90 0b 00 00 90 	movl   $0xb90,0xb90
 7c6:	0b 00 00 
    base.s.size = 0;
 7c9:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 7d0:	00 00 00 
    if(p->s.size >= nunits){
