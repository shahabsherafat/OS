 ...
 4d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 544:	ff 24 85 7c 08 00 00 	jmp    *0x87c(,%eax,4)
...
free(void *ap)
{
 ...
 661:	a1 7c 0b 00 00       	mov    0xb7c,%eax
{
 ...
 69f:	5b                   	pop    %ebx
  freep = p;
 6a0:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 6a7:	5d                   	pop    %ebp
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 7c 0b 00 00       	mov    %eax,0xb7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73b:	3b 05 7c 0b 00 00    	cmp    0xb7c,%eax
 ...
 75e:	e8 fd fe ff ff       	call   660 <free>
  return freep;
 763:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
 ...
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	b8 80 0b 00 00       	mov    $0xb80,%eax
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 80 0b 00 00 80 	movl   $0xb80,0xb80
 7b6:	0b 00 00 
    base.s.size = 0;
 7b9:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 7c0:	00 00 00 
    if(p->s.size >= nunits){
