...
80100292:	89 df                	mov    %ebx,%edi
  iunlock(ip);
80100294:	e8 77 1b 00 00       	call   80101e10 <iunlock>
  acquire(&cons.lock);
...
801002ff:	e8 2c 1a 00 00       	call   80101d30 <ilock>
        return -1;
...
80100355:	e8 d6 19 00 00       	call   80101d30 <ilock>
  return target - n;
...
80100399:	e8 c2 2a 00 00       	call   80102e60 <lapicid>
8010039e:	83 ec 08             	sub    $0x8,%esp
801003a1:	50                   	push   %eax
801003a2:	68 2d 77 10 80       	push   $0x8010772d
801003a7:	e8 b4 03 00 00       	call   80100760 <cprintf>
  cprintf(s);
801003ac:	58                   	pop    %eax
801003ad:	ff 75 08             	push   0x8(%ebp)
801003b0:	e8 ab 03 00 00       	call   80100760 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 af 7b 10 80 	movl   $0x80107baf,(%esp)
801003bc:	e8 9f 03 00 00       	call   80100760 <cprintf>
  getcallerpcs(&s, pcs);
...
801003dd:	e8 7e 03 00 00       	call   80100760 <cprintf>
  for(i=0; i<10; i++)
...
80100415:	89 55 e4             	mov    %edx,-0x1c(%ebp)
...
8010042d:	c1 e3 08             	shl    $0x8,%ebx
80100430:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80100431:	89 f2                	mov    %esi,%edx
80100433:	ec                   	in     (%dx),%al
  pos |= inb(CRTPORT+1);
80100434:	0f b6 f0             	movzbl %al,%esi
80100437:	09 de                	or     %ebx,%esi
  if(c == '\n'){
80100439:	83 f9 0a             	cmp    $0xa,%ecx
8010043c:	74 62                	je     801004a0 <cgaputc+0xa0>
  else if(c == BACKSPACE){
8010043e:	81 f9 00 01 00 00    	cmp    $0x100,%ecx
80100444:	74 3a                	je     80100480 <cgaputc+0x80>
  else if(c == KEY_LF){
80100446:	81 f9 e4 00 00 00    	cmp    $0xe4,%ecx
8010044c:	0f 84 e6 00 00 00    	je     80100538 <cgaputc+0x138>
  else if(c == KEY_RT){
80100452:	81 f9 e5 00 00 00    	cmp    $0xe5,%ecx
80100458:	0f 84 f2 00 00 00    	je     80100550 <cgaputc+0x150>
    crt[pos++] = (c&0xff) | 0x0700;
8010045e:	0f b6 c9             	movzbl %cl,%ecx
80100461:	8d 5e 01             	lea    0x1(%esi),%ebx
    crt[pos]   = ' ' | 0x0700;
80100464:	b8 20 07 00 00       	mov    $0x720,%eax
    crt[pos++] = (c&0xff) | 0x0700;
80100469:	01 f6                	add    %esi,%esi
8010046b:	80 cd 07             	or     $0x7,%ch
    crt[pos]   = ' ' | 0x0700;
8010046e:	66 89 86 02 80 0b 80 	mov    %ax,-0x7ff47ffe(%esi)
    crt[pos++] = (c&0xff) | 0x0700;
80100475:	66 89 8e 00 80 0b 80 	mov    %cx,-0x7ff48000(%esi)
    crt[pos]   = ' ' | 0x0700;
8010047c:	eb 35                	jmp    801004b3 <cgaputc+0xb3>
8010047e:	66 90                	xchg   %ax,%ax
    if(pos > 0){
80100480:	85 f6                	test   %esi,%esi
80100482:	0f 84 bb 00 00 00    	je     80100543 <cgaputc+0x143>
      --pos;
80100488:	8d 5e ff             	lea    -0x1(%esi),%ebx
      crt[pos] = ' ' | 0x0700;
8010048b:	ba 20 07 00 00       	mov    $0x720,%edx
80100490:	66 89 94 1b 00 80 0b 	mov    %dx,-0x7ff48000(%ebx,%ebx,1)
80100497:	80 
80100498:	eb 19                	jmp    801004b3 <cgaputc+0xb3>
8010049a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pos += 80 - pos%80;
801004a0:	b8 cd cc cc cc       	mov    $0xcccccccd,%eax
801004a5:	f7 e6                	mul    %esi
801004a7:	c1 ea 06             	shr    $0x6,%edx
801004aa:	8d 04 92             	lea    (%edx,%edx,4),%eax
801004ad:	c1 e0 04             	shl    $0x4,%eax
801004b0:	8d 58 50             	lea    0x50(%eax),%ebx
  if(pos < 0 || pos > 25*80)
801004b3:	81 fb d0 07 00 00    	cmp    $0x7d0,%ebx
801004b9:	0f 8f c7 00 00 00    	jg     80100586 <cgaputc+0x186>
  outb(CRTPORT+1, pos>>8);
801004bf:	0f b6 f7             	movzbl %bh,%esi
  if((pos/80) >= 24){
801004c2:	81 fb 7f 07 00 00    	cmp    $0x77f,%ebx
801004c8:	7e 3e                	jle    80100508 <cgaputc+0x108>
    memmove(crt, crt+80, sizeof(crt[0])*23*80);
801004ca:	83 ec 04             	sub    $0x4,%esp
    pos -= 80;
801004cd:	83 eb 50             	sub    $0x50,%ebx
  outb(CRTPORT+1, pos);
801004d0:	be 07 00 00 00       	mov    $0x7,%esi
    memmove(crt, crt+80, sizeof(crt[0])*23*80);
801004d5:	68 60 0e 00 00       	push   $0xe60
801004da:	68 a0 80 0b 80       	push   $0x800b80a0
801004df:	68 00 80 0b 80       	push   $0x800b8000
801004e4:	e8 d7 47 00 00       	call   80104cc0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
801004e9:	b8 80 07 00 00       	mov    $0x780,%eax
801004ee:	83 c4 0c             	add    $0xc,%esp
801004f1:	29 d8                	sub    %ebx,%eax
801004f3:	01 c0                	add    %eax,%eax
801004f5:	50                   	push   %eax
801004f6:	8d 84 1b 00 80 0b 80 	lea    -0x7ff48000(%ebx,%ebx,1),%eax
801004fd:	6a 00                	push   $0x0
801004ff:	50                   	push   %eax
80100500:	e8 2b 47 00 00       	call   80104c30 <memset>
  outb(CRTPORT+1, pos);
80100505:	83 c4 10             	add    $0x10,%esp
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80100508:	bf d4 03 00 00       	mov    $0x3d4,%edi
8010050d:	b8 0e 00 00 00       	mov    $0xe,%eax
80100512:	89 fa                	mov    %edi,%edx
80100514:	ee                   	out    %al,(%dx)
80100515:	b9 d5 03 00 00       	mov    $0x3d5,%ecx
8010051a:	89 f0                	mov    %esi,%eax
8010051c:	89 ca                	mov    %ecx,%edx
8010051e:	ee                   	out    %al,(%dx)
8010051f:	b8 0f 00 00 00       	mov    $0xf,%eax
80100524:	89 fa                	mov    %edi,%edx
80100526:	ee                   	out    %al,(%dx)
80100527:	89 d8                	mov    %ebx,%eax
80100529:	89 ca                	mov    %ecx,%edx
8010052b:	ee                   	out    %al,(%dx)
}
8010052c:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010052f:	5b                   	pop    %ebx
80100530:	5e                   	pop    %esi
80100531:	5f                   	pop    %edi
80100532:	5d                   	pop    %ebp
...
80100534:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      --pos;
80100538:	8d 5e ff             	lea    -0x1(%esi),%ebx
    if(pos > 0)
8010053b:	85 f6                	test   %esi,%esi
8010053d:	0f 85 70 ff ff ff    	jne    801004b3 <cgaputc+0xb3>
80100543:	31 db                	xor    %ebx,%ebx
80100545:	31 f6                	xor    %esi,%esi
80100547:	eb bf                	jmp    80100508 <cgaputc+0x108>
80100549:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(pos % 80 < 79){
80100550:	b8 cd cc cc cc       	mov    $0xcccccccd,%eax
  pos |= inb(CRTPORT+1);
80100555:	89 f3                	mov    %esi,%ebx
    if(pos % 80 < 79){
80100557:	f7 e6                	mul    %esi
80100559:	c1 ea 06             	shr    $0x6,%edx
8010055c:	8d 04 92             	lea    (%edx,%edx,4),%eax
8010055f:	89 f2                	mov    %esi,%edx
80100561:	c1 e0 04             	shl    $0x4,%eax
80100564:	29 c2                	sub    %eax,%edx
80100566:	83 fa 4f             	cmp    $0x4f,%edx
80100569:	0f 84 44 ff ff ff    	je     801004b3 <cgaputc+0xb3>
      crt[pos++] = (k&0xff) | 0x0700;
8010056f:	0f b6 45 e4          	movzbl -0x1c(%ebp),%eax
80100573:	83 c3 01             	add    $0x1,%ebx
80100576:	80 cc 07             	or     $0x7,%ah
80100579:	66 89 84 36 00 80 0b 	mov    %ax,-0x7ff48000(%esi,%esi,1)
80100580:	80 
80100581:	e9 2d ff ff ff       	jmp    801004b3 <cgaputc+0xb3>
    panic("pos under/overflow");
80100586:	83 ec 0c             	sub    $0xc,%esp
80100589:	68 45 77 10 80       	push   $0x80107745
8010058e:	e8 ed fd ff ff       	call   80100380 <panic>
80100593:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010059a:	00 
8010059b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

801005a0 <consputc.part.0>:
consputc(int c, int k)
801005a0:	55                   	push   %ebp
801005a1:	89 e5                	mov    %esp,%ebp
801005a3:	56                   	push   %esi
801005a4:	89 d6                	mov    %edx,%esi
801005a6:	53                   	push   %ebx
801005a7:	89 c3                	mov    %eax,%ebx
  if(c == BACKSPACE){
801005a9:	3d 00 01 00 00       	cmp    $0x100,%eax
801005ae:	74 50                	je     80100600 <consputc.part.0+0x60>
  else if(c == KEY_LF){
801005b0:	3d e4 00 00 00       	cmp    $0xe4,%eax
801005b5:	0f 84 7d 00 00 00    	je     80100638 <consputc.part.0+0x98>
  else if(c == KEY_RT){
801005bb:	3d e5 00 00 00       	cmp    $0xe5,%eax
801005c0:	74 1e                	je     801005e0 <consputc.part.0+0x40>
    uartputc(c);
801005c2:	83 ec 0c             	sub    $0xc,%esp
801005c5:	50                   	push   %eax
801005c6:	e8 75 5c 00 00       	call   80106240 <uartputc>
801005cb:	83 c4 10             	add    $0x10,%esp
}
801005ce:	8d 65 f8             	lea    -0x8(%ebp),%esp
  cgaputc(c, k);
801005d1:	89 f2                	mov    %esi,%edx
...
801005d7:	5d                   	pop    %ebp
  cgaputc(c, k);
801005d8:	e9 23 fe ff ff       	jmp    80100400 <cgaputc>
801005dd:	8d 76 00             	lea    0x0(%esi),%esi
    uartputc(k);
801005e0:	83 ec 0c             	sub    $0xc,%esp
801005e3:	52                   	push   %edx
801005e4:	e8 57 5c 00 00       	call   80106240 <uartputc>
801005e9:	83 c4 10             	add    $0x10,%esp
}
801005ec:	8d 65 f8             	lea    -0x8(%ebp),%esp
  cgaputc(c, k);
801005ef:	89 f2                	mov    %esi,%edx
...
801005f5:	5d                   	pop    %ebp
  cgaputc(c, k);
801005f6:	e9 05 fe ff ff       	jmp    80100400 <cgaputc>
801005fb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    uartputc('\b'); uartputc(' '); uartputc('\b');
80100600:	83 ec 0c             	sub    $0xc,%esp
80100603:	6a 08                	push   $0x8
80100605:	e8 36 5c 00 00       	call   80106240 <uartputc>
8010060a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100611:	e8 2a 5c 00 00       	call   80106240 <uartputc>
80100616:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010061d:	e8 1e 5c 00 00       	call   80106240 <uartputc>
80100622:	83 c4 10             	add    $0x10,%esp
}
80100625:	8d 65 f8             	lea    -0x8(%ebp),%esp
  cgaputc(c, k);
80100628:	89 f2                	mov    %esi,%edx
8010062a:	89 d8                	mov    %ebx,%eax
}
8010062c:	5b                   	pop    %ebx
8010062d:	5e                   	pop    %esi
8010062e:	5d                   	pop    %ebp
  cgaputc(c, k);
8010062f:	e9 cc fd ff ff       	jmp    80100400 <cgaputc>
80100634:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartputc('\b');
80100638:	83 ec 0c             	sub    $0xc,%esp
8010063b:	6a 08                	push   $0x8
8010063d:	e8 fe 5b 00 00       	call   80106240 <uartputc>
80100642:	83 c4 10             	add    $0x10,%esp
}
80100645:	8d 65 f8             	lea    -0x8(%ebp),%esp
  cgaputc(c, k);
80100648:	89 f2                	mov    %esi,%edx
8010064a:	89 d8                	mov    %ebx,%eax
}
8010064c:	5b                   	pop    %ebx
8010064d:	5e                   	pop    %esi
8010064e:	5d                   	pop    %ebp
  cgaputc(c, k);
8010064f:	e9 ac fd ff ff       	jmp    80100400 <cgaputc>
80100654:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010065b:	00 
...
801006a5:	e8 f6 fe ff ff       	call   801005a0 <consputc.part.0>
...
801006fb:	0f b6 92 00 7c 10 80 	movzbl -0x7fef8400(%edx),%edx
...
8010073a:	e8 61 fe ff ff       	call   801005a0 <consputc.part.0>
  while(--i >= 0)
...
80100774:	0f 85 16 01 00 00    	jne    80100890 <cprintf+0x130>
  if (fmt == 0)
8010077a:	85 f6                	test   %esi,%esi
8010077c:	0f 84 fd 01 00 00    	je     8010097f <cprintf+0x21f>
...
801007a4:	0f 84 c6 00 00 00    	je     80100870 <cprintf+0x110>
...
801007dc:	0f 85 d1 00 00 00    	jne    801008b3 <cprintf+0x153>
}
...
80100805:	e8 96 fd ff ff       	call   801005a0 <consputc.part.0>
      continue;
...
80100817:	0f 84 23 01 00 00    	je     80100940 <cprintf+0x1e0>
8010081d:	fa                   	cli
    for(;;)
8010081e:	eb fe                	jmp    8010081e <cprintf+0xbe>
    switch(c){
80100820:	83 ff 73             	cmp    $0x73,%edi
80100823:	0f 84 9f 00 00 00    	je     801008c8 <cprintf+0x168>
80100829:	83 ff 78             	cmp    $0x78,%edi
8010082c:	74 42                	je     80100870 <cprintf+0x110>
  if(panicked){
8010082e:	8b 15 58 ff 10 80    	mov    0x8010ff58,%edx
80100834:	85 d2                	test   %edx,%edx
80100836:	0f 85 f8 00 00 00    	jne    80100934 <cprintf+0x1d4>
    uartputc(c);
8010083c:	83 ec 0c             	sub    $0xc,%esp
8010083f:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80100842:	6a 25                	push   $0x25
80100844:	e8 f7 59 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100849:	31 d2                	xor    %edx,%edx
8010084b:	b8 25 00 00 00       	mov    $0x25,%eax
80100850:	e8 ab fb ff ff       	call   80100400 <cgaputc>
  if(panicked){
80100855:	a1 58 ff 10 80       	mov    0x8010ff58,%eax
8010085a:	83 c4 10             	add    $0x10,%esp
8010085d:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80100860:	85 c0                	test   %eax,%eax
80100862:	0f 84 fc 00 00 00    	je     80100964 <cprintf+0x204>
80100868:	fa                   	cli
    for(;;)
80100869:	eb fe                	jmp    80100869 <cprintf+0x109>
8010086b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      printint(*argp++, 16, 0);
80100870:	8b 01                	mov    (%ecx),%eax
80100872:	8d 79 04             	lea    0x4(%ecx),%edi
80100875:	ba 10 00 00 00       	mov    $0x10,%edx
8010087a:	31 c9                	xor    %ecx,%ecx
8010087c:	e8 4f fe ff ff       	call   801006d0 <printint>
80100881:	89 f9                	mov    %edi,%ecx
      break;
80100883:	e9 44 ff ff ff       	jmp    801007cc <cprintf+0x6c>
80100888:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010088f:	00 
    acquire(&cons.lock);
80100890:	83 ec 0c             	sub    $0xc,%esp
80100893:	68 20 ff 10 80       	push   $0x8010ff20
80100898:	e8 93 42 00 00       	call   80104b30 <acquire>
  if (fmt == 0)
8010089d:	83 c4 10             	add    $0x10,%esp
801008a0:	85 f6                	test   %esi,%esi
801008a2:	0f 84 d7 00 00 00    	je     8010097f <cprintf+0x21f>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
801008a8:	0f b6 06             	movzbl (%esi),%eax
801008ab:	85 c0                	test   %eax,%eax
801008ad:	0f 85 d6 fe ff ff    	jne    80100789 <cprintf+0x29>
    release(&cons.lock);
801008b3:	83 ec 0c             	sub    $0xc,%esp
801008b6:	68 20 ff 10 80       	push   $0x8010ff20
801008bb:	e8 10 42 00 00       	call   80104ad0 <release>
801008c0:	83 c4 10             	add    $0x10,%esp
801008c3:	e9 1a ff ff ff       	jmp    801007e2 <cprintf+0x82>
      if((s = (char*)*argp++) == 0)
801008c8:	8b 39                	mov    (%ecx),%edi
801008ca:	8d 51 04             	lea    0x4(%ecx),%edx
801008cd:	85 ff                	test   %edi,%edi
801008cf:	74 27                	je     801008f8 <cprintf+0x198>
      for(; *s; s++)
801008d1:	0f be 07             	movsbl (%edi),%eax
801008d4:	84 c0                	test   %al,%al
801008d6:	0f 84 9c 00 00 00    	je     80100978 <cprintf+0x218>
801008dc:	89 5d e0             	mov    %ebx,-0x20(%ebp)
801008df:	89 fb                	mov    %edi,%ebx
801008e1:	89 f7                	mov    %esi,%edi
801008e3:	89 d6                	mov    %edx,%esi
  if(panicked){
801008e5:	8b 15 58 ff 10 80    	mov    0x8010ff58,%edx
801008eb:	85 d2                	test   %edx,%edx
801008ed:	74 26                	je     80100915 <cprintf+0x1b5>
801008ef:	fa                   	cli
    for(;;)
801008f0:	eb fe                	jmp    801008f0 <cprintf+0x190>
801008f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        s = "(null)";
801008f8:	bf 58 77 10 80       	mov    $0x80107758,%edi
801008fd:	89 5d e0             	mov    %ebx,-0x20(%ebp)
80100900:	b8 28 00 00 00       	mov    $0x28,%eax
80100905:	89 fb                	mov    %edi,%ebx
80100907:	89 f7                	mov    %esi,%edi
80100909:	89 d6                	mov    %edx,%esi
  if(panicked){
8010090b:	8b 15 58 ff 10 80    	mov    0x8010ff58,%edx
80100911:	85 d2                	test   %edx,%edx
80100913:	75 da                	jne    801008ef <cprintf+0x18f>
80100915:	31 d2                	xor    %edx,%edx
      for(; *s; s++)
80100917:	83 c3 01             	add    $0x1,%ebx
8010091a:	e8 81 fc ff ff       	call   801005a0 <consputc.part.0>
8010091f:	0f be 03             	movsbl (%ebx),%eax
80100922:	84 c0                	test   %al,%al
80100924:	75 bf                	jne    801008e5 <cprintf+0x185>
      if((s = (char*)*argp++) == 0)
80100926:	89 f2                	mov    %esi,%edx
80100928:	8b 5d e0             	mov    -0x20(%ebp),%ebx
8010092b:	89 fe                	mov    %edi,%esi
8010092d:	89 d1                	mov    %edx,%ecx
8010092f:	e9 98 fe ff ff       	jmp    801007cc <cprintf+0x6c>
80100934:	fa                   	cli
    for(;;)
80100935:	eb fe                	jmp    80100935 <cprintf+0x1d5>
80100937:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010093e:	00 
8010093f:	90                   	nop
    uartputc(c);
80100940:	83 ec 0c             	sub    $0xc,%esp
80100943:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80100946:	6a 25                	push   $0x25
80100948:	e8 f3 58 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
8010094d:	31 d2                	xor    %edx,%edx
8010094f:	b8 25 00 00 00       	mov    $0x25,%eax
80100954:	e8 a7 fa ff ff       	call   80100400 <cgaputc>
}
80100959:	8b 4d e0             	mov    -0x20(%ebp),%ecx
8010095c:	83 c4 10             	add    $0x10,%esp
8010095f:	e9 68 fe ff ff       	jmp    801007cc <cprintf+0x6c>
80100964:	31 d2                	xor    %edx,%edx
80100966:	89 f8                	mov    %edi,%eax
80100968:	89 4d e0             	mov    %ecx,-0x20(%ebp)
8010096b:	e8 30 fc ff ff       	call   801005a0 <consputc.part.0>
      break;
80100970:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80100973:	e9 54 fe ff ff       	jmp    801007cc <cprintf+0x6c>
      if((s = (char*)*argp++) == 0)
80100978:	89 d1                	mov    %edx,%ecx
8010097a:	e9 4d fe ff ff       	jmp    801007cc <cprintf+0x6c>
    panic("null fmt");
8010097f:	83 ec 0c             	sub    $0xc,%esp
80100982:	68 5f 77 10 80       	push   $0x8010775f
80100987:	e8 f4 f9 ff ff       	call   80100380 <panic>
...
80100994:	56                   	push   %esi
  int c, doprocdump = 0;
80100995:	31 f6                	xor    %esi,%esi
{
80100997:	53                   	push   %ebx
80100998:	83 ec 28             	sub    $0x28,%esp
8010099b:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&cons.lock);
8010099e:	68 20 ff 10 80       	push   $0x8010ff20
801009a3:	e8 88 41 00 00       	call   80104b30 <acquire>
  while((c = getc()) >= 0){
801009a8:	83 c4 10             	add    $0x10,%esp
801009ab:	ff d7                	call   *%edi
801009ad:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801009b0:	85 c0                	test   %eax,%eax
801009b2:	0f 88 82 01 00 00    	js     80100b3a <consoleintr+0x1aa>
    switch(c){
801009b8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801009bb:	83 f8 7f             	cmp    $0x7f,%eax
801009be:	0f 84 bc 00 00 00    	je     80100a80 <consoleintr+0xf0>
801009c4:	7f 3a                	jg     80100a00 <consoleintr+0x70>
801009c6:	83 f8 10             	cmp    $0x10,%eax
801009c9:	0f 84 59 01 00 00    	je     80100b28 <consoleintr+0x198>
801009cf:	83 f8 15             	cmp    $0x15,%eax
801009d2:	74 6c                	je     80100a40 <consoleintr+0xb0>
801009d4:	83 f8 08             	cmp    $0x8,%eax
801009d7:	0f 84 a3 00 00 00    	je     80100a80 <consoleintr+0xf0>
      if(input.e < input.real_end){
801009dd:	8b 0d 08 ff 10 80    	mov    0x8010ff08,%ecx
801009e3:	8b 15 0c ff 10 80    	mov    0x8010ff0c,%edx
801009e9:	39 d1                	cmp    %edx,%ecx
801009eb:	0f 83 5b 02 00 00    	jae    80100c4c <consoleintr+0x2bc>
        if(c != 0 && input.real_end-input.r < INPUT_BUF){
801009f1:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801009f4:	85 db                	test   %ebx,%ebx
801009f6:	74 b3                	je     801009ab <consoleintr+0x1b>
801009f8:	e9 bd 01 00 00       	jmp    80100bba <consoleintr+0x22a>
801009fd:	8d 76 00             	lea    0x0(%esi),%esi
    switch(c){
80100a00:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80100a03:	3d e4 00 00 00       	cmp    $0xe4,%eax
80100a08:	0f 84 ea 00 00 00    	je     80100af8 <consoleintr+0x168>
80100a0e:	3d e5 00 00 00       	cmp    $0xe5,%eax
80100a13:	0f 85 8d 01 00 00    	jne    80100ba6 <consoleintr+0x216>
      if (input.e < input.real_end){
80100a19:	a1 08 ff 10 80       	mov    0x8010ff08,%eax
80100a1e:	3b 05 0c ff 10 80    	cmp    0x8010ff0c,%eax
80100a24:	73 85                	jae    801009ab <consoleintr+0x1b>
        char ch = input.buf[input.e % INPUT_BUF];
80100a26:	83 e0 7f             	and    $0x7f,%eax
80100a29:	0f be 98 80 fe 10 80 	movsbl -0x7fef0180(%eax),%ebx
  if(panicked){
80100a30:	a1 58 ff 10 80       	mov    0x8010ff58,%eax
80100a35:	85 c0                	test   %eax,%eax
80100a37:	0f 84 d1 02 00 00    	je     80100d0e <consoleintr+0x37e>
80100a3d:	fa                   	cli
    for(;;)
80100a3e:	eb fe                	jmp    80100a3e <consoleintr+0xae>
      while(input.e != input.w &&
80100a40:	a1 08 ff 10 80       	mov    0x8010ff08,%eax
80100a45:	3b 05 04 ff 10 80    	cmp    0x8010ff04,%eax
80100a4b:	0f 84 4b 01 00 00    	je     80100b9c <consoleintr+0x20c>
            input.buf[(input.e-1) % INPUT_BUF] != '\n'){
80100a51:	8d 50 ff             	lea    -0x1(%eax),%edx
80100a54:	89 d1                	mov    %edx,%ecx
80100a56:	83 e1 7f             	and    $0x7f,%ecx
      while(input.e != input.w &&
80100a59:	80 b9 80 fe 10 80 0a 	cmpb   $0xa,-0x7fef0180(%ecx)
80100a60:	0f 84 36 01 00 00    	je     80100b9c <consoleintr+0x20c>
  if(panicked){
80100a66:	a1 58 ff 10 80       	mov    0x8010ff58,%eax
        input.e--;
80100a6b:	89 15 08 ff 10 80    	mov    %edx,0x8010ff08
  if(panicked){
80100a71:	85 c0                	test   %eax,%eax
80100a73:	0f 84 e1 00 00 00    	je     80100b5a <consoleintr+0x1ca>
80100a79:	fa                   	cli
    for(;;)
80100a7a:	eb fe                	jmp    80100a7a <consoleintr+0xea>
80100a7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if (input.e != input.w) {
80100a80:	8b 15 08 ff 10 80    	mov    0x8010ff08,%edx
80100a86:	3b 15 04 ff 10 80    	cmp    0x8010ff04,%edx
80100a8c:	0f 84 19 ff ff ff    	je     801009ab <consoleintr+0x1b>
  if(panicked){
80100a92:	8b 1d 58 ff 10 80    	mov    0x8010ff58,%ebx
        if (input.e == input.real_end) {
80100a98:	8b 0d 0c ff 10 80    	mov    0x8010ff0c,%ecx
          input.e--;
80100a9e:	8d 42 ff             	lea    -0x1(%edx),%eax
80100aa1:	a3 08 ff 10 80       	mov    %eax,0x8010ff08
  if(panicked){
80100aa6:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
          input.real_end--;
80100aa9:	8d 59 ff             	lea    -0x1(%ecx),%ebx
        if (input.e == input.real_end) {
80100aac:	39 ca                	cmp    %ecx,%edx
80100aae:	0f 84 72 01 00 00    	je     80100c26 <consoleintr+0x296>
          for (uint i = input.e; i < input.real_end - 1; i++)
80100ab4:	39 d8                	cmp    %ebx,%eax
80100ab6:	73 26                	jae    80100ade <consoleintr+0x14e>
80100ab8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80100abf:	00 
            input.buf[i % INPUT_BUF] = input.buf[(i + 1) % INPUT_BUF];
80100ac0:	89 c2                	mov    %eax,%edx
80100ac2:	83 c0 01             	add    $0x1,%eax
80100ac5:	89 c1                	mov    %eax,%ecx
80100ac7:	83 e2 7f             	and    $0x7f,%edx
80100aca:	83 e1 7f             	and    $0x7f,%ecx
80100acd:	0f b6 89 80 fe 10 80 	movzbl -0x7fef0180(%ecx),%ecx
80100ad4:	88 8a 80 fe 10 80    	mov    %cl,-0x7fef0180(%edx)
          for (uint i = input.e; i < input.real_end - 1; i++)
80100ada:	39 d8                	cmp    %ebx,%eax
80100adc:	75 e2                	jne    80100ac0 <consoleintr+0x130>
          input.real_end--;
80100ade:	89 1d 0c ff 10 80    	mov    %ebx,0x8010ff0c
  if(panicked){
80100ae4:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80100ae7:	85 db                	test   %ebx,%ebx
80100ae9:	0f 84 c1 01 00 00    	je     80100cb0 <consoleintr+0x320>
80100aef:	fa                   	cli
    for(;;)
80100af0:	eb fe                	jmp    80100af0 <consoleintr+0x160>
80100af2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if (input.e > input.w){
80100af8:	a1 08 ff 10 80       	mov    0x8010ff08,%eax
80100afd:	39 05 04 ff 10 80    	cmp    %eax,0x8010ff04
80100b03:	0f 83 a2 fe ff ff    	jae    801009ab <consoleintr+0x1b>
        input.e--;
80100b09:	83 e8 01             	sub    $0x1,%eax
80100b0c:	a3 08 ff 10 80       	mov    %eax,0x8010ff08
  if(panicked){
80100b11:	a1 58 ff 10 80       	mov    0x8010ff58,%eax
80100b16:	85 c0                	test   %eax,%eax
80100b18:	0f 84 d2 01 00 00    	je     80100cf0 <consoleintr+0x360>
80100b1e:	fa                   	cli
    for(;;)
80100b1f:	eb fe                	jmp    80100b1f <consoleintr+0x18f>
80100b21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  while((c = getc()) >= 0){
80100b28:	ff d7                	call   *%edi
    switch(c){
80100b2a:	be 01 00 00 00       	mov    $0x1,%esi
  while((c = getc()) >= 0){
80100b2f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80100b32:	85 c0                	test   %eax,%eax
80100b34:	0f 89 7e fe ff ff    	jns    801009b8 <consoleintr+0x28>
  release(&cons.lock);
80100b3a:	83 ec 0c             	sub    $0xc,%esp
80100b3d:	68 20 ff 10 80       	push   $0x8010ff20
80100b42:	e8 89 3f 00 00       	call   80104ad0 <release>
  if(doprocdump) {
80100b47:	83 c4 10             	add    $0x10,%esp
80100b4a:	85 f6                	test   %esi,%esi
80100b4c:	0f 85 ee 00 00 00    	jne    80100c40 <consoleintr+0x2b0>
}
80100b52:	8d 65 f4             	lea    -0xc(%ebp),%esp
80100b55:	5b                   	pop    %ebx
80100b56:	5e                   	pop    %esi
80100b57:	5f                   	pop    %edi
80100b58:	5d                   	pop    %ebp
...
80100b5d:	6a 08                	push   $0x8
80100b5f:	e8 dc 56 00 00       	call   80106240 <uartputc>
80100b64:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100b6b:	e8 d0 56 00 00       	call   80106240 <uartputc>
80100b70:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100b77:	e8 c4 56 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100b7c:	b8 00 01 00 00       	mov    $0x100,%eax
80100b81:	31 d2                	xor    %edx,%edx
80100b83:	e8 78 f8 ff ff       	call   80100400 <cgaputc>
      while(input.e != input.w &&
80100b88:	a1 08 ff 10 80       	mov    0x8010ff08,%eax
80100b8d:	83 c4 10             	add    $0x10,%esp
80100b90:	3b 05 04 ff 10 80    	cmp    0x8010ff04,%eax
80100b96:	0f 85 b5 fe ff ff    	jne    80100a51 <consoleintr+0xc1>
      input.real_end = input.e;
80100b9c:	a3 0c ff 10 80       	mov    %eax,0x8010ff0c
      break;
80100ba1:	e9 05 fe ff ff       	jmp    801009ab <consoleintr+0x1b>
      if(input.e < input.real_end){
80100ba6:	8b 0d 08 ff 10 80    	mov    0x8010ff08,%ecx
80100bac:	8b 15 0c ff 10 80    	mov    0x8010ff0c,%edx
80100bb2:	39 d1                	cmp    %edx,%ecx
80100bb4:	0f 83 9d 00 00 00    	jae    80100c57 <consoleintr+0x2c7>
        if(c != 0 && input.real_end-input.r < INPUT_BUF){
80100bba:	89 d0                	mov    %edx,%eax
80100bbc:	2b 05 00 ff 10 80    	sub    0x8010ff00,%eax
80100bc2:	83 f8 7f             	cmp    $0x7f,%eax
80100bc5:	0f 87 e0 fd ff ff    	ja     801009ab <consoleintr+0x1b>
          if(c != '\n' && c != C('D')){
80100bcb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80100bce:	83 f8 0a             	cmp    $0xa,%eax
80100bd1:	0f 84 05 02 00 00    	je     80100ddc <consoleintr+0x44c>
80100bd7:	83 f8 04             	cmp    $0x4,%eax
80100bda:	0f 85 24 02 00 00    	jne    80100e04 <consoleintr+0x474>
          if(c == '\n' || c == C('D') || input.real_end == input.r+INPUT_BUF){
80100be0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80100be3:	83 f8 0a             	cmp    $0xa,%eax
80100be6:	0f 84 f0 01 00 00    	je     80100ddc <consoleintr+0x44c>
80100bec:	83 f8 04             	cmp    $0x4,%eax
80100bef:	0f 84 e7 01 00 00    	je     80100ddc <consoleintr+0x44c>
80100bf5:	a1 00 ff 10 80       	mov    0x8010ff00,%eax
80100bfa:	83 e8 80             	sub    $0xffffff80,%eax
80100bfd:	39 d0                	cmp    %edx,%eax
80100bff:	0f 85 a6 fd ff ff    	jne    801009ab <consoleintr+0x1b>
            input.e = input.real_end;
80100c05:	89 15 08 ff 10 80    	mov    %edx,0x8010ff08
            wakeup(&input.r);
80100c0b:	83 ec 0c             	sub    $0xc,%esp
            input.w = input.e;
80100c0e:	89 15 04 ff 10 80    	mov    %edx,0x8010ff04
            wakeup(&input.r);
80100c14:	68 00 ff 10 80       	push   $0x8010ff00
80100c19:	e8 52 3a 00 00       	call   80104670 <wakeup>
80100c1e:	83 c4 10             	add    $0x10,%esp
80100c21:	e9 85 fd ff ff       	jmp    801009ab <consoleintr+0x1b>
  if(panicked){
80100c26:	8b 45 e4             	mov    -0x1c(%ebp),%eax
          input.real_end--;
80100c29:	89 1d 0c ff 10 80    	mov    %ebx,0x8010ff0c
  if(panicked){
80100c2f:	85 c0                	test   %eax,%eax
80100c31:	0f 84 21 01 00 00    	je     80100d58 <consoleintr+0x3c8>
80100c37:	fa                   	cli
    for(;;)
80100c38:	eb fe                	jmp    80100c38 <consoleintr+0x2a8>
80100c3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
}
80100c40:	8d 65 f4             	lea    -0xc(%ebp),%esp
80100c43:	5b                   	pop    %ebx
80100c44:	5e                   	pop    %esi
80100c45:	5f                   	pop    %edi
80100c46:	5d                   	pop    %ebp
    procdump();
80100c47:	e9 04 3b 00 00       	jmp    80104750 <procdump>
        if(c != 0 && input.real_end-input.r < INPUT_BUF){
80100c4c:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80100c4f:	85 db                	test   %ebx,%ebx
80100c51:	0f 84 54 fd ff ff    	je     801009ab <consoleintr+0x1b>
80100c57:	89 d0                	mov    %edx,%eax
80100c59:	2b 05 00 ff 10 80    	sub    0x8010ff00,%eax
80100c5f:	83 f8 7f             	cmp    $0x7f,%eax
80100c62:	0f 87 43 fd ff ff    	ja     801009ab <consoleintr+0x1b>
          c = (c == '\r') ? '\n' : c;
80100c68:	8b 45 e4             	mov    -0x1c(%ebp),%eax
            input.buf[input.e] = c;
80100c6b:	89 c3                	mov    %eax,%ebx
          c = (c == '\r') ? '\n' : c;
80100c6d:	83 f8 0d             	cmp    $0xd,%eax
80100c70:	75 0c                	jne    80100c7e <consoleintr+0x2ee>
80100c72:	c7 45 e4 0a 00 00 00 	movl   $0xa,-0x1c(%ebp)
80100c79:	bb 0a 00 00 00       	mov    $0xa,%ebx
          input.buf[input.e++ % INPUT_BUF] = c;
80100c7e:	8d 41 01             	lea    0x1(%ecx),%eax
80100c81:	83 e1 7f             	and    $0x7f,%ecx
80100c84:	a3 08 ff 10 80       	mov    %eax,0x8010ff08
80100c89:	88 99 80 fe 10 80    	mov    %bl,-0x7fef0180(%ecx)
          if (input.e > input.real_end) input.real_end = input.e;
80100c8f:	39 c2                	cmp    %eax,%edx
80100c91:	73 05                	jae    80100c98 <consoleintr+0x308>
80100c93:	a3 0c ff 10 80       	mov    %eax,0x8010ff0c
  if(panicked){
80100c98:	a1 58 ff 10 80       	mov    0x8010ff58,%eax
80100c9d:	85 c0                	test   %eax,%eax
80100c9f:	0f 84 e9 00 00 00    	je     80100d8e <consoleintr+0x3fe>
80100ca5:	fa                   	cli
    for(;;)
80100ca6:	eb fe                	jmp    80100ca6 <consoleintr+0x316>
80100ca8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80100caf:	00 
    uartputc('\b');
80100cb0:	83 ec 0c             	sub    $0xc,%esp
80100cb3:	6a 08                	push   $0x8
80100cb5:	e8 86 55 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100cba:	31 d2                	xor    %edx,%edx
80100cbc:	b8 e4 00 00 00       	mov    $0xe4,%eax
80100cc1:	e8 3a f7 ff ff       	call   80100400 <cgaputc>
          for (uint i = input.e; i < input.real_end; i++)
80100cc6:	8b 1d 08 ff 10 80    	mov    0x8010ff08,%ebx
80100ccc:	83 c4 10             	add    $0x10,%esp
80100ccf:	3b 1d 0c ff 10 80    	cmp    0x8010ff0c,%ebx
80100cd5:	73 6d                	jae    80100d44 <consoleintr+0x3b4>
            consputc(input.buf[i % INPUT_BUF], 0);
80100cd7:	89 d8                	mov    %ebx,%eax
  if(panicked){
80100cd9:	8b 15 58 ff 10 80    	mov    0x8010ff58,%edx
            consputc(input.buf[i % INPUT_BUF], 0);
80100cdf:	83 e0 7f             	and    $0x7f,%eax
80100ce2:	0f be 80 80 fe 10 80 	movsbl -0x7fef0180(%eax),%eax
  if(panicked){
80100ce9:	85 d2                	test   %edx,%edx
80100ceb:	74 45                	je     80100d32 <consoleintr+0x3a2>
80100ced:	fa                   	cli
    for(;;)
80100cee:	eb fe                	jmp    80100cee <consoleintr+0x35e>
    uartputc('\b');
80100cf0:	83 ec 0c             	sub    $0xc,%esp
80100cf3:	6a 08                	push   $0x8
80100cf5:	e8 46 55 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100cfa:	31 d2                	xor    %edx,%edx
80100cfc:	b8 e4 00 00 00       	mov    $0xe4,%eax
80100d01:	e8 fa f6 ff ff       	call   80100400 <cgaputc>
}
80100d06:	83 c4 10             	add    $0x10,%esp
80100d09:	e9 9d fc ff ff       	jmp    801009ab <consoleintr+0x1b>
    uartputc(k);
80100d0e:	83 ec 0c             	sub    $0xc,%esp
80100d11:	53                   	push   %ebx
80100d12:	e8 29 55 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100d17:	89 da                	mov    %ebx,%edx
80100d19:	b8 e5 00 00 00       	mov    $0xe5,%eax
80100d1e:	e8 dd f6 ff ff       	call   80100400 <cgaputc>
        input.e++;
80100d23:	83 05 08 ff 10 80 01 	addl   $0x1,0x8010ff08
80100d2a:	83 c4 10             	add    $0x10,%esp
80100d2d:	e9 79 fc ff ff       	jmp    801009ab <consoleintr+0x1b>
80100d32:	31 d2                	xor    %edx,%edx
          for (uint i = input.e; i < input.real_end; i++)
80100d34:	83 c3 01             	add    $0x1,%ebx
80100d37:	e8 64 f8 ff ff       	call   801005a0 <consputc.part.0>
80100d3c:	3b 1d 0c ff 10 80    	cmp    0x8010ff0c,%ebx
80100d42:	72 93                	jb     80100cd7 <consoleintr+0x347>
  if(panicked){
80100d44:	8b 0d 58 ff 10 80    	mov    0x8010ff58,%ecx
80100d4a:	85 c9                	test   %ecx,%ecx
80100d4c:	0f 84 ae 01 00 00    	je     80100f00 <consoleintr+0x570>
80100d52:	fa                   	cli
    for(;;)
80100d53:	eb fe                	jmp    80100d53 <consoleintr+0x3c3>
80100d55:	8d 76 00             	lea    0x0(%esi),%esi
    uartputc('\b'); uartputc(' '); uartputc('\b');
80100d58:	83 ec 0c             	sub    $0xc,%esp
80100d5b:	6a 08                	push   $0x8
80100d5d:	e8 de 54 00 00       	call   80106240 <uartputc>
80100d62:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100d69:	e8 d2 54 00 00       	call   80106240 <uartputc>
80100d6e:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100d75:	e8 c6 54 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100d7a:	31 d2                	xor    %edx,%edx
80100d7c:	b8 00 01 00 00       	mov    $0x100,%eax
80100d81:	e8 7a f6 ff ff       	call   80100400 <cgaputc>
}
80100d86:	83 c4 10             	add    $0x10,%esp
80100d89:	e9 1d fc ff ff       	jmp    801009ab <consoleintr+0x1b>
80100d8e:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80100d91:	31 d2                	xor    %edx,%edx
80100d93:	89 d8                	mov    %ebx,%eax
80100d95:	e8 06 f8 ff ff       	call   801005a0 <consputc.part.0>
          if(c == '\n' || c == C('D') || input.real_end == input.r+INPUT_BUF){
80100d9a:	83 fb 0a             	cmp    $0xa,%ebx
80100d9d:	74 19                	je     80100db8 <consoleintr+0x428>
80100d9f:	83 fb 04             	cmp    $0x4,%ebx
80100da2:	74 14                	je     80100db8 <consoleintr+0x428>
80100da4:	a1 00 ff 10 80       	mov    0x8010ff00,%eax
80100da9:	83 e8 80             	sub    $0xffffff80,%eax
80100dac:	39 05 0c ff 10 80    	cmp    %eax,0x8010ff0c
80100db2:	0f 85 f3 fb ff ff    	jne    801009ab <consoleintr+0x1b>
            input.w = input.e;
80100db8:	a1 08 ff 10 80       	mov    0x8010ff08,%eax
            wakeup(&input.r);
80100dbd:	83 ec 0c             	sub    $0xc,%esp
            input.w = input.e;
80100dc0:	a3 04 ff 10 80       	mov    %eax,0x8010ff04
            input.real_end = input.e;
80100dc5:	a3 0c ff 10 80       	mov    %eax,0x8010ff0c
            wakeup(&input.r);
80100dca:	68 00 ff 10 80       	push   $0x8010ff00
80100dcf:	e8 9c 38 00 00       	call   80104670 <wakeup>
80100dd4:	83 c4 10             	add    $0x10,%esp
80100dd7:	e9 cf fb ff ff       	jmp    801009ab <consoleintr+0x1b>
              input.buf[input.e++ % INPUT_BUF] = '\n';
80100ddc:	8d 42 01             	lea    0x1(%edx),%eax
80100ddf:	83 e2 7f             	and    $0x7f,%edx
            if (c == '\n') {
80100de2:	83 7d e4 0a          	cmpl   $0xa,-0x1c(%ebp)
              input.buf[input.e++ % INPUT_BUF] = '\n';
80100de6:	a3 08 ff 10 80       	mov    %eax,0x8010ff08
            if (c == '\n') {
80100deb:	0f 84 78 01 00 00    	je     80100f69 <consoleintr+0x5d9>
              input.buf[input.e++ % INPUT_BUF] = C('D');
80100df1:	c6 82 80 fe 10 80 04 	movb   $0x4,-0x7fef0180(%edx)
              input.real_end = input.e;
80100df8:	89 c2                	mov    %eax,%edx
80100dfa:	a3 0c ff 10 80       	mov    %eax,0x8010ff0c
80100dff:	e9 07 fe ff ff       	jmp    80100c0b <consoleintr+0x27b>
            for (int i = (int)input.real_end - 1; i >= (int)input.e; i--)
80100e04:	8d 41 ff             	lea    -0x1(%ecx),%eax
80100e07:	8d 5a ff             	lea    -0x1(%edx),%ebx
80100e0a:	89 45 e0             	mov    %eax,-0x20(%ebp)
80100e0d:	39 d9                	cmp    %ebx,%ecx
80100e0f:	7f 49                	jg     80100e5a <consoleintr+0x4ca>
80100e11:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80100e14:	89 75 dc             	mov    %esi,-0x24(%ebp)
80100e17:	89 d6                	mov    %edx,%esi
              input.buf[(i + 1) % INPUT_BUF] = input.buf[i % INPUT_BUF];
80100e19:	89 da                	mov    %ebx,%edx
80100e1b:	c1 fa 1f             	sar    $0x1f,%edx
80100e1e:	c1 ea 19             	shr    $0x19,%edx
80100e21:	8d 04 13             	lea    (%ebx,%edx,1),%eax
80100e24:	83 e0 7f             	and    $0x7f,%eax
80100e27:	29 d0                	sub    %edx,%eax
80100e29:	0f b6 90 80 fe 10 80 	movzbl -0x7fef0180(%eax),%edx
80100e30:	8d 43 01             	lea    0x1(%ebx),%eax
            for (int i = (int)input.real_end - 1; i >= (int)input.e; i--)
80100e33:	83 eb 01             	sub    $0x1,%ebx
              input.buf[(i + 1) % INPUT_BUF] = input.buf[i % INPUT_BUF];
80100e36:	89 c1                	mov    %eax,%ecx
80100e38:	c1 f9 1f             	sar    $0x1f,%ecx
80100e3b:	c1 e9 19             	shr    $0x19,%ecx
80100e3e:	01 c8                	add    %ecx,%eax
80100e40:	83 e0 7f             	and    $0x7f,%eax
80100e43:	29 c8                	sub    %ecx,%eax
80100e45:	88 90 80 fe 10 80    	mov    %dl,-0x7fef0180(%eax)
            for (int i = (int)input.real_end - 1; i >= (int)input.e; i--)
80100e4b:	8b 45 e0             	mov    -0x20(%ebp),%eax
80100e4e:	39 c3                	cmp    %eax,%ebx
80100e50:	75 c7                	jne    80100e19 <consoleintr+0x489>
80100e52:	89 f2                	mov    %esi,%edx
80100e54:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80100e57:	8b 75 dc             	mov    -0x24(%ebp),%esi
            input.buf[input.e] = c;
80100e5a:	0f b6 45 e4          	movzbl -0x1c(%ebp),%eax
80100e5e:	88 81 80 fe 10 80    	mov    %al,-0x7fef0180(%ecx)
  if(panicked){
80100e64:	8b 0d 58 ff 10 80    	mov    0x8010ff58,%ecx
            input.real_end++;
80100e6a:	8d 42 01             	lea    0x1(%edx),%eax
80100e6d:	a3 0c ff 10 80       	mov    %eax,0x8010ff0c
  if(panicked){
80100e72:	85 c9                	test   %ecx,%ecx
80100e74:	74 0a                	je     80100e80 <consoleintr+0x4f0>
80100e76:	fa                   	cli
    for(;;)
80100e77:	eb fe                	jmp    80100e77 <consoleintr+0x4e7>
80100e79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80100e80:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80100e83:	31 d2                	xor    %edx,%edx
80100e85:	e8 16 f7 ff ff       	call   801005a0 <consputc.part.0>
            input.e++;
80100e8a:	a1 08 ff 10 80       	mov    0x8010ff08,%eax
80100e8f:	8d 58 01             	lea    0x1(%eax),%ebx
80100e92:	a1 0c ff 10 80       	mov    0x8010ff0c,%eax
80100e97:	89 1d 08 ff 10 80    	mov    %ebx,0x8010ff08
            for (uint i = input.e; i < input.real_end; i++)
80100e9d:	3b 1d 0c ff 10 80    	cmp    0x8010ff0c,%ebx
80100ea3:	0f 83 32 01 00 00    	jae    80100fdb <consoleintr+0x64b>
              consputc(input.buf[i % INPUT_BUF], 0);
80100ea9:	89 d8                	mov    %ebx,%eax
  if(panicked){
80100eab:	8b 15 58 ff 10 80    	mov    0x8010ff58,%edx
              consputc(input.buf[i % INPUT_BUF], 0);
80100eb1:	83 e0 7f             	and    $0x7f,%eax
80100eb4:	0f be 80 80 fe 10 80 	movsbl -0x7fef0180(%eax),%eax
  if(panicked){
80100ebb:	85 d2                	test   %edx,%edx
80100ebd:	74 09                	je     80100ec8 <consoleintr+0x538>
80100ebf:	fa                   	cli
    for(;;)
80100ec0:	eb fe                	jmp    80100ec0 <consoleintr+0x530>
80100ec2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80100ec8:	31 d2                	xor    %edx,%edx
            for (uint i = input.e; i < input.real_end; i++)
80100eca:	83 c3 01             	add    $0x1,%ebx
80100ecd:	e8 ce f6 ff ff       	call   801005a0 <consputc.part.0>
80100ed2:	a1 0c ff 10 80       	mov    0x8010ff0c,%eax
80100ed7:	39 c3                	cmp    %eax,%ebx
80100ed9:	72 ce                	jb     80100ea9 <consoleintr+0x519>
            for (uint k = input.e; k < input.real_end; k++)
80100edb:	8b 1d 08 ff 10 80    	mov    0x8010ff08,%ebx
80100ee1:	39 c3                	cmp    %eax,%ebx
80100ee3:	0f 83 f2 00 00 00    	jae    80100fdb <consoleintr+0x64b>
  if(panicked){
80100ee9:	a1 58 ff 10 80       	mov    0x8010ff58,%eax
80100eee:	85 c0                	test   %eax,%eax
80100ef0:	0f 84 b6 00 00 00    	je     80100fac <consoleintr+0x61c>
80100ef6:	fa                   	cli
    for(;;)
80100ef7:	eb fe                	jmp    80100ef7 <consoleintr+0x567>
80100ef9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartputc(c);
80100f00:	83 ec 0c             	sub    $0xc,%esp
80100f03:	6a 20                	push   $0x20
80100f05:	e8 36 53 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100f0a:	31 d2                	xor    %edx,%edx
80100f0c:	b8 20 00 00 00       	mov    $0x20,%eax
80100f11:	e8 ea f4 ff ff       	call   80100400 <cgaputc>
          for (uint k = input.e; k <= input.real_end; k++)
80100f16:	8b 1d 08 ff 10 80    	mov    0x8010ff08,%ebx
80100f1c:	83 c4 10             	add    $0x10,%esp
80100f1f:	39 1d 0c ff 10 80    	cmp    %ebx,0x8010ff0c
80100f25:	0f 82 80 fa ff ff    	jb     801009ab <consoleintr+0x1b>
  if(panicked){
80100f2b:	a1 58 ff 10 80       	mov    0x8010ff58,%eax
80100f30:	85 c0                	test   %eax,%eax
80100f32:	74 0c                	je     80100f40 <consoleintr+0x5b0>
80100f34:	fa                   	cli
    for(;;)
80100f35:	eb fe                	jmp    80100f35 <consoleintr+0x5a5>
80100f37:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80100f3e:	00 
80100f3f:	90                   	nop
    uartputc('\b');
80100f40:	83 ec 0c             	sub    $0xc,%esp
          for (uint k = input.e; k <= input.real_end; k++)
80100f43:	83 c3 01             	add    $0x1,%ebx
    uartputc('\b');
80100f46:	6a 08                	push   $0x8
80100f48:	e8 f3 52 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100f4d:	31 d2                	xor    %edx,%edx
80100f4f:	b8 e4 00 00 00       	mov    $0xe4,%eax
80100f54:	e8 a7 f4 ff ff       	call   80100400 <cgaputc>
          for (uint k = input.e; k <= input.real_end; k++)
80100f59:	83 c4 10             	add    $0x10,%esp
80100f5c:	39 1d 0c ff 10 80    	cmp    %ebx,0x8010ff0c
80100f62:	73 c7                	jae    80100f2b <consoleintr+0x59b>
80100f64:	e9 42 fa ff ff       	jmp    801009ab <consoleintr+0x1b>
              input.real_end = input.e;
80100f69:	a3 0c ff 10 80       	mov    %eax,0x8010ff0c
  if(panicked){
80100f6e:	a1 58 ff 10 80       	mov    0x8010ff58,%eax
              input.buf[input.e++ % INPUT_BUF] = '\n';
80100f73:	c6 82 80 fe 10 80 0a 	movb   $0xa,-0x7fef0180(%edx)
  if(panicked){
80100f7a:	85 c0                	test   %eax,%eax
80100f7c:	74 0a                	je     80100f88 <consoleintr+0x5f8>
80100f7e:	fa                   	cli
    for(;;)
80100f7f:	eb fe                	jmp    80100f7f <consoleintr+0x5ef>
80100f81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartputc(c);
80100f88:	83 ec 0c             	sub    $0xc,%esp
80100f8b:	6a 0a                	push   $0xa
80100f8d:	e8 ae 52 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100f92:	31 d2                	xor    %edx,%edx
80100f94:	b8 0a 00 00 00       	mov    $0xa,%eax
80100f99:	e8 62 f4 ff ff       	call   80100400 <cgaputc>
            input.w = input.e;
80100f9e:	8b 15 08 ff 10 80    	mov    0x8010ff08,%edx
}
80100fa4:	83 c4 10             	add    $0x10,%esp
80100fa7:	e9 5f fc ff ff       	jmp    80100c0b <consoleintr+0x27b>
    uartputc('\b');
80100fac:	83 ec 0c             	sub    $0xc,%esp
            for (uint k = input.e; k < input.real_end; k++)
80100faf:	83 c3 01             	add    $0x1,%ebx
    uartputc('\b');
80100fb2:	6a 08                	push   $0x8
80100fb4:	e8 87 52 00 00       	call   80106240 <uartputc>
  cgaputc(c, k);
80100fb9:	31 d2                	xor    %edx,%edx
80100fbb:	b8 e4 00 00 00       	mov    $0xe4,%eax
80100fc0:	e8 3b f4 ff ff       	call   80100400 <cgaputc>
            for (uint k = input.e; k < input.real_end; k++)
80100fc5:	8b 15 0c ff 10 80    	mov    0x8010ff0c,%edx
80100fcb:	83 c4 10             	add    $0x10,%esp
80100fce:	39 d3                	cmp    %edx,%ebx
80100fd0:	0f 82 13 ff ff ff    	jb     80100ee9 <consoleintr+0x559>
80100fd6:	e9 1a fc ff ff       	jmp    80100bf5 <consoleintr+0x265>
          if(c == '\n' || c == C('D') || input.real_end == input.r+INPUT_BUF){
80100fdb:	89 c2                	mov    %eax,%edx
80100fdd:	e9 13 fc ff ff       	jmp    80100bf5 <consoleintr+0x265>
80100fe2:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80100fe9:	00 
...
80101490:	e8 eb ee ff ff       	call   80100380 <panic>
...
80101571:	e8 0a ee ff ff       	call   80100380 <panic>
...
80101657:	e8 24 ed ff ff       	call   80100380 <panic>
...
8010172c:	e8 4f ec ff ff       	call   80100380 <panic>
...
80101766:	e8 15 ec ff ff       	call   80100380 <panic>
...
8010181e:	e8 5d eb ff ff       	call   80100380 <panic>
...
8010196d:	e8 0e ea ff ff       	call   80100380 <panic>
...
80101aca:	e8 b1 e8 ff ff       	call   80100380 <panic>
80101acf:	90                   	nop
...
80101ba3:	68 14 7c 10 80       	push   $0x80107c14
...
80101c78:	e8 03 e7 ff ff       	call   80100380 <panic>
...
80101df2:	e8 89 e5 ff ff       	call   80100380 <panic>
    panic("ilock");
80101df7:	83 ec 0c             	sub    $0xc,%esp
80101dfa:	68 19 78 10 80       	push   $0x80107819
80101dff:	e8 7c e5 ff ff       	call   80100380 <panic>
...
80101e4c:	e8 2f e5 ff ff       	call   80100380 <panic>
...
80102317:	e8 64 e0 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
...
80102546:	e8 35 de ff ff       	call   80100380 <panic>
...
801025fd:	e8 7e dd ff ff       	call   80100380 <panic>
...
8010271d:	e8 5e dc ff ff       	call   80100380 <panic>
...
8010299a:	68 68 7c 10 80       	push   $0x80107c68
...
80102cab:	0f b6 91 e0 7e 10 80 	movzbl -0x7fef8120(%ecx),%edx
  shift ^= togglecode[data];
80102cb2:	0f b6 81 e0 7d 10 80 	movzbl -0x7fef8220(%ecx),%eax
  shift |= shiftcode[data];
...
80102cc8:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
80102ccb:	8b 04 85 c0 7d 10 80 	mov    -0x7fef8240(,%eax,4),%eax
...
80102d05:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102d08:	0f b6 81 e0 7e 10 80 	movzbl -0x7fef8120(%ecx),%eax
...
80102d5b:	e8 30 dc ff ff       	call   80100990 <consoleintr>
}
...
8010354a:	e8 31 ce ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
8010354f:	83 ec 0c             	sub    $0xc,%esp
80103552:	68 00 79 10 80       	push   $0x80107900
80103557:	e8 24 ce ff ff       	call   80100380 <panic>
...
80103910:	e8 6b ca ff ff       	call   80100380 <panic>
...
80103968:	68 9c 7c 10 80       	push   $0x80107c9c
...
80103ec5:	68 bc 7c 10 80       	push   $0x80107cbc
...
8010441f:	e8 5c bf ff ff       	call   80100380 <panic>
...
80104798:	8b 14 85 e0 7f 10 80 	mov    -0x7fef8020(,%eax,4),%edx
      state = "???";
...
80104c1d:	e8 5e b7 ff ff       	call   80100380 <panic>
...
8010503c:	8b 14 85 00 80 10 80 	mov    -0x7fef8000(,%eax,4),%edx
...
801051f3:	e8 88 b1 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801051f8:	83 ec 0c             	sub    $0xc,%esp
801051fb:	68 8d 7a 10 80       	push   $0x80107a8d
80105200:	e8 7b b1 ff ff       	call   80100380 <panic>
...
80105ec4:	ff 24 85 58 80 10 80 	jmp    *-0x7fef7fa8(,%eax,4)
...
80105f95:	68 3c 7d 10 80       	push   $0x80107d3c
...
80105fe7:	68 e4 7c 10 80       	push   $0x80107ce4
...
80106103:	68 08 7d 10 80       	push   $0x80107d08
...
801062ab:	e8 e0 a6 ff ff       	call   80100990 <consoleintr>
}
...
80106de6:	e8 95 95 ff ff       	call   80100380 <panic>
...
801070fe:	e8 7d 92 ff ff       	call   80100380 <panic>
...
8010714d:	e8 2e 92 ff ff       	call   80100380 <panic>
...
801071d0:	68 80 7d 10 80       	push   $0x80107d80
801071d5:	e8 a6 91 ff ff       	call   80100380 <panic>
...
80107471:	e8 0a 8f ff ff       	call   80100380 <panic>
...
801075bc:	e8 bf 8d ff ff       	call   80100380 <panic>
