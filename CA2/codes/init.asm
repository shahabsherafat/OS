...
free(void *ap)
{
 ...
 641:	a1 5c 0b 00 00       	mov    0xb5c,%eax
{
 ...
 67f:	5b                   	pop    %ebx
  freep = p;
 680:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 687:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 5c 0b 00 00    	mov    0xb5c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71b:	3b 05 5c 0b 00 00    	cmp    0xb5c,%eax
 ...
 73e:	e8 fd fe ff ff       	call   640 <free>
  return freep;
 743:	8b 15 5c 0b 00 00    	mov    0xb5c,%edx
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 76f:	89 15 5c 0b 00 00    	mov    %edx,0xb5c
}
 ...
 787:	0b 00 00 
    base.s.size = 0;
 78a:	b8 60 0b 00 00       	mov    $0xb60,%eax
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 60 0b 00 00 60 	movl   $0xb60,0xb60
 796:	0b 00 00 
    base.s.size = 0;
 799:	c7 05 64 0b 00 00 00 	movl   $0x0,0xb64
 7a0:	00 00 00 
    if(p->s.size >= nunits){
