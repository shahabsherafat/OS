    ...
    39a8:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a16:	50                   	push   %eax
    3a17:	56                   	push   %esi
    3a18:	e8 e6 fe ff ff       	call   3903 <write>
  while(--i >= 0)
    ...
    3a49:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    3a80:	50                   	push   %eax
    3a81:	57                   	push   %edi
    3a82:	e8 7c fe ff ff       	call   3903 <write>
  ...
  write(fd, &c, 1);
    ...
    3ae0:	57                   	push   %edi
    3ae1:	e8 1d fe ff ff       	call   3903 <write>
    ...
    3af1:	52                   	push   %edx
    3af2:	57                   	push   %edi
    3af3:	e8 0b fe ff ff       	call   3903 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b5b:	53                   	push   %ebx
    3b5c:	57                   	push   %edi
    3b5d:	e8 a1 fd ff ff       	call   3903 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3b9a:	52                   	push   %edx
    3b9b:	57                   	push   %edi
    3b9c:	e8 62 fd ff ff       	call   3903 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cb6:	56                   	push   %esi
    3cb7:	e8 af fc ff ff       	call   396b <sbrk>
  if(p == (char*)-1)
