...
atoi(const char *s)
{
  ...
  while('0' <= *s && *s <= '9')
    ...
    3887:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
memmove(void *vdst, const void *vsrc, int n)
{
  ...
  dst = vdst;
    ...
    38c6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    39b8:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a26:	50                   	push   %eax
    3a27:	56                   	push   %esi
    3a28:	e8 d6 fe ff ff       	call   3903 <write>
  while(--i >= 0)
    ...
    3a59:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    3a90:	50                   	push   %eax
    3a91:	57                   	push   %edi
    3a92:	e8 6c fe ff ff       	call   3903 <write>
  ...
  write(fd, &c, 1);
    ...
    3af0:	57                   	push   %edi
    3af1:	e8 0d fe ff ff       	call   3903 <write>
    ...
    3b01:	52                   	push   %edx
    3b02:	57                   	push   %edi
    3b03:	e8 fb fd ff ff       	call   3903 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b6b:	53                   	push   %ebx
    3b6c:	57                   	push   %edi
    3b6d:	e8 91 fd ff ff       	call   3903 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3baa:	52                   	push   %edx
    3bab:	57                   	push   %edi
    3bac:	e8 52 fd ff ff       	call   3903 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cc6:	56                   	push   %esi
    3cc7:	e8 9f fc ff ff       	call   396b <sbrk>
  if(p == (char*)-1)
