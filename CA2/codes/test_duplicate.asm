 ...
 378:	89 d1                	mov    %edx,%ecx
{
 ...
 3ab:	0f b6 92 d0 07 00 00 	movzbl 0x7d0(%edx),%edx
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 484:	ff 24 85 78 07 00 00 	jmp    *0x778(,%eax,4)
 ...
 590:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 595:	bb 70 07 00 00       	mov    $0x770,%ebx
...
free(void *ap)
{
 ...
 5a1:	a1 6c 0a 00 00       	mov    0xa6c,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 6c 0a 00 00       	mov    %eax,0xa6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	3b 05 6c 0a 00 00    	cmp    0xa6c,%eax
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 6c 0a 00 00    	mov    %edx,0xa6c
}
 ...
 6df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 6c 0a 00 00 70 	movl   $0xa70,0xa6c
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 70 0a 00 00       	mov    $0xa70,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 70 0a 00 00 70 	movl   $0xa70,0xa70
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 74 0a 00 00 00 	movl   $0x0,0xa74
 700:	00 00 00 
    if(p->s.size >= nunits){
