 ...
 398:	89 d1                	mov    %edx,%ecx
{
 ...
 3cb:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4a4:	ff 24 85 98 07 00 00 	jmp    *0x798(,%eax,4)
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 90 07 00 00       	mov    $0x790,%ebx
