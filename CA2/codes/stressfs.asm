 ...
 448:	89 d1                	mov    %edx,%ecx
{
 ...
 4b6:	50                   	push   %eax
 4b7:	56                   	push   %esi
 4b8:	e8 d6 fe ff ff       	call   393 <write>
  while(--i >= 0)
 ...
 4e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 520:	50                   	push   %eax
 521:	57                   	push   %edi
 522:	e8 6c fe ff ff       	call   393 <write>
 ...
 591:	52                   	push   %edx
 592:	57                   	push   %edi
 593:	e8 fb fd ff ff       	call   393 <write>
        putc(fd, c);
 ...
 63a:	52                   	push   %edx
 63b:	57                   	push   %edi
 63c:	e8 52 fd ff ff       	call   393 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 756:	56                   	push   %esi
 757:	e8 9f fc ff ff       	call   3fb <sbrk>
  if(p == (char*)-1)
