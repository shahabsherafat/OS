 ...
 338:	89 d1                	mov    %edx,%ecx
{
 ...
 3a6:	50                   	push   %eax
 3a7:	56                   	push   %esi
 3a8:	e8 d6 fe ff ff       	call   283 <write>
  while(--i >= 0)
 ...
 3d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 410:	50                   	push   %eax
 411:	57                   	push   %edi
 412:	e8 6c fe ff ff       	call   283 <write>
 ...
 481:	52                   	push   %edx
 482:	57                   	push   %edi
 483:	e8 fb fd ff ff       	call   283 <write>
        putc(fd, c);
 ...
 52a:	52                   	push   %edx
 52b:	57                   	push   %edi
 52c:	e8 52 fd ff ff       	call   283 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 646:	56                   	push   %esi
 647:	e8 9f fc ff ff       	call   2eb <sbrk>
  if(p == (char*)-1)
