...
free(void *ap)
{
 ...
 581:	a1 f8 09 00 00       	mov    0x9f8,%eax
{
 ...
 5bf:	5b                   	pop    %ebx
  freep = p;
 5c0:	a3 f8 09 00 00       	mov    %eax,0x9f8
}
 5c5:	5e                   	pop    %esi
 5c6:	5f                   	pop    %edi
 5c7:	5d                   	pop    %ebp
 ...
 5d6:	72 ce                	jb     5a6 <free+0x26>
{
 ...
 5f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fa:	a3 f8 09 00 00       	mov    %eax,0x9f8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 f8 09 00 00    	mov    0x9f8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65b:	3b 05 f8 09 00 00    	cmp    0x9f8,%eax
 ...
 67e:	e8 fd fe ff ff       	call   580 <free>
  return freep;
 683:	8b 15 f8 09 00 00    	mov    0x9f8,%edx
 ...
 6c7:	09 00 00 
    base.s.size = 0;
 6ca:	b8 fc 09 00 00       	mov    $0x9fc,%eax
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 fc 09 00 00 fc 	movl   $0x9fc,0x9fc
 6d6:	09 00 00 
    base.s.size = 0;
 6d9:	c7 05 00 0a 00 00 00 	movl   $0x0,0xa00
 6e0:	00 00 00 
    if(p->s.size >= nunits){
