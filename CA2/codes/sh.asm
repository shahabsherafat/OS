...
fork1(void)
{
  ...
  if (pid == -1)
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
      88:	80 3d a1 1f 00 00 64 	cmpb   $0x64,0x1fa1
      8f:	75 d2                	jne    63 <main+0x63>
      91:	80 3d a2 1f 00 00 20 	cmpb   $0x20,0x1fa2
      98:	75 c9                	jne    63 <main+0x63>
      buf[strlen(buf) - 1] = 0; // chop \n
      9a:	83 ec 0c             	sub    $0xc,%esp
      9d:	68 a0 1f 00 00       	push   $0x1fa0
      a2:	e8 a9 10 00 00       	call   1150 <strlen>
      if (chdir(buf + 3) < 0)
      a7:	c7 04 24 a3 1f 00 00 	movl   $0x1fa3,(%esp)
      buf[strlen(buf) - 1] = 0; // chop \n
      ae:	c6 80 9f 1f 00 00 00 	movb   $0x0,0x1f9f(%eax)
      if (chdir(buf + 3) < 0)
      ...
      bf:	0f 89 7b ff ff ff    	jns    40 <main+0x40>
        printf(2, "cannot cd %s\n", buf + 3);
      c5:	50                   	push   %eax
      c6:	68 a3 1f 00 00       	push   $0x1fa3
      cb:	68 3c 18 00 00       	push   $0x183c
      d0:	6a 02                	push   $0x2
      d2:	e8 a9 13 00 00       	call   1480 <printf>
...
00000120 <auto_complete>:
{
  ...
  printf(2, "%s\t", instruction + buf_len);
     ...
     173:	51                   	push   %ecx
     174:	68 88 17 00 00       	push   $0x1788
     179:	6a 02                	push   $0x2
     17b:	e8 00 13 00 00       	call   1480 <printf>
}
...
00000190 <print_instructions>:
{
  ...
  printf(2, "\n");
     1a5:	68 b0 17 00 00       	push   $0x17b0
     1aa:	6a 02                	push   $0x2
     1ac:	e8 cf 12 00 00       	call   1480 <printf>
  for (int i = 0; i < count; i++) {
    ...
    if (instructions[i])
     ...
     1ca:	52                   	push   %edx
     1cb:	68 30 18 00 00       	push   $0x1830
     1d0:	6a 02                	push   $0x2
     1d2:	e8 a9 12 00 00       	call   1480 <printf>
  ...
  printf(2, "\t");
     ...
     1e4:	68 8a 17 00 00       	push   $0x178a
     1e9:	6a 02                	push   $0x2
     1eb:	e8 90 12 00 00       	call   1480 <printf>
  printf(2, "$ %s", prefix);
     1f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     1f3:	c7 45 0c 8c 17 00 00 	movl   $0x178c,0xc(%ebp)
     ...
     20d:	5d                   	pop    %ebp
  printf(2, "$ %s", prefix);
     20e:	e9 6d 12 00 00       	jmp    1480 <printf>
...
00000290 <get_matching_instructions>:
{
  ...
  fd = open(path, 0);
     29c:	6a 00                	push   $0x0
     29e:	68 91 17 00 00       	push   $0x1791
  ...
  char **instructions = malloc(sizeof(char *) * 16);
     ...
     2b2:	e8 e9 13 00 00       	call   16a0 <malloc>
  ...
  while (read(fd, &de, sizeof(de)) == sizeof(de)) {
    ...
    for (int i = 0; i < prefix_len; i++) {
     ...
     340:	6a 0f                	push   $0xf
     342:	e8 59 13 00 00       	call   16a0 <malloc>
  ...
  for (int i = 0; i < prefix_len; i++) {
    ...
    instructions[counter] = malloc(3);
     ...
     3fe:	6a 03                	push   $0x3
     400:	e8 9b 12 00 00       	call   16a0 <malloc>
...
00000440 <getcmd>:
{
  ...
  if (!temp_buf) {
     448:	a1 80 1f 00 00       	mov    0x1f80,%eax
{
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     45b:	a1 8c 1f 00 00       	mov    0x1f8c,%eax
     460:	0b 05 88 1f 00 00    	or     0x1f88,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     48e:	a1 80 1f 00 00       	mov    0x1f80,%eax
    ...
    TAPPRESS = 0;
     4a4:	c7 05 8c 1f 00 00 00 	movl   $0x0,0x1f8c
     4ab:	00 00 00 
    has_multiple_choice = 0;
     4ae:	c7 05 88 1f 00 00 00 	movl   $0x0,0x1f88
     4b5:	00 00 00 
  if (buf[0] == 0)
     4b8:	80 3b 00             	cmpb   $0x0,(%ebx)
     4bb:	0f 84 89 01 00 00    	je     64a <getcmd+0x20a>
  if (temp_buf)
     4c1:	a1 80 1f 00 00       	mov    0x1f80,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     4eb:	a1 80 1f 00 00       	mov    0x1f80,%eax
    ...
    has_multiple_choice = 0;
     505:	c7 05 88 1f 00 00 00 	movl   $0x0,0x1f88
     50c:	00 00 00 
    TAPPRESS = 0;
     50f:	c7 05 8c 1f 00 00 00 	movl   $0x0,0x1f8c
     516:	00 00 00 
    ...
    if (instruction_num == 0) {
     ...
     540:	8b 0d 88 1f 00 00    	mov    0x1f88,%ecx
     546:	85 c9                	test   %ecx,%ecx
     548:	0f 85 a2 00 00 00    	jne    5f0 <getcmd+0x1b0>
        if (temp_buf)
     54e:	a1 80 1f 00 00       	mov    0x1f80,%eax
        has_multiple_choice = 1; 
     553:	c7 05 88 1f 00 00 01 	movl   $0x1,0x1f88
     55a:	00 00 00 
        if (temp_buf)
     ...
     57f:	90                   	nop
      if (temp_buf)
     580:	a1 80 1f 00 00       	mov    0x1f80,%eax
      TAPPRESS = 1;
     585:	c7 05 8c 1f 00 00 01 	movl   $0x1,0x1f8c
     58c:	00 00 00 
      if (temp_buf)
    ...
    temp_buf = malloc(nbuf);
     ...
     59b:	56                   	push   %esi
     59c:	e8 ff 10 00 00       	call   16a0 <malloc>
    if (temp_buf)
     5a1:	83 c4 10             	add    $0x10,%esp
    temp_buf = malloc(nbuf);
     5a4:	a3 80 1f 00 00       	mov    %eax,0x1f80
    if (temp_buf)
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     5b4:	a1 8c 1f 00 00       	mov    0x1f8c,%eax
     5b9:	0b 05 88 1f 00 00    	or     0x1f88,%eax
     5bf:	0f 85 a7 fe ff ff    	jne    46c <getcmd+0x2c>
     5c5:	8d 76 00             	lea    0x0(%esi),%esi
    printf(2, "$ ");
     5c8:	83 ec 08             	sub    $0x8,%esp
     5cb:	68 93 17 00 00       	push   $0x1793
     5d0:	6a 02                	push   $0x2
     5d2:	e8 a9 0e 00 00       	call   1480 <printf>
    memset(buf, 0, nbuf);
     ...
     5f6:	e8 95 fb ff ff       	call   190 <print_instructions>
        if (temp_buf)
     5fb:	a1 80 1f 00 00       	mov    0x1f80,%eax
     600:	83 c4 10             	add    $0x10,%esp
        done_printing = 1;
     603:	c7 05 84 1f 00 00 01 	movl   $0x1,0x1f84
     60a:	00 00 00 
        if (temp_buf)
     ...
     626:	e8 f5 fa ff ff       	call   120 <auto_complete>
      if (temp_buf)
     62b:	a1 80 1f 00 00       	mov    0x1f80,%eax
     630:	83 c4 10             	add    $0x10,%esp
      TAPPRESS = 1;
     633:	c7 05 8c 1f 00 00 01 	movl   $0x1,0x1f8c
     63a:	00 00 00 
      if (temp_buf)
...
00000660 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     669:	68 30 18 00 00       	push   $0x1830
     66e:	6a 02                	push   $0x2
     670:	e8 0b 0e 00 00       	call   1480 <printf>
  exit();
...
00000680 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     695:	68 96 17 00 00       	push   $0x1796
...
000006a0 <runcmd>:
{
  ...
  switch (cmd->type) {
     ...
     6b9:	ff 24 85 54 18 00 00 	jmp    *0x1854(,%eax,4)
    if (ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     6d9:	68 a2 17 00 00       	push   $0x17a2
     6de:	6a 02                	push   $0x2
     6e0:	e8 9b 0d 00 00       	call   1480 <printf>
    break;
    ...
    panic("runcmd");
     ...
     79d:	68 9b 17 00 00       	push   $0x179b
     7a2:	e8 b9 fe ff ff       	call   660 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     7a7:	51                   	push   %ecx
     7a8:	ff 73 08             	push   0x8(%ebx)
     7ab:	68 b2 17 00 00       	push   $0x17b2
     7b0:	6a 02                	push   $0x2
     7b2:	e8 c9 0c 00 00       	call   1480 <printf>
      exit();
     7b7:	e8 57 0b 00 00       	call   1313 <exit>
      panic("pipe");
     7bc:	83 ec 0c             	sub    $0xc,%esp
     7bf:	68 c2 17 00 00       	push   $0x17c2
     ...
     825:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     837:	6a 54                	push   $0x54
     839:	e8 62 0e 00 00       	call   16a0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     867:	6a 18                	push   $0x18
     869:	e8 32 0e 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8b7:	6a 0c                	push   $0xc
     8b9:	e8 e2 0d 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8f7:	6a 0c                	push   $0xc
     8f9:	e8 a2 0d 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     937:	6a 08                	push   $0x8
     939:	e8 62 0d 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     969:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     98d:	50                   	push   %eax
     98e:	68 70 1f 00 00       	push   $0x1f70
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     9dd:	50                   	push   %eax
     9de:	68 70 1f 00 00       	push   $0x1f70
  ...
  *ps = s;
  ...
  switch (*s) {
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a36:	50                   	push   %eax
     a37:	68 68 1f 00 00       	push   $0x1f68
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a55:	50                   	push   %eax
     a56:	68 70 1f 00 00       	push   $0x1f70
...
peek(char **ps, char *es, char *toks)
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     afd:	50                   	push   %eax
     afe:	68 70 1f 00 00       	push   $0x1f70
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while (peek(ps, es, "<>")) {
     ...
     b63:	68 e4 17 00 00       	push   $0x17e4
     b68:	53                   	push   %ebx
     b69:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     bc0:	6a 18                	push   $0x18
     bc2:	e8 d9 0a 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     c1f:	6a 18                	push   $0x18
     c21:	e8 7a 0a 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd->cmd  = subcmd;
     c4a:	89 47 04             	mov    %eax,0x4(%edi)
  cmd->file = file;
     c4d:	89 4f 08             	mov    %ecx,0x8(%edi)
  cmd->efile = efile;
     c50:	89 57 0c             	mov    %edx,0xc(%edi)
  cmd->mode = mode;
     c53:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
  cmd->fd   = fd;
     c5a:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
      break;
  ...
  return cmd;
     ...
     c7e:	68 c7 17 00 00       	push   $0x17c7
...
parseexec(char **ps, char *es)
{
  ...
  if (peek(ps, es, "("))
     c9f:	68 e7 17 00 00       	push   $0x17e7
     ca4:	56                   	push   %esi
     ca5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     cbb:	6a 54                	push   $0x54
     cbd:	e8 de 09 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (!peek(ps, es, "|)&;")) {
     ...
     d06:	68 fe 17 00 00       	push   $0x17fe
     d0b:	56                   	push   %esi
     d0c:	53                   	push   %ebx
    ...
    if (argc >= MAXARGS)
     ...
     d50:	68 f0 17 00 00       	push   $0x17f0
  ...
  cmd->eargv[argc] = 0;
     ...
     d99:	68 e9 17 00 00       	push   $0x17e9
     d9e:	e8 bd f8 ff ff       	call   660 <panic>
     da3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
00000db0 <parsepipe>:
{
  ...
  if (peek(ps, es, "|")) {
     ...
     dc9:	68 03 18 00 00       	push   $0x1803
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     e0d:	e8 8e 08 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000e40 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     e72:	e8 29 08 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (peek(ps, es, "&")) {
     ...
     e9b:	68 05 18 00 00       	push   $0x1805
     ea0:	57                   	push   %edi
     ea1:	56                   	push   %esi
  ...
  if (peek(ps, es, ";")) {
     ...
     eb1:	68 01 18 00 00       	push   $0x1801
     eb6:	57                   	push   %edi
     eb7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     eed:	e8 ae 07 00 00       	call   16a0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000f20 <parseblock>:
{
  ...
  if (!peek(ps, es, "("))
     f2f:	68 e7 17 00 00       	push   $0x17e7
     f34:	56                   	push   %esi
     f35:	53                   	push   %ebx
  ...
  if (!peek(ps, es, ")"))
     ...
     f59:	68 23 18 00 00       	push   $0x1823
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch (cmd->type) {
     ...
     fc5:	ff 24 85 6c 18 00 00 	jmp    *0x186c(,%eax,4)
    ...
    1055:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
    ...
    1073:	68 8b 17 00 00       	push   $0x178b
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    109e:	52                   	push   %edx
    109f:	50                   	push   %eax
    10a0:	68 25 18 00 00       	push   $0x1825
    10a5:	6a 02                	push   $0x2
    10a7:	e8 d4 03 00 00       	call   1480 <printf>
    panic("syntax");
    10ac:	c7 04 24 e9 17 00 00 	movl   $0x17e9,(%esp)
    ...
    10c1:	31 c0                	xor    %eax,%eax
{
  ...
  return os;
    ...
    10e3:	c9                   	leave
    10e4:	c3                   	ret
    10e5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
{
    13ea:	83 ec 3c             	sub    $0x3c,%esp
    13ed:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    13f0:	85 d2                	test   %edx,%edx
    13f2:	0f 89 80 00 00 00    	jns    1478 <printint+0x98>
    13f8:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    13fc:	74 7a                	je     1478 <printint+0x98>
    x = -xx;
    13fe:	f7 d9                	neg    %ecx
    neg = 1;
  ...
  i = 0;
    1405:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    1408:	31 f6                	xor    %esi,%esi
    140a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    1410:	89 c8                	mov    %ecx,%eax
    1412:	31 d2                	xor    %edx,%edx
    1414:	89 f7                	mov    %esi,%edi
    1416:	f7 f3                	div    %ebx
    1418:	8d 76 01             	lea    0x1(%esi),%esi
    141b:	0f b6 92 dc 18 00 00 	movzbl 0x18dc(%edx),%edx
    1422:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    1426:	89 ca                	mov    %ecx,%edx
    1428:	89 c1                	mov    %eax,%ecx
    142a:	39 da                	cmp    %ebx,%edx
    142c:	73 e2                	jae    1410 <printint+0x30>
  if(neg)
    142e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    1431:	85 c0                	test   %eax,%eax
    1433:	74 07                	je     143c <printint+0x5c>
    buf[i++] = '-';
    1435:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    143a:	89 f7                	mov    %esi,%edi
    143c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    143f:	8b 75 c0             	mov    -0x40(%ebp),%esi
    1442:	01 df                	add    %ebx,%edi
    1444:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    1448:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    144b:	83 ec 04             	sub    $0x4,%esp
    144e:	88 45 d7             	mov    %al,-0x29(%ebp)
    1451:	8d 45 d7             	lea    -0x29(%ebp),%eax
    1454:	6a 01                	push   $0x1
    1456:	50                   	push   %eax
    1457:	56                   	push   %esi
    1458:	e8 d6 fe ff ff       	call   1333 <write>
  while(--i >= 0)
    145d:	89 f8                	mov    %edi,%eax
    145f:	83 c4 10             	add    $0x10,%esp
    1462:	83 ef 01             	sub    $0x1,%edi
    1465:	39 c3                	cmp    %eax,%ebx
    1467:	75 df                	jne    1448 <printint+0x68>
}
    1469:	8d 65 f4             	lea    -0xc(%ebp),%esp
    146c:	5b                   	pop    %ebx
    146d:	5e                   	pop    %esi
    146e:	5f                   	pop    %edi
    146f:	5d                   	pop    %ebp
  ...
  neg = 0;
    ...
    147a:	eb 89                	jmp    1405 <printint+0x25>
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    1489:	8b 75 0c             	mov    0xc(%ebp),%esi
{
    148c:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    148f:	0f b6 1e             	movzbl (%esi),%ebx
    1492:	83 c6 01             	add    $0x1,%esi
    1495:	84 db                	test   %bl,%bl
    1497:	74 67                	je     1500 <printf+0x80>
    1499:	8d 4d 10             	lea    0x10(%ebp),%ecx
    149c:	31 d2                	xor    %edx,%edx
    149e:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    14a1:	eb 34                	jmp    14d7 <printf+0x57>
    14a3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    14a7:	90                   	nop
    14a8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    14ab:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    14b0:	83 f8 25             	cmp    $0x25,%eax
    14b3:	74 18                	je     14cd <printf+0x4d>
  write(fd, &c, 1);
    14b5:	83 ec 04             	sub    $0x4,%esp
    14b8:	8d 45 e7             	lea    -0x19(%ebp),%eax
    14bb:	88 5d e7             	mov    %bl,-0x19(%ebp)
    14be:	6a 01                	push   $0x1
    14c0:	50                   	push   %eax
    14c1:	57                   	push   %edi
    14c2:	e8 6c fe ff ff       	call   1333 <write>
    14c7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    14ca:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    14cd:	0f b6 1e             	movzbl (%esi),%ebx
    14d0:	83 c6 01             	add    $0x1,%esi
    14d3:	84 db                	test   %bl,%bl
    14d5:	74 29                	je     1500 <printf+0x80>
    c = fmt[i] & 0xff;
    14d7:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    14da:	85 d2                	test   %edx,%edx
    14dc:	74 ca                	je     14a8 <printf+0x28>
      }
    } else if(state == '%'){
    14de:	83 fa 25             	cmp    $0x25,%edx
    14e1:	75 ea                	jne    14cd <printf+0x4d>
      if(c == 'd'){
    14e3:	83 f8 25             	cmp    $0x25,%eax
    14e6:	0f 84 04 01 00 00    	je     15f0 <printf+0x170>
    14ec:	83 e8 63             	sub    $0x63,%eax
    14ef:	83 f8 15             	cmp    $0x15,%eax
    14f2:	77 1c                	ja     1510 <printf+0x90>
    14f4:	ff 24 85 84 18 00 00 	jmp    *0x1884(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    1513:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1516:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    151a:	6a 01                	push   $0x1
    151c:	52                   	push   %edx
    151d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    1520:	57                   	push   %edi
    1521:	e8 0d fe ff ff       	call   1333 <write>
    1526:	83 c4 0c             	add    $0xc,%esp
    1529:	88 5d e7             	mov    %bl,-0x19(%ebp)
    152c:	6a 01                	push   $0x1
    152e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    1531:	52                   	push   %edx
    1532:	57                   	push   %edi
    1533:	e8 fb fd ff ff       	call   1333 <write>
        putc(fd, c);
    1538:	83 c4 10             	add    $0x10,%esp
      state = 0;
    153b:	31 d2                	xor    %edx,%edx
    153d:	eb 8e                	jmp    14cd <printf+0x4d>
    153f:	90                   	nop
        printint(fd, *ap, 16, 0);
    1540:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1543:	83 ec 0c             	sub    $0xc,%esp
    1546:	b9 10 00 00 00       	mov    $0x10,%ecx
    154b:	8b 13                	mov    (%ebx),%edx
    154d:	6a 00                	push   $0x0
    154f:	89 f8                	mov    %edi,%eax
        ap++;
    1551:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    1554:	e8 87 fe ff ff       	call   13e0 <printint>
        ap++;
    1559:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    155c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    155f:	31 d2                	xor    %edx,%edx
    1561:	e9 67 ff ff ff       	jmp    14cd <printf+0x4d>
        s = (char*)*ap;
    1566:	8b 45 d0             	mov    -0x30(%ebp),%eax
    1569:	8b 18                	mov    (%eax),%ebx
        ap++;
    156b:	83 c0 04             	add    $0x4,%eax
    156e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    1571:	85 db                	test   %ebx,%ebx
    1573:	0f 84 87 00 00 00    	je     1600 <printf+0x180>
        while(*s != 0){
    1579:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    157c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    157e:	84 c0                	test   %al,%al
    1580:	0f 84 47 ff ff ff    	je     14cd <printf+0x4d>
    1586:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1589:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    158c:	89 de                	mov    %ebx,%esi
    158e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
  ...
  write(fd, &c, 1);
    ...
    159b:	53                   	push   %ebx
    159c:	57                   	push   %edi
    159d:	e8 91 fd ff ff       	call   1333 <write>
        while(*s != 0){
    15a2:	0f b6 06             	movzbl (%esi),%eax
    15a5:	83 c4 10             	add    $0x10,%esp
    15a8:	84 c0                	test   %al,%al
    15aa:	75 e4                	jne    1590 <printf+0x110>
      state = 0;
    15ac:	8b 75 d4             	mov    -0x2c(%ebp),%esi
    15af:	31 d2                	xor    %edx,%edx
    15b1:	e9 17 ff ff ff       	jmp    14cd <printf+0x4d>
        printint(fd, *ap, 10, 1);
    15b6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    15b9:	83 ec 0c             	sub    $0xc,%esp
    15bc:	b9 0a 00 00 00       	mov    $0xa,%ecx
    15c1:	8b 13                	mov    (%ebx),%edx
    15c3:	6a 01                	push   $0x1
    15c5:	eb 88                	jmp    154f <printf+0xcf>
        putc(fd, *ap);
    15c7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    15ca:	83 ec 04             	sub    $0x4,%esp
    15cd:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    15d0:	8b 03                	mov    (%ebx),%eax
        ap++;
    15d2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    15d5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    15d8:	6a 01                	push   $0x1
    15da:	52                   	push   %edx
    15db:	57                   	push   %edi
    15dc:	e8 52 fd ff ff       	call   1333 <write>
        ap++;
    15e1:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    15e4:	83 c4 10             	add    $0x10,%esp
      state = 0;
    15e7:	31 d2                	xor    %edx,%edx
    15e9:	e9 df fe ff ff       	jmp    14cd <printf+0x4d>
    15ee:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    15f0:	83 ec 04             	sub    $0x4,%esp
    15f3:	88 5d e7             	mov    %bl,-0x19(%ebp)
    15f6:	8d 55 e7             	lea    -0x19(%ebp),%edx
    15f9:	6a 01                	push   $0x1
    15fb:	e9 31 ff ff ff       	jmp    1531 <printf+0xb1>
    1600:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1605:	bb 4a 18 00 00       	mov    $0x184a,%ebx
    160a:	e9 77 ff ff ff       	jmp    1586 <printf+0x106>
    160f:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1611:	a1 04 20 00 00       	mov    0x2004,%eax
{
  ...
  freep = p;
    ...
    164f:	5b                   	pop    %ebx
  freep = p;
    1650:	a3 04 20 00 00       	mov    %eax,0x2004
}
    1655:	5e                   	pop    %esi
    1656:	5f                   	pop    %edi
    1657:	5d                   	pop    %ebp
    ...
    1666:	72 ce                	jb     1636 <free+0x26>
{
  ...
  freep = p;
    168a:	a3 04 20 00 00       	mov    %eax,0x2004
    p->s.size += bp->s.size;
    168f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    1692:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    1695:	89 08                	mov    %ecx,(%eax)
}
    1697:	5b                   	pop    %ebx
    1698:	5e                   	pop    %esi
    1699:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16ac:	8b 15 04 20 00 00    	mov    0x2004,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    16bd:	0f 84 8d 00 00 00    	je     1750 <malloc+0xb0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16c8:	39 f9                	cmp    %edi,%ecx
    16ca:	73 64                	jae    1730 <malloc+0x90>
  if(nu < 4096)
    16cc:	bb 00 10 00 00       	mov    $0x1000,%ebx
    16d1:	39 df                	cmp    %ebx,%edi
    16d3:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    16d6:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    16dd:	eb 0a                	jmp    16e9 <malloc+0x49>
    16df:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    16e0:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    16e2:	8b 48 04             	mov    0x4(%eax),%ecx
    16e5:	39 f9                	cmp    %edi,%ecx
    16e7:	73 47                	jae    1730 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    16eb:	3b 05 04 20 00 00    	cmp    0x2004,%eax
    16f1:	75 ed                	jne    16e0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    16f3:	83 ec 0c             	sub    $0xc,%esp
    16f6:	56                   	push   %esi
    16f7:	e8 9f fc ff ff       	call   139b <sbrk>
  if(p == (char*)-1)
    16fc:	83 c4 10             	add    $0x10,%esp
    16ff:	83 f8 ff             	cmp    $0xffffffff,%eax
    1702:	74 1c                	je     1720 <malloc+0x80>
  hp->s.size = nu;
    1704:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1707:	83 ec 0c             	sub    $0xc,%esp
    170a:	83 c0 08             	add    $0x8,%eax
    170d:	50                   	push   %eax
    170e:	e8 fd fe ff ff       	call   1610 <free>
  return freep;
    1713:	8b 15 04 20 00 00    	mov    0x2004,%edx
      if((p = morecore(nunits)) == 0)
    1719:	83 c4 10             	add    $0x10,%esp
    171c:	85 d2                	test   %edx,%edx
    171e:	75 c0                	jne    16e0 <malloc+0x40>
        return 0;
  }
}
    1720:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    172a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    1730:	39 cf                	cmp    %ecx,%edi
    1732:	74 4c                	je     1780 <malloc+0xe0>
        p->s.size -= nunits;
    1734:	29 f9                	sub    %edi,%ecx
    1736:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    1739:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    173c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    173f:	89 15 04 20 00 00    	mov    %edx,0x2004
}
    1745:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    1748:	83 c0 08             	add    $0x8,%eax
}
    174b:	5b                   	pop    %ebx
    174c:	5e                   	pop    %esi
    174d:	5f                   	pop    %edi
    ...
    174f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1750:	c7 05 04 20 00 00 08 	movl   $0x2008,0x2004
    1757:	20 00 00 
    base.s.size = 0;
    175a:	b8 08 20 00 00       	mov    $0x2008,%eax
    base.s.ptr = freep = prevp = &base;
    175f:	c7 05 08 20 00 00 08 	movl   $0x2008,0x2008
    1766:	20 00 00 
    base.s.size = 0;
    1769:	c7 05 0c 20 00 00 00 	movl   $0x0,0x200c
    1770:	00 00 00 
    if(p->s.size >= nunits){
    1773:	e9 54 ff ff ff       	jmp    16cc <malloc+0x2c>
    1778:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    177f:	90                   	nop
        prevp->s.ptr = p->s.ptr;
    1780:	8b 08                	mov    (%eax),%ecx
    1782:	89 0a                	mov    %ecx,(%edx)
    1784:	eb b9                	jmp    173f <malloc+0x9f>
