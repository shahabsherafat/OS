...
main(void)
{
  ...
  printf(1, "\n[famdemo] parent PID = %d\n", me);
  1f:	68 68 08 00 00       	push   $0x868
  24:	6a 01                	push   $0x1
  26:	e8 35 05 00 00       	call   560 <printf>
  ...
  9f:	56                   	push   %esi
  a0:	53                   	push   %ebx
  a1:	68 bc 08 00 00       	push   $0x8bc
  a6:	6a 01                	push   $0x1
  a8:	e8 b3 04 00 00       	call   560 <printf>
 ...
 4c8:	89 d1                	mov    %edx,%ecx
{
 ...
 4fb:	0f b6 92 50 09 00 00 	movzbl 0x950(%edx),%edx
 ...
 536:	50                   	push   %eax
 537:	56                   	push   %esi
 538:	e8 d6 fe ff ff       	call   413 <write>
  while(--i >= 0)
 ...
 569:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	50                   	push   %eax
 5a1:	57                   	push   %edi
 5a2:	e8 6c fe ff ff       	call   413 <write>
 ...
 5d4:	ff 24 85 f8 08 00 00 	jmp    *0x8f8(,%eax,4)
 ...
 600:	57                   	push   %edi
 601:	e8 0d fe ff ff       	call   413 <write>
 ...
 611:	52                   	push   %edx
 612:	57                   	push   %edi
 613:	e8 fb fd ff ff       	call   413 <write>
        putc(fd, c);
 ...
 6ba:	52                   	push   %edx
 6bb:	57                   	push   %edi
 6bc:	e8 52 fd ff ff       	call   413 <write>
        ap++;
 ...
 6e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6e5:	bb b3 08 00 00       	mov    $0x8b3,%ebx
 ...
 6f1:	a1 f8 0b 00 00       	mov    0xbf8,%eax
{
 ...
 72f:	5b                   	pop    %ebx
  freep = p;
 730:	a3 f8 0b 00 00       	mov    %eax,0xbf8
}
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 737:	5d                   	pop    %ebp
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 f8 0b 00 00       	mov    %eax,0xbf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7cb:	3b 05 f8 0b 00 00    	cmp    0xbf8,%eax
 7d1:	75 ed                	jne    7c0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 7d3:	83 ec 0c             	sub    $0xc,%esp
 7d6:	56                   	push   %esi
 7d7:	e8 9f fc ff ff       	call   47b <sbrk>
  if(p == (char*)-1)
 ...
 7ee:	e8 fd fe ff ff       	call   6f0 <free>
  return freep;
 7f3:	8b 15 f8 0b 00 00    	mov    0xbf8,%edx
 ...
 81c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 81f:	89 15 f8 0b 00 00    	mov    %edx,0xbf8
}
 ...
 82f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 f8 0b 00 00 fc 	movl   $0xbfc,0xbf8
 837:	0b 00 00 
    base.s.size = 0;
 83a:	b8 fc 0b 00 00       	mov    $0xbfc,%eax
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 fc 0b 00 00 fc 	movl   $0xbfc,0xbfc
 846:	0b 00 00 
    base.s.size = 0;
 849:	c7 05 00 0c 00 00 00 	movl   $0x0,0xc00
 850:	00 00 00 
    if(p->s.size >= nunits){
