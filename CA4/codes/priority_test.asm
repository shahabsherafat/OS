...
main(int argc, char **argv)
{
  ...
  1b:	75 0f                	jne    2c <main+0x2c>
    cpu_intensive("LOW");
  1d:	b8 fb 07 00 00       	mov    $0x7fb,%eax
  ...
  37:	75 0f                	jne    48 <main+0x48>
    cpu_intensive("HIGH");
  39:	b8 ff 07 00 00       	mov    $0x7ff,%eax
 ...
 448:	89 d1                	mov    %edx,%ecx
{
 ...
 4b6:	50                   	push   %eax
 4b7:	56                   	push   %esi
 4b8:	e8 96 fe ff ff       	call   353 <write>
  while(--i >= 0)
 ...
 4e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 520:	50                   	push   %eax
 521:	57                   	push   %edi
 522:	e8 2c fe ff ff       	call   353 <write>
 ...
 591:	52                   	push   %edx
 592:	57                   	push   %edi
 593:	e8 bb fd ff ff       	call   353 <write>
        putc(fd, c);
 ...
 660:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 665:	bb 04 08 00 00       	mov    $0x804,%ebx
 ...
 671:	a1 6c 0b 00 00       	mov    0xb6c,%eax
{
 ...
 6af:	5b                   	pop    %ebx
  freep = p;
 6b0:	a3 6c 0b 00 00       	mov    %eax,0xb6c
}
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 6b7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 74b:	3b 05 6c 0b 00 00    	cmp    0xb6c,%eax
 751:	75 ed                	jne    740 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 753:	83 ec 0c             	sub    $0xc,%esp
 756:	56                   	push   %esi
 757:	e8 5f fc ff ff       	call   3bb <sbrk>
  if(p == (char*)-1)
 ...
 76e:	e8 fd fe ff ff       	call   670 <free>
  return freep;
 773:	8b 15 6c 0b 00 00    	mov    0xb6c,%edx
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 79f:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
}
 ...
 7af:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 6c 0b 00 00 70 	movl   $0xb70,0xb6c
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	b8 70 0b 00 00       	mov    $0xb70,%eax
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 70 0b 00 00 70 	movl   $0xb70,0xb70
 7c6:	0b 00 00 
    base.s.size = 0;
 7c9:	c7 05 74 0b 00 00 00 	movl   $0x0,0xb74
 7d0:	00 00 00 
    if(p->s.size >= nunits){
