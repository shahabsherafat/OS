...
main(void)
{
  ...
  6c:	6a 01                	push   $0x1
  6e:	e8 0d 04 00 00       	call   480 <printf>
    exit();
 ...
 611:	a1 20 0b 00 00       	mov    0xb20,%eax
{
 ...
 64f:	5b                   	pop    %ebx
  freep = p;
 650:	a3 20 0b 00 00       	mov    %eax,0xb20
}
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 20 0b 00 00    	mov    0xb20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6eb:	3b 05 20 0b 00 00    	cmp    0xb20,%eax
 ...
 70e:	e8 fd fe ff ff       	call   610 <free>
  return freep;
 713:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 757:	0b 00 00 
    base.s.size = 0;
 75a:	b8 24 0b 00 00       	mov    $0xb24,%eax
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 24 0b 00 00 24 	movl   $0xb24,0xb24
 766:	0b 00 00 
    base.s.size = 0;
 769:	c7 05 28 0b 00 00 00 	movl   $0x0,0xb28
 770:	00 00 00 
    if(p->s.size >= nunits){
