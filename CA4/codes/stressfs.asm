 ...
 488:	89 d1                	mov    %edx,%ecx
{
 ...
 4f6:	50                   	push   %eax
 4f7:	56                   	push   %esi
 4f8:	e8 96 fe ff ff       	call   393 <write>
  while(--i >= 0)
 ...
 529:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 560:	50                   	push   %eax
 561:	57                   	push   %edi
 562:	e8 2c fe ff ff       	call   393 <write>
 ...
 5d1:	52                   	push   %edx
 5d2:	57                   	push   %edi
 5d3:	e8 bb fd ff ff       	call   393 <write>
        putc(fd, c);
 ...
 63b:	53                   	push   %ebx
 63c:	57                   	push   %edi
 63d:	e8 51 fd ff ff       	call   393 <write>
        while(*s != 0){
 ...
 67a:	52                   	push   %edx
 67b:	57                   	push   %edi
 67c:	e8 12 fd ff ff       	call   393 <write>
        ap++;
...
free(void *ap)
{
 ...
 6b1:	a1 58 0b 00 00       	mov    0xb58,%eax
{
 ...
 6ef:	5b                   	pop    %ebx
  freep = p;
 6f0:	a3 58 0b 00 00       	mov    %eax,0xb58
}
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 6f7:	5d                   	pop    %ebp
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 58 0b 00 00       	mov    %eax,0xb58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 58 0b 00 00    	mov    0xb58,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78b:	3b 05 58 0b 00 00    	cmp    0xb58,%eax
 791:	75 ed                	jne    780 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 793:	83 ec 0c             	sub    $0xc,%esp
 796:	56                   	push   %esi
 797:	e8 5f fc ff ff       	call   3fb <sbrk>
  if(p == (char*)-1)
 ...
 7ae:	e8 fd fe ff ff       	call   6b0 <free>
  return freep;
 7b3:	8b 15 58 0b 00 00    	mov    0xb58,%edx
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7df:	89 15 58 0b 00 00    	mov    %edx,0xb58
}
 ...
 7ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 58 0b 00 00 5c 	movl   $0xb5c,0xb58
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	b8 5c 0b 00 00       	mov    $0xb5c,%eax
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 5c 0b 00 00 5c 	movl   $0xb5c,0xb5c
 806:	0b 00 00 
    base.s.size = 0;
 809:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
 810:	00 00 00 
    if(p->s.size >= nunits){
