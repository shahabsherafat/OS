...
fork1(void)
{
  ...
  if (pid == -1)
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
      88:	80 3d e1 1f 00 00 64 	cmpb   $0x64,0x1fe1
      8f:	75 d2                	jne    63 <main+0x63>
      91:	80 3d e2 1f 00 00 20 	cmpb   $0x20,0x1fe2
      98:	75 c9                	jne    63 <main+0x63>
      buf[strlen(buf) - 1] = 0; // chop \n
      9a:	83 ec 0c             	sub    $0xc,%esp
      9d:	68 e0 1f 00 00       	push   $0x1fe0
      a2:	e8 a9 10 00 00       	call   1150 <strlen>
      if (chdir(buf + 3) < 0)
      a7:	c7 04 24 e3 1f 00 00 	movl   $0x1fe3,(%esp)
      buf[strlen(buf) - 1] = 0; // chop \n
      ae:	c6 80 df 1f 00 00 00 	movb   $0x0,0x1fdf(%eax)
      if (chdir(buf + 3) < 0)
      ...
      bf:	0f 89 7b ff ff ff    	jns    40 <main+0x40>
        printf(2, "cannot cd %s\n", buf + 3);
      c5:	50                   	push   %eax
      c6:	68 e3 1f 00 00       	push   $0x1fe3
      cb:	68 7c 18 00 00       	push   $0x187c
      d0:	6a 02                	push   $0x2
      d2:	e8 e9 13 00 00       	call   14c0 <printf>
...
00000120 <auto_complete>:
{
  ...
  printf(2, "%s\t", instruction + buf_len);
     ...
     173:	51                   	push   %ecx
     174:	68 c8 17 00 00       	push   $0x17c8
     179:	6a 02                	push   $0x2
     17b:	e8 40 13 00 00       	call   14c0 <printf>
}
...
00000190 <print_instructions>:
{
  ...
  printf(2, "\n");
     1a5:	68 f0 17 00 00       	push   $0x17f0
     1aa:	6a 02                	push   $0x2
     1ac:	e8 0f 13 00 00       	call   14c0 <printf>
  for (int i = 0; i < count; i++) {
    ...
    if (instructions[i])
     ...
     1ca:	52                   	push   %edx
     1cb:	68 70 18 00 00       	push   $0x1870
     1d0:	6a 02                	push   $0x2
     1d2:	e8 e9 12 00 00       	call   14c0 <printf>
  ...
  printf(2, "\t");
     ...
     1e4:	68 ca 17 00 00       	push   $0x17ca
     1e9:	6a 02                	push   $0x2
     1eb:	e8 d0 12 00 00       	call   14c0 <printf>
  printf(2, "$ %s", prefix);
     1f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     1f3:	83 c4 10             	add    $0x10,%esp
     1f6:	c7 45 0c cc 17 00 00 	movl   $0x17cc,0xc(%ebp)
     ...
     20d:	5d                   	pop    %ebp
  printf(2, "$ %s", prefix);
     20e:	e9 ad 12 00 00       	jmp    14c0 <printf>
...
00000290 <get_matching_instructions>:
{
  ...
  fd = open(path, 0);
     29c:	6a 00                	push   $0x0
     29e:	68 d1 17 00 00       	push   $0x17d1
  ...
  char **instructions = malloc(sizeof(char *) * 16);
     ...
     2b2:	e8 29 14 00 00       	call   16e0 <malloc>
  ...
  while (read(fd, &de, sizeof(de)) == sizeof(de)) {
    ...
    for (int i = 0; i < prefix_len; i++) {
     ...
     340:	6a 0f                	push   $0xf
     342:	e8 99 13 00 00       	call   16e0 <malloc>
  ...
  for (int i = 0; i < prefix_len; i++) {
    ...
    instructions[counter] = malloc(3);
     ...
     3fe:	6a 03                	push   $0x3
     400:	e8 db 12 00 00       	call   16e0 <malloc>
...
00000440 <getcmd>:
{
  ...
  if (!temp_buf) {
     448:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
{
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     45b:	a1 cc 1f 00 00       	mov    0x1fcc,%eax
     460:	0b 05 c8 1f 00 00    	or     0x1fc8,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     48e:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
    ...
    TAPPRESS = 0;
     4a4:	c7 05 cc 1f 00 00 00 	movl   $0x0,0x1fcc
     4ab:	00 00 00 
    has_multiple_choice = 0;
     4ae:	c7 05 c8 1f 00 00 00 	movl   $0x0,0x1fc8
     4b5:	00 00 00 
  if (buf[0] == 0)
     4b8:	80 3b 00             	cmpb   $0x0,(%ebx)
     4bb:	0f 84 89 01 00 00    	je     64a <getcmd+0x20a>
  if (temp_buf)
     4c1:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     4eb:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
    ...
    has_multiple_choice = 0;
     505:	c7 05 c8 1f 00 00 00 	movl   $0x0,0x1fc8
     50c:	00 00 00 
    TAPPRESS = 0;
     50f:	c7 05 cc 1f 00 00 00 	movl   $0x0,0x1fcc
     516:	00 00 00 
    ...
    if (instruction_num == 0) {
     ...
     540:	8b 0d c8 1f 00 00    	mov    0x1fc8,%ecx
     546:	85 c9                	test   %ecx,%ecx
     548:	0f 85 a2 00 00 00    	jne    5f0 <getcmd+0x1b0>
        if (temp_buf)
     54e:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
        has_multiple_choice = 1; 
     553:	c7 05 c8 1f 00 00 01 	movl   $0x1,0x1fc8
     55a:	00 00 00 
        if (temp_buf)
     ...
     57b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      if (temp_buf)
     580:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
      TAPPRESS = 1;
     585:	c7 05 cc 1f 00 00 01 	movl   $0x1,0x1fcc
     58c:	00 00 00 
      if (temp_buf)
    ...
    temp_buf = malloc(nbuf);
     ...
     59b:	56                   	push   %esi
     59c:	e8 3f 11 00 00       	call   16e0 <malloc>
    if (temp_buf)
     5a1:	83 c4 10             	add    $0x10,%esp
    temp_buf = malloc(nbuf);
     5a4:	a3 c0 1f 00 00       	mov    %eax,0x1fc0
    if (temp_buf)
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     5b4:	a1 cc 1f 00 00       	mov    0x1fcc,%eax
     5b9:	0b 05 c8 1f 00 00    	or     0x1fc8,%eax
     5bf:	0f 85 a7 fe ff ff    	jne    46c <getcmd+0x2c>
     5c5:	8d 76 00             	lea    0x0(%esi),%esi
    printf(2, "$ ");
     5c8:	83 ec 08             	sub    $0x8,%esp
     5cb:	68 d3 17 00 00       	push   $0x17d3
     5d0:	6a 02                	push   $0x2
     5d2:	e8 e9 0e 00 00       	call   14c0 <printf>
    memset(buf, 0, nbuf);
     ...
     5f6:	e8 95 fb ff ff       	call   190 <print_instructions>
        if (temp_buf)
     5fb:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
     600:	83 c4 10             	add    $0x10,%esp
        done_printing = 1;
     603:	c7 05 c4 1f 00 00 01 	movl   $0x1,0x1fc4
     60a:	00 00 00 
        if (temp_buf)
     ...
     626:	e8 f5 fa ff ff       	call   120 <auto_complete>
      if (temp_buf)
     62b:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
     630:	83 c4 10             	add    $0x10,%esp
      TAPPRESS = 1;
     633:	c7 05 cc 1f 00 00 01 	movl   $0x1,0x1fcc
     63a:	00 00 00 
      if (temp_buf)
...
00000660 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     669:	68 70 18 00 00       	push   $0x1870
     66e:	6a 02                	push   $0x2
     670:	e8 4b 0e 00 00       	call   14c0 <printf>
  exit();
...
00000680 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     695:	68 d6 17 00 00       	push   $0x17d6
...
000006a0 <runcmd>:
{
  ...
  switch (cmd->type) {
     ...
     6b9:	ff 24 85 94 18 00 00 	jmp    *0x1894(,%eax,4)
    if (ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     6d9:	68 e2 17 00 00       	push   $0x17e2
     6de:	6a 02                	push   $0x2
     6e0:	e8 db 0d 00 00       	call   14c0 <printf>
    break;
    ...
    panic("runcmd");
     ...
     79d:	68 db 17 00 00       	push   $0x17db
     7a2:	e8 b9 fe ff ff       	call   660 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     7a7:	51                   	push   %ecx
     7a8:	ff 73 08             	push   0x8(%ebx)
     7ab:	68 f2 17 00 00       	push   $0x17f2
     7b0:	6a 02                	push   $0x2
     7b2:	e8 09 0d 00 00       	call   14c0 <printf>
      exit();
     7b7:	e8 57 0b 00 00       	call   1313 <exit>
      panic("pipe");
     7bc:	83 ec 0c             	sub    $0xc,%esp
     7bf:	68 02 18 00 00       	push   $0x1802
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     837:	6a 54                	push   $0x54
     839:	e8 a2 0e 00 00       	call   16e0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     867:	6a 18                	push   $0x18
     869:	e8 72 0e 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8b7:	6a 0c                	push   $0xc
     8b9:	e8 22 0e 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8f7:	6a 0c                	push   $0xc
     8f9:	e8 e2 0d 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     937:	6a 08                	push   $0x8
     939:	e8 a2 0d 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     969:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     98d:	50                   	push   %eax
     98e:	68 b0 1f 00 00       	push   $0x1fb0
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     9dd:	50                   	push   %eax
     9de:	68 b0 1f 00 00       	push   $0x1fb0
  ...
  *ps = s;
  ...
  switch (*s) {
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a36:	50                   	push   %eax
     a37:	68 a8 1f 00 00       	push   $0x1fa8
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a55:	50                   	push   %eax
     a56:	68 b0 1f 00 00       	push   $0x1fb0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     afd:	50                   	push   %eax
     afe:	68 b0 1f 00 00       	push   $0x1fb0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while (peek(ps, es, "<>")) {
     ...
     b63:	68 24 18 00 00       	push   $0x1824
     b68:	53                   	push   %ebx
     b69:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     bc0:	6a 18                	push   $0x18
     bc2:	e8 19 0b 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     c1f:	6a 18                	push   $0x18
     c21:	e8 ba 0a 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     c7e:	68 07 18 00 00       	push   $0x1807
...
parseexec(char **ps, char *es)
{
  ...
  if (peek(ps, es, "("))
     c9f:	68 27 18 00 00       	push   $0x1827
     ca4:	56                   	push   %esi
     ca5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     cbb:	6a 54                	push   $0x54
     cbd:	e8 1e 0a 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (!peek(ps, es, "|)&;")) {
     ...
     d06:	68 3e 18 00 00       	push   $0x183e
     d0b:	56                   	push   %esi
     d0c:	53                   	push   %ebx
    ...
    if (argc >= MAXARGS)
     ...
     d50:	68 30 18 00 00       	push   $0x1830
  ...
  cmd->eargv[argc] = 0;
     ...
     d99:	68 29 18 00 00       	push   $0x1829
...
00000db0 <parsepipe>:
{
  ...
  if (peek(ps, es, "|")) {
     ...
     dc9:	68 43 18 00 00       	push   $0x1843
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     e0d:	e8 ce 08 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000e40 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     e72:	e8 69 08 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (peek(ps, es, "&")) {
     ...
     e9b:	68 45 18 00 00       	push   $0x1845
     ea0:	57                   	push   %edi
     ea1:	56                   	push   %esi
  ...
  if (peek(ps, es, ";")) {
     ...
     eb1:	68 41 18 00 00       	push   $0x1841
     eb6:	57                   	push   %edi
     eb7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     eed:	e8 ee 07 00 00       	call   16e0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000f20 <parseblock>:
{
  ...
  if (!peek(ps, es, "("))
     f2f:	68 27 18 00 00       	push   $0x1827
     f34:	56                   	push   %esi
     f35:	53                   	push   %ebx
  ...
  if (!peek(ps, es, ")"))
     ...
     f59:	68 63 18 00 00       	push   $0x1863
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch (cmd->type) {
     ...
     fc5:	ff 24 85 ac 18 00 00 	jmp    *0x18ac(,%eax,4)
    ...
    1055:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
    ...
    1073:	68 cb 17 00 00       	push   $0x17cb
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    109e:	52                   	push   %edx
    109f:	50                   	push   %eax
    10a0:	68 65 18 00 00       	push   $0x1865
    10a5:	6a 02                	push   $0x2
    10a7:	e8 14 04 00 00       	call   14c0 <printf>
    panic("syntax");
    10ac:	c7 04 24 29 18 00 00 	movl   $0x1829,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    1428:	89 d1                	mov    %edx,%ecx
{
    142a:	83 ec 3c             	sub    $0x3c,%esp
    142d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    1430:	85 d2                	test   %edx,%edx
    1432:	0f 89 80 00 00 00    	jns    14b8 <printint+0x98>
    1438:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    143c:	74 7a                	je     14b8 <printint+0x98>
    x = -xx;
    143e:	f7 d9                	neg    %ecx
    neg = 1;
  ...
  i = 0;
    1445:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    1448:	31 f6                	xor    %esi,%esi
    144a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    1450:	89 c8                	mov    %ecx,%eax
    1452:	31 d2                	xor    %edx,%edx
    1454:	89 f7                	mov    %esi,%edi
    1456:	f7 f3                	div    %ebx
    1458:	8d 76 01             	lea    0x1(%esi),%esi
    145b:	0f b6 92 1c 19 00 00 	movzbl 0x191c(%edx),%edx
    1462:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    1466:	89 ca                	mov    %ecx,%edx
    1468:	89 c1                	mov    %eax,%ecx
    146a:	39 da                	cmp    %ebx,%edx
    146c:	73 e2                	jae    1450 <printint+0x30>
  if(neg)
    146e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    1471:	85 c0                	test   %eax,%eax
    1473:	74 07                	je     147c <printint+0x5c>
    buf[i++] = '-';
    1475:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    147a:	89 f7                	mov    %esi,%edi
    147c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    147f:	8b 75 c0             	mov    -0x40(%ebp),%esi
    1482:	01 df                	add    %ebx,%edi
    1484:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    1488:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    148b:	83 ec 04             	sub    $0x4,%esp
    148e:	88 45 d7             	mov    %al,-0x29(%ebp)
    1491:	8d 45 d7             	lea    -0x29(%ebp),%eax
    1494:	6a 01                	push   $0x1
    1496:	50                   	push   %eax
    1497:	56                   	push   %esi
    1498:	e8 96 fe ff ff       	call   1333 <write>
  while(--i >= 0)
    149d:	89 f8                	mov    %edi,%eax
    149f:	83 c4 10             	add    $0x10,%esp
    14a2:	83 ef 01             	sub    $0x1,%edi
    14a5:	39 c3                	cmp    %eax,%ebx
    14a7:	75 df                	jne    1488 <printint+0x68>
}
  ...
  neg = 0;
    ...
    14ba:	eb 89                	jmp    1445 <printint+0x25>
...
{
    14cc:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    14cf:	0f b6 1e             	movzbl (%esi),%ebx
    14d2:	83 c6 01             	add    $0x1,%esi
    14d5:	84 db                	test   %bl,%bl
    14d7:	74 67                	je     1540 <printf+0x80>
    14d9:	8d 4d 10             	lea    0x10(%ebp),%ecx
    14dc:	31 d2                	xor    %edx,%edx
    14de:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    14e1:	eb 34                	jmp    1517 <printf+0x57>
    14e3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    14e8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    14eb:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    14f0:	83 f8 25             	cmp    $0x25,%eax
    14f3:	74 18                	je     150d <printf+0x4d>
  write(fd, &c, 1);
    14f5:	83 ec 04             	sub    $0x4,%esp
    14f8:	8d 45 e7             	lea    -0x19(%ebp),%eax
    14fb:	88 5d e7             	mov    %bl,-0x19(%ebp)
    14fe:	6a 01                	push   $0x1
    1500:	50                   	push   %eax
    1501:	57                   	push   %edi
    1502:	e8 2c fe ff ff       	call   1333 <write>
    1507:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    150a:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    150d:	0f b6 1e             	movzbl (%esi),%ebx
    1510:	83 c6 01             	add    $0x1,%esi
    1513:	84 db                	test   %bl,%bl
    1515:	74 29                	je     1540 <printf+0x80>
    c = fmt[i] & 0xff;
    1517:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    151a:	85 d2                	test   %edx,%edx
    151c:	74 ca                	je     14e8 <printf+0x28>
      }
    } else if(state == '%'){
    151e:	83 fa 25             	cmp    $0x25,%edx
    1521:	75 ea                	jne    150d <printf+0x4d>
      if(c == 'd'){
    1523:	83 f8 25             	cmp    $0x25,%eax
    1526:	0f 84 04 01 00 00    	je     1630 <printf+0x170>
    152c:	83 e8 63             	sub    $0x63,%eax
    152f:	83 f8 15             	cmp    $0x15,%eax
    1532:	77 1c                	ja     1550 <printf+0x90>
    1534:	ff 24 85 c4 18 00 00 	jmp    *0x18c4(,%eax,4)
    153b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
    ...
    1546:	5d                   	pop    %ebp
    1547:	c3                   	ret
    1548:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    154f:	00 
  write(fd, &c, 1);
    1550:	83 ec 04             	sub    $0x4,%esp
    1553:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1556:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    155a:	6a 01                	push   $0x1
    155c:	52                   	push   %edx
    155d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    1560:	57                   	push   %edi
    1561:	e8 cd fd ff ff       	call   1333 <write>
    1566:	83 c4 0c             	add    $0xc,%esp
    1569:	88 5d e7             	mov    %bl,-0x19(%ebp)
    156c:	6a 01                	push   $0x1
    156e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    1571:	52                   	push   %edx
    1572:	57                   	push   %edi
    1573:	e8 bb fd ff ff       	call   1333 <write>
        putc(fd, c);
    1578:	83 c4 10             	add    $0x10,%esp
      state = 0;
    157b:	31 d2                	xor    %edx,%edx
    157d:	eb 8e                	jmp    150d <printf+0x4d>
    157f:	90                   	nop
        printint(fd, *ap, 16, 0);
    1580:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1583:	83 ec 0c             	sub    $0xc,%esp
    1586:	b9 10 00 00 00       	mov    $0x10,%ecx
    158b:	8b 13                	mov    (%ebx),%edx
    158d:	6a 00                	push   $0x0
    158f:	89 f8                	mov    %edi,%eax
        ap++;
    1591:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    1594:	e8 87 fe ff ff       	call   1420 <printint>
        ap++;
    1599:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    159c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    159f:	31 d2                	xor    %edx,%edx
    15a1:	e9 67 ff ff ff       	jmp    150d <printf+0x4d>
        s = (char*)*ap;
    15a6:	8b 45 d0             	mov    -0x30(%ebp),%eax
    15a9:	8b 18                	mov    (%eax),%ebx
        ap++;
    15ab:	83 c0 04             	add    $0x4,%eax
    15ae:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    15b1:	85 db                	test   %ebx,%ebx
    15b3:	0f 84 87 00 00 00    	je     1640 <printf+0x180>
        while(*s != 0){
    15b9:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    15bc:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    15be:	84 c0                	test   %al,%al
    15c0:	0f 84 47 ff ff ff    	je     150d <printf+0x4d>
    15c6:	8d 55 e7             	lea    -0x19(%ebp),%edx
    15c9:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    15cc:	89 de                	mov    %ebx,%esi
    15ce:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
    15d0:	83 ec 04             	sub    $0x4,%esp
    15d3:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
  ...
  write(fd, &c, 1);
    ...
    15db:	53                   	push   %ebx
    15dc:	57                   	push   %edi
    15dd:	e8 51 fd ff ff       	call   1333 <write>
        while(*s != 0){
    ...
    15f1:	e9 17 ff ff ff       	jmp    150d <printf+0x4d>
        printint(fd, *ap, 10, 1);
    15f6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    15f9:	83 ec 0c             	sub    $0xc,%esp
    15fc:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1601:	8b 13                	mov    (%ebx),%edx
    1603:	6a 01                	push   $0x1
    1605:	eb 88                	jmp    158f <printf+0xcf>
        putc(fd, *ap);
    1607:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    160a:	83 ec 04             	sub    $0x4,%esp
    160d:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    1610:	8b 03                	mov    (%ebx),%eax
        ap++;
    1612:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    1615:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    1618:	6a 01                	push   $0x1
    161a:	52                   	push   %edx
    161b:	57                   	push   %edi
    161c:	e8 12 fd ff ff       	call   1333 <write>
        ap++;
    1621:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    1624:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1627:	31 d2                	xor    %edx,%edx
    1629:	e9 df fe ff ff       	jmp    150d <printf+0x4d>
    162e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    1630:	83 ec 04             	sub    $0x4,%esp
    1633:	88 5d e7             	mov    %bl,-0x19(%ebp)
    1636:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1639:	6a 01                	push   $0x1
    163b:	e9 31 ff ff ff       	jmp    1571 <printf+0xb1>
    1640:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1645:	bb 8a 18 00 00       	mov    $0x188a,%ebx
    164a:	e9 77 ff ff ff       	jmp    15c6 <printf+0x106>
    164f:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1651:	a1 44 20 00 00       	mov    0x2044,%eax
{
  ...
  freep = p;
    ...
    168f:	5b                   	pop    %ebx
  freep = p;
    1690:	a3 44 20 00 00       	mov    %eax,0x2044
}
    1695:	5e                   	pop    %esi
    1696:	5f                   	pop    %edi
    1697:	5d                   	pop    %ebp
    ...
    16a6:	72 ce                	jb     1676 <free+0x26>
{
  ...
  freep = p;
    16ca:	a3 44 20 00 00       	mov    %eax,0x2044
    p->s.size += bp->s.size;
    16cf:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    16d2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    16d5:	89 08                	mov    %ecx,(%eax)
}
    16d7:	5b                   	pop    %ebx
    16d8:	5e                   	pop    %esi
    16d9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16ec:	8b 15 44 20 00 00    	mov    0x2044,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    16fd:	0f 84 8d 00 00 00    	je     1790 <malloc+0xb0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1708:	39 f9                	cmp    %edi,%ecx
    170a:	73 64                	jae    1770 <malloc+0x90>
  if(nu < 4096)
    170c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1711:	39 df                	cmp    %ebx,%edi
    1713:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    1716:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    171d:	eb 0a                	jmp    1729 <malloc+0x49>
    171f:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1720:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1722:	8b 48 04             	mov    0x4(%eax),%ecx
    1725:	39 f9                	cmp    %edi,%ecx
    1727:	73 47                	jae    1770 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    172b:	3b 05 44 20 00 00    	cmp    0x2044,%eax
    1731:	75 ed                	jne    1720 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1733:	83 ec 0c             	sub    $0xc,%esp
    1736:	56                   	push   %esi
    1737:	e8 5f fc ff ff       	call   139b <sbrk>
  if(p == (char*)-1)
    173c:	83 c4 10             	add    $0x10,%esp
    173f:	83 f8 ff             	cmp    $0xffffffff,%eax
    1742:	74 1c                	je     1760 <malloc+0x80>
  hp->s.size = nu;
    1744:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1747:	83 ec 0c             	sub    $0xc,%esp
    174a:	83 c0 08             	add    $0x8,%eax
    174d:	50                   	push   %eax
    174e:	e8 fd fe ff ff       	call   1650 <free>
  return freep;
    1753:	8b 15 44 20 00 00    	mov    0x2044,%edx
      if((p = morecore(nunits)) == 0)
    1759:	83 c4 10             	add    $0x10,%esp
    175c:	85 d2                	test   %edx,%edx
    175e:	75 c0                	jne    1720 <malloc+0x40>
        return 0;
  }
}
    1760:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    1772:	74 4c                	je     17c0 <malloc+0xe0>
        p->s.size -= nunits;
    ...
    177c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    177f:	89 15 44 20 00 00    	mov    %edx,0x2044
}
    ...
    178f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1790:	c7 05 44 20 00 00 48 	movl   $0x2048,0x2044
    1797:	20 00 00 
    base.s.size = 0;
    179a:	b8 48 20 00 00       	mov    $0x2048,%eax
    base.s.ptr = freep = prevp = &base;
    179f:	c7 05 48 20 00 00 48 	movl   $0x2048,0x2048
    17a6:	20 00 00 
    base.s.size = 0;
    17a9:	c7 05 4c 20 00 00 00 	movl   $0x0,0x204c
    17b0:	00 00 00 
    if(p->s.size >= nunits){
    17b3:	e9 54 ff ff ff       	jmp    170c <malloc+0x2c>
    17b8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    17bf:	00 
        prevp->s.ptr = p->s.ptr;
    17c0:	8b 08                	mov    (%eax),%ecx
    17c2:	89 0a                	mov    %ecx,(%edx)
    17c4:	eb b9                	jmp    177f <malloc+0x9f>
