   ...
   f:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  34:	68 1c 09 00 00       	push   $0x91c
  39:	e8 a2 01 00 00       	call   1e0 <strlen>
  3e:	83 c4 0c             	add    $0xc,%esp
  41:	50                   	push   %eax
  42:	68 1c 09 00 00       	push   $0x91c
  47:	53                   	push   %ebx
  ...
  55:	58                   	pop    %eax
  56:	5a                   	pop    %edx
  57:	68 87 08 00 00       	push   $0x887
  5c:	6a 01                	push   $0x1
  5e:	e8 ed 04 00 00       	call   550 <printf>
  run_one("KEYWORD", fname);
  63:	ba 6e 08 00 00       	mov    $0x86e,%edx
  68:	b8 99 08 00 00       	mov    $0x899,%eax
  6d:	e8 4e 00 00 00       	call   c0 <run_one>
  run_one("NOPE", fname);
  72:	ba 6e 08 00 00       	mov    $0x86e,%edx
  77:	b8 a1 08 00 00       	mov    $0x8a1,%eax
  7c:	e8 3f 00 00 00       	call   c0 <run_one>
  run_one("anything", "no_such_file.txt");
  81:	ba a6 08 00 00       	mov    $0x8a6,%edx
  86:	b8 b7 08 00 00       	mov    $0x8b7,%eax
  ...
  a5:	51                   	push   %ecx
  a6:	68 6e 08 00 00       	push   $0x86e
  ab:	68 75 08 00 00       	push   $0x875
  b0:	6a 02                	push   $0x2
  b2:	e8 99 04 00 00       	call   550 <printf>
    exit();
...
static void run_one(const char *key, const char *path){
  ...
  ef:	b9 58 08 00 00       	mov    $0x858,%ecx
  f4:	ba 6d 08 00 00       	mov    $0x86d,%edx
 ...
 108:	6a 01                	push   $0x1
 10a:	e8 41 04 00 00       	call   550 <printf>
    printf(1, "=> \"%s\"\n", out);
 10f:	83 c4 1c             	add    $0x1c,%esp
 112:	56                   	push   %esi
 113:	68 65 08 00 00       	push   $0x865
 118:	6a 01                	push   $0x1
 11a:	e8 31 04 00 00       	call   550 <printf>
 ...
 135:	6a 01                	push   $0x1
 137:	e8 14 04 00 00       	call   550 <printf>
 ...
 4b8:	89 d1                	mov    %edx,%ecx
{
 ...
 4eb:	0f b6 92 bc 09 00 00 	movzbl 0x9bc(%edx),%edx
 ...
 526:	50                   	push   %eax
 527:	56                   	push   %esi
 528:	e8 96 fe ff ff       	call   3c3 <write>
  while(--i >= 0)
 ...
 559:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 590:	50                   	push   %eax
 591:	57                   	push   %edi
 592:	e8 2c fe ff ff       	call   3c3 <write>
 ...
 5c4:	ff 24 85 64 09 00 00 	jmp    *0x964(,%eax,4)
 ...
 601:	52                   	push   %edx
 602:	57                   	push   %edi
 603:	e8 bb fd ff ff       	call   3c3 <write>
        putc(fd, c);
 ...
 66b:	53                   	push   %ebx
 66c:	57                   	push   %edi
 66d:	e8 51 fd ff ff       	call   3c3 <write>
        while(*s != 0){
 ...
 6aa:	52                   	push   %edx
 6ab:	57                   	push   %edi
 6ac:	e8 12 fd ff ff       	call   3c3 <write>
        ap++;
 ...
 6d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6d5:	bb c0 08 00 00       	mov    $0x8c0,%ebx
...
free(void *ap)
{
 ...
 6e1:	a1 90 0c 00 00       	mov    0xc90,%eax
{
 ...
 71f:	5b                   	pop    %ebx
  freep = p;
 720:	a3 90 0c 00 00       	mov    %eax,0xc90
}
 725:	5e                   	pop    %esi
 726:	5f                   	pop    %edi
 727:	5d                   	pop    %ebp
 ...
 736:	72 ce                	jb     706 <free+0x26>
{
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 90 0c 00 00       	mov    %eax,0xc90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 90 0c 00 00    	mov    0xc90,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bb:	3b 05 90 0c 00 00    	cmp    0xc90,%eax
 7c1:	75 ed                	jne    7b0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 7c3:	83 ec 0c             	sub    $0xc,%esp
 7c6:	56                   	push   %esi
 7c7:	e8 5f fc ff ff       	call   42b <sbrk>
  if(p == (char*)-1)
 ...
 7de:	e8 fd fe ff ff       	call   6e0 <free>
  return freep;
 7e3:	8b 15 90 0c 00 00    	mov    0xc90,%edx
 ...
 80c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 80f:	89 15 90 0c 00 00    	mov    %edx,0xc90
}
 ...
 81f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 90 0c 00 00 94 	movl   $0xc94,0xc90
 827:	0c 00 00 
    base.s.size = 0;
 82a:	b8 94 0c 00 00       	mov    $0xc94,%eax
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 94 0c 00 00 94 	movl   $0xc94,0xc94
 836:	0c 00 00 
    base.s.size = 0;
 839:	c7 05 98 0c 00 00 00 	movl   $0x0,0xc98
 840:	00 00 00 
    if(p->s.size >= nunits){
