 ...
 398:	89 d1                	mov    %edx,%ecx
{
 ...
 406:	50                   	push   %eax
 407:	56                   	push   %esi
 408:	e8 96 fe ff ff       	call   2a3 <write>
  while(--i >= 0)
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 470:	50                   	push   %eax
 471:	57                   	push   %edi
 472:	e8 2c fe ff ff       	call   2a3 <write>
 ...
 4e1:	52                   	push   %edx
 4e2:	57                   	push   %edi
 4e3:	e8 bb fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 58a:	52                   	push   %edx
 58b:	57                   	push   %edi
 58c:	e8 12 fd ff ff       	call   2a3 <write>
        ap++;
 ...
 5c1:	a1 38 0a 00 00       	mov    0xa38,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 38 0a 00 00       	mov    %eax,0xa38
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 38 0a 00 00       	mov    %eax,0xa38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 69b:	3b 05 38 0a 00 00    	cmp    0xa38,%eax
 6a1:	75 ed                	jne    690 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 6a3:	83 ec 0c             	sub    $0xc,%esp
 6a6:	56                   	push   %esi
 6a7:	e8 5f fc ff ff       	call   30b <sbrk>
  if(p == (char*)-1)
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 38 0a 00 00    	mov    0xa38,%edx
 ...
 707:	0a 00 00 
    base.s.size = 0;
 70a:	b8 3c 0a 00 00       	mov    $0xa3c,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 3c 0a 00 00 3c 	movl   $0xa3c,0xa3c
 716:	0a 00 00 
    base.s.size = 0;
 719:	c7 05 40 0a 00 00 00 	movl   $0x0,0xa40
 720:	00 00 00 
    if(p->s.size >= nunits){
