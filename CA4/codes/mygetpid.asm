 ...
 378:	89 d1                	mov    %edx,%ecx
{
 ...
 3e6:	50                   	push   %eax
 3e7:	56                   	push   %esi
 3e8:	e8 96 fe ff ff       	call   283 <write>
  while(--i >= 0)
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 450:	50                   	push   %eax
 451:	57                   	push   %edi
 452:	e8 2c fe ff ff       	call   283 <write>
 ...
 4c1:	52                   	push   %edx
 4c2:	57                   	push   %edi
 4c3:	e8 bb fd ff ff       	call   283 <write>
        putc(fd, c);
 ...
 56a:	52                   	push   %edx
 56b:	57                   	push   %edi
 56c:	e8 12 fd ff ff       	call   283 <write>
        ap++;
...
free(void *ap)
{
 ...
 5a1:	a1 0c 0a 00 00       	mov    0xa0c,%eax
{
 ...
 5df:	5b                   	pop    %ebx
  freep = p;
 5e0:	a3 0c 0a 00 00       	mov    %eax,0xa0c
}
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 5e7:	5d                   	pop    %ebp
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 0c 0a 00 00       	mov    %eax,0xa0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	3b 05 0c 0a 00 00    	cmp    0xa0c,%eax
 681:	75 ed                	jne    670 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 683:	83 ec 0c             	sub    $0xc,%esp
 686:	56                   	push   %esi
 687:	e8 5f fc ff ff       	call   2eb <sbrk>
  if(p == (char*)-1)
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
}
 ...
 6df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 0c 0a 00 00 10 	movl   $0xa10,0xa0c
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 10 0a 00 00       	mov    $0xa10,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 700:	00 00 00 
    if(p->s.size >= nunits){
