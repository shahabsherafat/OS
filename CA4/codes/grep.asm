 ...
 6c8:	89 d1                	mov    %edx,%ecx
{
 ...
 736:	50                   	push   %eax
 737:	56                   	push   %esi
 738:	e8 d6 fe ff ff       	call   613 <write>
  while(--i >= 0)
 ...
 769:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 7a0:	50                   	push   %eax
 7a1:	57                   	push   %edi
 7a2:	e8 6c fe ff ff       	call   613 <write>
 ...
 811:	52                   	push   %edx
 812:	57                   	push   %edi
 813:	e8 fb fd ff ff       	call   613 <write>
        putc(fd, c);
 ...
 8ba:	52                   	push   %edx
 8bb:	57                   	push   %edi
 8bc:	e8 52 fd ff ff       	call   613 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9d6:	56                   	push   %esi
 9d7:	e8 9f fc ff ff       	call   67b <sbrk>
  if(p == (char*)-1)
