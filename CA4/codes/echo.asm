 ...
 601:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 63f:	5b                   	pop    %ebx
  freep = p;
 640:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 647:	5d                   	pop    %ebp
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 88 0a 00 00       	mov    %eax,0xa88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6db:	3b 05 88 0a 00 00    	cmp    0xa88,%eax
 ...
 6fe:	e8 fd fe ff ff       	call   600 <free>
  return freep;
 703:	8b 15 88 0a 00 00    	mov    0xa88,%edx
 ...
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 756:	0a 00 00 
    base.s.size = 0;
 759:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 760:	00 00 00 
    if(p->s.size >= nunits){
