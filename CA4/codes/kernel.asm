...
80100028:	bc 90 89 11 80       	mov    $0x80118990,%esp
...
8010004c:	68 00 97 10 80       	push   $0x80109700
80100051:	68 20 d5 10 80       	push   $0x8010d520
80100056:	e8 15 5e 00 00       	call   80105e70 <initlock>
  bcache.head.next = &bcache.head;
...
8010008b:	c7 43 50 1c 1c 11 80 	movl   $0x80111c1c,0x50(%ebx)
    initsleeplock(&b->lock, "buffer");
80100092:	68 07 97 10 80       	push   $0x80109707
...
801000e4:	e8 77 5f 00 00       	call   80106060 <acquire>
...
80100162:	e8 99 5e 00 00       	call   80106000 <release>
      acquiresleep(&b->lock);
...
801001a1:	68 0e 97 10 80       	push   $0x8010970e
...
801001dc:	68 1f 97 10 80       	push   $0x8010971f
...
8010021b:	e8 40 5e 00 00       	call   80106060 <acquire>
  b->refcnt--;
...
80100268:	5d                   	pop    %ebp
  release(&bcache.lock);
80100269:	e9 92 5d 00 00       	jmp    80106000 <release>
    panic("brelse");
8010026e:	83 ec 0c             	sub    $0xc,%esp
80100271:	68 26 97 10 80       	push   $0x80109726
...
801003ac:	e8 af 5c 00 00       	call   80106060 <acquire>
...
80100406:	e8 f5 5b 00 00       	call   80106000 <release>
        ilock(ip);
...
80100473:	e8 88 5b 00 00       	call   80106000 <release>
  ilock(ip);
...
80100572:	68 2d 97 10 80       	push   $0x8010972d
...
80100580:	e8 db 07 00 00       	call   80100d60 <cprintf>
  cprintf("\n");
80100585:	c7 04 24 8e 9c 10 80 	movl   $0x80109c8e,(%esp)
...
80100598:	e8 f3 58 00 00       	call   80105e90 <getcallerpcs>
  for (i = 0; i < 10; i++)
...
801005a5:	83 c3 04             	add    $0x4,%ebx
    cprintf(" %p", pcs[i]);
801005a8:	68 41 97 10 80       	push   $0x80109741
...
80100605:	e8 46 7c 00 00       	call   80108250 <uartputc>
...
801006a9:	e8 a2 7b 00 00       	call   80108250 <uartputc>
...
801006ee:	68 45 97 10 80       	push   $0x80109745
...
8010071a:	e8 41 5f 00 00       	call   80106660 <memmove>
...
80100736:	e8 95 5e 00 00       	call   801065d0 <memset>
  outb(CRTPORT + 1, pos);
...
80100752:	e8 f9 7a 00 00       	call   80108250 <uartputc>
    uartputc(' ');
80100757:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010075e:	e8 ed 7a 00 00       	call   80108250 <uartputc>
    uartputc('\b');
80100763:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010076a:	e8 e1 7a 00 00       	call   80108250 <uartputc>
...
801007fa:	e8 51 7a 00 00       	call   80108250 <uartputc>
...
8010086b:	0f b6 92 4c 9d 10 80 	movzbl -0x7fef62b4(%edx),%edx
...
80100beb:	e8 70 54 00 00       	call   80106060 <acquire>
...
80100c76:	e8 85 53 00 00       	call   80106000 <release>
  ilock(ip);
80100c7b:	58                   	pop    %eax
...
80100e88:	e8 d3 51 00 00       	call   80106060 <acquire>
  if (fmt == 0)
...
80100eab:	e8 50 51 00 00       	call   80106000 <release>
...
80100ee2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        s = "(null)";
80100ee8:	bf 58 97 10 80       	mov    $0x80109758,%edi
...
80100f65:	68 5f 97 10 80       	push   $0x8010975f
...
80100f81:	e8 da 50 00 00       	call   80106060 <acquire>
  while ((c = getc()) >= 0)
...
80100fa8:	ff 24 85 e0 9c 10 80 	jmp    *-0x7fef6320(,%eax,4)
80100faf:	90                   	nop
...
80101508:	e8 f3 4a 00 00       	call   80106000 <release>
  if (doprocdump)
...
80101fe0:	68 68 97 10 80       	push   $0x80109768
80101fe5:	68 c0 21 11 80       	push   $0x801121c0
80101fea:	e8 81 3e 00 00       	call   80105e70 <initlock>
...
801020b4:	0f 85 f1 00 00 00    	jne    801021ab <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
801020ba:	e8 01 73 00 00       	call   801093c0 <setupkvm>
...
8010212b:	e8 c0 70 00 00       	call   801091f0 <allocuvm>
...
80102161:	e8 ba 6f 00 00       	call   80109120 <loaduvm>
...
801021a3:	e8 98 71 00 00       	call   80109340 <freevm>
  if(ip){
...
80102202:	e8 e9 6f 00 00       	call   801091f0 <allocuvm>
...
80102221:	31 f6                	xor    %esi,%esi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80102223:	e8 38 72 00 00       	call   80109460 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
8010226a:	e8 51 45 00 00       	call   801067c0 <strlen>
...
80102278:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
8010227b:	e8 40 45 00 00       	call   801067c0 <strlen>
...
8010228e:	e8 9d 73 00 00       	call   80109630 <copyout>
...
801022a3:	e8 98 70 00 00       	call   80109340 <freevm>
...
801022ff:	e8 2c 73 00 00       	call   80109630 <copyout>
...
8010233f:	e8 3c 44 00 00       	call   80106780 <safestrcpy>
  curproc->pgdir = pgdir;
...
8010236b:	e8 20 6c 00 00       	call   80108f90 <switchuvm>
  freevm(oldpgdir);
80102370:	89 34 24             	mov    %esi,(%esp)
80102373:	e8 c8 6f 00 00       	call   80109340 <freevm>
  return 0;
...
801023ba:	68 70 97 10 80       	push   $0x80109770
...
801023d6:	68 7c 97 10 80       	push   $0x8010977c
801023db:	68 00 22 11 80       	push   $0x80112200
801023e0:	e8 8b 3a 00 00       	call   80105e70 <initlock>
}
...
80102401:	e8 5a 3c 00 00       	call   80106060 <acquire>
...
80102431:	e8 ca 3b 00 00       	call   80106000 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
8010244a:	e8 b1 3b 00 00       	call   80106000 <release>
}
...
8010246f:	e8 ec 3b 00 00       	call   80106060 <acquire>
  if(f->ref < 1)
...
8010248c:	e8 6f 3b 00 00       	call   80106000 <release>
  return f;
}
...
8010249b:	68 83 97 10 80       	push   $0x80109783
...
801024c1:	e8 9a 3b 00 00       	call   80106060 <acquire>
  if(f->ref < 1)
...
801024fc:	e8 ff 3a 00 00       	call   80106000 <release>
...
8010252d:	5d                   	pop    %ebp
    release(&ftable.lock);
8010252e:	e9 cd 3a 00 00       	jmp    80106000 <release>
...
8010257c:	68 8b 97 10 80       	push   $0x8010978b
...
80102662:	68 95 97 10 80       	push   $0x80109795
...
80102737:	68 9e 97 10 80       	push   $0x8010979e
...
80102771:	68 a4 97 10 80       	push   $0x801097a4
...
80102829:	68 ae 97 10 80       	push   $0x801097ae
...
8010286d:	e8 5e 3d 00 00       	call   801065d0 <memset>
  log_write(bp);
...
801028aa:	e8 b1 37 00 00       	call   80106060 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80102917:	e8 e4 36 00 00       	call   80106000 <release>
...
80102945:	e8 b6 36 00 00       	call   80106000 <release>
      return ip;
...
80102978:	68 c4 97 10 80       	push   $0x801097c4
...
801029f7:	68 d4 97 10 80       	push   $0x801097d4
...
80102ad5:	68 e7 97 10 80       	push   $0x801097e7
...
80102b01:	e8 5a 3b 00 00       	call   80106660 <memmove>
  brelse(bp);
...
80102b7c:	e8 df 3a 00 00       	call   80106660 <memmove>
  brelse(bp);
...
80102bb3:	68 60 9d 10 80       	push   $0x80109d60
...
80102c4e:	e8 7d 39 00 00       	call   801065d0 <memset>
      dip->type = type;
...
80102c83:	68 07 98 10 80       	push   $0x80109807
...
80102cf1:	e8 6a 39 00 00       	call   80106660 <memmove>
  log_write(bp);
...
80102d1f:	e8 3c 33 00 00       	call   80106060 <acquire>
  ip->ref++;
80102d24:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80102d28:	c7 04 24 00 2c 11 80 	movl   $0x80112c00,(%esp)
80102d2f:	e8 cc 32 00 00       	call   80106000 <release>
}
...
80102dd8:	e8 83 38 00 00       	call   80106660 <memmove>
    brelse(bp);
...
80102dfd:	68 1f 98 10 80       	push   $0x8010981f
80102e02:	e8 49 d7 ff ff       	call   80100550 <panic>
    panic("ilock");
80102e07:	83 ec 0c             	sub    $0xc,%esp
80102e0a:	68 19 98 10 80       	push   $0x80109819
...
80102e33:	e8 38 2d 00 00       	call   80105b70 <holdingsleep>
...
80102e57:	68 2e 98 10 80       	push   $0x8010982e
...
80102ea6:	e8 b5 31 00 00       	call   80106060 <acquire>
  ip->ref--;
...
80102fe3:	e8 88 2b 00 00       	call   80105b70 <holdingsleep>
...
80103013:	68 2e 98 10 80       	push   $0x8010982e
...
801030f7:	e8 64 35 00 00       	call   80106660 <memmove>
    brelse(bp);
...
801031f5:	e8 66 34 00 00       	call   80106660 <memmove>
    log_write(bp);
...
8010327e:	e8 4d 34 00 00       	call   801066d0 <strncmp>
}
80103283:	c9                   	leave
80103284:	c3                   	ret
...
801032dd:	e8 ee 33 00 00       	call   801066d0 <strncmp>
      continue;
...
80103322:	68 48 98 10 80       	push   $0x80109848
80103327:	e8 24 d2 ff ff       	call   80100550 <panic>
    panic("dirlookup not DIR");
8010332c:	83 ec 0c             	sub    $0xc,%esp
8010332f:	68 36 98 10 80       	push   $0x80109836
...
8010336a:	e8 f1 2c 00 00       	call   80106060 <acquire>
  ip->ref++;
8010336f:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80103373:	c7 04 24 00 2c 11 80 	movl   $0x80112c00,(%esp)
8010337a:	e8 81 2c 00 00       	call   80106000 <release>
...
801033d7:	e8 84 32 00 00       	call   80106660 <memmove>
...
8010343c:	e8 2f 27 00 00       	call   80105b70 <holdingsleep>
...
8010348b:	e8 d0 31 00 00       	call   80106660 <memmove>
    name[len] = 0;
...
801034c5:	e8 a6 26 00 00       	call   80105b70 <holdingsleep>
...
80103515:	e8 56 26 00 00       	call   80105b70 <holdingsleep>
...
80103551:	68 2e 98 10 80       	push   $0x8010982e
...
801035bd:	e8 5e 31 00 00       	call   80106720 <strncpy>
  de.inum = inum;
...
801035fb:	68 57 98 10 80       	push   $0x80109857
80103600:	e8 4b cf ff ff       	call   80100550 <panic>
    panic("dirlink");
80103605:	83 ec 0c             	sub    $0xc,%esp
80103608:	68 8c 9b 10 80       	push   $0x80109b8c
...
80103676:	81 fe cf 07 00 00    	cmp    $0x7cf,%esi
...
8010371b:	68 6d 98 10 80       	push   $0x8010986d
80103720:	e8 2b ce ff ff       	call   80100550 <panic>
    panic("idestart");
80103725:	83 ec 0c             	sub    $0xc,%esp
80103728:	68 64 98 10 80       	push   $0x80109864
...
80103746:	68 7f 98 10 80       	push   $0x8010987f
8010374b:	68 a0 48 11 80       	push   $0x801148a0
80103750:	e8 1b 27 00 00       	call   80105e70 <initlock>
...
801037de:	e8 7d 28 00 00       	call   80106060 <acquire>
...
8010385b:	e8 a0 27 00 00       	call   80106000 <release>
...
8010387e:	e8 ed 22 00 00       	call   80105b70 <holdingsleep>
...
801038b8:	e8 a3 27 00 00       	call   80106060 <acquire>
...
80103915:	c9                   	leave
  release(&idelock);
80103916:	e9 e5 26 00 00       	jmp    80106000 <release>
...
801039aa:	68 b4 9d 10 80       	push   $0x80109db4
...
80103a52:	81 fb 90 89 11 80    	cmp    $0x80118990,%ebx
...
80103a72:	e8 59 2b 00 00       	call   801065d0 <memset>
...
80103aa8:	e8 b3 25 00 00       	call   80106060 <acquire>
...
80103ac2:	c9                   	leave
    release(&kmem.lock);
80103ac3:	e9 38 25 00 00       	jmp    80106000 <release>
    panic("kfree");
80103ac8:	83 ec 0c             	sub    $0xc,%esp
80103acb:	68 cc 98 10 80       	push   $0x801098cc
...
80103b9b:	68 d2 98 10 80       	push   $0x801098d2
80103ba0:	68 e0 48 11 80       	push   $0x801148e0
80103ba5:	e8 c6 22 00 00       	call   80105e70 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80103c38:	e8 23 24 00 00       	call   80106060 <acquire>
  r = kmem.freelist;
...
80103c63:	e8 98 23 00 00       	call   80106000 <release>
}
...
80103cbb:	0f b6 91 e0 a0 10 80 	movzbl -0x7fef5f20(%ecx),%edx
  shift ^= togglecode[data];
80103cc2:	0f b6 81 e0 9f 10 80 	movzbl -0x7fef6020(%ecx),%eax
  shift |= shiftcode[data];
...
80103cd8:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
80103cdb:	8b 04 85 c0 9f 10 80 	mov    -0x7fef6040(,%eax,4),%eax
...
80103d15:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80103d18:	0f b6 81 e0 a0 10 80 	movzbl -0x7fef5f20(%ecx),%eax
...
80104073:	e8 98 25 00 00       	call   80106610 <memcmp>
...
801041a4:	e8 b7 24 00 00       	call   80106660 <memmove>
...
8010424a:	68 d7 98 10 80       	push   $0x801098d7
8010424f:	68 40 49 11 80       	push   $0x80114940
80104254:	e8 17 1c 00 00       	call   80105e70 <initlock>
  readsb(dev, &sb);
80104259:	58                   	pop    %eax
...
801042eb:	e8 70 1d 00 00       	call   80106060 <acquire>
...
8010433c:	e8 bf 1c 00 00       	call   80106000 <release>
      break;
    }
  }
}
...
8010435e:	e8 fd 1c 00 00       	call   80106060 <acquire>
  log.outstanding -= 1;
...
8010439c:	e8 5f 1c 00 00       	call   80106000 <release>
}
...
801043b6:	e8 a5 1c 00 00       	call   80106060 <acquire>
    log.committing = 0;
...
801043d8:	e8 23 1c 00 00       	call   80106000 <release>
...
80104434:	e8 27 22 00 00       	call   80106660 <memmove>
...
80104494:	e8 67 1b 00 00       	call   80106000 <release>
...
801044a7:	68 db 98 10 80       	push   $0x801098db
...
801044f2:	e8 69 1b 00 00       	call   80106060 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80104538:	c9                   	leave
  release(&log.lock);
80104539:	e9 c2 1a 00 00       	jmp    80106000 <release>
...
80104555:	68 ea 98 10 80       	push   $0x801098ea
8010455a:	e8 f1 bf ff ff       	call   80100550 <panic>
    panic("log_write outside of trans");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 00 99 10 80       	push   $0x80109900
...
80104588:	68 1b 99 10 80       	push   $0x8010991b
8010458d:	e8 ce c7 ff ff       	call   80100d60 <cprintf>
  idtinit();       // load idt register
80104592:	e8 e9 38 00 00       	call   80107e80 <idtinit>
...
801045b3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801045b6:	e8 c5 49 00 00       	call   80108f80 <switchkvm>
  seginit();
801045bb:	e8 30 49 00 00       	call   80108ef0 <seginit>
  lapicinit();
...
80104614:	e8 47 3b 00 00       	call   80108160 <uartinit>
  pinit();         // process table
80104619:	e8 52 08 00 00       	call   80104e70 <pinit>
  tvinit();        // trap vectors
8010461e:	e8 dd 37 00 00       	call   80107e00 <tvinit>
  binit();         // buffer cache
...
80104644:	e8 17 20 00 00       	call   80106660 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80104649:	83 c4 10             	add    $0x10,%esp
8010464c:	69 05 24 4a 11 80 b0 	imul   $0xb0,0x80114a24,%eax
80104653:	00 00 00 
...
80104670:	69 05 24 4a 11 80 b0 	imul   $0xb0,0x80114a24,%eax
80104677:	00 00 00 
...
8010472e:	68 2f 99 10 80       	push   $0x8010992f
80104733:	56                   	push   %esi
80104734:	e8 d7 1e 00 00       	call   80106610 <memcmp>
...
801047e9:	68 34 99 10 80       	push   $0x80109934
801047ee:	50                   	push   %eax
801047ef:	e8 1c 1e 00 00       	call   80106610 <memcmp>
...
8010491b:	68 39 99 10 80       	push   $0x80109939
...
80104942:	68 2f 99 10 80       	push   $0x8010992f
80104947:	53                   	push   %ebx
80104948:	e8 c3 1c 00 00       	call   80106610 <memcmp>
...
80104978:	68 e8 9d 10 80       	push   $0x80109de8
...
80104a20:	00 00 00 
  initlock(&p->lock, "pipe");
80104a23:	68 51 99 10 80       	push   $0x80109951
80104a28:	50                   	push   %eax
80104a29:	e8 42 14 00 00       	call   80105e70 <initlock>
  (*f0)->type = FD_PIPE;
...
80104aaf:	e8 ac 15 00 00       	call   80106060 <acquire>
  if(writable){
...
80104b50:	e8 0b 15 00 00       	call   80106060 <acquire>
  for(i = 0; i < n; i++){
...
80104be4:	e8 17 14 00 00       	call   80106000 <release>
        return -1;
...
80104c40:	e8 bb 13 00 00       	call   80106000 <release>
  return n;
...
80104c76:	e8 e5 13 00 00       	call   80106060 <acquire>
...
80104d0e:	e8 ed 12 00 00       	call   80106000 <release>
  return i;
...
80104d29:	e8 d2 12 00 00       	call   80106000 <release>
      return -1;
...
80104d44:	bb f4 4f 11 80       	mov    $0x80114ff4,%ebx
{
80104d49:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
80104d4c:	68 c0 4f 11 80       	push   $0x80114fc0
80104d51:	e8 0a 13 00 00       	call   80106060 <acquire>
...
80104d63:	81 fb f4 6f 11 80    	cmp    $0x80116ff4,%ebx
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
80104d76:	a1 04 d0 10 80       	mov    0x8010d004,%eax
...
80104d88:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
80104d8b:	68 c0 4f 11 80       	push   $0x80114fc0
  p->pid = nextpid++;
80104d90:	89 15 04 d0 10 80    	mov    %edx,0x8010d004
  release(&ptable.lock);
80104d96:	e8 65 12 00 00       	call   80106000 <release>
...
80104db8:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80104dbb:	c7 40 14 ec 7d 10 80 	movl   $0x80107dec,0x14(%eax)
  p->context = (struct context*)sp;
...
80104dca:	e8 01 18 00 00       	call   801065d0 <memset>
...
80104df3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80104df5:	68 c0 4f 11 80       	push   $0x80114fc0
80104dfa:	e8 01 12 00 00       	call   80106000 <release>
  return 0;
...
80104e14:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104e1b:	00 
...
80104e23:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80104e26:	68 c0 4f 11 80       	push   $0x80114fc0
80104e2b:	e8 d0 11 00 00       	call   80106000 <release>

  if (first) {
80104e30:	a1 00 d0 10 80       	mov    0x8010d000,%eax
...
80104e3e:	66 90                	xchg   %ax,%ax
    first = 0;
80104e40:	c7 05 00 d0 10 80 00 	movl   $0x0,0x8010d000
80104e47:	00 00 00 
    iinit(ROOTDEV);
...
80104e63:	c9                   	leave
80104e64:	c3                   	ret
80104e65:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104e6c:	00 
...
80104e76:	68 56 99 10 80       	push   $0x80109956
80104e7b:	68 c0 4f 11 80       	push   $0x80114fc0
80104e80:	e8 eb 0f 00 00       	call   80105e70 <initlock>
}
...
80104e9c:	e8 cf ef ff ff       	call   80103e70 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80104ea1:	8b 35 24 4a 11 80    	mov    0x80114a24,%esi
...
80104ebd:	0f b6 99 40 4a 11 80 	movzbl -0x7feeb5c0(%ecx),%ebx
80104ec4:	39 c3                	cmp    %eax,%ebx
80104ec6:	75 e8                	jne    80104eb0 <mycpu+0x20>
}
80104ec8:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80104ecb:	8d 81 40 4a 11 80    	lea    -0x7feeb5c0(%ecx),%eax
}
80104ed1:	5b                   	pop    %ebx
80104ed2:	5e                   	pop    %esi
80104ed3:	5d                   	pop    %ebp
...
80104efb:	c9                   	leave
  return mycpu()-cpus;
80104efc:	2d 40 4a 11 80       	sub    $0x80114a40,%eax
80104f01:	c1 f8 04             	sar    $0x4,%eax
80104f04:	69 c0 a3 8b 2e ba    	imul   $0xba2e8ba3,%eax,%eax
}
80104f0a:	c3                   	ret
80104f0b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
80104f4c:	89 c3                	mov    %eax,%ebx
  initproc = p;
80104f4e:	a3 f4 6f 11 80       	mov    %eax,0x80116ff4
  if((p->pgdir = setupkvm()) == 0)
80104f53:	e8 68 44 00 00       	call   801093c0 <setupkvm>
...
80104f6b:	68 60 d4 10 80       	push   $0x8010d460
80104f70:	50                   	push   %eax
80104f71:	e8 2a 41 00 00       	call   801090a0 <inituvm>
...
80104f86:	e8 45 16 00 00       	call   801065d0 <memset>
...
80104fdf:	68 86 99 10 80       	push   $0x80109986
80104fe4:	50                   	push   %eax
80104fe5:	e8 96 17 00 00       	call   80106780 <safestrcpy>
  p->cwd = namei("/");
80104fea:	c7 04 24 8f 99 10 80 	movl   $0x8010998f,(%esp)
80104ff1:	e8 2a e6 ff ff       	call   80103620 <namei>
80104ff6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80104ff9:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
80105000:	e8 5b 10 00 00       	call   80106060 <acquire>
  p->state = RUNNABLE;
80105005:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
8010500c:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
80105013:	e8 e8 0f 00 00       	call   80106000 <release>
}
...
80105023:	68 6d 99 10 80       	push   $0x8010996d
...
80105035:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80105038:	e8 d3 0e 00 00       	call   80105f10 <pushcli>
  c = mycpu();
8010503d:	e8 4e fe ff ff       	call   80104e90 <mycpu>
  p = c->proc;
80105042:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80105048:	e8 13 0f 00 00       	call   80105f60 <popcli>
  sz = curproc->sz;
...
8010505b:	e8 30 3f 00 00       	call   80108f90 <switchuvm>
  return 0;
...
8010507a:	e8 71 41 00 00       	call   801091f0 <allocuvm>
...
8010509a:	e8 71 42 00 00       	call   80109310 <deallocuvm>
...
801050b6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801050b9:	e8 52 0e 00 00       	call   80105f10 <pushcli>
  c = mycpu();
801050be:	e8 cd fd ff ff       	call   80104e90 <mycpu>
  p = c->proc;
801050c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801050c9:	e8 92 0e 00 00       	call   80105f60 <popcli>
  if((np = allocproc()) == 0){
...
801050ee:	e8 bd 43 00 00       	call   801094b0 <copyuvm>
...
80105171:	e8 0a 16 00 00       	call   80106780 <safestrcpy>
  pid = np->pid;
80105176:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80105179:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
80105180:	e8 db 0e 00 00       	call   80106060 <acquire>
  np->state = RUNNABLE;
80105185:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
8010518c:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
80105193:	e8 68 0e 00 00       	call   80106000 <release>
  return pid;
...
801051f4:	31 ff                	xor    %edi,%edi
    acquire(&ptable.lock);
801051f6:	68 c0 4f 11 80       	push   $0x80114fc0
801051fb:	e8 60 0e 00 00       	call   80106060 <acquire>
...
80105203:	b9 ff ff ff 7f       	mov    $0x7fffffff,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105208:	b8 f4 4f 11 80       	mov    $0x80114ff4,%eax
...
80105224:	3d f4 6f 11 80       	cmp    $0x80116ff4,%eax
...
80105239:	e8 52 3d 00 00       	call   80108f90 <switchuvm>
      highp->state = RUNNING;
...
8010524b:	e8 8b 15 00 00       	call   801067db <swtch>
      switchkvm();
80105250:	e8 2b 3d 00 00       	call   80108f80 <switchkvm>
      c->proc = 0;
...
80105265:	68 c0 4f 11 80       	push   $0x80114fc0
8010526a:	e8 91 0d 00 00       	call   80106000 <release>
  for(;;){
...
80105284:	53                   	push   %ebx
  pushcli();
80105285:	e8 86 0c 00 00       	call   80105f10 <pushcli>
  c = mycpu();
8010528a:	e8 01 fc ff ff       	call   80104e90 <mycpu>
  p = c->proc;
8010528f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80105295:	e8 c6 0c 00 00       	call   80105f60 <popcli>
  if(!holding(&ptable.lock))
8010529a:	83 ec 0c             	sub    $0xc,%esp
8010529d:	68 c0 4f 11 80       	push   $0x80114fc0
801052a2:	e8 19 0d 00 00       	call   80105fc0 <holding>
...
801052e3:	e8 f3 14 00 00       	call   801067db <swtch>
  mycpu()->intena = intena;
...
80105349:	e8 c2 fb ff ff       	call   80104f10 <myproc>
  if(curproc == initproc)
8010534e:	39 05 f4 6f 11 80    	cmp    %eax,0x80116ff4
...
8010539c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
801053a3:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
801053aa:	e8 b1 0c 00 00       	call   80106060 <acquire>
...
801053df:	3d f4 6f 11 80       	cmp    $0x80116ff4,%eax
801053e4:	75 e4                	jne    801053ca <exit+0x8a>
      p->parent = initproc;
801053e6:	8b 0d f4 6f 11 80    	mov    0x80116ff4,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801053ec:	ba f4 4f 11 80       	mov    $0x80114ff4,%edx
...
801053fb:	81 fa f4 6f 11 80    	cmp    $0x80116ff4,%edx
...
8010540f:	75 e7                	jne    801053f8 <exit+0xb8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105411:	b8 f4 4f 11 80       	mov    $0x80114ff4,%eax
...
80105423:	3d f4 6f 11 80       	cmp    $0x80116ff4,%eax
...
8010544d:	68 de 99 10 80       	push   $0x801099de
80105452:	e8 f9 b0 ff ff       	call   80100550 <panic>
    panic("init exiting");
80105457:	83 ec 0c             	sub    $0xc,%esp
8010545a:	68 d1 99 10 80       	push   $0x801099d1
8010545f:	e8 ec b0 ff ff       	call   80100550 <panic>
80105464:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010546b:	00 
...
80105474:	53                   	push   %ebx
  pushcli();
80105475:	e8 96 0a 00 00       	call   80105f10 <pushcli>
  c = mycpu();
8010547a:	e8 11 fa ff ff       	call   80104e90 <mycpu>
  p = c->proc;
8010547f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80105485:	e8 d6 0a 00 00       	call   80105f60 <popcli>
  acquire(&ptable.lock);
8010548a:	83 ec 0c             	sub    $0xc,%esp
8010548d:	68 c0 4f 11 80       	push   $0x80114fc0
80105492:	e8 c9 0b 00 00       	call   80106060 <acquire>
80105497:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010549a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010549c:	bb f4 4f 11 80       	mov    $0x80114ff4,%ebx
...
801054ab:	81 fb f4 6f 11 80    	cmp    $0x80116ff4,%ebx
...
801054c1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801054c6:	81 fb f4 6f 11 80    	cmp    $0x80116ff4,%ebx
...
801054db:	0f 85 95 00 00 00    	jne    80105576 <wait+0x106>
  pushcli();
801054e1:	e8 2a 0a 00 00       	call   80105f10 <pushcli>
  c = mycpu();
801054e6:	e8 a5 f9 ff ff       	call   80104e90 <mycpu>
  p = c->proc;
801054eb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801054f1:	e8 6a 0a 00 00       	call   80105f60 <popcli>
  if(p == 0)
...
80105539:	e8 02 3e 00 00       	call   80109340 <freevm>
        p->pid = 0;
...
80105557:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010555e:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
80105565:	e8 96 0a 00 00       	call   80106000 <release>
        return pid;
...
80105579:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010557e:	68 c0 4f 11 80       	push   $0x80114fc0
80105583:	e8 78 0a 00 00       	call   80106000 <release>
      return -1;
80105588:	83 c4 10             	add    $0x10,%esp
8010558b:	eb e0                	jmp    8010556d <wait+0xfd>
    panic("sleep");
8010558d:	83 ec 0c             	sub    $0xc,%esp
80105590:	68 ea 99 10 80       	push   $0x801099ea
...
801055a7:	68 c0 4f 11 80       	push   $0x80114fc0
801055ac:	e8 af 0a 00 00       	call   80106060 <acquire>
  pushcli();
801055b1:	e8 5a 09 00 00       	call   80105f10 <pushcli>
  c = mycpu();
801055b6:	e8 d5 f8 ff ff       	call   80104e90 <mycpu>
  p = c->proc;
801055bb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801055c1:	e8 9a 09 00 00       	call   80105f60 <popcli>
  myproc()->state = RUNNABLE;
801055c6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
801055cd:	e8 ae fc ff ff       	call   80105280 <sched>
  release(&ptable.lock);
801055d2:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
801055d9:	e8 22 0a 00 00       	call   80106000 <release>
}
...
801055fc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801055ff:	e8 0c 09 00 00       	call   80105f10 <pushcli>
  c = mycpu();
80105604:	e8 87 f8 ff ff       	call   80104e90 <mycpu>
  p = c->proc;
80105609:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010560f:	e8 4c 09 00 00       	call   80105f60 <popcli>
  if(p == 0)
...
80105620:	81 fe c0 4f 11 80    	cmp    $0x80114fc0,%esi
80105626:	74 50                	je     80105678 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80105628:	83 ec 0c             	sub    $0xc,%esp
8010562b:	68 c0 4f 11 80       	push   $0x80114fc0
80105630:	e8 2b 0a 00 00       	call   80106060 <acquire>
    release(lk);
80105635:	89 34 24             	mov    %esi,(%esp)
80105638:	e8 c3 09 00 00       	call   80106000 <release>
  p->chan = chan;
...
8010564c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80105653:	c7 04 24 c0 4f 11 80 	movl   $0x80114fc0,(%esp)
8010565a:	e8 a1 09 00 00       	call   80106000 <release>
    acquire(lk);
8010565f:	83 c4 10             	add    $0x10,%esp
80105662:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
8010566b:	5d                   	pop    %ebp
    acquire(lk);
8010566c:	e9 ef 09 00 00       	jmp    80106060 <acquire>
...
80105699:	68 f0 99 10 80       	push   $0x801099f0
8010569e:	e8 ad ae ff ff       	call   80100550 <panic>
    panic("sleep");
801056a3:	83 ec 0c             	sub    $0xc,%esp
801056a6:	68 ea 99 10 80       	push   $0x801099ea
...
801056b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801056ba:	68 c0 4f 11 80       	push   $0x80114fc0
801056bf:	e8 9c 09 00 00       	call   80106060 <acquire>
801056c4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801056c7:	b8 f4 4f 11 80       	mov    $0x80114ff4,%eax
801056cc:	eb 0c                	jmp    801056da <wakeup+0x2a>
801056ce:	66 90                	xchg   %ax,%ax
801056d0:	83 e8 80             	sub    $0xffffff80,%eax
801056d3:	3d f4 6f 11 80       	cmp    $0x80116ff4,%eax
...
801056ef:	3d f4 6f 11 80       	cmp    $0x80116ff4,%eax
801056f4:	75 e4                	jne    801056da <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
801056f6:	c7 45 08 c0 4f 11 80 	movl   $0x80114fc0,0x8(%ebp)
}
801056fd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105700:	c9                   	leave
  release(&ptable.lock);
80105701:	e9 fa 08 00 00       	jmp    80106000 <release>
...
80105717:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010571a:	68 c0 4f 11 80       	push   $0x80114fc0
8010571f:	e8 3c 09 00 00       	call   80106060 <acquire>
80105724:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105727:	b8 f4 4f 11 80       	mov    $0x80114ff4,%eax
8010572c:	eb 0c                	jmp    8010573a <kill+0x2a>
8010572e:	66 90                	xchg   %ax,%ax
80105730:	83 e8 80             	sub    $0xffffff80,%eax
80105733:	3d f4 6f 11 80       	cmp    $0x80116ff4,%eax
...
80105756:	68 c0 4f 11 80       	push   $0x80114fc0
8010575b:	e8 a0 08 00 00       	call   80106000 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80105773:	68 c0 4f 11 80       	push   $0x80114fc0
80105778:	e8 83 08 00 00       	call   80106000 <release>
}
...
80105799:	bb 60 50 11 80       	mov    $0x80115060,%ebx
8010579e:	83 ec 3c             	sub    $0x3c,%esp
801057a1:	eb 24                	jmp    801057c7 <procdump+0x37>
801057a3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    if(p->state == SLEEPING){
...
801057cc:	74 ea                	je     801057b8 <procdump+0x28>
      state = "???";
801057ce:	ba 01 9a 10 80       	mov    $0x80109a01,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801057d3:	83 f8 05             	cmp    $0x5,%eax
801057d6:	77 11                	ja     801057e9 <procdump+0x59>
801057d8:	8b 14 85 e0 a1 10 80 	mov    -0x7fef5e20(,%eax,4),%edx
      state = "???";
801057df:	b8 01 9a 10 80       	mov    $0x80109a01,%eax
...
801057ee:	68 05 9a 10 80       	push   $0x80109a05
...
80105815:	e8 76 06 00 00       	call   80105e90 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010582d:	68 41 97 10 80       	push   $0x80109741
...
801058a1:	68 0e 9a 10 80       	push   $0x80109a0e
...
801058b0:	68 2b 9a 10 80       	push   $0x80109a2b
  int have_child = 0;
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801058b5:	bb f4 4f 11 80       	mov    $0x80114ff4,%ebx
  cprintf("Children of process %d:\n", target->pid);
...
801058d3:	81 fb f4 6f 11 80    	cmp    $0x80116ff4,%ebx
...
8010591b:	ff 76 10             	push   0x10(%esi)
  ...
  if (parent) {
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010591e:	bb f4 4f 11 80       	mov    $0x80114ff4,%ebx
  cprintf("Siblings of process %d:\n", target->pid);
80105923:	68 61 9a 10 80       	push   $0x80109a61
...
80105943:	81 fb f4 6f 11 80    	cmp    $0x80116ff4,%ebx
...
80105987:	68 c0 4f 11 80       	push   $0x80114fc0
8010598c:	e8 6f 06 00 00       	call   80106000 <release>
  return 0;
...
801059a1:	68 7a 9a 10 80       	push   $0x80109a7a
...
801059b3:	68 53 9a 10 80       	push   $0x80109a53
...
801059c8:	68 c0 4f 11 80       	push   $0x80114fc0
801059cd:	e8 2e 06 00 00       	call   80106000 <release>
    return -1;              // pid not found
...
801059e0:	5d                   	pop    %ebp
801059e1:	c3                   	ret
801059e2:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801059e9:	00 
...
80105a03:	68 c0 4f 11 80       	push   $0x80114fc0
80105a08:	e8 53 06 00 00       	call   80106060 <acquire>
80105a0d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105a10:	b8 f4 4f 11 80       	mov    $0x80114ff4,%eax
...
80105a23:	3d f4 6f 11 80       	cmp    $0x80116ff4,%eax
...
80105a38:	68 c0 4f 11 80       	push   $0x80114fc0
80105a3d:	e8 be 05 00 00       	call   80106000 <release>
  return old;
...
80105a6a:	68 c3 9a 10 80       	push   $0x80109ac3
80105a6f:	8d 43 04             	lea    0x4(%ebx),%eax
80105a72:	50                   	push   %eax
80105a73:	e8 f8 03 00 00       	call   80105e70 <initlock>
  lk->name = name;
...
80105aaf:	e8 ac 05 00 00       	call   80106060 <acquire>
  while (lk->locked) {
...
80105aec:	5d                   	pop    %ebp
  release(&lk->lk);
80105aed:	e9 0e 05 00 00       	jmp    80106000 <release>
80105af2:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105af9:	00 
...
80105b09:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80105b0c:	8d 73 04             	lea    0x4(%ebx),%esi
80105b0f:	56                   	push   %esi
80105b10:	e8 4b 05 00 00       	call   80106060 <acquire>

  if(lk->locked == 0)
80105b15:	8b 03                	mov    (%ebx),%eax
80105b17:	83 c4 10             	add    $0x10,%esp
80105b1a:	85 c0                	test   %eax,%eax
80105b1c:	74 35                	je     80105b53 <releasesleep+0x53>
    panic("releasesleep: lock is not held");

  if(lk->pid != myproc()->pid)
80105b1e:	8b 7b 3c             	mov    0x3c(%ebx),%edi
80105b21:	e8 ea f3 ff ff       	call   80104f10 <myproc>
80105b26:	3b 78 10             	cmp    0x10(%eax),%edi
80105b29:	75 35                	jne    80105b60 <releasesleep+0x60>
...
80105b2b:	83 ec 0c             	sub    $0xc,%esp
  lk->locked = 0;
80105b2e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80105b34:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80105b3b:	53                   	push   %ebx
80105b3c:	e8 6f fb ff ff       	call   801056b0 <wakeup>

  release(&lk->lk);
80105b41:	83 c4 10             	add    $0x10,%esp
80105b44:	89 75 08             	mov    %esi,0x8(%ebp)
}
80105b47:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105b4a:	5b                   	pop    %ebx
80105b4b:	5e                   	pop    %esi
80105b4c:	5f                   	pop    %edi
80105b4d:	5d                   	pop    %ebp
  release(&lk->lk);
80105b4e:	e9 ad 04 00 00       	jmp    80106000 <release>
    panic("releasesleep: lock is not held");
80105b53:	83 ec 0c             	sub    $0xc,%esp
80105b56:	68 30 9e 10 80       	push   $0x80109e30
80105b5b:	e8 f0 a9 ff ff       	call   80100550 <panic>
    panic("releasesleep: not owner");
80105b60:	83 ec 0c             	sub    $0xc,%esp
80105b63:	68 ce 9a 10 80       	push   $0x80109ace
80105b68:	e8 e3 a9 ff ff       	call   80100550 <panic>
...
80105b82:	e8 d9 04 00 00       	call   80106060 <acquire>
...
80105b94:	e8 67 04 00 00       	call   80106000 <release>
  return r;
}
...
80105bab:	e8 60 f3 ff ff       	call   80104f10 <myproc>
80105bb0:	39 58 10             	cmp    %ebx,0x10(%eax)
...
80105bc3:	83 ec 08             	sub    $0x8,%esp
  if(!testlk_inited){
80105bc6:	8b 0d 00 70 11 80    	mov    0x80117000,%ecx
80105bcc:	85 c9                	test   %ecx,%ecx
80105bce:	74 70                	je     80105c40 <sys_sleeplock_hold+0x80>
  acquire(&lk->lk);
80105bd0:	83 ec 0c             	sub    $0xc,%esp
80105bd3:	68 24 70 11 80       	push   $0x80117024
80105bd8:	e8 83 04 00 00       	call   80106060 <acquire>
  while (lk->locked) {
80105bdd:	8b 15 20 70 11 80    	mov    0x80117020,%edx
80105be3:	83 c4 10             	add    $0x10,%esp
80105be6:	85 d2                	test   %edx,%edx
80105be8:	74 24                	je     80105c0e <sys_sleeplock_hold+0x4e>
80105bea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    sleep(lk, &lk->lk);
80105bf0:	83 ec 08             	sub    $0x8,%esp
80105bf3:	68 24 70 11 80       	push   $0x80117024
80105bf8:	68 20 70 11 80       	push   $0x80117020
80105bfd:	e8 ee f9 ff ff       	call   801055f0 <sleep>
  while (lk->locked) {
80105c02:	a1 20 70 11 80       	mov    0x80117020,%eax
80105c07:	83 c4 10             	add    $0x10,%esp
80105c0a:	85 c0                	test   %eax,%eax
80105c0c:	75 e2                	jne    80105bf0 <sys_sleeplock_hold+0x30>
  lk->locked = 1;
80105c0e:	c7 05 20 70 11 80 01 	movl   $0x1,0x80117020
80105c15:	00 00 00 
  lk->pid = myproc()->pid;
80105c18:	e8 f3 f2 ff ff       	call   80104f10 <myproc>
  release(&lk->lk);
80105c1d:	83 ec 0c             	sub    $0xc,%esp
  lk->pid = myproc()->pid;
80105c20:	8b 40 10             	mov    0x10(%eax),%eax
  release(&lk->lk);
80105c23:	68 24 70 11 80       	push   $0x80117024
  lk->pid = myproc()->pid;
80105c28:	a3 5c 70 11 80       	mov    %eax,0x8011705c
  release(&lk->lk);
80105c2d:	e8 ce 03 00 00       	call   80106000 <release>
...
80105c43:	68 c3 9a 10 80       	push   $0x80109ac3
80105c48:	68 24 70 11 80       	push   $0x80117024
80105c4d:	e8 1e 02 00 00       	call   80105e70 <initlock>
    testlk_inited = 1;
80105c52:	83 c4 10             	add    $0x10,%esp
  lk->name = name;
80105c55:	c7 05 58 70 11 80 e6 	movl   $0x80109ae6,0x80117058
80105c5c:	9a 10 80 
  lk->locked = 0;
80105c5f:	c7 05 20 70 11 80 00 	movl   $0x0,0x80117020
80105c66:	00 00 00 
  lk->pid = 0;
80105c69:	c7 05 5c 70 11 80 00 	movl   $0x0,0x8011705c
80105c70:	00 00 00 
    testlk_inited = 1;
80105c73:	c7 05 00 70 11 80 01 	movl   $0x1,0x80117000
80105c7a:	00 00 00 
80105c7d:	e9 4e ff ff ff       	jmp    80105bd0 <sys_sleeplock_hold+0x10>
80105c82:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105c89:	00 
80105c8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80105c90 <sys_sleeplock_drop>:
...
80105c93:	83 ec 08             	sub    $0x8,%esp
  if(!testlk_inited){
80105c96:	a1 00 70 11 80       	mov    0x80117000,%eax
80105c9b:	85 c0                	test   %eax,%eax
80105c9d:	74 11                	je     80105cb0 <sys_sleeplock_drop+0x20>
    initsleeplock(&testlk, "testlk");
    testlk_inited = 1;
  }
  releasesleep(&testlk);
80105c9f:	83 ec 0c             	sub    $0xc,%esp
80105ca2:	68 20 70 11 80       	push   $0x80117020
80105ca7:	e8 54 fe ff ff       	call   80105b00 <releasesleep>
  return 0;
}
...
80105cb3:	68 c3 9a 10 80       	push   $0x80109ac3
80105cb8:	68 24 70 11 80       	push   $0x80117024
80105cbd:	e8 ae 01 00 00       	call   80105e70 <initlock>
    testlk_inited = 1;
80105cc2:	83 c4 10             	add    $0x10,%esp
  lk->name = name;
80105cc5:	c7 05 58 70 11 80 e6 	movl   $0x80109ae6,0x80117058
80105ccc:	9a 10 80 
  lk->locked = 0;
80105ccf:	c7 05 20 70 11 80 00 	movl   $0x0,0x80117020
80105cd6:	00 00 00 
  lk->pid = 0;
80105cd9:	c7 05 5c 70 11 80 00 	movl   $0x0,0x8011705c
80105ce0:	00 00 00 
    testlk_inited = 1;
80105ce3:	c7 05 00 70 11 80 01 	movl   $0x1,0x80117000
80105cea:	00 00 00 
80105ced:	eb b0                	jmp    80105c9f <sys_sleeplock_drop+0xf>
80105cef:	90                   	nop
...
80105cfa:	68 ed 9a 10 80       	push   $0x80109aed
80105cff:	53                   	push   %ebx
80105d00:	e8 6b 01 00 00       	call   80105e70 <initlock>
  pl->locked = 0;
80105d05:	c7 43 34 00 00 00 00 	movl   $0x0,0x34(%ebx)
  pl->owner = 0;
  pl->head = 0;
}
80105d0c:	83 c4 10             	add    $0x10,%esp
  pl->owner = 0;
80105d0f:	c7 43 38 00 00 00 00 	movl   $0x0,0x38(%ebx)
  pl->head = 0;
80105d16:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
}
80105d1d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105d20:	c9                   	leave
80105d21:	c3                   	ret
80105d22:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105d29:	00 
80105d2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80105d30 <plock_acquire>:
...
80105d3c:	8b 7d 0c             	mov    0xc(%ebp),%edi
  struct proc *cur = myproc();
80105d3f:	e8 cc f1 ff ff       	call   80104f10 <myproc>
...
80105d48:	89 c6                	mov    %eax,%esi
  acquire(&pl->lk);
80105d4a:	e8 11 03 00 00       	call   80106060 <acquire>

  // If free, take it immediately.
  if(pl->locked == 0){
80105d4f:	8b 43 34             	mov    0x34(%ebx),%eax
80105d52:	83 c4 10             	add    $0x10,%esp
80105d55:	85 c0                	test   %eax,%eax
80105d57:	74 3f                	je     80105d98 <plock_acquire+0x68>
    release(&pl->lk);
    return;
  }
...
80105d59:	e8 a2 de ff ff       	call   80103c00 <kalloc>
  if(n == 0){
80105d5e:	85 c0                	test   %eax,%eax
80105d60:	74 4f                	je     80105db1 <plock_acquire+0x81>
  ...
  n->p = cur;
80105d62:	89 30                	mov    %esi,(%eax)
  n->priority = priority;
80105d64:	89 78 04             	mov    %edi,0x4(%eax)
  n->next = pl->head;
80105d67:	8b 53 3c             	mov    0x3c(%ebx),%edx
80105d6a:	89 50 08             	mov    %edx,0x8(%eax)
  pl->head = n;
80105d6d:	89 43 3c             	mov    %eax,0x3c(%ebx)
...
80105d75:	e8 76 f8 ff ff       	call   801055f0 <sleep>

    // We only proceed when lock has been handed off to us.
    if(pl->owner == cur)
80105d7a:	83 c4 10             	add    $0x10,%esp
80105d7d:	39 73 38             	cmp    %esi,0x38(%ebx)
80105d80:	75 ee                	jne    80105d70 <plock_acquire+0x40>
      break;
  }

  // At this point, we own the lock (handoff complete).
  release(&pl->lk);
80105d82:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80105d8b:	5d                   	pop    %ebp
  release(&pl->lk);
80105d8c:	e9 6f 02 00 00       	jmp    80106000 <release>
80105d91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    pl->locked = 1;
80105d98:	c7 43 34 01 00 00 00 	movl   $0x1,0x34(%ebx)
    pl->owner = cur;
80105d9f:	89 73 38             	mov    %esi,0x38(%ebx)
  release(&pl->lk);
80105da2:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80105dab:	5d                   	pop    %ebp
  release(&pl->lk);
80105dac:	e9 4f 02 00 00       	jmp    80106000 <release>
    release(&pl->lk);
80105db1:	83 ec 0c             	sub    $0xc,%esp
80105db4:	53                   	push   %ebx
80105db5:	e8 46 02 00 00       	call   80106000 <release>
    panic("plock_acquire: kalloc failed");
80105dba:	c7 04 24 f3 9a 10 80 	movl   $0x80109af3,(%esp)
80105dc1:	e8 8a a7 ff ff       	call   80100550 <panic>
80105dc6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105dcd:	00 
80105dce:	66 90                	xchg   %ax,%ax

80105dd0 <release_plock>:
...
80105ddf:	e8 7c 02 00 00       	call   80106060 <acquire>

  // If no one is waiting, unlock fully.
  if(pl->head == 0){
80105de4:	8b 5e 3c             	mov    0x3c(%esi),%ebx
80105de7:	83 c4 10             	add    $0x10,%esp
80105dea:	31 c9                	xor    %ecx,%ecx
80105dec:	89 d8                	mov    %ebx,%eax
80105dee:	85 db                	test   %ebx,%ebx
80105df0:	75 08                	jne    80105dfa <release_plock+0x2a>
80105df2:	eb 64                	jmp    80105e58 <release_plock+0x88>
...
80105df8:	89 d0                	mov    %edx,%eax
    if(cur->priority > best->priority){
80105dfa:	8b 53 04             	mov    0x4(%ebx),%edx
80105dfd:	39 50 04             	cmp    %edx,0x4(%eax)
80105e00:	7e 04                	jle    80105e06 <release_plock+0x36>
      best_prev = prev;
80105e02:	89 cf                	mov    %ecx,%edi
      best = cur;
80105e04:	89 c3                	mov    %eax,%ebx
    cur = cur->next;
80105e06:	8b 50 08             	mov    0x8(%eax),%edx
  while(cur != 0){
80105e09:	89 c1                	mov    %eax,%ecx
80105e0b:	85 d2                	test   %edx,%edx
80105e0d:	75 e9                	jne    80105df8 <release_plock+0x28>
  }
  ...
  if(best_prev == 0){
    // best is head
    pl->head = best->next;
80105e0f:	8b 43 08             	mov    0x8(%ebx),%eax
  if(best_prev == 0){
80105e12:	85 ff                	test   %edi,%edi
80105e14:	74 3a                	je     80105e50 <release_plock+0x80>
  } else {
    best_prev->next = best->next;
80105e16:	89 47 08             	mov    %eax,0x8(%edi)
  }

  // Direct handoff: keep locked=1, just change owner to selected process.
  pl->locked = 1;
80105e19:	c7 46 34 01 00 00 00 	movl   $0x1,0x34(%esi)
  pl->owner = best->p;
...
80105e22:	83 ec 0c             	sub    $0xc,%esp
  pl->owner = best->p;
80105e25:	89 46 38             	mov    %eax,0x38(%esi)
  wakeup(best->p);
80105e28:	50                   	push   %eax
80105e29:	e8 82 f8 ff ff       	call   801056b0 <wakeup>

  // Free the node memory (no longer needed).
  kfree((char*)best);
80105e2e:	89 1c 24             	mov    %ebx,(%esp)
80105e31:	e8 0a dc ff ff       	call   80103a40 <kfree>

  release(&pl->lk);
80105e36:	83 c4 10             	add    $0x10,%esp
80105e39:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80105e42:	5d                   	pop    %ebp
  release(&pl->lk);
80105e43:	e9 b8 01 00 00       	jmp    80106000 <release>
80105e48:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105e4f:	00 
    pl->head = best->next;
80105e50:	89 46 3c             	mov    %eax,0x3c(%esi)
80105e53:	eb c4                	jmp    80105e19 <release_plock+0x49>
80105e55:	8d 76 00             	lea    0x0(%esi),%esi
    pl->locked = 0;
80105e58:	c7 46 34 00 00 00 00 	movl   $0x0,0x34(%esi)
    pl->owner = 0;
80105e5f:	c7 46 38 00 00 00 00 	movl   $0x0,0x38(%esi)
    release(&pl->lk);
80105e66:	eb d1                	jmp    80105e39 <release_plock+0x69>
...
80105e73:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
80105e76:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->locked = 0;
80105e79:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
80105e7f:	89 50 04             	mov    %edx,0x4(%eax)
  lk->cpu = 0;
80105e82:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80105e89:	5d                   	pop    %ebp
80105e8a:	c3                   	ret
80105e8b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

80105e90 <getcallerpcs>:
}
...
80105e97:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  uint *ebp;
  int i;

  ebp = (uint*)v - 2;
80105e9a:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105e9d:	05 f8 ff ff 7f       	add    $0x7ffffff8,%eax
80105ea2:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
  for(i = 0; i < 10; i++){
80105ea7:	b8 00 00 00 00       	mov    $0x0,%eax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105eac:	76 10                	jbe    80105ebe <getcallerpcs+0x2e>
80105eae:	eb 28                	jmp    80105ed8 <getcallerpcs+0x48>
80105eb0:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80105eb6:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80105ebc:	77 1a                	ja     80105ed8 <getcallerpcs+0x48>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105ebe:	8b 5a 04             	mov    0x4(%edx),%ebx
80105ec1:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
80105ec4:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
80105ec7:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80105ec9:	83 f8 0a             	cmp    $0xa,%eax
80105ecc:	75 e2                	jne    80105eb0 <getcallerpcs+0x20>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
80105ece:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105ed1:	c9                   	leave
80105ed2:	c3                   	ret
80105ed3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
80105ed8:	8d 04 81             	lea    (%ecx,%eax,4),%eax
80105edb:	83 c1 28             	add    $0x28,%ecx
80105ede:	89 ca                	mov    %ecx,%edx
80105ee0:	29 c2                	sub    %eax,%edx
80105ee2:	83 e2 04             	and    $0x4,%edx
80105ee5:	74 11                	je     80105ef8 <getcallerpcs+0x68>
    pcs[i] = 0;
80105ee7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80105eed:	83 c0 04             	add    $0x4,%eax
80105ef0:	39 c1                	cmp    %eax,%ecx
80105ef2:	74 da                	je     80105ece <getcallerpcs+0x3e>
80105ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pcs[i] = 0;
80105ef8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80105efe:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
80105f01:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
80105f08:	39 c1                	cmp    %eax,%ecx
80105f0a:	75 ec                	jne    80105ef8 <getcallerpcs+0x68>
80105f0c:	eb c0                	jmp    80105ece <getcallerpcs+0x3e>
...
80105f19:	fa                   	cli
  ...
  cli();
  if(mycpu()->ncli == 0)
80105f1a:	e8 71 ef ff ff       	call   80104e90 <mycpu>
80105f1f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80105f25:	85 c0                	test   %eax,%eax
80105f27:	74 17                	je     80105f40 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80105f29:	e8 62 ef ff ff       	call   80104e90 <mycpu>
80105f2e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80105f3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80105f40:	e8 4b ef ff ff       	call   80104e90 <mycpu>
80105f45:	81 e3 00 02 00 00    	and    $0x200,%ebx
80105f4b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80105f51:	eb d6                	jmp    80105f29 <pushcli+0x19>
80105f53:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105f5a:	00 
...
80105f67:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80105f68:	f6 c4 02             	test   $0x2,%ah
80105f6b:	75 35                	jne    80105fa2 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80105f6d:	e8 1e ef ff ff       	call   80104e90 <mycpu>
80105f72:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
80105f79:	78 34                	js     80105faf <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80105f7b:	e8 10 ef ff ff       	call   80104e90 <mycpu>
80105f80:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105f86:	85 d2                	test   %edx,%edx
80105f88:	74 06                	je     80105f90 <popcli+0x30>
    sti();
}
80105f8a:	c9                   	leave
80105f8b:	c3                   	ret
80105f8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80105f90:	e8 fb ee ff ff       	call   80104e90 <mycpu>
80105f95:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80105f9b:	85 c0                	test   %eax,%eax
80105f9d:	74 eb                	je     80105f8a <popcli+0x2a>
  asm volatile("sti");
80105f9f:	fb                   	sti
}
80105fa0:	c9                   	leave
...
80105fa5:	68 10 9b 10 80       	push   $0x80109b10
80105faa:	e8 a1 a5 ff ff       	call   80100550 <panic>
    panic("popcli");
80105faf:	83 ec 0c             	sub    $0xc,%esp
80105fb2:	68 27 9b 10 80       	push   $0x80109b27
80105fb7:	e8 94 a5 ff ff       	call   80100550 <panic>
...
80105fc8:	31 db                	xor    %ebx,%ebx
  pushcli();
80105fca:	e8 41 ff ff ff       	call   80105f10 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80105fcf:	8b 06                	mov    (%esi),%eax
80105fd1:	85 c0                	test   %eax,%eax
80105fd3:	75 0b                	jne    80105fe0 <holding+0x20>
  popcli();
80105fd5:	e8 86 ff ff ff       	call   80105f60 <popcli>
}
80105fda:	89 d8                	mov    %ebx,%eax
80105fdc:	5b                   	pop    %ebx
80105fdd:	5e                   	pop    %esi
80105fde:	5d                   	pop    %ebp
80105fdf:	c3                   	ret
  r = lock->locked && lock->cpu == mycpu();
80105fe0:	8b 5e 08             	mov    0x8(%esi),%ebx
80105fe3:	e8 a8 ee ff ff       	call   80104e90 <mycpu>
80105fe8:	39 c3                	cmp    %eax,%ebx
80105fea:	0f 94 c3             	sete   %bl
  popcli();
80105fed:	e8 6e ff ff ff       	call   80105f60 <popcli>
  r = lock->locked && lock->cpu == mycpu();
80105ff2:	0f b6 db             	movzbl %bl,%ebx
}
...
80105ff9:	5d                   	pop    %ebp
80105ffa:	c3                   	ret
80105ffb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
80106005:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80106008:	e8 03 ff ff ff       	call   80105f10 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010600d:	8b 03                	mov    (%ebx),%eax
8010600f:	85 c0                	test   %eax,%eax
80106011:	75 15                	jne    80106028 <release+0x28>
  popcli();
80106013:	e8 48 ff ff ff       	call   80105f60 <popcli>
    panic("release");
80106018:	83 ec 0c             	sub    $0xc,%esp
8010601b:	68 2e 9b 10 80       	push   $0x80109b2e
80106020:	e8 2b a5 ff ff       	call   80100550 <panic>
80106025:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80106028:	8b 73 08             	mov    0x8(%ebx),%esi
8010602b:	e8 60 ee ff ff       	call   80104e90 <mycpu>
80106030:	39 c6                	cmp    %eax,%esi
80106032:	75 df                	jne    80106013 <release+0x13>
  popcli();
80106034:	e8 27 ff ff ff       	call   80105f60 <popcli>
  lk->pcs[0] = 0;
80106039:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80106040:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80106047:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010604c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
...
80106057:	5d                   	pop    %ebp
  popcli();
80106058:	e9 03 ff ff ff       	jmp    80105f60 <popcli>
...
80106064:	83 ec 04             	sub    $0x4,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80106067:	e8 a4 fe ff ff       	call   80105f10 <pushcli>
  if(holding(lk))
8010606c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010606f:	e8 9c fe ff ff       	call   80105f10 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80106074:	8b 03                	mov    (%ebx),%eax
80106076:	85 c0                	test   %eax,%eax
80106078:	0f 85 b2 00 00 00    	jne    80106130 <acquire+0xd0>
  popcli();
8010607e:	e8 dd fe ff ff       	call   80105f60 <popcli>
  asm volatile("lock; xchgl %0, %1" :
80106083:	b9 01 00 00 00       	mov    $0x1,%ecx
80106088:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010608f:	00 
  while(xchg(&lk->locked, 1) != 0)
80106090:	8b 55 08             	mov    0x8(%ebp),%edx
80106093:	89 c8                	mov    %ecx,%eax
80106095:	f0 87 02             	lock xchg %eax,(%edx)
80106098:	85 c0                	test   %eax,%eax
8010609a:	75 f4                	jne    80106090 <acquire+0x30>
  __sync_synchronize();
8010609c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
801060a1:	8b 5d 08             	mov    0x8(%ebp),%ebx
801060a4:	e8 e7 ed ff ff       	call   80104e90 <mycpu>
  getcallerpcs(&lk, lk->pcs);
801060a9:	8b 4d 08             	mov    0x8(%ebp),%ecx
  for(i = 0; i < 10; i++){
801060ac:	31 d2                	xor    %edx,%edx
  lk->cpu = mycpu();
801060ae:	89 43 08             	mov    %eax,0x8(%ebx)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801060b1:	8d 85 00 00 00 80    	lea    -0x80000000(%ebp),%eax
801060b7:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
801060bc:	77 32                	ja     801060f0 <acquire+0x90>
  ebp = (uint*)v - 2;
801060be:	89 e8                	mov    %ebp,%eax
801060c0:	eb 14                	jmp    801060d6 <acquire+0x76>
801060c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801060c8:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
801060ce:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
801060d4:	77 1a                	ja     801060f0 <acquire+0x90>
    pcs[i] = ebp[1];     // saved %eip
801060d6:	8b 58 04             	mov    0x4(%eax),%ebx
801060d9:	89 5c 91 0c          	mov    %ebx,0xc(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
801060dd:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
801060e0:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801060e2:	83 fa 0a             	cmp    $0xa,%edx
801060e5:	75 e1                	jne    801060c8 <acquire+0x68>
}
801060e7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801060ea:	c9                   	leave
801060eb:	c3                   	ret
801060ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801060f0:	8d 44 91 0c          	lea    0xc(%ecx,%edx,4),%eax
801060f4:	83 c1 34             	add    $0x34,%ecx
801060f7:	89 ca                	mov    %ecx,%edx
801060f9:	29 c2                	sub    %eax,%edx
801060fb:	83 e2 04             	and    $0x4,%edx
801060fe:	74 10                	je     80106110 <acquire+0xb0>
    pcs[i] = 0;
80106100:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80106106:	83 c0 04             	add    $0x4,%eax
80106109:	39 c1                	cmp    %eax,%ecx
8010610b:	74 da                	je     801060e7 <acquire+0x87>
8010610d:	8d 76 00             	lea    0x0(%esi),%esi
    pcs[i] = 0;
80106110:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80106116:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
80106119:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
80106120:	39 c1                	cmp    %eax,%ecx
80106122:	75 ec                	jne    80106110 <acquire+0xb0>
80106124:	eb c1                	jmp    801060e7 <acquire+0x87>
80106126:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010612d:	00 
8010612e:	66 90                	xchg   %ax,%ax
  r = lock->locked && lock->cpu == mycpu();
80106130:	8b 5b 08             	mov    0x8(%ebx),%ebx
80106133:	e8 58 ed ff ff       	call   80104e90 <mycpu>
80106138:	39 c3                	cmp    %eax,%ebx
8010613a:	0f 85 3e ff ff ff    	jne    8010607e <acquire+0x1e>
  popcli();
80106140:	e8 1b fe ff ff       	call   80105f60 <popcli>
    panic("acquire");
80106145:	83 ec 0c             	sub    $0xc,%esp
80106148:	68 36 9b 10 80       	push   $0x80109b36
8010614d:	e8 fe a3 ff ff       	call   80100550 <panic>
...
80106167:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&rw->lk, "rwlock");
8010616a:	68 43 9b 10 80       	push   $0x80109b43
8010616f:	53                   	push   %ebx
80106170:	e8 fb fc ff ff       	call   80105e70 <initlock>
  rw->num_of_readers = 0;
  rw->writer = 0;
...
80106178:	83 c4 10             	add    $0x10,%esp
  rw->num_of_readers = 0;
8010617b:	c7 43 34 00 00 00 00 	movl   $0x0,0x34(%ebx)
  rw->writer = 0;
80106182:	c7 43 38 00 00 00 00 	movl   $0x0,0x38(%ebx)
  rw->num_of_waiting_writers = 0;
80106189:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  rw->name = name;
80106190:	89 43 40             	mov    %eax,0x40(%ebx)
  rw->wpid = 0;
80106193:	c7 43 44 00 00 00 00 	movl   $0x0,0x44(%ebx)
}
...
801061ab:	e8 b0 fe ff ff       	call   80106060 <acquire>
...
801061b3:	eb 10                	jmp    801061c5 <rwlock_acquire_read+0x25>
801061b5:	8d 76 00             	lea    0x0(%esi),%esi
    sleep(rw, &rw->lk);
801061b8:	83 ec 08             	sub    $0x8,%esp
801061bb:	53                   	push   %ebx
801061bc:	53                   	push   %ebx
801061bd:	e8 2e f4 ff ff       	call   801055f0 <sleep>
801061c2:	83 c4 10             	add    $0x10,%esp
  while(rw->writer || rw->num_of_waiting_writers > 0){
801061c5:	8b 53 38             	mov    0x38(%ebx),%edx
801061c8:	85 d2                	test   %edx,%edx
801061ca:	75 ec                	jne    801061b8 <rwlock_acquire_read+0x18>
801061cc:	8b 43 3c             	mov    0x3c(%ebx),%eax
801061cf:	85 c0                	test   %eax,%eax
801061d1:	7f e5                	jg     801061b8 <rwlock_acquire_read+0x18>
  }

  rw->num_of_readers++;
801061d3:	83 43 34 01          	addl   $0x1,0x34(%ebx)
  release(&rw->lk);
801061d7:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
801061da:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801061dd:	c9                   	leave
  release(&rw->lk);
801061de:	e9 1d fe ff ff       	jmp    80106000 <release>
801061e3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801061ea:	00 
801061eb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

801061f0 <rwlock_release_read>:
...
801061f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&rw->lk);
801061fa:	53                   	push   %ebx
801061fb:	e8 60 fe ff ff       	call   80106060 <acquire>

  if(rw->num_of_readers < 1)
80106200:	8b 43 34             	mov    0x34(%ebx),%eax
80106203:	83 c4 10             	add    $0x10,%esp
80106206:	85 c0                	test   %eax,%eax
80106208:	7e 2e                	jle    80106238 <rwlock_release_read+0x48>
    panic("rwlock_release_read: num_of_readers underflow");

  rw->num_of_readers--;
8010620a:	83 e8 01             	sub    $0x1,%eax
8010620d:	89 43 34             	mov    %eax,0x34(%ebx)

  // If this was the last reader, wake up waiting writer.
  if(rw->num_of_readers == 0)
80106210:	74 0e                	je     80106220 <rwlock_release_read+0x30>
    wakeup(rw);

  release(&rw->lk);
80106212:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80106215:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106218:	c9                   	leave
  release(&rw->lk);
80106219:	e9 e2 fd ff ff       	jmp    80106000 <release>
8010621e:	66 90                	xchg   %ax,%ax
    wakeup(rw);
80106220:	83 ec 0c             	sub    $0xc,%esp
80106223:	53                   	push   %ebx
80106224:	e8 87 f4 ff ff       	call   801056b0 <wakeup>
80106229:	83 c4 10             	add    $0x10,%esp
  release(&rw->lk);
8010622c:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
8010622f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106232:	c9                   	leave
  release(&rw->lk);
80106233:	e9 c8 fd ff ff       	jmp    80106000 <release>
    panic("rwlock_release_read: num_of_readers underflow");
80106238:	83 ec 0c             	sub    $0xc,%esp
8010623b:	68 50 9e 10 80       	push   $0x80109e50
80106240:	e8 0b a3 ff ff       	call   80100550 <panic>
80106245:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010624c:	00 
8010624d:	8d 76 00             	lea    0x0(%esi),%esi

80106250 <rwlock_acquire_write>:
...
80106257:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&rw->lk);
8010625a:	53                   	push   %ebx
8010625b:	e8 00 fe ff ff       	call   80106060 <acquire>

  rw->num_of_waiting_writers++;
80106260:	83 43 3c 01          	addl   $0x1,0x3c(%ebx)
...
80106267:	eb 14                	jmp    8010627d <rwlock_acquire_write+0x2d>
80106269:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    sleep(rw, &rw->lk);
80106270:	83 ec 08             	sub    $0x8,%esp
80106273:	53                   	push   %ebx
80106274:	53                   	push   %ebx
80106275:	e8 76 f3 ff ff       	call   801055f0 <sleep>
8010627a:	83 c4 10             	add    $0x10,%esp
  while(rw->writer || rw->num_of_readers > 0){
8010627d:	8b 53 38             	mov    0x38(%ebx),%edx
80106280:	85 d2                	test   %edx,%edx
80106282:	75 ec                	jne    80106270 <rwlock_acquire_write+0x20>
80106284:	8b 43 34             	mov    0x34(%ebx),%eax
80106287:	85 c0                	test   %eax,%eax
80106289:	7f e5                	jg     80106270 <rwlock_acquire_write+0x20>
  }

  rw->num_of_waiting_writers--;
8010628b:	83 6b 3c 01          	subl   $0x1,0x3c(%ebx)
  rw->writer = 1;
8010628f:	c7 43 38 01 00 00 00 	movl   $0x1,0x38(%ebx)
  rw->wpid = myproc()->pid;
80106296:	e8 75 ec ff ff       	call   80104f10 <myproc>
8010629b:	8b 40 10             	mov    0x10(%eax),%eax
8010629e:	89 43 44             	mov    %eax,0x44(%ebx)

  release(&rw->lk);
801062a1:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
801062a4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801062a7:	c9                   	leave
  release(&rw->lk);
801062a8:	e9 53 fd ff ff       	jmp    80106000 <release>
801062ad:	8d 76 00             	lea    0x0(%esi),%esi

801062b0 <rwlock_release_write>:
...
801062bc:	e8 9f fd ff ff       	call   80106060 <acquire>

  if(rw->writer == 0)
801062c1:	8b 43 38             	mov    0x38(%ebx),%eax
801062c4:	83 c4 10             	add    $0x10,%esp
801062c7:	85 c0                	test   %eax,%eax
801062c9:	74 35                	je     80106300 <rwlock_release_write+0x50>
    panic("rwlock_release_write: no writer");

  if(rw->wpid != myproc()->pid)
801062cb:	8b 73 44             	mov    0x44(%ebx),%esi
801062ce:	e8 3d ec ff ff       	call   80104f10 <myproc>
801062d3:	3b 70 10             	cmp    0x10(%eax),%esi
801062d6:	75 35                	jne    8010630d <rwlock_release_write+0x5d>
...
801062d8:	83 ec 0c             	sub    $0xc,%esp
  rw->writer = 0;
801062db:	c7 43 38 00 00 00 00 	movl   $0x0,0x38(%ebx)
  rw->wpid = 0;
801062e2:	c7 43 44 00 00 00 00 	movl   $0x0,0x44(%ebx)
  wakeup(rw);
801062e9:	53                   	push   %ebx
801062ea:	e8 c1 f3 ff ff       	call   801056b0 <wakeup>

  release(&rw->lk);
801062ef:	83 c4 10             	add    $0x10,%esp
801062f2:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
801062fa:	5d                   	pop    %ebp
  release(&rw->lk);
801062fb:	e9 00 fd ff ff       	jmp    80106000 <release>
    panic("rwlock_release_write: no writer");
80106300:	83 ec 0c             	sub    $0xc,%esp
80106303:	68 80 9e 10 80       	push   $0x80109e80
80106308:	e8 43 a2 ff ff       	call   80100550 <panic>
    panic("rwlock_release_write: not owner");
8010630d:	83 ec 0c             	sub    $0xc,%esp
80106310:	68 a0 9e 10 80       	push   $0x80109ea0
80106315:	e8 36 a2 ff ff       	call   80100550 <panic>
8010631a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80106320 <sys_rwlock_rlock>:
  }
}
...
80106323:	83 ec 08             	sub    $0x8,%esp
  if(!u_rw_inited){
80106326:	8b 0d a0 70 11 80    	mov    0x801170a0,%ecx
8010632c:	85 c9                	test   %ecx,%ecx
8010632e:	74 60                	je     80106390 <sys_rwlock_rlock+0x70>
  acquire(&rw->lk);
80106330:	83 ec 0c             	sub    $0xc,%esp
80106333:	68 c0 70 11 80       	push   $0x801170c0
80106338:	e8 23 fd ff ff       	call   80106060 <acquire>
  while(rw->writer || rw->num_of_waiting_writers > 0){
8010633d:	83 c4 10             	add    $0x10,%esp
80106340:	eb 1b                	jmp    8010635d <sys_rwlock_rlock+0x3d>
80106342:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    sleep(rw, &rw->lk);
80106348:	83 ec 08             	sub    $0x8,%esp
8010634b:	68 c0 70 11 80       	push   $0x801170c0
80106350:	68 c0 70 11 80       	push   $0x801170c0
80106355:	e8 96 f2 ff ff       	call   801055f0 <sleep>
8010635a:	83 c4 10             	add    $0x10,%esp
  while(rw->writer || rw->num_of_waiting_writers > 0){
8010635d:	8b 15 f8 70 11 80    	mov    0x801170f8,%edx
80106363:	85 d2                	test   %edx,%edx
80106365:	75 e1                	jne    80106348 <sys_rwlock_rlock+0x28>
80106367:	a1 fc 70 11 80       	mov    0x801170fc,%eax
8010636c:	85 c0                	test   %eax,%eax
8010636e:	7f d8                	jg     80106348 <sys_rwlock_rlock+0x28>
  release(&rw->lk);
80106370:	83 ec 0c             	sub    $0xc,%esp
  rw->num_of_readers++;
80106373:	83 05 f4 70 11 80 01 	addl   $0x1,0x801170f4
  release(&rw->lk);
8010637a:	68 c0 70 11 80       	push   $0x801170c0
8010637f:	e8 7c fc ff ff       	call   80106000 <release>
  rw_init_once();
  rwlock_acquire_read(&u_rw);
  return 0;
}
80106384:	31 c0                	xor    %eax,%eax
80106386:	c9                   	leave
80106387:	c3                   	ret
80106388:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010638f:	00 
  initlock(&rw->lk, "rwlock");
80106390:	83 ec 08             	sub    $0x8,%esp
80106393:	68 43 9b 10 80       	push   $0x80109b43
80106398:	68 c0 70 11 80       	push   $0x801170c0
8010639d:	e8 ce fa ff ff       	call   80105e70 <initlock>
}
801063a2:	83 c4 10             	add    $0x10,%esp
  rw->num_of_readers = 0;
801063a5:	c7 05 f4 70 11 80 00 	movl   $0x0,0x801170f4
801063ac:	00 00 00 
  rw->writer = 0;
801063af:	c7 05 f8 70 11 80 00 	movl   $0x0,0x801170f8
801063b6:	00 00 00 
  rw->num_of_waiting_writers = 0;
801063b9:	c7 05 fc 70 11 80 00 	movl   $0x0,0x801170fc
801063c0:	00 00 00 
  rw->name = name;
801063c3:	c7 05 00 71 11 80 3e 	movl   $0x80109b3e,0x80117100
801063ca:	9b 10 80 
  rw->wpid = 0;
801063cd:	c7 05 04 71 11 80 00 	movl   $0x0,0x80117104
801063d4:	00 00 00 
    u_rw_inited = 1;
801063d7:	c7 05 a0 70 11 80 01 	movl   $0x1,0x801170a0
801063de:	00 00 00 
}
801063e1:	e9 4a ff ff ff       	jmp    80106330 <sys_rwlock_rlock+0x10>
801063e6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801063ed:	00 
801063ee:	66 90                	xchg   %ax,%ax

801063f0 <sys_rwlock_runlock>:
...
801063f3:	83 ec 08             	sub    $0x8,%esp
  if(!u_rw_inited){
801063f6:	a1 a0 70 11 80       	mov    0x801170a0,%eax
801063fb:	85 c0                	test   %eax,%eax
801063fd:	74 41                	je     80106440 <sys_rwlock_runlock+0x50>
  acquire(&rw->lk);
801063ff:	83 ec 0c             	sub    $0xc,%esp
80106402:	68 c0 70 11 80       	push   $0x801170c0
80106407:	e8 54 fc ff ff       	call   80106060 <acquire>
  if(rw->num_of_readers < 1)
8010640c:	a1 f4 70 11 80       	mov    0x801170f4,%eax
80106411:	83 c4 10             	add    $0x10,%esp
80106414:	85 c0                	test   %eax,%eax
80106416:	0f 8e 99 00 00 00    	jle    801064b5 <sys_rwlock_runlock+0xc5>
  rw->num_of_readers--;
8010641c:	83 e8 01             	sub    $0x1,%eax
8010641f:	a3 f4 70 11 80       	mov    %eax,0x801170f4
  if(rw->num_of_readers == 0)
80106424:	74 7a                	je     801064a0 <sys_rwlock_runlock+0xb0>
  release(&rw->lk);
80106426:	83 ec 0c             	sub    $0xc,%esp
80106429:	68 c0 70 11 80       	push   $0x801170c0
8010642e:	e8 cd fb ff ff       	call   80106000 <release>
  rw_init_once();
...
80106443:	68 43 9b 10 80       	push   $0x80109b43
80106448:	68 c0 70 11 80       	push   $0x801170c0
8010644d:	e8 1e fa ff ff       	call   80105e70 <initlock>
}
80106452:	83 c4 10             	add    $0x10,%esp
  rw->num_of_readers = 0;
80106455:	c7 05 f4 70 11 80 00 	movl   $0x0,0x801170f4
8010645c:	00 00 00 
  rw->writer = 0;
8010645f:	c7 05 f8 70 11 80 00 	movl   $0x0,0x801170f8
80106466:	00 00 00 
  rw->num_of_waiting_writers = 0;
80106469:	c7 05 fc 70 11 80 00 	movl   $0x0,0x801170fc
80106470:	00 00 00 
  rw->name = name;
80106473:	c7 05 00 71 11 80 3e 	movl   $0x80109b3e,0x80117100
8010647a:	9b 10 80 
  rw->wpid = 0;
8010647d:	c7 05 04 71 11 80 00 	movl   $0x0,0x80117104
80106484:	00 00 00 
    u_rw_inited = 1;
80106487:	c7 05 a0 70 11 80 01 	movl   $0x1,0x801170a0
8010648e:	00 00 00 
}
80106491:	e9 69 ff ff ff       	jmp    801063ff <sys_rwlock_runlock+0xf>
80106496:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010649d:	00 
8010649e:	66 90                	xchg   %ax,%ax
    wakeup(rw);
801064a0:	83 ec 0c             	sub    $0xc,%esp
801064a3:	68 c0 70 11 80       	push   $0x801170c0
801064a8:	e8 03 f2 ff ff       	call   801056b0 <wakeup>
801064ad:	83 c4 10             	add    $0x10,%esp
801064b0:	e9 71 ff ff ff       	jmp    80106426 <sys_rwlock_runlock+0x36>
    panic("rwlock_release_read: num_of_readers underflow");
801064b5:	83 ec 0c             	sub    $0xc,%esp
801064b8:	68 50 9e 10 80       	push   $0x80109e50
801064bd:	e8 8e a0 ff ff       	call   80100550 <panic>
801064c2:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801064c9:	00 
801064ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

801064d0 <sys_rwlock_wlock>:
...
801064d3:	83 ec 08             	sub    $0x8,%esp
  if(!u_rw_inited){
801064d6:	a1 a0 70 11 80       	mov    0x801170a0,%eax
801064db:	85 c0                	test   %eax,%eax
801064dd:	74 11                	je     801064f0 <sys_rwlock_wlock+0x20>
  rw_init_once();
  rwlock_acquire_write(&u_rw);
801064df:	83 ec 0c             	sub    $0xc,%esp
801064e2:	68 c0 70 11 80       	push   $0x801170c0
801064e7:	e8 64 fd ff ff       	call   80106250 <rwlock_acquire_write>
  return 0;
}
...
801064f3:	68 43 9b 10 80       	push   $0x80109b43
801064f8:	68 c0 70 11 80       	push   $0x801170c0
801064fd:	e8 6e f9 ff ff       	call   80105e70 <initlock>
}
80106502:	83 c4 10             	add    $0x10,%esp
  rw->num_of_readers = 0;
80106505:	c7 05 f4 70 11 80 00 	movl   $0x0,0x801170f4
8010650c:	00 00 00 
  rw->writer = 0;
8010650f:	c7 05 f8 70 11 80 00 	movl   $0x0,0x801170f8
80106516:	00 00 00 
  rw->num_of_waiting_writers = 0;
80106519:	c7 05 fc 70 11 80 00 	movl   $0x0,0x801170fc
80106520:	00 00 00 
  rw->name = name;
80106523:	c7 05 00 71 11 80 3e 	movl   $0x80109b3e,0x80117100
8010652a:	9b 10 80 
  rw->wpid = 0;
8010652d:	c7 05 04 71 11 80 00 	movl   $0x0,0x80117104
80106534:	00 00 00 
    u_rw_inited = 1;
80106537:	c7 05 a0 70 11 80 01 	movl   $0x1,0x801170a0
8010653e:	00 00 00 
}
80106541:	eb 9c                	jmp    801064df <sys_rwlock_wlock+0xf>
80106543:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010654a:	00 
8010654b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

80106550 <sys_rwlock_wunlock>:
...
80106553:	83 ec 08             	sub    $0x8,%esp
  if(!u_rw_inited){
80106556:	a1 a0 70 11 80       	mov    0x801170a0,%eax
8010655b:	85 c0                	test   %eax,%eax
8010655d:	74 11                	je     80106570 <sys_rwlock_wunlock+0x20>
  rw_init_once();
  rwlock_release_write(&u_rw);
8010655f:	83 ec 0c             	sub    $0xc,%esp
80106562:	68 c0 70 11 80       	push   $0x801170c0
80106567:	e8 44 fd ff ff       	call   801062b0 <rwlock_release_write>
  return 0;
}
...
80106573:	68 43 9b 10 80       	push   $0x80109b43
80106578:	68 c0 70 11 80       	push   $0x801170c0
8010657d:	e8 ee f8 ff ff       	call   80105e70 <initlock>
}
80106582:	83 c4 10             	add    $0x10,%esp
  rw->num_of_readers = 0;
80106585:	c7 05 f4 70 11 80 00 	movl   $0x0,0x801170f4
8010658c:	00 00 00 
  rw->writer = 0;
8010658f:	c7 05 f8 70 11 80 00 	movl   $0x0,0x801170f8
80106596:	00 00 00 
  rw->num_of_waiting_writers = 0;
80106599:	c7 05 fc 70 11 80 00 	movl   $0x0,0x801170fc
801065a0:	00 00 00 
  rw->name = name;
801065a3:	c7 05 00 71 11 80 3e 	movl   $0x80109b3e,0x80117100
801065aa:	9b 10 80 
  rw->wpid = 0;
801065ad:	c7 05 04 71 11 80 00 	movl   $0x0,0x80117104
801065b4:	00 00 00 
    u_rw_inited = 1;
801065b7:	c7 05 a0 70 11 80 01 	movl   $0x1,0x801170a0
801065be:	00 00 00 
}
801065c1:	eb 9c                	jmp    8010655f <sys_rwlock_wunlock+0xf>
801065c3:	66 90                	xchg   %ax,%ax
801065c5:	66 90                	xchg   %ax,%ax
...
801065d4:	8b 55 08             	mov    0x8(%ebp),%edx
801065d7:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
801065da:	89 d0                	mov    %edx,%eax
801065dc:	09 c8                	or     %ecx,%eax
801065de:	a8 03                	test   $0x3,%al
801065e0:	75 1e                	jne    80106600 <memset+0x30>
    c &= 0xFF;
801065e2:	0f b6 45 0c          	movzbl 0xc(%ebp),%eax
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801065e6:	c1 e9 02             	shr    $0x2,%ecx
  asm volatile("cld; rep stosl" :
801065e9:	89 d7                	mov    %edx,%edi
801065eb:	69 c0 01 01 01 01    	imul   $0x1010101,%eax,%eax
801065f1:	fc                   	cld
801065f2:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
801065f4:	8b 7d fc             	mov    -0x4(%ebp),%edi
801065f7:	89 d0                	mov    %edx,%eax
801065f9:	c9                   	leave
801065fa:	c3                   	ret
801065fb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  asm volatile("cld; rep stosb" :
80106600:	8b 45 0c             	mov    0xc(%ebp),%eax
80106603:	89 d7                	mov    %edx,%edi
80106605:	fc                   	cld
80106606:	f3 aa                	rep stos %al,%es:(%edi)
80106608:	8b 7d fc             	mov    -0x4(%ebp),%edi
8010660b:	89 d0                	mov    %edx,%eax
8010660d:	c9                   	leave
8010660e:	c3                   	ret
8010660f:	90                   	nop
...
80106614:	8b 75 10             	mov    0x10(%ebp),%esi
80106617:	8b 45 08             	mov    0x8(%ebp),%eax
8010661a:	53                   	push   %ebx
8010661b:	8b 55 0c             	mov    0xc(%ebp),%edx
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
8010661e:	85 f6                	test   %esi,%esi
80106620:	74 2e                	je     80106650 <memcmp+0x40>
80106622:	01 c6                	add    %eax,%esi
80106624:	eb 14                	jmp    8010663a <memcmp+0x2a>
80106626:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010662d:	00 
8010662e:	66 90                	xchg   %ax,%ax
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
80106630:	83 c0 01             	add    $0x1,%eax
80106633:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80106636:	39 f0                	cmp    %esi,%eax
80106638:	74 16                	je     80106650 <memcmp+0x40>
    if(*s1 != *s2)
8010663a:	0f b6 08             	movzbl (%eax),%ecx
8010663d:	0f b6 1a             	movzbl (%edx),%ebx
80106640:	38 d9                	cmp    %bl,%cl
80106642:	74 ec                	je     80106630 <memcmp+0x20>
      return *s1 - *s2;
80106644:	0f b6 c1             	movzbl %cl,%eax
80106647:	29 d8                	sub    %ebx,%eax
  }
...
80106654:	5d                   	pop    %ebp
80106655:	c3                   	ret
80106656:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010665d:	00 
...
8010666b:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010666e:	39 d6                	cmp    %edx,%esi
80106670:	73 26                	jae    80106698 <memmove+0x38>
80106672:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
80106675:	39 ca                	cmp    %ecx,%edx
80106677:	73 1f                	jae    80106698 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
80106679:	85 c0                	test   %eax,%eax
8010667b:	74 0f                	je     8010668c <memmove+0x2c>
8010667d:	83 e8 01             	sub    $0x1,%eax
      *--d = *--s;
80106680:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80106684:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80106687:	83 e8 01             	sub    $0x1,%eax
8010668a:	73 f4                	jae    80106680 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
8010668c:	5e                   	pop    %esi
8010668d:	89 d0                	mov    %edx,%eax
8010668f:	5f                   	pop    %edi
80106690:	5d                   	pop    %ebp
80106691:	c3                   	ret
80106692:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80106698:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
8010669b:	89 d7                	mov    %edx,%edi
8010669d:	85 c0                	test   %eax,%eax
8010669f:	74 eb                	je     8010668c <memmove+0x2c>
801066a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
801066a8:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
801066a9:	39 ce                	cmp    %ecx,%esi
801066ab:	75 fb                	jne    801066a8 <memmove+0x48>
}
801066ad:	5e                   	pop    %esi
...
801066b1:	5d                   	pop    %ebp
801066b2:	c3                   	ret
801066b3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801066ba:	00 
801066bb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
801066c0:	eb 9e                	jmp    80106660 <memmove>
801066c2:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801066c9:	00 
...
801066d4:	8b 55 10             	mov    0x10(%ebp),%edx
801066d7:	8b 45 08             	mov    0x8(%ebp),%eax
801066da:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  while(n > 0 && *p && *p == *q)
801066dd:	85 d2                	test   %edx,%edx
801066df:	75 16                	jne    801066f7 <strncmp+0x27>
801066e1:	eb 2d                	jmp    80106710 <strncmp+0x40>
801066e3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
801066e8:	3a 19                	cmp    (%ecx),%bl
801066ea:	75 12                	jne    801066fe <strncmp+0x2e>
    n--, p++, q++;
801066ec:	83 c0 01             	add    $0x1,%eax
801066ef:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
801066f2:	83 ea 01             	sub    $0x1,%edx
801066f5:	74 19                	je     80106710 <strncmp+0x40>
801066f7:	0f b6 18             	movzbl (%eax),%ebx
801066fa:	84 db                	test   %bl,%bl
801066fc:	75 ea                	jne    801066e8 <strncmp+0x18>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
801066fe:	0f b6 00             	movzbl (%eax),%eax
80106701:	0f b6 11             	movzbl (%ecx),%edx
}
80106704:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106707:	c9                   	leave
  return (uchar)*p - (uchar)*q;
80106708:	29 d0                	sub    %edx,%eax
}
8010670a:	c3                   	ret
8010670b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
80106710:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    return 0;
80106713:	31 c0                	xor    %eax,%eax
}
80106715:	c9                   	leave
80106716:	c3                   	ret
80106717:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010671e:	00 
8010671f:	90                   	nop
...
80106725:	8b 75 08             	mov    0x8(%ebp),%esi
80106728:	53                   	push   %ebx
80106729:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
8010672c:	89 f0                	mov    %esi,%eax
8010672e:	eb 15                	jmp    80106745 <strncpy+0x25>
80106730:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80106734:	8b 7d 0c             	mov    0xc(%ebp),%edi
80106737:	83 c0 01             	add    $0x1,%eax
8010673a:	0f b6 4f ff          	movzbl -0x1(%edi),%ecx
8010673e:	88 48 ff             	mov    %cl,-0x1(%eax)
80106741:	84 c9                	test   %cl,%cl
80106743:	74 13                	je     80106758 <strncpy+0x38>
80106745:	89 d3                	mov    %edx,%ebx
80106747:	83 ea 01             	sub    $0x1,%edx
8010674a:	85 db                	test   %ebx,%ebx
8010674c:	7f e2                	jg     80106730 <strncpy+0x10>
    ;
  while(n-- > 0)
    *s++ = 0;
  return os;
...
8010674e:	5b                   	pop    %ebx
8010674f:	89 f0                	mov    %esi,%eax
80106751:	5e                   	pop    %esi
80106752:	5f                   	pop    %edi
80106753:	5d                   	pop    %ebp
80106754:	c3                   	ret
80106755:	8d 76 00             	lea    0x0(%esi),%esi
  while(n-- > 0)
80106758:	8d 0c 18             	lea    (%eax,%ebx,1),%ecx
8010675b:	83 e9 01             	sub    $0x1,%ecx
8010675e:	85 d2                	test   %edx,%edx
80106760:	74 ec                	je     8010674e <strncpy+0x2e>
80106762:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    *s++ = 0;
80106768:	83 c0 01             	add    $0x1,%eax
8010676b:	89 ca                	mov    %ecx,%edx
8010676d:	c6 40 ff 00          	movb   $0x0,-0x1(%eax)
  while(n-- > 0)
80106771:	29 c2                	sub    %eax,%edx
80106773:	85 d2                	test   %edx,%edx
80106775:	7f f1                	jg     80106768 <strncpy+0x48>
}
80106777:	5b                   	pop    %ebx
...
80106784:	8b 55 10             	mov    0x10(%ebp),%edx
80106787:	8b 75 08             	mov    0x8(%ebp),%esi
8010678a:	53                   	push   %ebx
8010678b:	8b 45 0c             	mov    0xc(%ebp),%eax
  char *os;

  os = s;
  if(n <= 0)
8010678e:	85 d2                	test   %edx,%edx
80106790:	7e 25                	jle    801067b7 <safestrcpy+0x37>
80106792:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
80106796:	89 f2                	mov    %esi,%edx
80106798:	eb 16                	jmp    801067b0 <safestrcpy+0x30>
8010679a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
801067a0:	0f b6 08             	movzbl (%eax),%ecx
801067a3:	83 c0 01             	add    $0x1,%eax
801067a6:	83 c2 01             	add    $0x1,%edx
801067a9:	88 4a ff             	mov    %cl,-0x1(%edx)
801067ac:	84 c9                	test   %cl,%cl
801067ae:	74 04                	je     801067b4 <safestrcpy+0x34>
801067b0:	39 d8                	cmp    %ebx,%eax
801067b2:	75 ec                	jne    801067a0 <safestrcpy+0x20>
    ;
  *s = 0;
801067b4:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
801067b7:	89 f0                	mov    %esi,%eax
801067b9:	5b                   	pop    %ebx
801067ba:	5e                   	pop    %esi
801067bb:	5d                   	pop    %ebp
801067bc:	c3                   	ret
...
801067c0:	55                   	push   %ebp
  ...
  for(n = 0; s[n]; n++)
801067c1:	31 c0                	xor    %eax,%eax
{
801067c3:	89 e5                	mov    %esp,%ebp
801067c5:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
801067c8:	80 3a 00             	cmpb   $0x0,(%edx)
801067cb:	74 0c                	je     801067d9 <strlen+0x19>
801067cd:	8d 76 00             	lea    0x0(%esi),%esi
801067d0:	83 c0 01             	add    $0x1,%eax
801067d3:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
801067d7:	75 f7                	jne    801067d0 <strlen+0x10>
    ;
  return n;
}
801067d9:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
801067db:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801067df:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801067e6:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801067e7:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801067e9:	89 d4                	mov    %edx,%esp
...
801067f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801067fa:	e8 11 e7 ff ff       	call   80104f10 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801067ff:	8b 00                	mov    (%eax),%eax
80106801:	39 c3                	cmp    %eax,%ebx
80106803:	73 1b                	jae    80106820 <fetchint+0x30>
80106805:	8d 53 04             	lea    0x4(%ebx),%edx
80106808:	39 d0                	cmp    %edx,%eax
8010680a:	72 14                	jb     80106820 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
8010680c:	8b 45 0c             	mov    0xc(%ebp),%eax
...
80106825:	eb ee                	jmp    80106815 <fetchint+0x25>
80106827:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010682e:	00 
8010682f:	90                   	nop
...
80106837:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010683a:	e8 d1 e6 ff ff       	call   80104f10 <myproc>

  if(addr >= curproc->sz)
8010683f:	3b 18                	cmp    (%eax),%ebx
80106841:	73 2d                	jae    80106870 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
80106843:	8b 55 0c             	mov    0xc(%ebp),%edx
80106846:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80106848:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
8010684a:	39 d3                	cmp    %edx,%ebx
8010684c:	73 22                	jae    80106870 <fetchstr+0x40>
8010684e:	89 d8                	mov    %ebx,%eax
80106850:	eb 0d                	jmp    8010685f <fetchstr+0x2f>
80106852:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80106858:	83 c0 01             	add    $0x1,%eax
8010685b:	39 d0                	cmp    %edx,%eax
8010685d:	73 11                	jae    80106870 <fetchstr+0x40>
    if(*s == 0)
8010685f:	80 38 00             	cmpb   $0x0,(%eax)
80106862:	75 f4                	jne    80106858 <fetchstr+0x28>
      return s - *pp;
80106864:	29 d8                	sub    %ebx,%eax
  }
  return -1;
}
80106866:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106869:	c9                   	leave
8010686a:	c3                   	ret
8010686b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
80106870:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    return -1;
...
80106885:	e8 86 e6 ff ff       	call   80104f10 <myproc>
8010688a:	8b 55 08             	mov    0x8(%ebp),%edx
8010688d:	8b 40 18             	mov    0x18(%eax),%eax
80106890:	8b 40 44             	mov    0x44(%eax),%eax
80106893:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80106896:	e8 75 e6 ff ff       	call   80104f10 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010689b:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
8010689e:	8b 00                	mov    (%eax),%eax
801068a0:	39 c6                	cmp    %eax,%esi
801068a2:	73 1c                	jae    801068c0 <argint+0x40>
801068a4:	8d 53 08             	lea    0x8(%ebx),%edx
801068a7:	39 d0                	cmp    %edx,%eax
801068a9:	72 15                	jb     801068c0 <argint+0x40>
  *ip = *(int*)(addr);
801068ab:	8b 45 0c             	mov    0xc(%ebp),%eax
801068ae:	8b 53 04             	mov    0x4(%ebx),%edx
801068b1:	89 10                	mov    %edx,(%eax)
  return 0;
...
801068c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801068c5:	eb ee                	jmp    801068b5 <argint+0x35>
...
801068d6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
801068d9:	e8 32 e6 ff ff       	call   80104f10 <myproc>
801068de:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801068e0:	e8 2b e6 ff ff       	call   80104f10 <myproc>
801068e5:	8b 55 08             	mov    0x8(%ebp),%edx
801068e8:	8b 40 18             	mov    0x18(%eax),%eax
801068eb:	8b 40 44             	mov    0x44(%eax),%eax
801068ee:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801068f1:	e8 1a e6 ff ff       	call   80104f10 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801068f6:	8d 7b 04             	lea    0x4(%ebx),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
801068f9:	8b 00                	mov    (%eax),%eax
801068fb:	39 c7                	cmp    %eax,%edi
801068fd:	73 31                	jae    80106930 <argptr+0x60>
801068ff:	8d 4b 08             	lea    0x8(%ebx),%ecx
80106902:	39 c8                	cmp    %ecx,%eax
80106904:	72 2a                	jb     80106930 <argptr+0x60>
 
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80106906:	8b 55 10             	mov    0x10(%ebp),%edx
  *ip = *(int*)(addr);
80106909:	8b 43 04             	mov    0x4(%ebx),%eax
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
8010690c:	85 d2                	test   %edx,%edx
8010690e:	78 20                	js     80106930 <argptr+0x60>
80106910:	8b 16                	mov    (%esi),%edx
80106912:	39 d0                	cmp    %edx,%eax
80106914:	73 1a                	jae    80106930 <argptr+0x60>
80106916:	8b 5d 10             	mov    0x10(%ebp),%ebx
80106919:	01 c3                	add    %eax,%ebx
8010691b:	39 da                	cmp    %ebx,%edx
8010691d:	72 11                	jb     80106930 <argptr+0x60>
    return -1;
  *pp = (char*)i;
8010691f:	8b 55 0c             	mov    0xc(%ebp),%edx
80106922:	89 02                	mov    %eax,(%edx)
  return 0;
80106924:	31 c0                	xor    %eax,%eax
}
80106926:	83 c4 0c             	add    $0xc,%esp
80106929:	5b                   	pop    %ebx
8010692a:	5e                   	pop    %esi
8010692b:	5f                   	pop    %edi
8010692c:	5d                   	pop    %ebp
...
80106935:	eb ef                	jmp    80106926 <argptr+0x56>
...
80106944:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80106945:	e8 c6 e5 ff ff       	call   80104f10 <myproc>
8010694a:	8b 55 08             	mov    0x8(%ebp),%edx
8010694d:	8b 40 18             	mov    0x18(%eax),%eax
80106950:	8b 40 44             	mov    0x44(%eax),%eax
80106953:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80106956:	e8 b5 e5 ff ff       	call   80104f10 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010695b:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
8010695e:	8b 00                	mov    (%eax),%eax
80106960:	39 c6                	cmp    %eax,%esi
80106962:	73 44                	jae    801069a8 <argstr+0x68>
80106964:	8d 53 08             	lea    0x8(%ebx),%edx
80106967:	39 d0                	cmp    %edx,%eax
80106969:	72 3d                	jb     801069a8 <argstr+0x68>
  *ip = *(int*)(addr);
8010696b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
8010696e:	e8 9d e5 ff ff       	call   80104f10 <myproc>
  if(addr >= curproc->sz)
80106973:	3b 18                	cmp    (%eax),%ebx
80106975:	73 31                	jae    801069a8 <argstr+0x68>
  *pp = (char*)addr;
80106977:	8b 55 0c             	mov    0xc(%ebp),%edx
8010697a:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
8010697c:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
8010697e:	39 d3                	cmp    %edx,%ebx
80106980:	73 26                	jae    801069a8 <argstr+0x68>
80106982:	89 d8                	mov    %ebx,%eax
80106984:	eb 11                	jmp    80106997 <argstr+0x57>
80106986:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010698d:	00 
8010698e:	66 90                	xchg   %ax,%ax
80106990:	83 c0 01             	add    $0x1,%eax
80106993:	39 d0                	cmp    %edx,%eax
80106995:	73 11                	jae    801069a8 <argstr+0x68>
    if(*s == 0)
80106997:	80 38 00             	cmpb   $0x0,(%eax)
8010699a:	75 f4                	jne    80106990 <argstr+0x50>
      return s - *pp;
8010699c:	29 d8                	sub    %ebx,%eax
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
801069af:	5d                   	pop    %ebp
801069b0:	c3                   	ret
801069b1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801069b8:	00 
...
801069c4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801069c7:	e8 44 e5 ff ff       	call   80104f10 <myproc>
801069cc:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
801069ce:	8b 40 18             	mov    0x18(%eax),%eax
801069d1:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801069d4:	8d 50 ff             	lea    -0x1(%eax),%edx
801069d7:	83 fa 21             	cmp    $0x21,%edx
801069da:	77 24                	ja     80106a00 <syscall+0x40>
801069dc:	8b 14 85 00 a2 10 80 	mov    -0x7fef5e00(,%eax,4),%edx
801069e3:	85 d2                	test   %edx,%edx
801069e5:	74 19                	je     80106a00 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
801069e7:	ff d2                	call   *%edx
801069e9:	89 c2                	mov    %eax,%edx
801069eb:	8b 43 18             	mov    0x18(%ebx),%eax
801069ee:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
801069f1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801069f4:	c9                   	leave
801069f5:	c3                   	ret
801069f6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801069fd:	00 
801069fe:	66 90                	xchg   %ax,%ax
    cprintf("%d %s: unknown sys call %d\n",
80106a00:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80106a01:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80106a04:	50                   	push   %eax
80106a05:	ff 73 10             	push   0x10(%ebx)
80106a08:	68 4a 9b 10 80       	push   $0x80109b4a
80106a0d:	e8 4e a3 ff ff       	call   80100d60 <cprintf>
    curproc->tf->eax = -1;
80106a12:	8b 43 18             	mov    0x18(%ebx),%eax
80106a15:	83 c4 10             	add    $0x10,%esp
80106a18:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
80106a1f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106a22:	c9                   	leave
80106a23:	c3                   	ret
...
80106a35:	8d 7d da             	lea    -0x26(%ebp),%edi
{
80106a38:	53                   	push   %ebx
80106a39:	83 ec 34             	sub    $0x34,%esp
80106a3c:	89 4d d0             	mov    %ecx,-0x30(%ebp)
80106a3f:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106a42:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80106a45:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80106a48:	57                   	push   %edi
80106a49:	50                   	push   %eax
80106a4a:	e8 f1 cb ff ff       	call   80103640 <nameiparent>
80106a4f:	83 c4 10             	add    $0x10,%esp
80106a52:	85 c0                	test   %eax,%eax
80106a54:	74 5e                	je     80106ab4 <create+0x84>
    return 0;
  ilock(dp);
80106a56:	83 ec 0c             	sub    $0xc,%esp
80106a59:	89 c3                	mov    %eax,%ebx
80106a5b:	50                   	push   %eax
80106a5c:	e8 df c2 ff ff       	call   80102d40 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80106a61:	83 c4 0c             	add    $0xc,%esp
80106a64:	6a 00                	push   $0x0
80106a66:	57                   	push   %edi
80106a67:	53                   	push   %ebx
80106a68:	e8 23 c8 ff ff       	call   80103290 <dirlookup>
80106a6d:	83 c4 10             	add    $0x10,%esp
80106a70:	89 c6                	mov    %eax,%esi
80106a72:	85 c0                	test   %eax,%eax
80106a74:	74 4a                	je     80106ac0 <create+0x90>
    iunlockput(dp);
80106a76:	83 ec 0c             	sub    $0xc,%esp
80106a79:	53                   	push   %ebx
80106a7a:	e8 51 c5 ff ff       	call   80102fd0 <iunlockput>
    ilock(ip);
80106a7f:	89 34 24             	mov    %esi,(%esp)
80106a82:	e8 b9 c2 ff ff       	call   80102d40 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80106a87:	83 c4 10             	add    $0x10,%esp
80106a8a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80106a8f:	75 17                	jne    80106aa8 <create+0x78>
80106a91:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80106a96:	75 10                	jne    80106aa8 <create+0x78>
...
80106aab:	56                   	push   %esi
80106aac:	e8 1f c5 ff ff       	call   80102fd0 <iunlockput>
    return 0;
80106ab1:	83 c4 10             	add    $0x10,%esp
}
80106ab4:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106ab7:	31 f6                	xor    %esi,%esi
}
80106ab9:	5b                   	pop    %ebx
...
80106ac0:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
80106ac4:	83 ec 08             	sub    $0x8,%esp
80106ac7:	50                   	push   %eax
80106ac8:	ff 33                	push   (%ebx)
80106aca:	e8 01 c1 ff ff       	call   80102bd0 <ialloc>
80106acf:	83 c4 10             	add    $0x10,%esp
80106ad2:	89 c6                	mov    %eax,%esi
80106ad4:	85 c0                	test   %eax,%eax
80106ad6:	0f 84 bc 00 00 00    	je     80106b98 <create+0x168>
  ilock(ip);
80106adc:	83 ec 0c             	sub    $0xc,%esp
80106adf:	50                   	push   %eax
80106ae0:	e8 5b c2 ff ff       	call   80102d40 <ilock>
  ip->major = major;
80106ae5:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80106ae9:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
80106aed:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80106af1:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80106af5:	b8 01 00 00 00       	mov    $0x1,%eax
80106afa:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
80106afe:	89 34 24             	mov    %esi,(%esp)
80106b01:	e8 8a c1 ff ff       	call   80102c90 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80106b06:	83 c4 10             	add    $0x10,%esp
80106b09:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106b0e:	74 30                	je     80106b40 <create+0x110>
  if(dirlink(dp, name, ip->inum) < 0)
80106b10:	83 ec 04             	sub    $0x4,%esp
80106b13:	ff 76 04             	push   0x4(%esi)
80106b16:	57                   	push   %edi
80106b17:	53                   	push   %ebx
80106b18:	e8 43 ca ff ff       	call   80103560 <dirlink>
80106b1d:	83 c4 10             	add    $0x10,%esp
80106b20:	85 c0                	test   %eax,%eax
80106b22:	78 67                	js     80106b8b <create+0x15b>
  iunlockput(dp);
80106b24:	83 ec 0c             	sub    $0xc,%esp
80106b27:	53                   	push   %ebx
80106b28:	e8 a3 c4 ff ff       	call   80102fd0 <iunlockput>
  return ip;
...
80106b40:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++;  // for ".."
80106b43:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
80106b48:	53                   	push   %ebx
80106b49:	e8 42 c1 ff ff       	call   80102c90 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106b4e:	83 c4 0c             	add    $0xc,%esp
80106b51:	ff 76 04             	push   0x4(%esi)
80106b54:	68 82 9b 10 80       	push   $0x80109b82
80106b59:	56                   	push   %esi
80106b5a:	e8 01 ca ff ff       	call   80103560 <dirlink>
80106b5f:	83 c4 10             	add    $0x10,%esp
80106b62:	85 c0                	test   %eax,%eax
80106b64:	78 18                	js     80106b7e <create+0x14e>
80106b66:	83 ec 04             	sub    $0x4,%esp
80106b69:	ff 73 04             	push   0x4(%ebx)
80106b6c:	68 81 9b 10 80       	push   $0x80109b81
80106b71:	56                   	push   %esi
80106b72:	e8 e9 c9 ff ff       	call   80103560 <dirlink>
80106b77:	83 c4 10             	add    $0x10,%esp
80106b7a:	85 c0                	test   %eax,%eax
80106b7c:	79 92                	jns    80106b10 <create+0xe0>
      panic("create dots");
80106b7e:	83 ec 0c             	sub    $0xc,%esp
80106b81:	68 75 9b 10 80       	push   $0x80109b75
80106b86:	e8 c5 99 ff ff       	call   80100550 <panic>
    panic("create: dirlink");
80106b8b:	83 ec 0c             	sub    $0xc,%esp
80106b8e:	68 84 9b 10 80       	push   $0x80109b84
80106b93:	e8 b8 99 ff ff       	call   80100550 <panic>
    panic("create: ialloc");
80106b98:	83 ec 0c             	sub    $0xc,%esp
80106b9b:	68 66 9b 10 80       	push   $0x80109b66
80106ba0:	e8 ab 99 ff ff       	call   80100550 <panic>
80106ba5:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106bac:	00 
...
{
80106bb8:	83 ec 18             	sub    $0x18,%esp
  if(argint(n, &fd) < 0)
80106bbb:	50                   	push   %eax
80106bbc:	6a 00                	push   $0x0
80106bbe:	e8 bd fc ff ff       	call   80106880 <argint>
80106bc3:	83 c4 10             	add    $0x10,%esp
80106bc6:	85 c0                	test   %eax,%eax
80106bc8:	78 36                	js     80106c00 <sys_dup+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80106bca:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106bce:	77 30                	ja     80106c00 <sys_dup+0x50>
80106bd0:	e8 3b e3 ff ff       	call   80104f10 <myproc>
80106bd5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106bd8:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80106bdc:	85 f6                	test   %esi,%esi
80106bde:	74 20                	je     80106c00 <sys_dup+0x50>
  struct proc *curproc = myproc();
80106be0:	e8 2b e3 ff ff       	call   80104f10 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80106be5:	31 db                	xor    %ebx,%ebx
80106be7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106bee:	00 
80106bef:	90                   	nop
    if(curproc->ofile[fd] == 0){
80106bf0:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80106bf4:	85 d2                	test   %edx,%edx
80106bf6:	74 18                	je     80106c10 <sys_dup+0x60>
  for(fd = 0; fd < NOFILE; fd++){
80106bf8:	83 c3 01             	add    $0x1,%ebx
80106bfb:	83 fb 10             	cmp    $0x10,%ebx
80106bfe:	75 f0                	jne    80106bf0 <sys_dup+0x40>
}
80106c00:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80106c03:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
80106c08:	89 d8                	mov    %ebx,%eax
80106c0a:	5b                   	pop    %ebx
80106c0b:	5e                   	pop    %esi
80106c0c:	5d                   	pop    %ebp
80106c0d:	c3                   	ret
...
80106c10:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80106c13:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80106c17:	56                   	push   %esi
80106c18:	e8 43 b8 ff ff       	call   80102460 <filedup>
  return fd;
80106c1d:	83 c4 10             	add    $0x10,%esp
}
80106c20:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106c23:	89 d8                	mov    %ebx,%eax
80106c25:	5b                   	pop    %ebx
80106c26:	5e                   	pop    %esi
80106c27:	5d                   	pop    %ebp
80106c28:	c3                   	ret
...
80106c34:	53                   	push   %ebx
  if(argint(n, &fd) < 0)
80106c35:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
80106c38:	83 ec 18             	sub    $0x18,%esp
  if(argint(n, &fd) < 0)
80106c3b:	53                   	push   %ebx
80106c3c:	6a 00                	push   $0x0
80106c3e:	e8 3d fc ff ff       	call   80106880 <argint>
80106c43:	83 c4 10             	add    $0x10,%esp
80106c46:	85 c0                	test   %eax,%eax
80106c48:	78 5e                	js     80106ca8 <sys_read+0x78>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80106c4a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106c4e:	77 58                	ja     80106ca8 <sys_read+0x78>
80106c50:	e8 bb e2 ff ff       	call   80104f10 <myproc>
80106c55:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106c58:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80106c5c:	85 f6                	test   %esi,%esi
80106c5e:	74 48                	je     80106ca8 <sys_read+0x78>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80106c60:	83 ec 08             	sub    $0x8,%esp
80106c63:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106c66:	50                   	push   %eax
80106c67:	6a 02                	push   $0x2
80106c69:	e8 12 fc ff ff       	call   80106880 <argint>
80106c6e:	83 c4 10             	add    $0x10,%esp
80106c71:	85 c0                	test   %eax,%eax
80106c73:	78 33                	js     80106ca8 <sys_read+0x78>
80106c75:	83 ec 04             	sub    $0x4,%esp
80106c78:	ff 75 f0             	push   -0x10(%ebp)
80106c7b:	53                   	push   %ebx
80106c7c:	6a 01                	push   $0x1
80106c7e:	e8 4d fc ff ff       	call   801068d0 <argptr>
80106c83:	83 c4 10             	add    $0x10,%esp
80106c86:	85 c0                	test   %eax,%eax
80106c88:	78 1e                	js     80106ca8 <sys_read+0x78>
  return fileread(f, p, n);
80106c8a:	83 ec 04             	sub    $0x4,%esp
80106c8d:	ff 75 f0             	push   -0x10(%ebp)
80106c90:	ff 75 f4             	push   -0xc(%ebp)
80106c93:	56                   	push   %esi
80106c94:	e8 47 b9 ff ff       	call   801025e0 <fileread>
...
80106ca1:	5d                   	pop    %ebp
80106ca2:	c3                   	ret
80106ca3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    return -1;
80106ca8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106cad:	eb ed                	jmp    80106c9c <sys_read+0x6c>
80106caf:	90                   	nop
...
80106cb4:	53                   	push   %ebx
  if(argint(n, &fd) < 0)
80106cb5:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
80106cb8:	83 ec 18             	sub    $0x18,%esp
  if(argint(n, &fd) < 0)
80106cbb:	53                   	push   %ebx
80106cbc:	6a 00                	push   $0x0
80106cbe:	e8 bd fb ff ff       	call   80106880 <argint>
80106cc3:	83 c4 10             	add    $0x10,%esp
80106cc6:	85 c0                	test   %eax,%eax
80106cc8:	78 5e                	js     80106d28 <sys_write+0x78>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80106cca:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106cce:	77 58                	ja     80106d28 <sys_write+0x78>
80106cd0:	e8 3b e2 ff ff       	call   80104f10 <myproc>
80106cd5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106cd8:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80106cdc:	85 f6                	test   %esi,%esi
80106cde:	74 48                	je     80106d28 <sys_write+0x78>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80106ce0:	83 ec 08             	sub    $0x8,%esp
80106ce3:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106ce6:	50                   	push   %eax
80106ce7:	6a 02                	push   $0x2
80106ce9:	e8 92 fb ff ff       	call   80106880 <argint>
80106cee:	83 c4 10             	add    $0x10,%esp
80106cf1:	85 c0                	test   %eax,%eax
80106cf3:	78 33                	js     80106d28 <sys_write+0x78>
80106cf5:	83 ec 04             	sub    $0x4,%esp
80106cf8:	ff 75 f0             	push   -0x10(%ebp)
80106cfb:	53                   	push   %ebx
80106cfc:	6a 01                	push   $0x1
80106cfe:	e8 cd fb ff ff       	call   801068d0 <argptr>
80106d03:	83 c4 10             	add    $0x10,%esp
80106d06:	85 c0                	test   %eax,%eax
80106d08:	78 1e                	js     80106d28 <sys_write+0x78>
  return filewrite(f, p, n);
80106d0a:	83 ec 04             	sub    $0x4,%esp
80106d0d:	ff 75 f0             	push   -0x10(%ebp)
80106d10:	ff 75 f4             	push   -0xc(%ebp)
80106d13:	56                   	push   %esi
80106d14:	e8 57 b9 ff ff       	call   80102670 <filewrite>
...
80106d21:	5d                   	pop    %ebp
80106d22:	c3                   	ret
80106d23:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    return -1;
80106d28:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d2d:	eb ed                	jmp    80106d1c <sys_write+0x6c>
80106d2f:	90                   	nop
...
80106d34:	53                   	push   %ebx
  if(argint(n, &fd) < 0)
80106d35:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
80106d38:	83 ec 18             	sub    $0x18,%esp
  if(argint(n, &fd) < 0)
80106d3b:	50                   	push   %eax
80106d3c:	6a 00                	push   $0x0
80106d3e:	e8 3d fb ff ff       	call   80106880 <argint>
80106d43:	83 c4 10             	add    $0x10,%esp
80106d46:	85 c0                	test   %eax,%eax
80106d48:	78 3e                	js     80106d88 <sys_close+0x58>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80106d4a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106d4e:	77 38                	ja     80106d88 <sys_close+0x58>
80106d50:	e8 bb e1 ff ff       	call   80104f10 <myproc>
80106d55:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106d58:	8d 5a 08             	lea    0x8(%edx),%ebx
80106d5b:	8b 74 98 08          	mov    0x8(%eax,%ebx,4),%esi
80106d5f:	85 f6                	test   %esi,%esi
80106d61:	74 25                	je     80106d88 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80106d63:	e8 a8 e1 ff ff       	call   80104f10 <myproc>
  fileclose(f);
80106d68:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80106d6b:	c7 44 98 08 00 00 00 	movl   $0x0,0x8(%eax,%ebx,4)
80106d72:	00 
  fileclose(f);
80106d73:	56                   	push   %esi
80106d74:	e8 37 b7 ff ff       	call   801024b0 <fileclose>
  return 0;
...
80106d8d:	eb ef                	jmp    80106d7e <sys_close+0x4e>
80106d8f:	90                   	nop
...
80106d94:	53                   	push   %ebx
  if(argint(n, &fd) < 0)
80106d95:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
80106d98:	83 ec 18             	sub    $0x18,%esp
  if(argint(n, &fd) < 0)
80106d9b:	53                   	push   %ebx
80106d9c:	6a 00                	push   $0x0
80106d9e:	e8 dd fa ff ff       	call   80106880 <argint>
80106da3:	83 c4 10             	add    $0x10,%esp
80106da6:	85 c0                	test   %eax,%eax
80106da8:	78 46                	js     80106df0 <sys_fstat+0x60>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80106daa:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106dae:	77 40                	ja     80106df0 <sys_fstat+0x60>
80106db0:	e8 5b e1 ff ff       	call   80104f10 <myproc>
80106db5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106db8:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80106dbc:	85 f6                	test   %esi,%esi
80106dbe:	74 30                	je     80106df0 <sys_fstat+0x60>
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80106dc0:	83 ec 04             	sub    $0x4,%esp
80106dc3:	6a 14                	push   $0x14
80106dc5:	53                   	push   %ebx
80106dc6:	6a 01                	push   $0x1
80106dc8:	e8 03 fb ff ff       	call   801068d0 <argptr>
80106dcd:	83 c4 10             	add    $0x10,%esp
80106dd0:	85 c0                	test   %eax,%eax
80106dd2:	78 1c                	js     80106df0 <sys_fstat+0x60>
  return filestat(f, st);
80106dd4:	83 ec 08             	sub    $0x8,%esp
80106dd7:	ff 75 f4             	push   -0xc(%ebp)
80106dda:	56                   	push   %esi
80106ddb:	e8 b0 b7 ff ff       	call   80102590 <filestat>
80106de0:	83 c4 10             	add    $0x10,%esp
}
80106de3:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106de6:	5b                   	pop    %ebx
80106de7:	5e                   	pop    %esi
80106de8:	5d                   	pop    %ebp
80106de9:	c3                   	ret
...
80106df5:	eb ec                	jmp    80106de3 <sys_fstat+0x53>
80106df7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106dfe:	00 
80106dff:	90                   	nop
...
80106e05:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
80106e08:	53                   	push   %ebx
80106e09:	83 ec 34             	sub    $0x34,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80106e0c:	50                   	push   %eax
80106e0d:	6a 00                	push   $0x0
80106e0f:	e8 2c fb ff ff       	call   80106940 <argstr>
80106e14:	83 c4 10             	add    $0x10,%esp
80106e17:	85 c0                	test   %eax,%eax
80106e19:	0f 88 fb 00 00 00    	js     80106f1a <sys_link+0x11a>
80106e1f:	83 ec 08             	sub    $0x8,%esp
80106e22:	8d 45 d0             	lea    -0x30(%ebp),%eax
80106e25:	50                   	push   %eax
80106e26:	6a 01                	push   $0x1
80106e28:	e8 13 fb ff ff       	call   80106940 <argstr>
80106e2d:	83 c4 10             	add    $0x10,%esp
80106e30:	85 c0                	test   %eax,%eax
80106e32:	0f 88 e2 00 00 00    	js     80106f1a <sys_link+0x11a>
  begin_op();
80106e38:	e8 a3 d4 ff ff       	call   801042e0 <begin_op>
  if((ip = namei(old)) == 0){
80106e3d:	83 ec 0c             	sub    $0xc,%esp
80106e40:	ff 75 d4             	push   -0x2c(%ebp)
80106e43:	e8 d8 c7 ff ff       	call   80103620 <namei>
80106e48:	83 c4 10             	add    $0x10,%esp
80106e4b:	89 c3                	mov    %eax,%ebx
80106e4d:	85 c0                	test   %eax,%eax
80106e4f:	0f 84 df 00 00 00    	je     80106f34 <sys_link+0x134>
  ilock(ip);
80106e55:	83 ec 0c             	sub    $0xc,%esp
80106e58:	50                   	push   %eax
80106e59:	e8 e2 be ff ff       	call   80102d40 <ilock>
  if(ip->type == T_DIR){
80106e5e:	83 c4 10             	add    $0x10,%esp
80106e61:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80106e66:	0f 84 b5 00 00 00    	je     80106f21 <sys_link+0x121>
  iupdate(ip);
80106e6c:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80106e6f:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80106e74:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80106e77:	53                   	push   %ebx
80106e78:	e8 13 be ff ff       	call   80102c90 <iupdate>
  iunlock(ip);
80106e7d:	89 1c 24             	mov    %ebx,(%esp)
80106e80:	e8 9b bf ff ff       	call   80102e20 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80106e85:	58                   	pop    %eax
80106e86:	5a                   	pop    %edx
80106e87:	57                   	push   %edi
80106e88:	ff 75 d0             	push   -0x30(%ebp)
80106e8b:	e8 b0 c7 ff ff       	call   80103640 <nameiparent>
80106e90:	83 c4 10             	add    $0x10,%esp
80106e93:	89 c6                	mov    %eax,%esi
80106e95:	85 c0                	test   %eax,%eax
80106e97:	74 5b                	je     80106ef4 <sys_link+0xf4>
  ilock(dp);
80106e99:	83 ec 0c             	sub    $0xc,%esp
80106e9c:	50                   	push   %eax
80106e9d:	e8 9e be ff ff       	call   80102d40 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80106ea2:	8b 03                	mov    (%ebx),%eax
80106ea4:	83 c4 10             	add    $0x10,%esp
80106ea7:	39 06                	cmp    %eax,(%esi)
80106ea9:	75 3d                	jne    80106ee8 <sys_link+0xe8>
80106eab:	83 ec 04             	sub    $0x4,%esp
80106eae:	ff 73 04             	push   0x4(%ebx)
80106eb1:	57                   	push   %edi
80106eb2:	56                   	push   %esi
80106eb3:	e8 a8 c6 ff ff       	call   80103560 <dirlink>
80106eb8:	83 c4 10             	add    $0x10,%esp
80106ebb:	85 c0                	test   %eax,%eax
80106ebd:	78 29                	js     80106ee8 <sys_link+0xe8>
  iunlockput(dp);
80106ebf:	83 ec 0c             	sub    $0xc,%esp
80106ec2:	56                   	push   %esi
80106ec3:	e8 08 c1 ff ff       	call   80102fd0 <iunlockput>
  iput(ip);
80106ec8:	89 1c 24             	mov    %ebx,(%esp)
80106ecb:	e8 a0 bf ff ff       	call   80102e70 <iput>
  end_op();
80106ed0:	e8 7b d4 ff ff       	call   80104350 <end_op>
  return 0;
...
80106eec:	e8 df c0 ff ff       	call   80102fd0 <iunlockput>
    goto bad;
80106ef1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80106ef4:	83 ec 0c             	sub    $0xc,%esp
80106ef7:	53                   	push   %ebx
80106ef8:	e8 43 be ff ff       	call   80102d40 <ilock>
  ip->nlink--;
80106efd:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80106f02:	89 1c 24             	mov    %ebx,(%esp)
80106f05:	e8 86 bd ff ff       	call   80102c90 <iupdate>
  iunlockput(ip);
80106f0a:	89 1c 24             	mov    %ebx,(%esp)
80106f0d:	e8 be c0 ff ff       	call   80102fd0 <iunlockput>
  end_op();
80106f12:	e8 39 d4 ff ff       	call   80104350 <end_op>
  return -1;
80106f17:	83 c4 10             	add    $0x10,%esp
    return -1;
80106f1a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f1f:	eb b9                	jmp    80106eda <sys_link+0xda>
    iunlockput(ip);
80106f21:	83 ec 0c             	sub    $0xc,%esp
80106f24:	53                   	push   %ebx
80106f25:	e8 a6 c0 ff ff       	call   80102fd0 <iunlockput>
    end_op();
80106f2a:	e8 21 d4 ff ff       	call   80104350 <end_op>
    return -1;
80106f2f:	83 c4 10             	add    $0x10,%esp
80106f32:	eb e6                	jmp    80106f1a <sys_link+0x11a>
    end_op();
80106f34:	e8 17 d4 ff ff       	call   80104350 <end_op>
    return -1;
80106f39:	eb df                	jmp    80106f1a <sys_link+0x11a>
...
80106f44:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80106f45:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
80106f48:	53                   	push   %ebx
80106f49:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
80106f4c:	50                   	push   %eax
80106f4d:	6a 00                	push   $0x0
80106f4f:	e8 ec f9 ff ff       	call   80106940 <argstr>
80106f54:	83 c4 10             	add    $0x10,%esp
80106f57:	85 c0                	test   %eax,%eax
80106f59:	0f 88 54 01 00 00    	js     801070b3 <sys_unlink+0x173>
  begin_op();
80106f5f:	e8 7c d3 ff ff       	call   801042e0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80106f64:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80106f67:	83 ec 08             	sub    $0x8,%esp
80106f6a:	53                   	push   %ebx
80106f6b:	ff 75 c0             	push   -0x40(%ebp)
80106f6e:	e8 cd c6 ff ff       	call   80103640 <nameiparent>
80106f73:	83 c4 10             	add    $0x10,%esp
80106f76:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80106f79:	85 c0                	test   %eax,%eax
80106f7b:	0f 84 58 01 00 00    	je     801070d9 <sys_unlink+0x199>
  ilock(dp);
80106f81:	8b 7d b4             	mov    -0x4c(%ebp),%edi
80106f84:	83 ec 0c             	sub    $0xc,%esp
80106f87:	57                   	push   %edi
80106f88:	e8 b3 bd ff ff       	call   80102d40 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80106f8d:	58                   	pop    %eax
80106f8e:	5a                   	pop    %edx
80106f8f:	68 82 9b 10 80       	push   $0x80109b82
80106f94:	53                   	push   %ebx
80106f95:	e8 d6 c2 ff ff       	call   80103270 <namecmp>
80106f9a:	83 c4 10             	add    $0x10,%esp
80106f9d:	85 c0                	test   %eax,%eax
80106f9f:	0f 84 fb 00 00 00    	je     801070a0 <sys_unlink+0x160>
80106fa5:	83 ec 08             	sub    $0x8,%esp
80106fa8:	68 81 9b 10 80       	push   $0x80109b81
80106fad:	53                   	push   %ebx
80106fae:	e8 bd c2 ff ff       	call   80103270 <namecmp>
80106fb3:	83 c4 10             	add    $0x10,%esp
80106fb6:	85 c0                	test   %eax,%eax
80106fb8:	0f 84 e2 00 00 00    	je     801070a0 <sys_unlink+0x160>
  if((ip = dirlookup(dp, name, &off)) == 0)
80106fbe:	83 ec 04             	sub    $0x4,%esp
80106fc1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80106fc4:	50                   	push   %eax
80106fc5:	53                   	push   %ebx
80106fc6:	57                   	push   %edi
80106fc7:	e8 c4 c2 ff ff       	call   80103290 <dirlookup>
80106fcc:	83 c4 10             	add    $0x10,%esp
80106fcf:	89 c3                	mov    %eax,%ebx
80106fd1:	85 c0                	test   %eax,%eax
80106fd3:	0f 84 c7 00 00 00    	je     801070a0 <sys_unlink+0x160>
  ilock(ip);
80106fd9:	83 ec 0c             	sub    $0xc,%esp
80106fdc:	50                   	push   %eax
80106fdd:	e8 5e bd ff ff       	call   80102d40 <ilock>
  if(ip->nlink < 1)
80106fe2:	83 c4 10             	add    $0x10,%esp
80106fe5:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80106fea:	0f 8e 0a 01 00 00    	jle    801070fa <sys_unlink+0x1ba>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106ff0:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80106ff5:	8d 7d d8             	lea    -0x28(%ebp),%edi
80106ff8:	74 66                	je     80107060 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
80106ffa:	83 ec 04             	sub    $0x4,%esp
80106ffd:	6a 10                	push   $0x10
80106fff:	6a 00                	push   $0x0
80107001:	57                   	push   %edi
80107002:	e8 c9 f5 ff ff       	call   801065d0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80107007:	6a 10                	push   $0x10
80107009:	ff 75 c4             	push   -0x3c(%ebp)
8010700c:	57                   	push   %edi
8010700d:	ff 75 b4             	push   -0x4c(%ebp)
80107010:	e8 3b c1 ff ff       	call   80103150 <writei>
80107015:	83 c4 20             	add    $0x20,%esp
80107018:	83 f8 10             	cmp    $0x10,%eax
8010701b:	0f 85 cc 00 00 00    	jne    801070ed <sys_unlink+0x1ad>
  if(ip->type == T_DIR){
80107021:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80107026:	0f 84 94 00 00 00    	je     801070c0 <sys_unlink+0x180>
  iunlockput(dp);
8010702c:	83 ec 0c             	sub    $0xc,%esp
8010702f:	ff 75 b4             	push   -0x4c(%ebp)
80107032:	e8 99 bf ff ff       	call   80102fd0 <iunlockput>
  ip->nlink--;
80107037:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010703c:	89 1c 24             	mov    %ebx,(%esp)
8010703f:	e8 4c bc ff ff       	call   80102c90 <iupdate>
  iunlockput(ip);
80107044:	89 1c 24             	mov    %ebx,(%esp)
80107047:	e8 84 bf ff ff       	call   80102fd0 <iunlockput>
  end_op();
8010704c:	e8 ff d2 ff ff       	call   80104350 <end_op>
  return 0;
80107051:	83 c4 10             	add    $0x10,%esp
80107054:	31 c0                	xor    %eax,%eax
}
...
80107060:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80107064:	76 94                	jbe    80106ffa <sys_unlink+0xba>
80107066:	be 20 00 00 00       	mov    $0x20,%esi
8010706b:	eb 0b                	jmp    80107078 <sys_unlink+0x138>
8010706d:	8d 76 00             	lea    0x0(%esi),%esi
80107070:	83 c6 10             	add    $0x10,%esi
80107073:	3b 73 58             	cmp    0x58(%ebx),%esi
80107076:	73 82                	jae    80106ffa <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80107078:	6a 10                	push   $0x10
8010707a:	56                   	push   %esi
8010707b:	57                   	push   %edi
8010707c:	53                   	push   %ebx
8010707d:	e8 ce bf ff ff       	call   80103050 <readi>
80107082:	83 c4 10             	add    $0x10,%esp
80107085:	83 f8 10             	cmp    $0x10,%eax
80107088:	75 56                	jne    801070e0 <sys_unlink+0x1a0>
    if(de.inum != 0)
8010708a:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
8010708f:	74 df                	je     80107070 <sys_unlink+0x130>
    iunlockput(ip);
80107091:	83 ec 0c             	sub    $0xc,%esp
80107094:	53                   	push   %ebx
80107095:	e8 36 bf ff ff       	call   80102fd0 <iunlockput>
    goto bad;
8010709a:	83 c4 10             	add    $0x10,%esp
8010709d:	8d 76 00             	lea    0x0(%esi),%esi
  iunlockput(dp);
801070a0:	83 ec 0c             	sub    $0xc,%esp
801070a3:	ff 75 b4             	push   -0x4c(%ebp)
801070a6:	e8 25 bf ff ff       	call   80102fd0 <iunlockput>
  end_op();
801070ab:	e8 a0 d2 ff ff       	call   80104350 <end_op>
  return -1;
801070b0:	83 c4 10             	add    $0x10,%esp
    return -1;
801070b3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070b8:	eb 9c                	jmp    80107056 <sys_unlink+0x116>
801070ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
801070c0:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
801070c3:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
801070c6:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
801070cb:	50                   	push   %eax
801070cc:	e8 bf bb ff ff       	call   80102c90 <iupdate>
801070d1:	83 c4 10             	add    $0x10,%esp
801070d4:	e9 53 ff ff ff       	jmp    8010702c <sys_unlink+0xec>
    end_op();
801070d9:	e8 72 d2 ff ff       	call   80104350 <end_op>
    return -1;
801070de:	eb d3                	jmp    801070b3 <sys_unlink+0x173>
      panic("isdirempty: readi");
801070e0:	83 ec 0c             	sub    $0xc,%esp
801070e3:	68 a6 9b 10 80       	push   $0x80109ba6
801070e8:	e8 63 94 ff ff       	call   80100550 <panic>
    panic("unlink: writei");
801070ed:	83 ec 0c             	sub    $0xc,%esp
801070f0:	68 b8 9b 10 80       	push   $0x80109bb8
801070f5:	e8 56 94 ff ff       	call   80100550 <panic>
    panic("unlink: nlink < 1");
801070fa:	83 ec 0c             	sub    $0xc,%esp
801070fd:	68 94 9b 10 80       	push   $0x80109b94
80107102:	e8 49 94 ff ff       	call   80100550 <panic>
...
80107115:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
...
8010711f:	e8 1c f8 ff ff       	call   80106940 <argstr>
80107124:	83 c4 10             	add    $0x10,%esp
80107127:	85 c0                	test   %eax,%eax
80107129:	0f 88 8e 00 00 00    	js     801071bd <sys_open+0xad>
8010712f:	83 ec 08             	sub    $0x8,%esp
80107132:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80107135:	50                   	push   %eax
80107136:	6a 01                	push   $0x1
80107138:	e8 43 f7 ff ff       	call   80106880 <argint>
8010713d:	83 c4 10             	add    $0x10,%esp
80107140:	85 c0                	test   %eax,%eax
80107142:	78 79                	js     801071bd <sys_open+0xad>
    return -1;

  begin_op();
80107144:	e8 97 d1 ff ff       	call   801042e0 <begin_op>

  if(omode & O_CREATE){
80107149:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
8010714d:	75 79                	jne    801071c8 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80107152:	ff 75 e0             	push   -0x20(%ebp)
80107155:	e8 c6 c4 ff ff       	call   80103620 <namei>
8010715a:	83 c4 10             	add    $0x10,%esp
8010715d:	89 c6                	mov    %eax,%esi
8010715f:	85 c0                	test   %eax,%eax
80107161:	0f 84 7e 00 00 00    	je     801071e5 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
8010716b:	e8 d0 bb ff ff       	call   80102d40 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80107170:	83 c4 10             	add    $0x10,%esp
80107173:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80107178:	0f 84 ba 00 00 00    	je     80107238 <sys_open+0x128>
      end_op();
      return -1;
    }
  }
...
8010717e:	e8 6d b2 ff ff       	call   801023f0 <filealloc>
80107183:	89 c7                	mov    %eax,%edi
80107185:	85 c0                	test   %eax,%eax
80107187:	74 23                	je     801071ac <sys_open+0x9c>
  struct proc *curproc = myproc();
80107189:	e8 82 dd ff ff       	call   80104f10 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010718e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80107190:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80107194:	85 d2                	test   %edx,%edx
80107196:	74 58                	je     801071f0 <sys_open+0xe0>
  for(fd = 0; fd < NOFILE; fd++){
80107198:	83 c3 01             	add    $0x1,%ebx
8010719b:	83 fb 10             	cmp    $0x10,%ebx
8010719e:	75 f0                	jne    80107190 <sys_open+0x80>
    if(f)
      fileclose(f);
801071a0:	83 ec 0c             	sub    $0xc,%esp
801071a3:	57                   	push   %edi
801071a4:	e8 07 b3 ff ff       	call   801024b0 <fileclose>
801071a9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801071ac:	83 ec 0c             	sub    $0xc,%esp
801071af:	56                   	push   %esi
801071b0:	e8 1b be ff ff       	call   80102fd0 <iunlockput>
    end_op();
801071b5:	e8 96 d1 ff ff       	call   80104350 <end_op>
    return -1;
801071ba:	83 c4 10             	add    $0x10,%esp
    return -1;
801071bd:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801071c2:	eb 65                	jmp    80107229 <sys_open+0x119>
801071c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
801071c8:	83 ec 0c             	sub    $0xc,%esp
801071cb:	31 c9                	xor    %ecx,%ecx
801071cd:	ba 02 00 00 00       	mov    $0x2,%edx
801071d2:	6a 00                	push   $0x0
801071d4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801071d7:	e8 54 f8 ff ff       	call   80106a30 <create>
    if(ip == 0){
...
801071e3:	75 99                	jne    8010717e <sys_open+0x6e>
      end_op();
801071e5:	e8 66 d1 ff ff       	call   80104350 <end_op>
      return -1;
801071ea:	eb d1                	jmp    801071bd <sys_open+0xad>
801071ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
801071f0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801071f3:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
  iunlock(ip);
801071f7:	56                   	push   %esi
801071f8:	e8 23 bc ff ff       	call   80102e20 <iunlock>
  end_op();
801071fd:	e8 4e d1 ff ff       	call   80104350 <end_op>

  f->type = FD_INODE;
80107202:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
...
8010720b:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
8010720e:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80107211:	89 d0                	mov    %edx,%eax
  f->off = 0;
80107213:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
8010721a:	f7 d0                	not    %eax
8010721c:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010721f:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
80107222:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80107225:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
80107229:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010722c:	89 d8                	mov    %ebx,%eax
8010722e:	5b                   	pop    %ebx
8010722f:	5e                   	pop    %esi
80107230:	5f                   	pop    %edi
80107231:	5d                   	pop    %ebp
80107232:	c3                   	ret
80107233:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
80107238:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010723b:	85 c9                	test   %ecx,%ecx
8010723d:	0f 84 3b ff ff ff    	je     8010717e <sys_open+0x6e>
80107243:	e9 64 ff ff ff       	jmp    801071ac <sys_open+0x9c>
...
80107253:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80107256:	e8 85 d0 ff ff       	call   801042e0 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010725b:	83 ec 08             	sub    $0x8,%esp
8010725e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107261:	50                   	push   %eax
80107262:	6a 00                	push   $0x0
80107264:	e8 d7 f6 ff ff       	call   80106940 <argstr>
80107269:	83 c4 10             	add    $0x10,%esp
8010726c:	85 c0                	test   %eax,%eax
8010726e:	78 30                	js     801072a0 <sys_mkdir+0x50>
80107270:	83 ec 0c             	sub    $0xc,%esp
80107273:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107276:	31 c9                	xor    %ecx,%ecx
80107278:	ba 01 00 00 00       	mov    $0x1,%edx
8010727d:	6a 00                	push   $0x0
8010727f:	e8 ac f7 ff ff       	call   80106a30 <create>
80107284:	83 c4 10             	add    $0x10,%esp
80107287:	85 c0                	test   %eax,%eax
80107289:	74 15                	je     801072a0 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
8010728f:	e8 3c bd ff ff       	call   80102fd0 <iunlockput>
  end_op();
80107294:	e8 b7 d0 ff ff       	call   80104350 <end_op>
  return 0;
80107299:	83 c4 10             	add    $0x10,%esp
8010729c:	31 c0                	xor    %eax,%eax
}
8010729e:	c9                   	leave
8010729f:	c3                   	ret
    end_op();
801072a0:	e8 ab d0 ff ff       	call   80104350 <end_op>
    return -1;
...
801072d9:	e8 a2 f5 ff ff       	call   80106880 <argint>
  if((argstr(0, &path)) < 0 ||
...
801072ee:	e8 8d f5 ff ff       	call   80106880 <argint>
     argint(1, &major) < 0 ||
...
8010730e:	e8 1d f7 ff ff       	call   80106a30 <create>
     argint(2, &minor) < 0 ||
...
8010731e:	e8 ad bc ff ff       	call   80102fd0 <iunlockput>
  end_op();
80107323:	e8 28 d0 ff ff       	call   80104350 <end_op>
  return 0;
...
8010732f:	90                   	nop
    end_op();
80107330:	e8 1b d0 ff ff       	call   80104350 <end_op>
    return -1;
...
80107345:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80107348:	e8 c3 db ff ff       	call   80104f10 <myproc>
8010734d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010734f:	e8 8c cf ff ff       	call   801042e0 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80107354:	83 ec 08             	sub    $0x8,%esp
80107357:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010735a:	50                   	push   %eax
8010735b:	6a 00                	push   $0x0
8010735d:	e8 de f5 ff ff       	call   80106940 <argstr>
...
8010736f:	e8 ac c2 ff ff       	call   80103620 <namei>
...
80107381:	e8 ba b9 ff ff       	call   80102d40 <ilock>
  if(ip->type != T_DIR){
...
80107394:	e8 87 ba ff ff       	call   80102e20 <iunlock>
  iput(curproc->cwd);
80107399:	58                   	pop    %eax
8010739a:	ff 76 68             	push   0x68(%esi)
8010739d:	e8 ce ba ff ff       	call   80102e70 <iput>
  end_op();
801073a2:	e8 a9 cf ff ff       	call   80104350 <end_op>
  curproc->cwd = ip;
...
801073c4:	e8 07 bc ff ff       	call   80102fd0 <iunlockput>
    end_op();
801073c9:	e8 82 cf ff ff       	call   80104350 <end_op>
    return -1;
801073ce:	83 c4 10             	add    $0x10,%esp
    return -1;
801073d1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801073d6:	eb d7                	jmp    801073af <sys_chdir+0x6f>
801073d8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801073df:	00 
    end_op();
801073e0:	e8 6b cf ff ff       	call   80104350 <end_op>
    return -1;
801073e5:	eb ea                	jmp    801073d1 <sys_chdir+0x91>
...
80107405:	e8 36 f5 ff ff       	call   80106940 <argstr>
...
80107421:	e8 5a f4 ff ff       	call   80106880 <argint>
...
80107440:	e8 8b f1 ff ff       	call   801065d0 <memset>
...
8010746a:	e8 81 f3 ff ff       	call   801067f0 <fetchint>
...
80107488:	e8 a3 f3 ff ff       	call   80106830 <fetchstr>
...
801074c5:	e8 86 ab ff ff       	call   80102050 <exec>
...
801074d3:	5d                   	pop    %ebp
801074d4:	c3                   	ret
801074d5:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801074dc:	00 
...
801074f1:	e8 da f3 ff ff       	call   801068d0 <argptr>
801074f6:	83 c4 10             	add    $0x10,%esp
801074f9:	85 c0                	test   %eax,%eax
801074fb:	0f 88 8b 00 00 00    	js     8010758c <sys_pipe+0xac>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80107501:	83 ec 08             	sub    $0x8,%esp
80107504:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80107507:	50                   	push   %eax
80107508:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010750b:	50                   	push   %eax
8010750c:	e8 9f d4 ff ff       	call   801049b0 <pipealloc>
80107511:	83 c4 10             	add    $0x10,%esp
80107514:	85 c0                	test   %eax,%eax
80107516:	78 74                	js     8010758c <sys_pipe+0xac>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80107518:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
8010751b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010751d:	e8 ee d9 ff ff       	call   80104f10 <myproc>
    if(curproc->ofile[fd] == 0){
80107522:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80107526:	85 f6                	test   %esi,%esi
80107528:	74 16                	je     80107540 <sys_pipe+0x60>
8010752a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
80107530:	83 c3 01             	add    $0x1,%ebx
80107533:	83 fb 10             	cmp    $0x10,%ebx
80107536:	74 3d                	je     80107575 <sys_pipe+0x95>
    if(curproc->ofile[fd] == 0){
80107538:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
8010753c:	85 f6                	test   %esi,%esi
8010753e:	75 f0                	jne    80107530 <sys_pipe+0x50>
      curproc->ofile[fd] = f;
80107540:	8d 73 08             	lea    0x8(%ebx),%esi
80107543:	89 7c b0 08          	mov    %edi,0x8(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80107547:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010754a:	e8 c1 d9 ff ff       	call   80104f10 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010754f:	31 d2                	xor    %edx,%edx
80107551:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80107558:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
8010755c:	85 c9                	test   %ecx,%ecx
8010755e:	74 38                	je     80107598 <sys_pipe+0xb8>
  for(fd = 0; fd < NOFILE; fd++){
80107560:	83 c2 01             	add    $0x1,%edx
80107563:	83 fa 10             	cmp    $0x10,%edx
80107566:	75 f0                	jne    80107558 <sys_pipe+0x78>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80107568:	e8 a3 d9 ff ff       	call   80104f10 <myproc>
8010756d:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
80107574:	00 
    fileclose(rf);
80107575:	83 ec 0c             	sub    $0xc,%esp
80107578:	ff 75 e0             	push   -0x20(%ebp)
8010757b:	e8 30 af ff ff       	call   801024b0 <fileclose>
    fileclose(wf);
80107580:	58                   	pop    %eax
80107581:	ff 75 e4             	push   -0x1c(%ebp)
80107584:	e8 27 af ff ff       	call   801024b0 <fileclose>
    return -1;
80107589:	83 c4 10             	add    $0x10,%esp
    return -1;
8010758c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107591:	eb 16                	jmp    801075a9 <sys_pipe+0xc9>
80107593:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80107598:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
  }
  fd[0] = fd0;
8010759c:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010759f:	89 18                	mov    %ebx,(%eax)
  fd[1] = fd1;
801075a1:	8b 45 dc             	mov    -0x24(%ebp),%eax
801075a4:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
801075a7:	31 c0                	xor    %eax,%eax
}
...
801075c0 <sys_make_duplicate_file>:
...
801075c4:	56                   	push   %esi
  ...
  if(argstr(0, &org) < 0)
801075c5:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
{
801075cb:	53                   	push   %ebx
801075cc:	81 ec b4 00 00 00    	sub    $0xb4,%esp
  if(argstr(0, &org) < 0)
801075d2:	50                   	push   %eax
801075d3:	6a 00                	push   $0x0
801075d5:	e8 66 f3 ff ff       	call   80106940 <argstr>
801075da:	83 c4 10             	add    $0x10,%esp
801075dd:	85 c0                	test   %eax,%eax
801075df:	0f 88 6d 01 00 00    	js     80107752 <sys_make_duplicate_file+0x192>
    return -1;

  int olen = strlen(org);
801075e5:	83 ec 0c             	sub    $0xc,%esp
801075e8:	ff b5 64 ff ff ff    	push   -0x9c(%ebp)
801075ee:	e8 cd f1 ff ff       	call   801067c0 <strlen>
  if(olen + 6 >= MAXPATH)          /* room for "_copy" */
801075f3:	83 c4 10             	add    $0x10,%esp
  int olen = strlen(org);
801075f6:	89 c3                	mov    %eax,%ebx
  if(olen + 6 >= MAXPATH)          /* room for "_copy" */
801075f8:	83 f8 79             	cmp    $0x79,%eax
801075fb:	0f 8f 51 01 00 00    	jg     80107752 <sys_make_duplicate_file+0x192>
    return -1;
  safestrcpy(newname, org, MAXPATH);
80107601:	83 ec 04             	sub    $0x4,%esp
80107604:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
8010760a:	68 80 00 00 00       	push   $0x80
  memmove(newname + olen, "_copy", 6);
8010760f:	01 f3                	add    %esi,%ebx
  safestrcpy(newname, org, MAXPATH);
80107611:	ff b5 64 ff ff ff    	push   -0x9c(%ebp)
80107617:	56                   	push   %esi
80107618:	e8 63 f1 ff ff       	call   80106780 <safestrcpy>
  memmove(newname + olen, "_copy", 6);
8010761d:	83 c4 0c             	add    $0xc,%esp
80107620:	6a 06                	push   $0x6
80107622:	68 c7 9b 10 80       	push   $0x80109bc7
80107627:	53                   	push   %ebx
80107628:	e8 33 f0 ff ff       	call   80106660 <memmove>

  begin_op();
8010762d:	e8 ae cc ff ff       	call   801042e0 <begin_op>

  if(namei(newname) != 0){          // no locks needed for pure existence test
80107632:	89 34 24             	mov    %esi,(%esp)
80107635:	e8 e6 bf ff ff       	call   80103620 <namei>
8010763a:	83 c4 10             	add    $0x10,%esp
8010763d:	85 c0                	test   %eax,%eax
8010763f:	0f 85 5d 01 00 00    	jne    801077a2 <sys_make_duplicate_file+0x1e2>
    end_op();
    return -1;
  }
...
80107648:	ff b5 64 ff ff ff    	push   -0x9c(%ebp)
8010764e:	e8 cd bf ff ff       	call   80103620 <namei>
  if(!orgi){
80107653:	83 c4 10             	add    $0x10,%esp
  orgi = namei(org);
80107656:	89 85 54 ff ff ff    	mov    %eax,-0xac(%ebp)
8010765c:	89 c3                	mov    %eax,%ebx
  if(!orgi){
8010765e:	85 c0                	test   %eax,%eax
80107660:	0f 84 3c 01 00 00    	je     801077a2 <sys_make_duplicate_file+0x1e2>
    end_op();
    return -1;
  }
...
8010766a:	e8 d1 b6 ff ff       	call   80102d40 <ilock>
  if(orgi->type != T_FILE){
8010766f:	83 c4 10             	add    $0x10,%esp
80107672:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
80107677:	0f 85 4b 01 00 00    	jne    801077c8 <sys_make_duplicate_file+0x208>
    iunlockput(orgi);
    end_op();
    return -1;
  }
...
80107680:	56                   	push   %esi
80107681:	e8 9a bf ff ff       	call   80103620 <namei>
  if(newi){
80107686:	83 c4 10             	add    $0x10,%esp
80107689:	85 c0                	test   %eax,%eax
8010768b:	0f 85 18 01 00 00    	jne    801077a9 <sys_make_duplicate_file+0x1e9>
    iunlockput(orgi);
    end_op();
    return -1;
  }
...
80107696:	ba 02 00 00 00       	mov    $0x2,%edx
8010769b:	89 f0                	mov    %esi,%eax
8010769d:	6a 00                	push   $0x0
8010769f:	e8 8c f3 ff ff       	call   80106a30 <create>
  if(!newi){
801076a4:	83 c4 10             	add    $0x10,%esp
  newi = create(newname, T_FILE, 0, 0);
801076a7:	89 85 50 ff ff ff    	mov    %eax,-0xb0(%ebp)
  if(!newi){
801076ad:	85 c0                	test   %eax,%eax
801076af:	0f 84 2e 01 00 00    	je     801077e3 <sys_make_duplicate_file+0x223>
    iput(orgi);
    end_op();
    return -1;
  }
...
801076b5:	8b 85 54 ff ff ff    	mov    -0xac(%ebp),%eax
801076bb:	8b 70 58             	mov    0x58(%eax),%esi
  char *kbuf = kalloc();
801076be:	e8 3d c5 ff ff       	call   80103c00 <kalloc>
801076c3:	89 c3                	mov    %eax,%ebx
  if(!kbuf){
801076c5:	85 c0                	test   %eax,%eax
801076c7:	0f 84 3a 01 00 00    	je     80107807 <sys_make_duplicate_file+0x247>
    iput(orgi);
    end_op();
    return -1;
  }
  ...
  uint done = 0;
801076cd:	31 ff                	xor    %edi,%edi
  while(done < total){
801076cf:	85 f6                	test   %esi,%esi
801076d1:	75 28                	jne    801076fb <sys_make_duplicate_file+0x13b>
801076d3:	e9 88 00 00 00       	jmp    80107760 <sys_make_duplicate_file+0x1a0>
801076d8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801076df:	00 
...
801076e3:	ff b5 50 ff ff ff    	push   -0xb0(%ebp)
801076e9:	e8 62 ba ff ff       	call   80103150 <writei>
    if(put < 0) goto err;
801076ee:	83 c4 10             	add    $0x10,%esp
801076f1:	85 c0                	test   %eax,%eax
801076f3:	78 29                	js     8010771e <sys_make_duplicate_file+0x15e>

    done += put;
801076f5:	01 c7                	add    %eax,%edi
  while(done < total){
801076f7:	39 f7                	cmp    %esi,%edi
801076f9:	73 65                	jae    80107760 <sys_make_duplicate_file+0x1a0>
    uint chunk = total - done;
801076fb:	89 f0                	mov    %esi,%eax
    if(chunk > BSIZE) chunk = BSIZE;
801076fd:	b9 00 02 00 00       	mov    $0x200,%ecx
    uint chunk = total - done;
80107702:	29 f8                	sub    %edi,%eax
    if(chunk > BSIZE) chunk = BSIZE;
80107704:	39 c8                	cmp    %ecx,%eax
80107706:	0f 47 c1             	cmova  %ecx,%eax
    int got = readi(orgi, kbuf, done, chunk);
80107709:	50                   	push   %eax
8010770a:	57                   	push   %edi
8010770b:	53                   	push   %ebx
8010770c:	ff b5 54 ff ff ff    	push   -0xac(%ebp)
80107712:	e8 39 b9 ff ff       	call   80103050 <readi>
    if(got < 0) goto err;
80107717:	83 c4 10             	add    $0x10,%esp
8010771a:	85 c0                	test   %eax,%eax
8010771c:	79 c2                	jns    801076e0 <sys_make_duplicate_file+0x120>
  kfree(kbuf);
  end_op();
  return 0;
...
80107721:	ff b5 50 ff ff ff    	push   -0xb0(%ebp)
80107727:	e8 a4 b8 ff ff       	call   80102fd0 <iunlockput>
  iunlock(orgi);
8010772c:	8b b5 54 ff ff ff    	mov    -0xac(%ebp),%esi
80107732:	89 34 24             	mov    %esi,(%esp)
80107735:	e8 e6 b6 ff ff       	call   80102e20 <iunlock>
  iput(orgi);
8010773a:	89 34 24             	mov    %esi,(%esp)
8010773d:	e8 2e b7 ff ff       	call   80102e70 <iput>
  kfree(kbuf);
80107742:	89 1c 24             	mov    %ebx,(%esp)
80107745:	e8 f6 c2 ff ff       	call   80103a40 <kfree>
  end_op();
8010774a:	e8 01 cc ff ff       	call   80104350 <end_op>
  return -1;
8010774f:	83 c4 10             	add    $0x10,%esp
}
80107752:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
80107755:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
8010775a:	5b                   	pop    %ebx
8010775b:	5e                   	pop    %esi
8010775c:	5f                   	pop    %edi
...
8010775f:	90                   	nop
  newi->size = total;
80107760:	8b 85 50 ff ff ff    	mov    -0xb0(%ebp),%eax
  iupdate(newi);
80107766:	83 ec 0c             	sub    $0xc,%esp
  newi->size = total;
80107769:	89 70 58             	mov    %esi,0x58(%eax)
  iupdate(newi);
8010776c:	89 c6                	mov    %eax,%esi
8010776e:	50                   	push   %eax
8010776f:	e8 1c b5 ff ff       	call   80102c90 <iupdate>
  iunlock(newi);
80107774:	89 34 24             	mov    %esi,(%esp)
80107777:	e8 a4 b6 ff ff       	call   80102e20 <iunlock>
  iunlock(orgi);
8010777c:	58                   	pop    %eax
8010777d:	ff b5 54 ff ff ff    	push   -0xac(%ebp)
80107783:	e8 98 b6 ff ff       	call   80102e20 <iunlock>
  kfree(kbuf);
80107788:	89 1c 24             	mov    %ebx,(%esp)
8010778b:	e8 b0 c2 ff ff       	call   80103a40 <kfree>
  end_op();
80107790:	e8 bb cb ff ff       	call   80104350 <end_op>
  return 0;
...
801077a1:	c3                   	ret
    end_op();
801077a2:	e8 a9 cb ff ff       	call   80104350 <end_op>
    return -1;
801077a7:	eb a9                	jmp    80107752 <sys_make_duplicate_file+0x192>
    iunlockput(newi);
801077a9:	83 ec 0c             	sub    $0xc,%esp
801077ac:	50                   	push   %eax
801077ad:	e8 1e b8 ff ff       	call   80102fd0 <iunlockput>
    iunlockput(orgi);
801077b2:	5a                   	pop    %edx
801077b3:	ff b5 54 ff ff ff    	push   -0xac(%ebp)
801077b9:	e8 12 b8 ff ff       	call   80102fd0 <iunlockput>
    end_op();
801077be:	e8 8d cb ff ff       	call   80104350 <end_op>
    return -1;
801077c3:	83 c4 10             	add    $0x10,%esp
801077c6:	eb 8a                	jmp    80107752 <sys_make_duplicate_file+0x192>
    iunlockput(orgi);
801077c8:	83 ec 0c             	sub    $0xc,%esp
801077cb:	ff b5 54 ff ff ff    	push   -0xac(%ebp)
801077d1:	e8 fa b7 ff ff       	call   80102fd0 <iunlockput>
    end_op();
801077d6:	e8 75 cb ff ff       	call   80104350 <end_op>
    return -1;
801077db:	83 c4 10             	add    $0x10,%esp
801077de:	e9 6f ff ff ff       	jmp    80107752 <sys_make_duplicate_file+0x192>
    iunlock(orgi);
801077e3:	8b b5 54 ff ff ff    	mov    -0xac(%ebp),%esi
801077e9:	83 ec 0c             	sub    $0xc,%esp
801077ec:	56                   	push   %esi
    iunlock(orgi);
801077ed:	e8 2e b6 ff ff       	call   80102e20 <iunlock>
    iput(orgi);
801077f2:	89 34 24             	mov    %esi,(%esp)
801077f5:	e8 76 b6 ff ff       	call   80102e70 <iput>
    end_op();
801077fa:	e8 51 cb ff ff       	call   80104350 <end_op>
    return -1;
801077ff:	83 c4 10             	add    $0x10,%esp
80107802:	e9 4b ff ff ff       	jmp    80107752 <sys_make_duplicate_file+0x192>
    iunlockput(newi);
80107807:	83 ec 0c             	sub    $0xc,%esp
8010780a:	ff b5 50 ff ff ff    	push   -0xb0(%ebp)
80107810:	e8 bb b7 ff ff       	call   80102fd0 <iunlockput>
    iunlock(orgi);
80107815:	8b b5 54 ff ff ff    	mov    -0xac(%ebp),%esi
8010781b:	89 34 24             	mov    %esi,(%esp)
8010781e:	eb cd                	jmp    801077ed <sys_make_duplicate_file+0x22d>

80107820 <sys_grep_syscall>:
    }
...
80107825:	8d 45 dc             	lea    -0x24(%ebp),%eax
int sys_grep_syscall(void){
80107828:	53                   	push   %ebx
80107829:	83 ec 44             	sub    $0x44,%esp
    if(argstr(0, &keyword) < 0)
8010782c:	50                   	push   %eax
8010782d:	6a 00                	push   $0x0
8010782f:	e8 0c f1 ff ff       	call   80106940 <argstr>
80107834:	83 c4 10             	add    $0x10,%esp
80107837:	85 c0                	test   %eax,%eax
80107839:	0f 88 96 02 00 00    	js     80107ad5 <sys_grep_syscall+0x2b5>
        return -1;
    if((1, &filename) < 0)
        return -1;
    if(argint(3, &bufsz) < 0 || bufsz <= 1)
8010783f:	83 ec 08             	sub    $0x8,%esp
80107842:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80107845:	50                   	push   %eax
80107846:	6a 03                	push   $0x3
80107848:	e8 33 f0 ff ff       	call   80106880 <argint>
8010784d:	83 c4 10             	add    $0x10,%esp
80107850:	85 c0                	test   %eax,%eax
80107852:	0f 88 7d 02 00 00    	js     80107ad5 <sys_grep_syscall+0x2b5>
80107858:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010785b:	83 f8 01             	cmp    $0x1,%eax
8010785e:	0f 8e 71 02 00 00    	jle    80107ad5 <sys_grep_syscall+0x2b5>
        return -1;
    if(argptr(2, &ubuf, bufsz) < 0)
80107864:	83 ec 04             	sub    $0x4,%esp
80107867:	50                   	push   %eax
80107868:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010786b:	50                   	push   %eax
8010786c:	6a 02                	push   $0x2
8010786e:	e8 5d f0 ff ff       	call   801068d0 <argptr>
80107873:	83 c4 10             	add    $0x10,%esp
80107876:	85 c0                	test   %eax,%eax
80107878:	0f 88 57 02 00 00    	js     80107ad5 <sys_grep_syscall+0x2b5>
        return -1;

    struct inode *ip = namei(filename);
8010787e:	83 ec 0c             	sub    $0xc,%esp
80107881:	6a 00                	push   $0x0
80107883:	e8 98 bd ff ff       	call   80103620 <namei>
    if(!ip)
80107888:	83 c4 10             	add    $0x10,%esp
    struct inode *ip = namei(filename);
8010788b:	89 45 c8             	mov    %eax,-0x38(%ebp)
8010788e:	89 c3                	mov    %eax,%ebx
    if(!ip)
80107890:	85 c0                	test   %eax,%eax
80107892:	0f 84 3d 02 00 00    	je     80107ad5 <sys_grep_syscall+0x2b5>
        return -1;

    ilock(ip);
80107898:	83 ec 0c             	sub    $0xc,%esp
8010789b:	50                   	push   %eax
8010789c:	e8 9f b4 ff ff       	call   80102d40 <ilock>
    if(ip->type != T_FILE && ip->type != T_DEV){
801078a1:	0f b7 43 50          	movzwl 0x50(%ebx),%eax
801078a5:	83 c4 10             	add    $0x10,%esp
801078a8:	66 89 45 d4          	mov    %ax,-0x2c(%ebp)
801078ac:	83 e8 02             	sub    $0x2,%eax
801078af:	66 83 f8 01          	cmp    $0x1,%ax
801078b3:	0f 87 0e 02 00 00    	ja     80107ac7 <sys_grep_syscall+0x2a7>
        iunlockput(ip);
        return -1;
    }

    char *buf = kalloc();
801078b9:	e8 42 c3 ff ff       	call   80103c00 <kalloc>
801078be:	89 45 cc             	mov    %eax,-0x34(%ebp)
    if(!buf){
801078c1:	85 c0                	test   %eax,%eax
801078c3:	0f 84 fe 01 00 00    	je     80107ac7 <sys_grep_syscall+0x2a7>
        iunlockput(ip);
        return -1;
    }

    char *line = kalloc();
801078c9:	e8 32 c3 ff ff       	call   80103c00 <kalloc>
801078ce:	89 c7                	mov    %eax,%edi
    if(!line){
801078d0:	85 c0                	test   %eax,%eax
801078d2:	0f 84 07 02 00 00    	je     80107adf <sys_grep_syscall+0x2bf>
        return -1;
    }
    ...
    int res = -1;
    int line_len = 0;
801078d8:	31 f6                	xor    %esi,%esi
    int offset = 0;
801078da:	31 db                	xor    %ebx,%ebx

    while(1){
        int n = readi(ip, buf, offset, CHUNK);
801078dc:	68 00 02 00 00       	push   $0x200
801078e1:	53                   	push   %ebx
801078e2:	ff 75 cc             	push   -0x34(%ebp)
801078e5:	ff 75 c8             	push   -0x38(%ebp)
801078e8:	e8 63 b7 ff ff       	call   80103050 <readi>
        if(n < 0)
801078ed:	83 c4 10             	add    $0x10,%esp
801078f0:	85 c0                	test   %eax,%eax
801078f2:	0f 88 ab 00 00 00    	js     801079a3 <sys_grep_syscall+0x183>
            break;

        if(n == 0){
801078f8:	0f 84 5d 01 00 00    	je     80107a5b <sys_grep_syscall+0x23b>
            }
        ...
        for(int i = 0; i < n; i++){
801078fe:	89 5d bc             	mov    %ebx,-0x44(%ebp)
80107901:	31 d2                	xor    %edx,%edx
80107903:	eb 1a                	jmp    8010791f <sys_grep_syscall+0xff>
...
80107908:	81 fe fe 0f 00 00    	cmp    $0xffe,%esi
8010790e:	0f 8e f1 00 00 00    	jle    80107a05 <sys_grep_syscall+0x1e5>
        for(int i = 0; i < n; i++){
80107914:	83 c2 01             	add    $0x1,%edx
80107917:	39 d0                	cmp    %edx,%eax
80107919:	0f 8e f7 00 00 00    	jle    80107a16 <sys_grep_syscall+0x1f6>
            char c = buf[i];
8010791f:	8b 5d cc             	mov    -0x34(%ebp),%ebx
80107922:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
            if(c == '\n'){
80107926:	80 f9 0a             	cmp    $0xa,%cl
80107929:	75 dd                	jne    80107908 <sys_grep_syscall+0xe8>
                if(line_has_keyword(line, line_len, keyword)){
8010792b:	8b 5d dc             	mov    -0x24(%ebp),%ebx
    if(!key[0])
8010792e:	0f b6 0b             	movzbl (%ebx),%ecx
80107931:	88 4d d4             	mov    %cl,-0x2c(%ebp)
80107934:	84 c9                	test   %cl,%cl
80107936:	74 3c                	je     80107974 <sys_grep_syscall+0x154>
    for (int i = 0; i < n; i++){
80107938:	85 f6                	test   %esi,%esi
8010793a:	0f 8e b0 00 00 00    	jle    801079f0 <sys_grep_syscall+0x1d0>
80107940:	89 d9                	mov    %ebx,%ecx
80107942:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80107945:	89 45 c0             	mov    %eax,-0x40(%ebp)
80107948:	29 f1                	sub    %esi,%ecx
8010794a:	89 4d d0             	mov    %ecx,-0x30(%ebp)
8010794d:	89 d9                	mov    %ebx,%ecx
8010794f:	90                   	nop
80107950:	89 d8                	mov    %ebx,%eax
        while(i+j < n && key[j] && line[i+j] == key[j])
80107952:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
80107956:	29 c8                	sub    %ecx,%eax
80107958:	39 c6                	cmp    %eax,%esi
8010795a:	0f 8e 7c 00 00 00    	jle    801079dc <sys_grep_syscall+0x1bc>
80107960:	3a 14 07             	cmp    (%edi,%eax,1),%dl
80107963:	75 77                	jne    801079dc <sys_grep_syscall+0x1bc>
80107965:	83 c0 01             	add    $0x1,%eax
        if(key[j] == 0)
80107968:	0f b6 14 01          	movzbl (%ecx,%eax,1),%edx
        while(i+j < n && key[j] && line[i+j] == key[j])
8010796c:	39 c6                	cmp    %eax,%esi
8010796e:	74 68                	je     801079d8 <sys_grep_syscall+0x1b8>
80107970:	84 d2                	test   %dl,%dl
80107972:	75 ec                	jne    80107960 <sys_grep_syscall+0x140>
                    int copylen = (line_len < bufsz - 1) ? line_len : (bufsz - 1);
80107974:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107977:	8d 58 ff             	lea    -0x1(%eax),%ebx
8010797a:	39 f3                	cmp    %esi,%ebx
8010797c:	0f 4f de             	cmovg  %esi,%ebx
                    if(copyout(myproc()->pgdir, (uint)ubuf, line, copylen) >= 0){
8010797f:	8b 55 e0             	mov    -0x20(%ebp),%edx
80107982:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80107985:	e8 86 d5 ff ff       	call   80104f10 <myproc>
8010798a:	53                   	push   %ebx
8010798b:	57                   	push   %edi
8010798c:	8b 55 d4             	mov    -0x2c(%ebp),%edx
8010798f:	52                   	push   %edx
80107990:	ff 70 04             	push   0x4(%eax)
80107993:	e8 98 1c 00 00       	call   80109630 <copyout>
80107998:	83 c4 10             	add    $0x10,%esp
8010799b:	85 c0                	test   %eax,%eax
8010799d:	0f 89 89 00 00 00    	jns    80107a2c <sys_grep_syscall+0x20c>
    int res = -1;
801079a3:	be ff ff ff ff       	mov    $0xffffffff,%esi
        }
...
801079ab:	ff 75 cc             	push   -0x34(%ebp)
801079ae:	e8 8d c0 ff ff       	call   80103a40 <kfree>
    kfree(line);
801079b3:	89 3c 24             	mov    %edi,(%esp)
801079b6:	e8 85 c0 ff ff       	call   80103a40 <kfree>
    iunlockput(ip);
801079bb:	58                   	pop    %eax
801079bc:	ff 75 c8             	push   -0x38(%ebp)
801079bf:	e8 0c b6 ff ff       	call   80102fd0 <iunlockput>

    return res;
801079c4:	83 c4 10             	add    $0x10,%esp
801079c7:	8d 65 f4             	lea    -0xc(%ebp),%esp
801079ca:	89 f0                	mov    %esi,%eax
801079cc:	5b                   	pop    %ebx
801079cd:	5e                   	pop    %esi
801079ce:	5f                   	pop    %edi
801079cf:	5d                   	pop    %ebp
...
801079d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        if(key[j] == 0)
801079d8:	84 d2                	test   %dl,%dl
801079da:	74 98                	je     80107974 <sys_grep_syscall+0x154>
    for (int i = 0; i < n; i++){
801079dc:	8b 45 d0             	mov    -0x30(%ebp),%eax
801079df:	83 e9 01             	sub    $0x1,%ecx
801079e2:	39 c1                	cmp    %eax,%ecx
801079e4:	0f 85 66 ff ff ff    	jne    80107950 <sys_grep_syscall+0x130>
801079ea:	8b 55 c4             	mov    -0x3c(%ebp),%edx
801079ed:	8b 45 c0             	mov    -0x40(%ebp),%eax
        for(int i = 0; i < n; i++){
801079f0:	83 c2 01             	add    $0x1,%edx
801079f3:	39 d0                	cmp    %edx,%eax
801079f5:	7e 58                	jle    80107a4f <sys_grep_syscall+0x22f>
            char c = buf[i];
801079f7:	8b 75 cc             	mov    -0x34(%ebp),%esi
801079fa:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
            if(c == '\n'){
801079fe:	80 f9 0a             	cmp    $0xa,%cl
80107a01:	74 1d                	je     80107a20 <sys_grep_syscall+0x200>
                line_len = 0;
80107a03:	31 f6                	xor    %esi,%esi
        for(int i = 0; i < n; i++){
80107a05:	83 c2 01             	add    $0x1,%edx
                line[line_len++] = c;
80107a08:	88 0c 37             	mov    %cl,(%edi,%esi,1)
80107a0b:	83 c6 01             	add    $0x1,%esi
        for(int i = 0; i < n; i++){
80107a0e:	39 d0                	cmp    %edx,%eax
80107a10:	0f 8f 09 ff ff ff    	jg     8010791f <sys_grep_syscall+0xff>
80107a16:	8b 5d bc             	mov    -0x44(%ebp),%ebx
        offset += n;
80107a19:	01 c3                	add    %eax,%ebx
    while(1){
80107a1b:	e9 bc fe ff ff       	jmp    801078dc <sys_grep_syscall+0xbc>
    if(!key[0])
80107a20:	80 3b 00             	cmpb   $0x0,(%ebx)
80107a23:	75 cb                	jne    801079f0 <sys_grep_syscall+0x1d0>
                line_len = 0;
80107a25:	31 f6                	xor    %esi,%esi
80107a27:	e9 48 ff ff ff       	jmp    80107974 <sys_grep_syscall+0x154>
                        copyout(myproc()->pgdir, (uint)(ubuf + copylen), &z, 1);
80107a2c:	03 5d e0             	add    -0x20(%ebp),%ebx
                        char z = 0;
80107a2f:	c6 45 db 00          	movb   $0x0,-0x25(%ebp)
                        copyout(myproc()->pgdir, (uint)(ubuf + copylen), &z, 1);
80107a33:	e8 d8 d4 ff ff       	call   80104f10 <myproc>
80107a38:	8d 55 db             	lea    -0x25(%ebp),%edx
80107a3b:	6a 01                	push   $0x1
80107a3d:	52                   	push   %edx
80107a3e:	53                   	push   %ebx
80107a3f:	ff 70 04             	push   0x4(%eax)
80107a42:	e8 e9 1b 00 00       	call   80109630 <copyout>
                        res = line_len;
80107a47:	83 c4 10             	add    $0x10,%esp
80107a4a:	e9 59 ff ff ff       	jmp    801079a8 <sys_grep_syscall+0x188>
                line_len = 0;
80107a4f:	8b 5d bc             	mov    -0x44(%ebp),%ebx
80107a52:	31 f6                	xor    %esi,%esi
        offset += n;
80107a54:	01 c3                	add    %eax,%ebx
    while(1){
80107a56:	e9 81 fe ff ff       	jmp    801078dc <sys_grep_syscall+0xbc>
            if(line_len > 0 && line_has_keyword(line, line_len, keyword)){
80107a5b:	89 45 d4             	mov    %eax,-0x2c(%ebp)
80107a5e:	85 f6                	test   %esi,%esi
80107a60:	0f 8e 3d ff ff ff    	jle    801079a3 <sys_grep_syscall+0x183>
80107a66:	8b 45 dc             	mov    -0x24(%ebp),%eax
80107a69:	8d 1c 3e             	lea    (%esi,%edi,1),%ebx
80107a6c:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    if(!key[0])
80107a6f:	0f b6 00             	movzbl (%eax),%eax
80107a72:	88 45 d0             	mov    %al,-0x30(%ebp)
80107a75:	84 c0                	test   %al,%al
80107a77:	74 28                	je     80107aa1 <sys_grep_syscall+0x281>
        while(i+j < n && key[j] && line[i+j] == key[j])
80107a79:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80107a7c:	39 c6                	cmp    %eax,%esi
80107a7e:	7e 37                	jle    80107ab7 <sys_grep_syscall+0x297>
80107a80:	8b 4d c4             	mov    -0x3c(%ebp),%ecx
80107a83:	0f b6 55 d0          	movzbl -0x30(%ebp),%edx
80107a87:	01 f8                	add    %edi,%eax
80107a89:	83 c1 01             	add    $0x1,%ecx
80107a8c:	38 10                	cmp    %dl,(%eax)
80107a8e:	75 27                	jne    80107ab7 <sys_grep_syscall+0x297>
80107a90:	83 c0 01             	add    $0x1,%eax
        if(key[j] == 0)
80107a93:	0f b6 11             	movzbl (%ecx),%edx
        while(i+j < n && key[j] && line[i+j] == key[j])
80107a96:	83 c1 01             	add    $0x1,%ecx
80107a99:	39 d8                	cmp    %ebx,%eax
80107a9b:	74 16                	je     80107ab3 <sys_grep_syscall+0x293>
80107a9d:	84 d2                	test   %dl,%dl
80107a9f:	75 eb                	jne    80107a8c <sys_grep_syscall+0x26c>
                int copylen = (line_len < bufsz - 1) ? line_len : (bufsz - 1);
80107aa1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107aa4:	83 e8 01             	sub    $0x1,%eax
80107aa7:	39 f0                	cmp    %esi,%eax
80107aa9:	0f 4f c6             	cmovg  %esi,%eax
80107aac:	89 c3                	mov    %eax,%ebx
80107aae:	e9 cc fe ff ff       	jmp    8010797f <sys_grep_syscall+0x15f>
        if(key[j] == 0)
80107ab3:	84 d2                	test   %dl,%dl
80107ab5:	74 ea                	je     80107aa1 <sys_grep_syscall+0x281>
    for (int i = 0; i < n; i++){
80107ab7:	83 45 d4 01          	addl   $0x1,-0x2c(%ebp)
80107abb:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80107abe:	39 c6                	cmp    %eax,%esi
80107ac0:	75 b7                	jne    80107a79 <sys_grep_syscall+0x259>
80107ac2:	e9 dc fe ff ff       	jmp    801079a3 <sys_grep_syscall+0x183>
        iunlockput(ip);
80107ac7:	83 ec 0c             	sub    $0xc,%esp
80107aca:	ff 75 c8             	push   -0x38(%ebp)
80107acd:	e8 fe b4 ff ff       	call   80102fd0 <iunlockput>
        return -1;
80107ad2:	83 c4 10             	add    $0x10,%esp
        return -1;
80107ad5:	be ff ff ff ff       	mov    $0xffffffff,%esi
80107ada:	e9 e8 fe ff ff       	jmp    801079c7 <sys_grep_syscall+0x1a7>
        kfree(buf);
80107adf:	83 ec 0c             	sub    $0xc,%esp
80107ae2:	ff 75 cc             	push   -0x34(%ebp)
80107ae5:	e8 56 bf ff ff       	call   80103a40 <kfree>
        iunlockput(ip);
80107aea:	5a                   	pop    %edx
80107aeb:	ff 75 c8             	push   -0x38(%ebp)
80107aee:	e8 dd b4 ff ff       	call   80102fd0 <iunlockput>
        return -1;
80107af3:	83 c4 10             	add    $0x10,%esp
80107af6:	eb dd                	jmp    80107ad5 <sys_grep_syscall+0x2b5>
...
{
  return fork();
80107b00:	e9 ab d5 ff ff       	jmp    801050b0 <fork>
80107b05:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107b0c:	00 
...
80107b13:	83 ec 08             	sub    $0x8,%esp
  exit();
80107b16:	e8 25 d8 ff ff       	call   80105340 <exit>
...
{
  return wait();
80107b20:	e9 4b d9 ff ff       	jmp    80105470 <wait>
80107b25:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107b2c:	00 
...
80107b3c:	e8 3f ed ff ff       	call   80106880 <argint>
...
80107b4e:	e8 bd db ff ff       	call   80105710 <kill>
80107b53:	83 c4 10             	add    $0x10,%esp
}
80107b56:	c9                   	leave
80107b57:	c3                   	ret
80107b58:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107b5f:	00 
80107b60:	c9                   	leave
    return -1;
...
80107b73:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80107b76:	e8 95 d3 ff ff       	call   80104f10 <myproc>
...
80107b8d:	e8 ee ec ff ff       	call   80106880 <argint>
80107b92:	83 c4 10             	add    $0x10,%esp
80107b95:	85 c0                	test   %eax,%eax
80107b97:	78 27                	js     80107bc0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80107b99:	e8 72 d3 ff ff       	call   80104f10 <myproc>
  if(growproc(n) < 0)
80107b9e:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80107ba1:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80107ba3:	ff 75 f4             	push   -0xc(%ebp)
80107ba6:	e8 85 d4 ff ff       	call   80105030 <growproc>
...
80107bb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80107bc0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80107bc5:	eb eb                	jmp    80107bb2 <sys_sbrk+0x32>
80107bc7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107bce:	00 
80107bcf:	90                   	nop
...
80107bdd:	e8 9e ec ff ff       	call   80106880 <argint>
80107be2:	83 c4 10             	add    $0x10,%esp
80107be5:	85 c0                	test   %eax,%eax
80107be7:	78 64                	js     80107c4d <sys_sleep+0x7d>
    return -1;
  acquire(&tickslock);
80107be9:	83 ec 0c             	sub    $0xc,%esp
80107bec:	68 40 71 11 80       	push   $0x80117140
80107bf1:	e8 6a e4 ff ff       	call   80106060 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80107bf6:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80107bf9:	8b 1d 20 71 11 80    	mov    0x80117120,%ebx
  while(ticks - ticks0 < n){
80107bff:	83 c4 10             	add    $0x10,%esp
80107c02:	85 d2                	test   %edx,%edx
80107c04:	75 2b                	jne    80107c31 <sys_sleep+0x61>
80107c06:	eb 58                	jmp    80107c60 <sys_sleep+0x90>
...
80107c13:	68 40 71 11 80       	push   $0x80117140
80107c18:	68 20 71 11 80       	push   $0x80117120
80107c1d:	e8 ce d9 ff ff       	call   801055f0 <sleep>
  while(ticks - ticks0 < n){
80107c22:	a1 20 71 11 80       	mov    0x80117120,%eax
...
80107c2f:	73 2f                	jae    80107c60 <sys_sleep+0x90>
    if(myproc()->killed){
80107c31:	e8 da d2 ff ff       	call   80104f10 <myproc>
80107c36:	8b 40 24             	mov    0x24(%eax),%eax
80107c39:	85 c0                	test   %eax,%eax
80107c3b:	74 d3                	je     80107c10 <sys_sleep+0x40>
      release(&tickslock);
80107c3d:	83 ec 0c             	sub    $0xc,%esp
80107c40:	68 40 71 11 80       	push   $0x80117140
80107c45:	e8 b6 e3 ff ff       	call   80106000 <release>
      return -1;
...
80107c4d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    return -1;
80107c50:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107c55:	c9                   	leave
80107c56:	c3                   	ret
80107c57:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107c5e:	00 
80107c5f:	90                   	nop
  release(&tickslock);
80107c60:	83 ec 0c             	sub    $0xc,%esp
80107c63:	68 40 71 11 80       	push   $0x80117140
80107c68:	e8 93 e3 ff ff       	call   80106000 <release>
}
...
80107c84:	83 ec 10             	sub    $0x10,%esp
  uint xticks;

  acquire(&tickslock);
80107c87:	68 40 71 11 80       	push   $0x80117140
80107c8c:	e8 cf e3 ff ff       	call   80106060 <acquire>
  xticks = ticks;
80107c91:	8b 1d 20 71 11 80    	mov    0x80117120,%ebx
  release(&tickslock);
80107c97:	c7 04 24 40 71 11 80 	movl   $0x80117140,(%esp)
80107c9e:	e8 5d e3 ff ff       	call   80106000 <release>
  return xticks;
}
80107ca3:	89 d8                	mov    %ebx,%eax
80107ca5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107ca8:	c9                   	leave
80107ca9:	c3                   	ret
80107caa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107cb0 <sys_show_process_family>:
...
80107cb3:	83 ec 20             	sub    $0x20,%esp
  int pid;
  if (argint(0, &pid) < 0) 
80107cb6:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107cb9:	50                   	push   %eax
80107cba:	6a 00                	push   $0x0
80107cbc:	e8 bf eb ff ff       	call   80106880 <argint>
80107cc1:	83 c4 10             	add    $0x10,%esp
80107cc4:	85 c0                	test   %eax,%eax
80107cc6:	78 18                	js     80107ce0 <sys_show_process_family+0x30>
    {
      return -1;
    }
  return process_family(pid);
80107cc8:	83 ec 0c             	sub    $0xc,%esp
80107ccb:	ff 75 f4             	push   -0xc(%ebp)
80107cce:	e8 7d db ff ff       	call   80105850 <process_family>
80107cd3:	83 c4 10             	add    $0x10,%esp
}
80107cd6:	c9                   	leave
80107cd7:	c3                   	ret
80107cd8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107cdf:	00 
80107ce0:	c9                   	leave
      return -1;
80107ce1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107ce6:	c3                   	ret
80107ce7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107cee:	00 
80107cef:	90                   	nop

80107cf0 <sys_simple_arithmetic>:
...
80107cf7:	e8 14 d2 ff ff       	call   80104f10 <myproc>
  int a = p->tf->ebx; 
80107cfc:	8b 40 18             	mov    0x18(%eax),%eax
80107cff:	8b 50 10             	mov    0x10(%eax),%edx
  int b = p->tf->ecx;
80107d02:	8b 48 18             	mov    0x18(%eax),%ecx

  int sum = a + b;
  int diff = a - b;
80107d05:	89 d0                	mov    %edx,%eax
  int sum = a + b;
80107d07:	8d 1c 0a             	lea    (%edx,%ecx,1),%ebx
  int diff = a - b;
80107d0a:	29 c8                	sub    %ecx,%eax
  int res = sum * diff;
80107d0c:	0f af d8             	imul   %eax,%ebx

  cprintf("simple_arith: a=%d b=%d -> (%d+%d)*(%d-%d) = %d\n",a, b, a, b, a, b, res);
80107d0f:	53                   	push   %ebx
80107d10:	51                   	push   %ecx
80107d11:	52                   	push   %edx
80107d12:	51                   	push   %ecx
80107d13:	52                   	push   %edx
80107d14:	51                   	push   %ecx
80107d15:	52                   	push   %edx
80107d16:	68 c0 9e 10 80       	push   $0x80109ec0
80107d1b:	e8 40 90 ff ff       	call   80100d60 <cprintf>

  return res;
}
80107d20:	89 d8                	mov    %ebx,%eax
80107d22:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107d25:	c9                   	leave
80107d26:	c3                   	ret
80107d27:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107d2e:	00 
80107d2f:	90                   	nop

80107d30 <sys_set_priority_syscall>:
...
80107d33:	83 ec 20             	sub    $0x20,%esp
  int pid, prio;
  if(argint(0, &pid)  < 0) return -1;
80107d36:	8d 45 f0             	lea    -0x10(%ebp),%eax
80107d39:	50                   	push   %eax
80107d3a:	6a 00                	push   $0x0
80107d3c:	e8 3f eb ff ff       	call   80106880 <argint>
80107d41:	83 c4 10             	add    $0x10,%esp
80107d44:	85 c0                	test   %eax,%eax
80107d46:	78 28                	js     80107d70 <sys_set_priority_syscall+0x40>
  if(argint(1, &prio) < 0) return -1;
80107d48:	83 ec 08             	sub    $0x8,%esp
80107d4b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107d4e:	50                   	push   %eax
80107d4f:	6a 01                	push   $0x1
80107d51:	e8 2a eb ff ff       	call   80106880 <argint>
80107d56:	83 c4 10             	add    $0x10,%esp
80107d59:	85 c0                	test   %eax,%eax
80107d5b:	78 13                	js     80107d70 <sys_set_priority_syscall+0x40>
  return set_priority(pid, prio);
80107d5d:	83 ec 08             	sub    $0x8,%esp
80107d60:	ff 75 f4             	push   -0xc(%ebp)
80107d63:	ff 75 f0             	push   -0x10(%ebp)
80107d66:	e8 85 dc ff ff       	call   801059f0 <set_priority>
...
80107d70:	c9                   	leave
  if(argint(0, &pid)  < 0) return -1;
80107d71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107d76:	c3                   	ret
80107d77:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107d7e:	00 
80107d7f:	90                   	nop

80107d80 <sys_acquire_plock_sys>:
...
80107d83:	83 ec 20             	sub    $0x20,%esp
  int pr;
  if(argint(0, &pr) < 0)
80107d86:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107d89:	50                   	push   %eax
80107d8a:	6a 00                	push   $0x0
80107d8c:	e8 ef ea ff ff       	call   80106880 <argint>
80107d91:	83 c4 10             	add    $0x10,%esp
80107d94:	85 c0                	test   %eax,%eax
80107d96:	78 18                	js     80107db0 <sys_acquire_plock_sys+0x30>
    return -1;
  plock_acquire(&plock_global, pr);
80107d98:	83 ec 08             	sub    $0x8,%esp
80107d9b:	ff 75 f4             	push   -0xc(%ebp)
80107d9e:	68 60 70 11 80       	push   $0x80117060
80107da3:	e8 88 df ff ff       	call   80105d30 <plock_acquire>
  return 0;
...
80107db0:	c9                   	leave
    return -1;
80107db1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107db6:	c3                   	ret
80107db7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107dbe:	00 
80107dbf:	90                   	nop

80107dc0 <sys_release_plock_sys>:
...
80107dc3:	83 ec 14             	sub    $0x14,%esp
  release_plock(&plock_global);
80107dc6:	68 60 70 11 80       	push   $0x80117060
80107dcb:	e8 00 e0 ff ff       	call   80105dd0 <release_plock>
  return 0;
}
...
80107dd5:	06                   	push   %es
  pushl %fs
80107dd6:	0f a0                	push   %fs
  pushl %gs
80107dd8:	0f a8                	push   %gs
  pushal
80107dda:	60                   	pusha
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80107ddb:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80107ddf:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80107de1:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80107de3:	54                   	push   %esp
  call trap
80107de4:	e8 c7 00 00 00       	call   80107eb0 <trap>
  addl $4, %esp
80107de9:	83 c4 04             	add    $0x4,%esp
...
80107dec:	61                   	popa
  popl %gs
80107ded:	0f a9                	pop    %gs
  popl %fs
80107def:	0f a1                	pop    %fs
  popl %es
80107df1:	07                   	pop    %es
  popl %ds
80107df2:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80107df3:	83 c4 08             	add    $0x8,%esp
  iret
80107df6:	cf                   	iret
...
80107e08:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107e0f:	00 
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80107e10:	8b 14 85 08 d0 10 80 	mov    -0x7fef2ff8(,%eax,4),%edx
80107e17:	c7 04 c5 82 71 11 80 	movl   $0x8e000008,-0x7fee8e7e(,%eax,8)
80107e1e:	08 00 00 8e 
80107e22:	66 89 14 c5 80 71 11 	mov    %dx,-0x7fee8e80(,%eax,8)
80107e29:	80 
80107e2a:	c1 ea 10             	shr    $0x10,%edx
80107e2d:	66 89 14 c5 86 71 11 	mov    %dx,-0x7fee8e7a(,%eax,8)
80107e34:	80 
  for(i = 0; i < 256; i++)
80107e35:	83 c0 01             	add    $0x1,%eax
80107e38:	3d 00 01 00 00       	cmp    $0x100,%eax
80107e3d:	75 d1                	jne    80107e10 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);

  initlock(&tickslock, "time");
80107e3f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80107e42:	a1 08 d1 10 80       	mov    0x8010d108,%eax
80107e47:	c7 05 82 73 11 80 08 	movl   $0xef000008,0x80117382
80107e4e:	00 00 ef 
  initlock(&tickslock, "time");
80107e51:	68 cd 9b 10 80       	push   $0x80109bcd
80107e56:	68 40 71 11 80       	push   $0x80117140
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80107e5b:	66 a3 80 73 11 80    	mov    %ax,0x80117380
80107e61:	c1 e8 10             	shr    $0x10,%eax
80107e64:	66 a3 86 73 11 80    	mov    %ax,0x80117386
  initlock(&tickslock, "time");
80107e6a:	e8 01 e0 ff ff       	call   80105e70 <initlock>
}
80107e6f:	83 c4 10             	add    $0x10,%esp
80107e72:	c9                   	leave
80107e73:	c3                   	ret
80107e74:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107e7b:	00 
...
80107e80:	55                   	push   %ebp
  pd[0] = size-1;
80107e81:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80107e86:	89 e5                	mov    %esp,%ebp
80107e88:	83 ec 10             	sub    $0x10,%esp
80107e8b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107e8f:	b8 80 71 11 80       	mov    $0x80117180,%eax
80107e94:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107e98:	c1 e8 10             	shr    $0x10,%eax
80107e9b:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80107e9f:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107ea2:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80107ea5:	c9                   	leave
80107ea6:	c3                   	ret
80107ea7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80107eae:	00 
80107eaf:	90                   	nop
...
80107eb9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80107ebc:	8b 43 30             	mov    0x30(%ebx),%eax
80107ebf:	83 f8 40             	cmp    $0x40,%eax
80107ec2:	0f 84 58 01 00 00    	je     80108020 <trap+0x170>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80107ec8:	83 e8 20             	sub    $0x20,%eax
80107ecb:	83 f8 1f             	cmp    $0x1f,%eax
80107ece:	0f 87 7c 00 00 00    	ja     80107f50 <trap+0xa0>
80107ed4:	ff 24 85 8c a2 10 80 	jmp    *-0x7fef5d74(,%eax,4)
80107edb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      release(&tickslock);
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80107ee0:	e8 eb b8 ff ff       	call   801037d0 <ideintr>
    lapiceoi();
80107ee5:	e8 a6 bf ff ff       	call   80103e90 <lapiceoi>
  }
...
80107eea:	e8 21 d0 ff ff       	call   80104f10 <myproc>
80107eef:	85 c0                	test   %eax,%eax
80107ef1:	74 1a                	je     80107f0d <trap+0x5d>
80107ef3:	e8 18 d0 ff ff       	call   80104f10 <myproc>
80107ef8:	8b 50 24             	mov    0x24(%eax),%edx
80107efb:	85 d2                	test   %edx,%edx
80107efd:	74 0e                	je     80107f0d <trap+0x5d>
80107eff:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80107f03:	f7 d0                	not    %eax
80107f05:	a8 03                	test   $0x3,%al
80107f07:	0f 84 db 01 00 00    	je     801080e8 <trap+0x238>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80107f0d:	e8 fe cf ff ff       	call   80104f10 <myproc>
80107f12:	85 c0                	test   %eax,%eax
80107f14:	74 0f                	je     80107f25 <trap+0x75>
80107f16:	e8 f5 cf ff ff       	call   80104f10 <myproc>
80107f1b:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80107f1f:	0f 84 ab 00 00 00    	je     80107fd0 <trap+0x120>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107f25:	e8 e6 cf ff ff       	call   80104f10 <myproc>
80107f2a:	85 c0                	test   %eax,%eax
80107f2c:	74 1a                	je     80107f48 <trap+0x98>
80107f2e:	e8 dd cf ff ff       	call   80104f10 <myproc>
80107f33:	8b 40 24             	mov    0x24(%eax),%eax
80107f36:	85 c0                	test   %eax,%eax
80107f38:	74 0e                	je     80107f48 <trap+0x98>
80107f3a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80107f3e:	f7 d0                	not    %eax
80107f40:	a8 03                	test   $0x3,%al
80107f42:	0f 84 05 01 00 00    	je     8010804d <trap+0x19d>
    exit();
}
...
80107f50:	e8 bb cf ff ff       	call   80104f10 <myproc>
80107f55:	8b 7b 38             	mov    0x38(%ebx),%edi
80107f58:	85 c0                	test   %eax,%eax
80107f5a:	0f 84 a2 01 00 00    	je     80108102 <trap+0x252>
80107f60:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80107f64:	0f 84 98 01 00 00    	je     80108102 <trap+0x252>
...
80107f6a:	0f 20 d1             	mov    %cr2,%ecx
80107f6d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107f70:	e8 7b cf ff ff       	call   80104ef0 <cpuid>
80107f75:	8b 73 30             	mov    0x30(%ebx),%esi
80107f78:	89 45 dc             	mov    %eax,-0x24(%ebp)
80107f7b:	8b 43 34             	mov    0x34(%ebx),%eax
80107f7e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80107f81:	e8 8a cf ff ff       	call   80104f10 <myproc>
80107f86:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107f89:	e8 82 cf ff ff       	call   80104f10 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107f8e:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80107f91:	51                   	push   %ecx
80107f92:	57                   	push   %edi
80107f93:	8b 55 dc             	mov    -0x24(%ebp),%edx
80107f96:	52                   	push   %edx
80107f97:	ff 75 e4             	push   -0x1c(%ebp)
80107f9a:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80107f9b:	8b 75 e0             	mov    -0x20(%ebp),%esi
80107f9e:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107fa1:	56                   	push   %esi
80107fa2:	ff 70 10             	push   0x10(%eax)
80107fa5:	68 4c 9f 10 80       	push   $0x80109f4c
80107faa:	e8 b1 8d ff ff       	call   80100d60 <cprintf>
    myproc()->killed = 1;
80107faf:	83 c4 20             	add    $0x20,%esp
80107fb2:	e8 59 cf ff ff       	call   80104f10 <myproc>
80107fb7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107fbe:	e8 4d cf ff ff       	call   80104f10 <myproc>
80107fc3:	85 c0                	test   %eax,%eax
80107fc5:	0f 85 28 ff ff ff    	jne    80107ef3 <trap+0x43>
80107fcb:	e9 3d ff ff ff       	jmp    80107f0d <trap+0x5d>
  if(myproc() && myproc()->state == RUNNING &&
80107fd0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80107fd4:	0f 85 4b ff ff ff    	jne    80107f25 <trap+0x75>
    yield();
80107fda:	e8 c1 d5 ff ff       	call   801055a0 <yield>
80107fdf:	e9 41 ff ff ff       	jmp    80107f25 <trap+0x75>
80107fe4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107fe8:	8b 7b 38             	mov    0x38(%ebx),%edi
80107feb:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80107fef:	e8 fc ce ff ff       	call   80104ef0 <cpuid>
80107ff4:	57                   	push   %edi
80107ff5:	56                   	push   %esi
80107ff6:	50                   	push   %eax
80107ff7:	68 f4 9e 10 80       	push   $0x80109ef4
80107ffc:	e8 5f 8d ff ff       	call   80100d60 <cprintf>
    lapiceoi();
80108001:	e8 8a be ff ff       	call   80103e90 <lapiceoi>
    break;
80108006:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80108009:	e8 02 cf ff ff       	call   80104f10 <myproc>
8010800e:	85 c0                	test   %eax,%eax
80108010:	0f 85 dd fe ff ff    	jne    80107ef3 <trap+0x43>
80108016:	e9 f2 fe ff ff       	jmp    80107f0d <trap+0x5d>
8010801b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80108020:	e8 eb ce ff ff       	call   80104f10 <myproc>
80108025:	8b 70 24             	mov    0x24(%eax),%esi
80108028:	85 f6                	test   %esi,%esi
8010802a:	0f 85 c8 00 00 00    	jne    801080f8 <trap+0x248>
    myproc()->tf = tf;
80108030:	e8 db ce ff ff       	call   80104f10 <myproc>
80108035:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80108038:	e8 83 e9 ff ff       	call   801069c0 <syscall>
    if(myproc()->killed)
8010803d:	e8 ce ce ff ff       	call   80104f10 <myproc>
80108042:	8b 48 24             	mov    0x24(%eax),%ecx
80108045:	85 c9                	test   %ecx,%ecx
80108047:	0f 84 fb fe ff ff    	je     80107f48 <trap+0x98>
}
8010804d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80108050:	5b                   	pop    %ebx
80108051:	5e                   	pop    %esi
80108052:	5f                   	pop    %edi
80108053:	5d                   	pop    %ebp
      exit();
80108054:	e9 e7 d2 ff ff       	jmp    80105340 <exit>
80108059:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80108060:	e8 4b 02 00 00       	call   801082b0 <uartintr>
    lapiceoi();
80108065:	e8 26 be ff ff       	call   80103e90 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010806a:	e8 a1 ce ff ff       	call   80104f10 <myproc>
8010806f:	85 c0                	test   %eax,%eax
80108071:	0f 85 7c fe ff ff    	jne    80107ef3 <trap+0x43>
80108077:	e9 91 fe ff ff       	jmp    80107f0d <trap+0x5d>
8010807c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80108080:	e8 db bc ff ff       	call   80103d60 <kbdintr>
    lapiceoi();
80108085:	e8 06 be ff ff       	call   80103e90 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010808a:	e8 81 ce ff ff       	call   80104f10 <myproc>
8010808f:	85 c0                	test   %eax,%eax
80108091:	0f 85 5c fe ff ff    	jne    80107ef3 <trap+0x43>
80108097:	e9 71 fe ff ff       	jmp    80107f0d <trap+0x5d>
8010809c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801080a0:	e8 4b ce ff ff       	call   80104ef0 <cpuid>
801080a5:	85 c0                	test   %eax,%eax
801080a7:	0f 85 38 fe ff ff    	jne    80107ee5 <trap+0x35>
      acquire(&tickslock);
801080ad:	83 ec 0c             	sub    $0xc,%esp
801080b0:	68 40 71 11 80       	push   $0x80117140
801080b5:	e8 a6 df ff ff       	call   80106060 <acquire>
      ticks++;
801080ba:	83 05 20 71 11 80 01 	addl   $0x1,0x80117120
      wakeup(&ticks);
801080c1:	c7 04 24 20 71 11 80 	movl   $0x80117120,(%esp)
801080c8:	e8 e3 d5 ff ff       	call   801056b0 <wakeup>
      release(&tickslock);
801080cd:	c7 04 24 40 71 11 80 	movl   $0x80117140,(%esp)
801080d4:	e8 27 df ff ff       	call   80106000 <release>
801080d9:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
801080dc:	e9 04 fe ff ff       	jmp    80107ee5 <trap+0x35>
801080e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
801080e8:	e8 53 d2 ff ff       	call   80105340 <exit>
801080ed:	e9 1b fe ff ff       	jmp    80107f0d <trap+0x5d>
801080f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
801080f8:	e8 43 d2 ff ff       	call   80105340 <exit>
801080fd:	e9 2e ff ff ff       	jmp    80108030 <trap+0x180>
80108102:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80108105:	e8 e6 cd ff ff       	call   80104ef0 <cpuid>
8010810a:	83 ec 0c             	sub    $0xc,%esp
8010810d:	56                   	push   %esi
8010810e:	57                   	push   %edi
8010810f:	50                   	push   %eax
80108110:	ff 73 30             	push   0x30(%ebx)
80108113:	68 18 9f 10 80       	push   $0x80109f18
80108118:	e8 43 8c ff ff       	call   80100d60 <cprintf>
      panic("trap");
8010811d:	83 c4 14             	add    $0x14,%esp
80108120:	68 d2 9b 10 80       	push   $0x80109bd2
80108125:	e8 26 84 ff ff       	call   80100550 <panic>
8010812a:	66 90                	xchg   %ax,%ax
8010812c:	66 90                	xchg   %ax,%ax
...
{
  if(!uart)
80108130:	a1 80 79 11 80       	mov    0x80117980,%eax
...
80108155:	c3                   	ret
80108156:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010815d:	00 
8010815e:	66 90                	xchg   %ax,%ax
...
801081b7:	0f 84 7c 00 00 00    	je     80108239 <uartinit+0xd9>
  uart = 1;
801081bd:	c7 05 80 79 11 80 01 	movl   $0x1,0x80117980
801081c4:	00 00 00 
801081c7:	89 fa                	mov    %edi,%edx
801081c9:	ec                   	in     (%dx),%al
801081ca:	ba f8 03 00 00       	mov    $0x3f8,%edx
801081cf:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
801081d0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801081d3:	bf d7 9b 10 80       	mov    $0x80109bd7,%edi
801081d8:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
801081dd:	6a 00                	push   $0x0
801081df:	6a 04                	push   $0x4
801081e1:	e8 1a b8 ff ff       	call   80103a00 <ioapicenable>
801081e6:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
801081e9:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
801081ed:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
801081f0:	a1 80 79 11 80       	mov    0x80117980,%eax
801081f5:	85 c0                	test   %eax,%eax
801081f7:	74 32                	je     8010822b <uartinit+0xcb>
801081f9:	89 f2                	mov    %esi,%edx
801081fb:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801081fc:	a8 20                	test   $0x20,%al
801081fe:	75 21                	jne    80108221 <uartinit+0xc1>
80108200:	bb 80 00 00 00       	mov    $0x80,%ebx
80108205:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
80108208:	83 ec 0c             	sub    $0xc,%esp
8010820b:	6a 0a                	push   $0xa
8010820d:	e8 9e bc ff ff       	call   80103eb0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80108212:	83 c4 10             	add    $0x10,%esp
80108215:	83 eb 01             	sub    $0x1,%ebx
80108218:	74 07                	je     80108221 <uartinit+0xc1>
8010821a:	89 f2                	mov    %esi,%edx
8010821c:	ec                   	in     (%dx),%al
8010821d:	a8 20                	test   $0x20,%al
8010821f:	74 e7                	je     80108208 <uartinit+0xa8>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80108221:	ba f8 03 00 00       	mov    $0x3f8,%edx
80108226:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
8010822a:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
8010822b:	0f b6 47 01          	movzbl 0x1(%edi),%eax
8010822f:	83 c7 01             	add    $0x1,%edi
80108232:	88 45 e7             	mov    %al,-0x19(%ebp)
80108235:	84 c0                	test   %al,%al
80108237:	75 b7                	jne    801081f0 <uartinit+0x90>
}
...
8010823f:	5d                   	pop    %ebp
80108240:	c3                   	ret
80108241:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80108248:	00 
80108249:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80108250 <uartputc>:
  if(!uart)
80108250:	a1 80 79 11 80       	mov    0x80117980,%eax
80108255:	85 c0                	test   %eax,%eax
80108257:	74 4f                	je     801082a8 <uartputc+0x58>
{
80108259:	55                   	push   %ebp
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010825a:	ba fd 03 00 00       	mov    $0x3fd,%edx
8010825f:	89 e5                	mov    %esp,%ebp
80108261:	56                   	push   %esi
80108262:	53                   	push   %ebx
80108263:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80108264:	a8 20                	test   $0x20,%al
80108266:	75 29                	jne    80108291 <uartputc+0x41>
80108268:	bb 80 00 00 00       	mov    $0x80,%ebx
8010826d:	be fd 03 00 00       	mov    $0x3fd,%esi
80108272:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    microdelay(10);
80108278:	83 ec 0c             	sub    $0xc,%esp
8010827b:	6a 0a                	push   $0xa
8010827d:	e8 2e bc ff ff       	call   80103eb0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80108282:	83 c4 10             	add    $0x10,%esp
80108285:	83 eb 01             	sub    $0x1,%ebx
80108288:	74 07                	je     80108291 <uartputc+0x41>
8010828a:	89 f2                	mov    %esi,%edx
8010828c:	ec                   	in     (%dx),%al
8010828d:	a8 20                	test   $0x20,%al
8010828f:	74 e7                	je     80108278 <uartputc+0x28>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80108291:	8b 45 08             	mov    0x8(%ebp),%eax
80108294:	ba f8 03 00 00       	mov    $0x3f8,%edx
80108299:	ee                   	out    %al,(%dx)
}
8010829a:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010829d:	5b                   	pop    %ebx
8010829e:	5e                   	pop    %esi
8010829f:	5d                   	pop    %ebp
801082a0:	c3                   	ret
...
801082b6:	68 30 81 10 80       	push   $0x80108130
801082bb:	e8 b0 8c ff ff       	call   80100f70 <consoleintr>
}
...
801082c7:	6a 00                	push   $0x0
  jmp alltraps
801082c9:	e9 06 fb ff ff       	jmp    80107dd4 <alltraps>
...
801082ce:	6a 00                	push   $0x0
  pushl $1
801082d0:	6a 01                	push   $0x1
  jmp alltraps
801082d2:	e9 fd fa ff ff       	jmp    80107dd4 <alltraps>
...
801082d7:	6a 00                	push   $0x0
  pushl $2
801082d9:	6a 02                	push   $0x2
  jmp alltraps
801082db:	e9 f4 fa ff ff       	jmp    80107dd4 <alltraps>
...
801082e0:	6a 00                	push   $0x0
  pushl $3
801082e2:	6a 03                	push   $0x3
  jmp alltraps
801082e4:	e9 eb fa ff ff       	jmp    80107dd4 <alltraps>
...
801082e9:	6a 00                	push   $0x0
  pushl $4
801082eb:	6a 04                	push   $0x4
  jmp alltraps
801082ed:	e9 e2 fa ff ff       	jmp    80107dd4 <alltraps>
...
801082f2:	6a 00                	push   $0x0
  pushl $5
801082f4:	6a 05                	push   $0x5
  jmp alltraps
801082f6:	e9 d9 fa ff ff       	jmp    80107dd4 <alltraps>
...
801082fb:	6a 00                	push   $0x0
  pushl $6
801082fd:	6a 06                	push   $0x6
  jmp alltraps
801082ff:	e9 d0 fa ff ff       	jmp    80107dd4 <alltraps>
...
80108304:	6a 00                	push   $0x0
  pushl $7
80108306:	6a 07                	push   $0x7
  jmp alltraps
80108308:	e9 c7 fa ff ff       	jmp    80107dd4 <alltraps>

8010830d <vector8>:
.globl vector8
vector8:
  pushl $8
8010830d:	6a 08                	push   $0x8
  jmp alltraps
8010830f:	e9 c0 fa ff ff       	jmp    80107dd4 <alltraps>
...
80108314:	6a 00                	push   $0x0
  pushl $9
80108316:	6a 09                	push   $0x9
  jmp alltraps
80108318:	e9 b7 fa ff ff       	jmp    80107dd4 <alltraps>

8010831d <vector10>:
.globl vector10
vector10:
  pushl $10
8010831d:	6a 0a                	push   $0xa
  jmp alltraps
8010831f:	e9 b0 fa ff ff       	jmp    80107dd4 <alltraps>

80108324 <vector11>:
.globl vector11
vector11:
  pushl $11
80108324:	6a 0b                	push   $0xb
  jmp alltraps
80108326:	e9 a9 fa ff ff       	jmp    80107dd4 <alltraps>

8010832b <vector12>:
.globl vector12
vector12:
  pushl $12
8010832b:	6a 0c                	push   $0xc
  jmp alltraps
8010832d:	e9 a2 fa ff ff       	jmp    80107dd4 <alltraps>

80108332 <vector13>:
.globl vector13
vector13:
  pushl $13
80108332:	6a 0d                	push   $0xd
  jmp alltraps
80108334:	e9 9b fa ff ff       	jmp    80107dd4 <alltraps>

80108339 <vector14>:
.globl vector14
vector14:
  pushl $14
80108339:	6a 0e                	push   $0xe
  jmp alltraps
8010833b:	e9 94 fa ff ff       	jmp    80107dd4 <alltraps>
...
80108340:	6a 00                	push   $0x0
  pushl $15
80108342:	6a 0f                	push   $0xf
  jmp alltraps
80108344:	e9 8b fa ff ff       	jmp    80107dd4 <alltraps>
...
80108349:	6a 00                	push   $0x0
  pushl $16
8010834b:	6a 10                	push   $0x10
  jmp alltraps
8010834d:	e9 82 fa ff ff       	jmp    80107dd4 <alltraps>

80108352 <vector17>:
.globl vector17
vector17:
  pushl $17
80108352:	6a 11                	push   $0x11
  jmp alltraps
80108354:	e9 7b fa ff ff       	jmp    80107dd4 <alltraps>
...
80108359:	6a 00                	push   $0x0
  pushl $18
8010835b:	6a 12                	push   $0x12
  jmp alltraps
8010835d:	e9 72 fa ff ff       	jmp    80107dd4 <alltraps>
...
80108362:	6a 00                	push   $0x0
  pushl $19
80108364:	6a 13                	push   $0x13
  jmp alltraps
80108366:	e9 69 fa ff ff       	jmp    80107dd4 <alltraps>
...
8010836b:	6a 00                	push   $0x0
  pushl $20
8010836d:	6a 14                	push   $0x14
  jmp alltraps
8010836f:	e9 60 fa ff ff       	jmp    80107dd4 <alltraps>
...
80108374:	6a 00                	push   $0x0
  pushl $21
80108376:	6a 15                	push   $0x15
  jmp alltraps
80108378:	e9 57 fa ff ff       	jmp    80107dd4 <alltraps>
...
8010837d:	6a 00                	push   $0x0
  pushl $22
8010837f:	6a 16                	push   $0x16
  jmp alltraps
80108381:	e9 4e fa ff ff       	jmp    80107dd4 <alltraps>
...
80108386:	6a 00                	push   $0x0
  pushl $23
80108388:	6a 17                	push   $0x17
  jmp alltraps
8010838a:	e9 45 fa ff ff       	jmp    80107dd4 <alltraps>
...
8010838f:	6a 00                	push   $0x0
  pushl $24
80108391:	6a 18                	push   $0x18
  jmp alltraps
80108393:	e9 3c fa ff ff       	jmp    80107dd4 <alltraps>
...
80108398:	6a 00                	push   $0x0
  pushl $25
8010839a:	6a 19                	push   $0x19
  jmp alltraps
8010839c:	e9 33 fa ff ff       	jmp    80107dd4 <alltraps>
...
801083a1:	6a 00                	push   $0x0
  pushl $26
801083a3:	6a 1a                	push   $0x1a
  jmp alltraps
801083a5:	e9 2a fa ff ff       	jmp    80107dd4 <alltraps>
...
801083aa:	6a 00                	push   $0x0
  pushl $27
801083ac:	6a 1b                	push   $0x1b
  jmp alltraps
801083ae:	e9 21 fa ff ff       	jmp    80107dd4 <alltraps>
...
801083b3:	6a 00                	push   $0x0
  pushl $28
801083b5:	6a 1c                	push   $0x1c
  jmp alltraps
801083b7:	e9 18 fa ff ff       	jmp    80107dd4 <alltraps>
...
801083bc:	6a 00                	push   $0x0
  pushl $29
801083be:	6a 1d                	push   $0x1d
  jmp alltraps
801083c0:	e9 0f fa ff ff       	jmp    80107dd4 <alltraps>
...
801083c5:	6a 00                	push   $0x0
  pushl $30
801083c7:	6a 1e                	push   $0x1e
  jmp alltraps
801083c9:	e9 06 fa ff ff       	jmp    80107dd4 <alltraps>
...
801083ce:	6a 00                	push   $0x0
  pushl $31
801083d0:	6a 1f                	push   $0x1f
  jmp alltraps
801083d2:	e9 fd f9 ff ff       	jmp    80107dd4 <alltraps>
...
801083d7:	6a 00                	push   $0x0
  pushl $32
801083d9:	6a 20                	push   $0x20
  jmp alltraps
801083db:	e9 f4 f9 ff ff       	jmp    80107dd4 <alltraps>
...
801083e0:	6a 00                	push   $0x0
  pushl $33
801083e2:	6a 21                	push   $0x21
  jmp alltraps
801083e4:	e9 eb f9 ff ff       	jmp    80107dd4 <alltraps>
...
801083e9:	6a 00                	push   $0x0
  pushl $34
801083eb:	6a 22                	push   $0x22
  jmp alltraps
801083ed:	e9 e2 f9 ff ff       	jmp    80107dd4 <alltraps>
...
801083f2:	6a 00                	push   $0x0
  pushl $35
801083f4:	6a 23                	push   $0x23
  jmp alltraps
801083f6:	e9 d9 f9 ff ff       	jmp    80107dd4 <alltraps>
...
801083fb:	6a 00                	push   $0x0
  pushl $36
801083fd:	6a 24                	push   $0x24
  jmp alltraps
801083ff:	e9 d0 f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108404:	6a 00                	push   $0x0
  pushl $37
80108406:	6a 25                	push   $0x25
  jmp alltraps
80108408:	e9 c7 f9 ff ff       	jmp    80107dd4 <alltraps>
...
8010840d:	6a 00                	push   $0x0
  pushl $38
8010840f:	6a 26                	push   $0x26
  jmp alltraps
80108411:	e9 be f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108416:	6a 00                	push   $0x0
  pushl $39
80108418:	6a 27                	push   $0x27
  jmp alltraps
8010841a:	e9 b5 f9 ff ff       	jmp    80107dd4 <alltraps>
...
8010841f:	6a 00                	push   $0x0
  pushl $40
80108421:	6a 28                	push   $0x28
  jmp alltraps
80108423:	e9 ac f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108428:	6a 00                	push   $0x0
  pushl $41
8010842a:	6a 29                	push   $0x29
  jmp alltraps
8010842c:	e9 a3 f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108431:	6a 00                	push   $0x0
  pushl $42
80108433:	6a 2a                	push   $0x2a
  jmp alltraps
80108435:	e9 9a f9 ff ff       	jmp    80107dd4 <alltraps>
...
8010843a:	6a 00                	push   $0x0
  pushl $43
8010843c:	6a 2b                	push   $0x2b
  jmp alltraps
8010843e:	e9 91 f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108443:	6a 00                	push   $0x0
  pushl $44
80108445:	6a 2c                	push   $0x2c
  jmp alltraps
80108447:	e9 88 f9 ff ff       	jmp    80107dd4 <alltraps>
...
8010844c:	6a 00                	push   $0x0
  pushl $45
8010844e:	6a 2d                	push   $0x2d
  jmp alltraps
80108450:	e9 7f f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108455:	6a 00                	push   $0x0
  pushl $46
80108457:	6a 2e                	push   $0x2e
  jmp alltraps
80108459:	e9 76 f9 ff ff       	jmp    80107dd4 <alltraps>
...
8010845e:	6a 00                	push   $0x0
  pushl $47
80108460:	6a 2f                	push   $0x2f
  jmp alltraps
80108462:	e9 6d f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108467:	6a 00                	push   $0x0
  pushl $48
80108469:	6a 30                	push   $0x30
  jmp alltraps
8010846b:	e9 64 f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108470:	6a 00                	push   $0x0
  pushl $49
80108472:	6a 31                	push   $0x31
  jmp alltraps
80108474:	e9 5b f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108479:	6a 00                	push   $0x0
  pushl $50
8010847b:	6a 32                	push   $0x32
  jmp alltraps
8010847d:	e9 52 f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108482:	6a 00                	push   $0x0
  pushl $51
80108484:	6a 33                	push   $0x33
  jmp alltraps
80108486:	e9 49 f9 ff ff       	jmp    80107dd4 <alltraps>
...
8010848b:	6a 00                	push   $0x0
  pushl $52
8010848d:	6a 34                	push   $0x34
  jmp alltraps
8010848f:	e9 40 f9 ff ff       	jmp    80107dd4 <alltraps>
...
80108494:	6a 00                	push   $0x0
  pushl $53
80108496:	6a 35                	push   $0x35
  jmp alltraps
80108498:	e9 37 f9 ff ff       	jmp    80107dd4 <alltraps>
...
8010849d:	6a 00                	push   $0x0
  pushl $54
8010849f:	6a 36                	push   $0x36
  jmp alltraps
801084a1:	e9 2e f9 ff ff       	jmp    80107dd4 <alltraps>
...
801084a6:	6a 00                	push   $0x0
  pushl $55
801084a8:	6a 37                	push   $0x37
  jmp alltraps
801084aa:	e9 25 f9 ff ff       	jmp    80107dd4 <alltraps>
...
801084af:	6a 00                	push   $0x0
  pushl $56
801084b1:	6a 38                	push   $0x38
  jmp alltraps
801084b3:	e9 1c f9 ff ff       	jmp    80107dd4 <alltraps>
...
801084b8:	6a 00                	push   $0x0
  pushl $57
801084ba:	6a 39                	push   $0x39
  jmp alltraps
801084bc:	e9 13 f9 ff ff       	jmp    80107dd4 <alltraps>
...
801084c1:	6a 00                	push   $0x0
  pushl $58
801084c3:	6a 3a                	push   $0x3a
  jmp alltraps
801084c5:	e9 0a f9 ff ff       	jmp    80107dd4 <alltraps>
...
801084ca:	6a 00                	push   $0x0
  pushl $59
801084cc:	6a 3b                	push   $0x3b
  jmp alltraps
801084ce:	e9 01 f9 ff ff       	jmp    80107dd4 <alltraps>
...
801084d3:	6a 00                	push   $0x0
  pushl $60
801084d5:	6a 3c                	push   $0x3c
  jmp alltraps
801084d7:	e9 f8 f8 ff ff       	jmp    80107dd4 <alltraps>
...
801084dc:	6a 00                	push   $0x0
  pushl $61
801084de:	6a 3d                	push   $0x3d
  jmp alltraps
801084e0:	e9 ef f8 ff ff       	jmp    80107dd4 <alltraps>
...
801084e5:	6a 00                	push   $0x0
  pushl $62
801084e7:	6a 3e                	push   $0x3e
  jmp alltraps
801084e9:	e9 e6 f8 ff ff       	jmp    80107dd4 <alltraps>
...
801084ee:	6a 00                	push   $0x0
  pushl $63
801084f0:	6a 3f                	push   $0x3f
  jmp alltraps
801084f2:	e9 dd f8 ff ff       	jmp    80107dd4 <alltraps>
...
801084f7:	6a 00                	push   $0x0
  pushl $64
801084f9:	6a 40                	push   $0x40
  jmp alltraps
801084fb:	e9 d4 f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108500:	6a 00                	push   $0x0
  pushl $65
80108502:	6a 41                	push   $0x41
  jmp alltraps
80108504:	e9 cb f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108509:	6a 00                	push   $0x0
  pushl $66
8010850b:	6a 42                	push   $0x42
  jmp alltraps
8010850d:	e9 c2 f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108512:	6a 00                	push   $0x0
  pushl $67
80108514:	6a 43                	push   $0x43
  jmp alltraps
80108516:	e9 b9 f8 ff ff       	jmp    80107dd4 <alltraps>
...
8010851b:	6a 00                	push   $0x0
  pushl $68
8010851d:	6a 44                	push   $0x44
  jmp alltraps
8010851f:	e9 b0 f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108524:	6a 00                	push   $0x0
  pushl $69
80108526:	6a 45                	push   $0x45
  jmp alltraps
80108528:	e9 a7 f8 ff ff       	jmp    80107dd4 <alltraps>
...
8010852d:	6a 00                	push   $0x0
  pushl $70
8010852f:	6a 46                	push   $0x46
  jmp alltraps
80108531:	e9 9e f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108536:	6a 00                	push   $0x0
  pushl $71
80108538:	6a 47                	push   $0x47
  jmp alltraps
8010853a:	e9 95 f8 ff ff       	jmp    80107dd4 <alltraps>
...
8010853f:	6a 00                	push   $0x0
  pushl $72
80108541:	6a 48                	push   $0x48
  jmp alltraps
80108543:	e9 8c f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108548:	6a 00                	push   $0x0
  pushl $73
8010854a:	6a 49                	push   $0x49
  jmp alltraps
8010854c:	e9 83 f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108551:	6a 00                	push   $0x0
  pushl $74
80108553:	6a 4a                	push   $0x4a
  jmp alltraps
80108555:	e9 7a f8 ff ff       	jmp    80107dd4 <alltraps>
...
8010855a:	6a 00                	push   $0x0
  pushl $75
8010855c:	6a 4b                	push   $0x4b
  jmp alltraps
8010855e:	e9 71 f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108563:	6a 00                	push   $0x0
  pushl $76
80108565:	6a 4c                	push   $0x4c
  jmp alltraps
80108567:	e9 68 f8 ff ff       	jmp    80107dd4 <alltraps>
...
8010856c:	6a 00                	push   $0x0
  pushl $77
8010856e:	6a 4d                	push   $0x4d
  jmp alltraps
80108570:	e9 5f f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108575:	6a 00                	push   $0x0
  pushl $78
80108577:	6a 4e                	push   $0x4e
  jmp alltraps
80108579:	e9 56 f8 ff ff       	jmp    80107dd4 <alltraps>
...
8010857e:	6a 00                	push   $0x0
  pushl $79
80108580:	6a 4f                	push   $0x4f
  jmp alltraps
80108582:	e9 4d f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108587:	6a 00                	push   $0x0
  pushl $80
80108589:	6a 50                	push   $0x50
  jmp alltraps
8010858b:	e9 44 f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108590:	6a 00                	push   $0x0
  pushl $81
80108592:	6a 51                	push   $0x51
  jmp alltraps
80108594:	e9 3b f8 ff ff       	jmp    80107dd4 <alltraps>
...
80108599:	6a 00                	push   $0x0
  pushl $82
8010859b:	6a 52                	push   $0x52
  jmp alltraps
8010859d:	e9 32 f8 ff ff       	jmp    80107dd4 <alltraps>
...
801085a2:	6a 00                	push   $0x0
  pushl $83
801085a4:	6a 53                	push   $0x53
  jmp alltraps
801085a6:	e9 29 f8 ff ff       	jmp    80107dd4 <alltraps>
...
801085ab:	6a 00                	push   $0x0
  pushl $84
801085ad:	6a 54                	push   $0x54
  jmp alltraps
801085af:	e9 20 f8 ff ff       	jmp    80107dd4 <alltraps>
...
801085b4:	6a 00                	push   $0x0
  pushl $85
801085b6:	6a 55                	push   $0x55
  jmp alltraps
801085b8:	e9 17 f8 ff ff       	jmp    80107dd4 <alltraps>
...
801085bd:	6a 00                	push   $0x0
  pushl $86
801085bf:	6a 56                	push   $0x56
  jmp alltraps
801085c1:	e9 0e f8 ff ff       	jmp    80107dd4 <alltraps>
...
801085c6:	6a 00                	push   $0x0
  pushl $87
801085c8:	6a 57                	push   $0x57
  jmp alltraps
801085ca:	e9 05 f8 ff ff       	jmp    80107dd4 <alltraps>
...
801085cf:	6a 00                	push   $0x0
  pushl $88
801085d1:	6a 58                	push   $0x58
  jmp alltraps
801085d3:	e9 fc f7 ff ff       	jmp    80107dd4 <alltraps>
...
801085d8:	6a 00                	push   $0x0
  pushl $89
801085da:	6a 59                	push   $0x59
  jmp alltraps
801085dc:	e9 f3 f7 ff ff       	jmp    80107dd4 <alltraps>
...
801085e1:	6a 00                	push   $0x0
  pushl $90
801085e3:	6a 5a                	push   $0x5a
  jmp alltraps
801085e5:	e9 ea f7 ff ff       	jmp    80107dd4 <alltraps>
...
801085ea:	6a 00                	push   $0x0
  pushl $91
801085ec:	6a 5b                	push   $0x5b
  jmp alltraps
801085ee:	e9 e1 f7 ff ff       	jmp    80107dd4 <alltraps>
...
801085f3:	6a 00                	push   $0x0
  pushl $92
801085f5:	6a 5c                	push   $0x5c
  jmp alltraps
801085f7:	e9 d8 f7 ff ff       	jmp    80107dd4 <alltraps>
...
801085fc:	6a 00                	push   $0x0
  pushl $93
801085fe:	6a 5d                	push   $0x5d
  jmp alltraps
80108600:	e9 cf f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108605:	6a 00                	push   $0x0
  pushl $94
80108607:	6a 5e                	push   $0x5e
  jmp alltraps
80108609:	e9 c6 f7 ff ff       	jmp    80107dd4 <alltraps>
...
8010860e:	6a 00                	push   $0x0
  pushl $95
80108610:	6a 5f                	push   $0x5f
  jmp alltraps
80108612:	e9 bd f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108617:	6a 00                	push   $0x0
  pushl $96
80108619:	6a 60                	push   $0x60
  jmp alltraps
8010861b:	e9 b4 f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108620:	6a 00                	push   $0x0
  pushl $97
80108622:	6a 61                	push   $0x61
  jmp alltraps
80108624:	e9 ab f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108629:	6a 00                	push   $0x0
  pushl $98
8010862b:	6a 62                	push   $0x62
  jmp alltraps
8010862d:	e9 a2 f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108632:	6a 00                	push   $0x0
  pushl $99
80108634:	6a 63                	push   $0x63
  jmp alltraps
80108636:	e9 99 f7 ff ff       	jmp    80107dd4 <alltraps>
...
8010863b:	6a 00                	push   $0x0
  pushl $100
8010863d:	6a 64                	push   $0x64
  jmp alltraps
8010863f:	e9 90 f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108644:	6a 00                	push   $0x0
  pushl $101
80108646:	6a 65                	push   $0x65
  jmp alltraps
80108648:	e9 87 f7 ff ff       	jmp    80107dd4 <alltraps>
...
8010864d:	6a 00                	push   $0x0
  pushl $102
8010864f:	6a 66                	push   $0x66
  jmp alltraps
80108651:	e9 7e f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108656:	6a 00                	push   $0x0
  pushl $103
80108658:	6a 67                	push   $0x67
  jmp alltraps
8010865a:	e9 75 f7 ff ff       	jmp    80107dd4 <alltraps>
...
8010865f:	6a 00                	push   $0x0
  pushl $104
80108661:	6a 68                	push   $0x68
  jmp alltraps
80108663:	e9 6c f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108668:	6a 00                	push   $0x0
  pushl $105
8010866a:	6a 69                	push   $0x69
  jmp alltraps
8010866c:	e9 63 f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108671:	6a 00                	push   $0x0
  pushl $106
80108673:	6a 6a                	push   $0x6a
  jmp alltraps
80108675:	e9 5a f7 ff ff       	jmp    80107dd4 <alltraps>
...
8010867a:	6a 00                	push   $0x0
  pushl $107
8010867c:	6a 6b                	push   $0x6b
  jmp alltraps
8010867e:	e9 51 f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108683:	6a 00                	push   $0x0
  pushl $108
80108685:	6a 6c                	push   $0x6c
  jmp alltraps
80108687:	e9 48 f7 ff ff       	jmp    80107dd4 <alltraps>
...
8010868c:	6a 00                	push   $0x0
  pushl $109
8010868e:	6a 6d                	push   $0x6d
  jmp alltraps
80108690:	e9 3f f7 ff ff       	jmp    80107dd4 <alltraps>
...
80108695:	6a 00                	push   $0x0
  pushl $110
80108697:	6a 6e                	push   $0x6e
  jmp alltraps
80108699:	e9 36 f7 ff ff       	jmp    80107dd4 <alltraps>
...
8010869e:	6a 00                	push   $0x0
  pushl $111
801086a0:	6a 6f                	push   $0x6f
  jmp alltraps
801086a2:	e9 2d f7 ff ff       	jmp    80107dd4 <alltraps>
...
801086a7:	6a 00                	push   $0x0
  pushl $112
801086a9:	6a 70                	push   $0x70
  jmp alltraps
801086ab:	e9 24 f7 ff ff       	jmp    80107dd4 <alltraps>
...
801086b0:	6a 00                	push   $0x0
  pushl $113
801086b2:	6a 71                	push   $0x71
  jmp alltraps
801086b4:	e9 1b f7 ff ff       	jmp    80107dd4 <alltraps>
...
801086b9:	6a 00                	push   $0x0
  pushl $114
801086bb:	6a 72                	push   $0x72
  jmp alltraps
801086bd:	e9 12 f7 ff ff       	jmp    80107dd4 <alltraps>
...
801086c2:	6a 00                	push   $0x0
  pushl $115
801086c4:	6a 73                	push   $0x73
  jmp alltraps
801086c6:	e9 09 f7 ff ff       	jmp    80107dd4 <alltraps>
...
801086cb:	6a 00                	push   $0x0
  pushl $116
801086cd:	6a 74                	push   $0x74
  jmp alltraps
801086cf:	e9 00 f7 ff ff       	jmp    80107dd4 <alltraps>
...
801086d4:	6a 00                	push   $0x0
  pushl $117
801086d6:	6a 75                	push   $0x75
  jmp alltraps
801086d8:	e9 f7 f6 ff ff       	jmp    80107dd4 <alltraps>
...
801086dd:	6a 00                	push   $0x0
  pushl $118
801086df:	6a 76                	push   $0x76
  jmp alltraps
801086e1:	e9 ee f6 ff ff       	jmp    80107dd4 <alltraps>
...
801086e6:	6a 00                	push   $0x0
  pushl $119
801086e8:	6a 77                	push   $0x77
  jmp alltraps
801086ea:	e9 e5 f6 ff ff       	jmp    80107dd4 <alltraps>
...
801086ef:	6a 00                	push   $0x0
  pushl $120
801086f1:	6a 78                	push   $0x78
  jmp alltraps
801086f3:	e9 dc f6 ff ff       	jmp    80107dd4 <alltraps>
...
801086f8:	6a 00                	push   $0x0
  pushl $121
801086fa:	6a 79                	push   $0x79
  jmp alltraps
801086fc:	e9 d3 f6 ff ff       	jmp    80107dd4 <alltraps>
...
80108701:	6a 00                	push   $0x0
  pushl $122
80108703:	6a 7a                	push   $0x7a
  jmp alltraps
80108705:	e9 ca f6 ff ff       	jmp    80107dd4 <alltraps>
...
8010870a:	6a 00                	push   $0x0
  pushl $123
8010870c:	6a 7b                	push   $0x7b
  jmp alltraps
8010870e:	e9 c1 f6 ff ff       	jmp    80107dd4 <alltraps>
...
80108713:	6a 00                	push   $0x0
  pushl $124
80108715:	6a 7c                	push   $0x7c
  jmp alltraps
80108717:	e9 b8 f6 ff ff       	jmp    80107dd4 <alltraps>
...
8010871c:	6a 00                	push   $0x0
  pushl $125
8010871e:	6a 7d                	push   $0x7d
  jmp alltraps
80108720:	e9 af f6 ff ff       	jmp    80107dd4 <alltraps>
...
80108725:	6a 00                	push   $0x0
  pushl $126
80108727:	6a 7e                	push   $0x7e
  jmp alltraps
80108729:	e9 a6 f6 ff ff       	jmp    80107dd4 <alltraps>
...
8010872e:	6a 00                	push   $0x0
  pushl $127
80108730:	6a 7f                	push   $0x7f
  jmp alltraps
80108732:	e9 9d f6 ff ff       	jmp    80107dd4 <alltraps>
...
80108737:	6a 00                	push   $0x0
  pushl $128
80108739:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010873e:	e9 91 f6 ff ff       	jmp    80107dd4 <alltraps>
...
80108743:	6a 00                	push   $0x0
  pushl $129
80108745:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010874a:	e9 85 f6 ff ff       	jmp    80107dd4 <alltraps>
...
8010874f:	6a 00                	push   $0x0
  pushl $130
80108751:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80108756:	e9 79 f6 ff ff       	jmp    80107dd4 <alltraps>
...
8010875b:	6a 00                	push   $0x0
  pushl $131
8010875d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80108762:	e9 6d f6 ff ff       	jmp    80107dd4 <alltraps>
...
80108767:	6a 00                	push   $0x0
  pushl $132
80108769:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010876e:	e9 61 f6 ff ff       	jmp    80107dd4 <alltraps>
...
80108773:	6a 00                	push   $0x0
  pushl $133
80108775:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010877a:	e9 55 f6 ff ff       	jmp    80107dd4 <alltraps>
...
8010877f:	6a 00                	push   $0x0
  pushl $134
80108781:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80108786:	e9 49 f6 ff ff       	jmp    80107dd4 <alltraps>
...
8010878b:	6a 00                	push   $0x0
  pushl $135
8010878d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80108792:	e9 3d f6 ff ff       	jmp    80107dd4 <alltraps>
...
80108797:	6a 00                	push   $0x0
  pushl $136
80108799:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010879e:	e9 31 f6 ff ff       	jmp    80107dd4 <alltraps>
...
801087a3:	6a 00                	push   $0x0
  pushl $137
801087a5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801087aa:	e9 25 f6 ff ff       	jmp    80107dd4 <alltraps>
...
801087af:	6a 00                	push   $0x0
  pushl $138
801087b1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801087b6:	e9 19 f6 ff ff       	jmp    80107dd4 <alltraps>
...
801087bb:	6a 00                	push   $0x0
  pushl $139
801087bd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801087c2:	e9 0d f6 ff ff       	jmp    80107dd4 <alltraps>
...
801087c7:	6a 00                	push   $0x0
  pushl $140
801087c9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801087ce:	e9 01 f6 ff ff       	jmp    80107dd4 <alltraps>
...
801087d3:	6a 00                	push   $0x0
  pushl $141
801087d5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801087da:	e9 f5 f5 ff ff       	jmp    80107dd4 <alltraps>
...
801087df:	6a 00                	push   $0x0
  pushl $142
801087e1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801087e6:	e9 e9 f5 ff ff       	jmp    80107dd4 <alltraps>
...
801087eb:	6a 00                	push   $0x0
  pushl $143
801087ed:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801087f2:	e9 dd f5 ff ff       	jmp    80107dd4 <alltraps>
...
801087f7:	6a 00                	push   $0x0
  pushl $144
801087f9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801087fe:	e9 d1 f5 ff ff       	jmp    80107dd4 <alltraps>
...
80108803:	6a 00                	push   $0x0
  pushl $145
80108805:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010880a:	e9 c5 f5 ff ff       	jmp    80107dd4 <alltraps>
...
8010880f:	6a 00                	push   $0x0
  pushl $146
80108811:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80108816:	e9 b9 f5 ff ff       	jmp    80107dd4 <alltraps>
...
8010881b:	6a 00                	push   $0x0
  pushl $147
8010881d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80108822:	e9 ad f5 ff ff       	jmp    80107dd4 <alltraps>
...
80108827:	6a 00                	push   $0x0
  pushl $148
80108829:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010882e:	e9 a1 f5 ff ff       	jmp    80107dd4 <alltraps>
...
80108833:	6a 00                	push   $0x0
  pushl $149
80108835:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010883a:	e9 95 f5 ff ff       	jmp    80107dd4 <alltraps>
...
8010883f:	6a 00                	push   $0x0
  pushl $150
80108841:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80108846:	e9 89 f5 ff ff       	jmp    80107dd4 <alltraps>
...
8010884b:	6a 00                	push   $0x0
  pushl $151
8010884d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80108852:	e9 7d f5 ff ff       	jmp    80107dd4 <alltraps>
...
80108857:	6a 00                	push   $0x0
  pushl $152
80108859:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010885e:	e9 71 f5 ff ff       	jmp    80107dd4 <alltraps>
...
80108863:	6a 00                	push   $0x0
  pushl $153
80108865:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010886a:	e9 65 f5 ff ff       	jmp    80107dd4 <alltraps>
...
8010886f:	6a 00                	push   $0x0
  pushl $154
80108871:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80108876:	e9 59 f5 ff ff       	jmp    80107dd4 <alltraps>
...
8010887b:	6a 00                	push   $0x0
  pushl $155
8010887d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80108882:	e9 4d f5 ff ff       	jmp    80107dd4 <alltraps>
...
80108887:	6a 00                	push   $0x0
  pushl $156
80108889:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010888e:	e9 41 f5 ff ff       	jmp    80107dd4 <alltraps>
...
80108893:	6a 00                	push   $0x0
  pushl $157
80108895:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010889a:	e9 35 f5 ff ff       	jmp    80107dd4 <alltraps>
...
8010889f:	6a 00                	push   $0x0
  pushl $158
801088a1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801088a6:	e9 29 f5 ff ff       	jmp    80107dd4 <alltraps>
...
801088ab:	6a 00                	push   $0x0
  pushl $159
801088ad:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801088b2:	e9 1d f5 ff ff       	jmp    80107dd4 <alltraps>
...
801088b7:	6a 00                	push   $0x0
  pushl $160
801088b9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801088be:	e9 11 f5 ff ff       	jmp    80107dd4 <alltraps>
...
801088c3:	6a 00                	push   $0x0
  pushl $161
801088c5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801088ca:	e9 05 f5 ff ff       	jmp    80107dd4 <alltraps>
...
801088cf:	6a 00                	push   $0x0
  pushl $162
801088d1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801088d6:	e9 f9 f4 ff ff       	jmp    80107dd4 <alltraps>
...
801088db:	6a 00                	push   $0x0
  pushl $163
801088dd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801088e2:	e9 ed f4 ff ff       	jmp    80107dd4 <alltraps>
...
801088e7:	6a 00                	push   $0x0
  pushl $164
801088e9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801088ee:	e9 e1 f4 ff ff       	jmp    80107dd4 <alltraps>
...
801088f3:	6a 00                	push   $0x0
  pushl $165
801088f5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801088fa:	e9 d5 f4 ff ff       	jmp    80107dd4 <alltraps>
...
801088ff:	6a 00                	push   $0x0
  pushl $166
80108901:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80108906:	e9 c9 f4 ff ff       	jmp    80107dd4 <alltraps>
...
8010890b:	6a 00                	push   $0x0
  pushl $167
8010890d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80108912:	e9 bd f4 ff ff       	jmp    80107dd4 <alltraps>
...
80108917:	6a 00                	push   $0x0
  pushl $168
80108919:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010891e:	e9 b1 f4 ff ff       	jmp    80107dd4 <alltraps>
...
80108923:	6a 00                	push   $0x0
  pushl $169
80108925:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010892a:	e9 a5 f4 ff ff       	jmp    80107dd4 <alltraps>
...
8010892f:	6a 00                	push   $0x0
  pushl $170
80108931:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80108936:	e9 99 f4 ff ff       	jmp    80107dd4 <alltraps>
...
8010893b:	6a 00                	push   $0x0
  pushl $171
8010893d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80108942:	e9 8d f4 ff ff       	jmp    80107dd4 <alltraps>
...
80108947:	6a 00                	push   $0x0
  pushl $172
80108949:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010894e:	e9 81 f4 ff ff       	jmp    80107dd4 <alltraps>
...
80108953:	6a 00                	push   $0x0
  pushl $173
80108955:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010895a:	e9 75 f4 ff ff       	jmp    80107dd4 <alltraps>
...
8010895f:	6a 00                	push   $0x0
  pushl $174
80108961:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80108966:	e9 69 f4 ff ff       	jmp    80107dd4 <alltraps>
...
8010896b:	6a 00                	push   $0x0
  pushl $175
8010896d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80108972:	e9 5d f4 ff ff       	jmp    80107dd4 <alltraps>
...
80108977:	6a 00                	push   $0x0
  pushl $176
80108979:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010897e:	e9 51 f4 ff ff       	jmp    80107dd4 <alltraps>
...
80108983:	6a 00                	push   $0x0
  pushl $177
80108985:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010898a:	e9 45 f4 ff ff       	jmp    80107dd4 <alltraps>
...
8010898f:	6a 00                	push   $0x0
  pushl $178
80108991:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80108996:	e9 39 f4 ff ff       	jmp    80107dd4 <alltraps>
...
8010899b:	6a 00                	push   $0x0
  pushl $179
8010899d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801089a2:	e9 2d f4 ff ff       	jmp    80107dd4 <alltraps>
...
801089a7:	6a 00                	push   $0x0
  pushl $180
801089a9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801089ae:	e9 21 f4 ff ff       	jmp    80107dd4 <alltraps>
...
801089b3:	6a 00                	push   $0x0
  pushl $181
801089b5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801089ba:	e9 15 f4 ff ff       	jmp    80107dd4 <alltraps>
...
801089bf:	6a 00                	push   $0x0
  pushl $182
801089c1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801089c6:	e9 09 f4 ff ff       	jmp    80107dd4 <alltraps>
...
801089cb:	6a 00                	push   $0x0
  pushl $183
801089cd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801089d2:	e9 fd f3 ff ff       	jmp    80107dd4 <alltraps>
...
801089d7:	6a 00                	push   $0x0
  pushl $184
801089d9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801089de:	e9 f1 f3 ff ff       	jmp    80107dd4 <alltraps>
...
801089e3:	6a 00                	push   $0x0
  pushl $185
801089e5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801089ea:	e9 e5 f3 ff ff       	jmp    80107dd4 <alltraps>
...
801089ef:	6a 00                	push   $0x0
  pushl $186
801089f1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801089f6:	e9 d9 f3 ff ff       	jmp    80107dd4 <alltraps>
...
801089fb:	6a 00                	push   $0x0
  pushl $187
801089fd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80108a02:	e9 cd f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a07:	6a 00                	push   $0x0
  pushl $188
80108a09:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80108a0e:	e9 c1 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a13:	6a 00                	push   $0x0
  pushl $189
80108a15:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80108a1a:	e9 b5 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a1f:	6a 00                	push   $0x0
  pushl $190
80108a21:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80108a26:	e9 a9 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a2b:	6a 00                	push   $0x0
  pushl $191
80108a2d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80108a32:	e9 9d f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a37:	6a 00                	push   $0x0
  pushl $192
80108a39:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80108a3e:	e9 91 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a43:	6a 00                	push   $0x0
  pushl $193
80108a45:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80108a4a:	e9 85 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a4f:	6a 00                	push   $0x0
  pushl $194
80108a51:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80108a56:	e9 79 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a5b:	6a 00                	push   $0x0
  pushl $195
80108a5d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80108a62:	e9 6d f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a67:	6a 00                	push   $0x0
  pushl $196
80108a69:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80108a6e:	e9 61 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a73:	6a 00                	push   $0x0
  pushl $197
80108a75:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80108a7a:	e9 55 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a7f:	6a 00                	push   $0x0
  pushl $198
80108a81:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80108a86:	e9 49 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a8b:	6a 00                	push   $0x0
  pushl $199
80108a8d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80108a92:	e9 3d f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108a97:	6a 00                	push   $0x0
  pushl $200
80108a99:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80108a9e:	e9 31 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108aa3:	6a 00                	push   $0x0
  pushl $201
80108aa5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80108aaa:	e9 25 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108aaf:	6a 00                	push   $0x0
  pushl $202
80108ab1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80108ab6:	e9 19 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108abb:	6a 00                	push   $0x0
  pushl $203
80108abd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80108ac2:	e9 0d f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108ac7:	6a 00                	push   $0x0
  pushl $204
80108ac9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80108ace:	e9 01 f3 ff ff       	jmp    80107dd4 <alltraps>
...
80108ad3:	6a 00                	push   $0x0
  pushl $205
80108ad5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80108ada:	e9 f5 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108adf:	6a 00                	push   $0x0
  pushl $206
80108ae1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80108ae6:	e9 e9 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108aeb:	6a 00                	push   $0x0
  pushl $207
80108aed:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80108af2:	e9 dd f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108af7:	6a 00                	push   $0x0
  pushl $208
80108af9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80108afe:	e9 d1 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b03:	6a 00                	push   $0x0
  pushl $209
80108b05:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80108b0a:	e9 c5 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b0f:	6a 00                	push   $0x0
  pushl $210
80108b11:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80108b16:	e9 b9 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b1b:	6a 00                	push   $0x0
  pushl $211
80108b1d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80108b22:	e9 ad f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b27:	6a 00                	push   $0x0
  pushl $212
80108b29:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80108b2e:	e9 a1 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b33:	6a 00                	push   $0x0
  pushl $213
80108b35:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80108b3a:	e9 95 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b3f:	6a 00                	push   $0x0
  pushl $214
80108b41:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80108b46:	e9 89 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b4b:	6a 00                	push   $0x0
  pushl $215
80108b4d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80108b52:	e9 7d f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b57:	6a 00                	push   $0x0
  pushl $216
80108b59:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80108b5e:	e9 71 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b63:	6a 00                	push   $0x0
  pushl $217
80108b65:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80108b6a:	e9 65 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b6f:	6a 00                	push   $0x0
  pushl $218
80108b71:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80108b76:	e9 59 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b7b:	6a 00                	push   $0x0
  pushl $219
80108b7d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80108b82:	e9 4d f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b87:	6a 00                	push   $0x0
  pushl $220
80108b89:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80108b8e:	e9 41 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b93:	6a 00                	push   $0x0
  pushl $221
80108b95:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80108b9a:	e9 35 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108b9f:	6a 00                	push   $0x0
  pushl $222
80108ba1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80108ba6:	e9 29 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108bab:	6a 00                	push   $0x0
  pushl $223
80108bad:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80108bb2:	e9 1d f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108bb7:	6a 00                	push   $0x0
  pushl $224
80108bb9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80108bbe:	e9 11 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108bc3:	6a 00                	push   $0x0
  pushl $225
80108bc5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80108bca:	e9 05 f2 ff ff       	jmp    80107dd4 <alltraps>
...
80108bcf:	6a 00                	push   $0x0
  pushl $226
80108bd1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80108bd6:	e9 f9 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108bdb:	6a 00                	push   $0x0
  pushl $227
80108bdd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80108be2:	e9 ed f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108be7:	6a 00                	push   $0x0
  pushl $228
80108be9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80108bee:	e9 e1 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108bf3:	6a 00                	push   $0x0
  pushl $229
80108bf5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80108bfa:	e9 d5 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108bff:	6a 00                	push   $0x0
  pushl $230
80108c01:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80108c06:	e9 c9 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c0b:	6a 00                	push   $0x0
  pushl $231
80108c0d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80108c12:	e9 bd f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c17:	6a 00                	push   $0x0
  pushl $232
80108c19:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80108c1e:	e9 b1 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c23:	6a 00                	push   $0x0
  pushl $233
80108c25:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80108c2a:	e9 a5 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c2f:	6a 00                	push   $0x0
  pushl $234
80108c31:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80108c36:	e9 99 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c3b:	6a 00                	push   $0x0
  pushl $235
80108c3d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80108c42:	e9 8d f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c47:	6a 00                	push   $0x0
  pushl $236
80108c49:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80108c4e:	e9 81 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c53:	6a 00                	push   $0x0
  pushl $237
80108c55:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80108c5a:	e9 75 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c5f:	6a 00                	push   $0x0
  pushl $238
80108c61:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80108c66:	e9 69 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c6b:	6a 00                	push   $0x0
  pushl $239
80108c6d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80108c72:	e9 5d f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c77:	6a 00                	push   $0x0
  pushl $240
80108c79:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80108c7e:	e9 51 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c83:	6a 00                	push   $0x0
  pushl $241
80108c85:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80108c8a:	e9 45 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c8f:	6a 00                	push   $0x0
  pushl $242
80108c91:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80108c96:	e9 39 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108c9b:	6a 00                	push   $0x0
  pushl $243
80108c9d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80108ca2:	e9 2d f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108ca7:	6a 00                	push   $0x0
  pushl $244
80108ca9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80108cae:	e9 21 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108cb3:	6a 00                	push   $0x0
  pushl $245
80108cb5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80108cba:	e9 15 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108cbf:	6a 00                	push   $0x0
  pushl $246
80108cc1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80108cc6:	e9 09 f1 ff ff       	jmp    80107dd4 <alltraps>
...
80108ccb:	6a 00                	push   $0x0
  pushl $247
80108ccd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80108cd2:	e9 fd f0 ff ff       	jmp    80107dd4 <alltraps>
...
80108cd7:	6a 00                	push   $0x0
  pushl $248
80108cd9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80108cde:	e9 f1 f0 ff ff       	jmp    80107dd4 <alltraps>
...
80108ce3:	6a 00                	push   $0x0
  pushl $249
80108ce5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80108cea:	e9 e5 f0 ff ff       	jmp    80107dd4 <alltraps>
...
80108cef:	6a 00                	push   $0x0
  pushl $250
80108cf1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80108cf6:	e9 d9 f0 ff ff       	jmp    80107dd4 <alltraps>
...
80108cfb:	6a 00                	push   $0x0
  pushl $251
80108cfd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80108d02:	e9 cd f0 ff ff       	jmp    80107dd4 <alltraps>
...
80108d07:	6a 00                	push   $0x0
  pushl $252
80108d09:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80108d0e:	e9 c1 f0 ff ff       	jmp    80107dd4 <alltraps>
...
80108d13:	6a 00                	push   $0x0
  pushl $253
80108d15:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80108d1a:	e9 b5 f0 ff ff       	jmp    80107dd4 <alltraps>
...
80108d1f:	6a 00                	push   $0x0
  pushl $254
80108d21:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80108d26:	e9 a9 f0 ff ff       	jmp    80107dd4 <alltraps>
...
80108d2b:	6a 00                	push   $0x0
  pushl $255
80108d2d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80108d32:	e9 9d f0 ff ff       	jmp    80107dd4 <alltraps>
80108d37:	66 90                	xchg   %ax,%ax
80108d39:	66 90                	xchg   %ax,%ax
80108d3b:	66 90                	xchg   %ax,%ax
80108d3d:	66 90                	xchg   %ax,%ax
80108d3f:	90                   	nop

80108d40 <deallocuvm.part.0>:
...
80108d45:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80108d46:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
80108d4c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80108d52:	83 ec 1c             	sub    $0x1c,%esp
  for(; a  < oldsz; a += PGSIZE){
80108d55:	39 d3                	cmp    %edx,%ebx
80108d57:	73 56                	jae    80108daf <deallocuvm.part.0+0x6f>
80108d59:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80108d5c:	89 c6                	mov    %eax,%esi
80108d5e:	89 d7                	mov    %edx,%edi
80108d60:	eb 12                	jmp    80108d74 <deallocuvm.part.0+0x34>
80108d62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80108d68:	83 c2 01             	add    $0x1,%edx
80108d6b:	89 d3                	mov    %edx,%ebx
80108d6d:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
80108d70:	39 fb                	cmp    %edi,%ebx
80108d72:	73 38                	jae    80108dac <deallocuvm.part.0+0x6c>
  pde = &pgdir[PDX(va)];
80108d74:	89 da                	mov    %ebx,%edx
80108d76:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80108d79:	8b 04 96             	mov    (%esi,%edx,4),%eax
80108d7c:	a8 01                	test   $0x1,%al
80108d7e:	74 e8                	je     80108d68 <deallocuvm.part.0+0x28>
  return &pgtab[PTX(va)];
80108d80:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80108d82:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80108d87:	c1 e9 0a             	shr    $0xa,%ecx
80108d8a:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
80108d90:	8d 84 08 00 00 00 80 	lea    -0x80000000(%eax,%ecx,1),%eax
    if(!pte)
80108d97:	85 c0                	test   %eax,%eax
80108d99:	74 cd                	je     80108d68 <deallocuvm.part.0+0x28>
    else if((*pte & PTE_P) != 0){
80108d9b:	8b 10                	mov    (%eax),%edx
80108d9d:	f6 c2 01             	test   $0x1,%dl
80108da0:	75 1e                	jne    80108dc0 <deallocuvm.part.0+0x80>
  for(; a  < oldsz; a += PGSIZE){
80108da2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80108da8:	39 fb                	cmp    %edi,%ebx
80108daa:	72 c8                	jb     80108d74 <deallocuvm.part.0+0x34>
80108dac:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      kfree(v);
      *pte = 0;
    }
  }
...
80108daf:	8d 65 f4             	lea    -0xc(%ebp),%esp
80108db2:	89 c8                	mov    %ecx,%eax
80108db4:	5b                   	pop    %ebx
80108db5:	5e                   	pop    %esi
80108db6:	5f                   	pop    %edi
80108db7:	5d                   	pop    %ebp
...
80108db9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(pa == 0)
80108dc0:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80108dc6:	74 26                	je     80108dee <deallocuvm.part.0+0xae>
      kfree(v);
80108dc8:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80108dcb:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80108dd1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108dd4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80108dda:	52                   	push   %edx
80108ddb:	e8 60 ac ff ff       	call   80103a40 <kfree>
      *pte = 0;
80108de0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(; a  < oldsz; a += PGSIZE){
80108de3:	83 c4 10             	add    $0x10,%esp
      *pte = 0;
80108de6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80108dec:	eb 82                	jmp    80108d70 <deallocuvm.part.0+0x30>
        panic("kfree");
80108dee:	83 ec 0c             	sub    $0xc,%esp
80108df1:	68 cc 98 10 80       	push   $0x801098cc
80108df6:	e8 55 77 ff ff       	call   80100550 <panic>
80108dfb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

80108e00 <mappages>:
{
80108e00:	55                   	push   %ebp
80108e01:	89 e5                	mov    %esp,%ebp
80108e03:	57                   	push   %edi
80108e04:	56                   	push   %esi
80108e05:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80108e06:	89 d3                	mov    %edx,%ebx
80108e08:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
80108e0e:	83 ec 1c             	sub    $0x1c,%esp
80108e11:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80108e14:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80108e18:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108e1d:	89 45 dc             	mov    %eax,-0x24(%ebp)
80108e20:	8b 45 08             	mov    0x8(%ebp),%eax
80108e23:	29 d8                	sub    %ebx,%eax
80108e25:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108e28:	eb 3f                	jmp    80108e69 <mappages+0x69>
80108e2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80108e30:	89 da                	mov    %ebx,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80108e32:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80108e37:	c1 ea 0a             	shr    $0xa,%edx
80108e3a:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80108e40:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108e47:	85 c0                	test   %eax,%eax
80108e49:	74 75                	je     80108ec0 <mappages+0xc0>
    if(*pte & PTE_P)
80108e4b:	f6 00 01             	testb  $0x1,(%eax)
80108e4e:	0f 85 86 00 00 00    	jne    80108eda <mappages+0xda>
    *pte = pa | perm | PTE_P;
80108e54:	0b 75 0c             	or     0xc(%ebp),%esi
80108e57:	83 ce 01             	or     $0x1,%esi
80108e5a:	89 30                	mov    %esi,(%eax)
    if(a == last)
80108e5c:	8b 45 dc             	mov    -0x24(%ebp),%eax
80108e5f:	39 c3                	cmp    %eax,%ebx
80108e61:	74 6d                	je     80108ed0 <mappages+0xd0>
    a += PGSIZE;
80108e63:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80108e69:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
80108e6c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80108e6f:	8d 34 03             	lea    (%ebx,%eax,1),%esi
80108e72:	89 d8                	mov    %ebx,%eax
80108e74:	c1 e8 16             	shr    $0x16,%eax
80108e77:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80108e7a:	8b 07                	mov    (%edi),%eax
80108e7c:	a8 01                	test   $0x1,%al
80108e7e:	75 b0                	jne    80108e30 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80108e80:	e8 7b ad ff ff       	call   80103c00 <kalloc>
80108e85:	85 c0                	test   %eax,%eax
80108e87:	74 37                	je     80108ec0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80108e89:	83 ec 04             	sub    $0x4,%esp
80108e8c:	68 00 10 00 00       	push   $0x1000
80108e91:	6a 00                	push   $0x0
80108e93:	50                   	push   %eax
80108e94:	89 45 d8             	mov    %eax,-0x28(%ebp)
80108e97:	e8 34 d7 ff ff       	call   801065d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80108e9c:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80108e9f:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80108ea2:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80108ea8:	83 c8 07             	or     $0x7,%eax
80108eab:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80108ead:	89 d8                	mov    %ebx,%eax
80108eaf:	c1 e8 0a             	shr    $0xa,%eax
80108eb2:	25 fc 0f 00 00       	and    $0xffc,%eax
80108eb7:	01 d0                	add    %edx,%eax
80108eb9:	eb 90                	jmp    80108e4b <mappages+0x4b>
80108ebb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
}
80108ec0:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80108ec3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80108ec8:	5b                   	pop    %ebx
80108ec9:	5e                   	pop    %esi
80108eca:	5f                   	pop    %edi
80108ecb:	5d                   	pop    %ebp
80108ecc:	c3                   	ret
80108ecd:	8d 76 00             	lea    0x0(%esi),%esi
80108ed0:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
80108ed3:	31 c0                	xor    %eax,%eax
}
80108ed5:	5b                   	pop    %ebx
80108ed6:	5e                   	pop    %esi
80108ed7:	5f                   	pop    %edi
...
80108edd:	68 df 9b 10 80       	push   $0x80109bdf
80108ee2:	e8 69 76 ff ff       	call   80100550 <panic>
80108ee7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80108eee:	00 
80108eef:	90                   	nop
...
80108ef3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80108ef6:	e8 f5 bf ff ff       	call   80104ef0 <cpuid>
  pd[0] = size-1;
80108efb:	ba 2f 00 00 00       	mov    $0x2f,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80108f00:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80108f06:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
80108f0a:	c7 80 b8 4a 11 80 ff 	movl   $0xffff,-0x7feeb548(%eax)
80108f11:	ff 00 00 
80108f14:	c7 80 bc 4a 11 80 00 	movl   $0xcf9a00,-0x7feeb544(%eax)
80108f1b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108f1e:	c7 80 c0 4a 11 80 ff 	movl   $0xffff,-0x7feeb540(%eax)
80108f25:	ff 00 00 
80108f28:	c7 80 c4 4a 11 80 00 	movl   $0xcf9200,-0x7feeb53c(%eax)
80108f2f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108f32:	c7 80 c8 4a 11 80 ff 	movl   $0xffff,-0x7feeb538(%eax)
80108f39:	ff 00 00 
80108f3c:	c7 80 cc 4a 11 80 00 	movl   $0xcffa00,-0x7feeb534(%eax)
80108f43:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108f46:	c7 80 d0 4a 11 80 ff 	movl   $0xffff,-0x7feeb530(%eax)
80108f4d:	ff 00 00 
80108f50:	c7 80 d4 4a 11 80 00 	movl   $0xcff200,-0x7feeb52c(%eax)
80108f57:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80108f5a:	05 b0 4a 11 80       	add    $0x80114ab0,%eax
  pd[1] = (uint)p;
80108f5f:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80108f63:	c1 e8 10             	shr    $0x10,%eax
80108f66:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80108f6a:	8d 45 f2             	lea    -0xe(%ebp),%eax
80108f6d:	0f 01 10             	lgdtl  (%eax)
}
80108f70:	c9                   	leave
80108f71:	c3                   	ret
80108f72:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80108f79:	00 
80108f7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80108f80 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80108f80:	a1 84 79 11 80       	mov    0x80117984,%eax
80108f85:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80108f93:	57                   	push   %edi
80108f94:	56                   	push   %esi
80108f95:	53                   	push   %ebx
80108f96:	83 ec 1c             	sub    $0x1c,%esp
80108f99:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80108f9c:	85 f6                	test   %esi,%esi
80108f9e:	0f 84 cb 00 00 00    	je     8010906f <switchuvm+0xdf>
  if(p->kstack == 0)
80108fa4:	8b 46 08             	mov    0x8(%esi),%eax
80108fa7:	85 c0                	test   %eax,%eax
80108fa9:	0f 84 da 00 00 00    	je     80109089 <switchuvm+0xf9>
  if(p->pgdir == 0)
80108faf:	8b 46 04             	mov    0x4(%esi),%eax
80108fb2:	85 c0                	test   %eax,%eax
80108fb4:	0f 84 c2 00 00 00    	je     8010907c <switchuvm+0xec>
  pushcli();
80108fba:	e8 51 cf ff ff       	call   80105f10 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80108fbf:	e8 cc be ff ff       	call   80104e90 <mycpu>
80108fc4:	89 c3                	mov    %eax,%ebx
80108fc6:	e8 c5 be ff ff       	call   80104e90 <mycpu>
80108fcb:	89 c7                	mov    %eax,%edi
80108fcd:	e8 be be ff ff       	call   80104e90 <mycpu>
80108fd2:	83 c7 08             	add    $0x8,%edi
80108fd5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108fd8:	e8 b3 be ff ff       	call   80104e90 <mycpu>
80108fdd:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80108fe0:	ba 67 00 00 00       	mov    $0x67,%edx
80108fe5:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80108fec:	83 c0 08             	add    $0x8,%eax
80108fef:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80108ff6:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80108ffb:	83 c1 08             	add    $0x8,%ecx
80108ffe:	c1 e8 18             	shr    $0x18,%eax
80109001:	c1 e9 10             	shr    $0x10,%ecx
80109004:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
8010900a:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80109010:	b9 99 40 00 00       	mov    $0x4099,%ecx
80109015:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010901c:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80109021:	e8 6a be ff ff       	call   80104e90 <mycpu>
80109026:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010902d:	e8 5e be ff ff       	call   80104e90 <mycpu>
80109032:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80109036:	8b 5e 08             	mov    0x8(%esi),%ebx
80109039:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010903f:	e8 4c be ff ff       	call   80104e90 <mycpu>
80109044:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80109047:	e8 44 be ff ff       	call   80104e90 <mycpu>
8010904c:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80109050:	b8 28 00 00 00       	mov    $0x28,%eax
80109055:	0f 00 d8             	ltr    %eax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80109058:	8b 46 04             	mov    0x4(%esi),%eax
8010905b:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80109060:	0f 22 d8             	mov    %eax,%cr3
}
80109063:	8d 65 f4             	lea    -0xc(%ebp),%esp
80109066:	5b                   	pop    %ebx
80109067:	5e                   	pop    %esi
80109068:	5f                   	pop    %edi
80109069:	5d                   	pop    %ebp
  popcli();
8010906a:	e9 f1 ce ff ff       	jmp    80105f60 <popcli>
    panic("switchuvm: no process");
8010906f:	83 ec 0c             	sub    $0xc,%esp
80109072:	68 e5 9b 10 80       	push   $0x80109be5
80109077:	e8 d4 74 ff ff       	call   80100550 <panic>
    panic("switchuvm: no pgdir");
8010907c:	83 ec 0c             	sub    $0xc,%esp
8010907f:	68 10 9c 10 80       	push   $0x80109c10
80109084:	e8 c7 74 ff ff       	call   80100550 <panic>
    panic("switchuvm: no kstack");
80109089:	83 ec 0c             	sub    $0xc,%esp
8010908c:	68 fb 9b 10 80       	push   $0x80109bfb
80109091:	e8 ba 74 ff ff       	call   80100550 <panic>
80109096:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010909d:	00 
...
801090a3:	57                   	push   %edi
801090a4:	56                   	push   %esi
801090a5:	53                   	push   %ebx
801090a6:	83 ec 1c             	sub    $0x1c,%esp
801090a9:	8b 45 08             	mov    0x8(%ebp),%eax
801090ac:	8b 75 10             	mov    0x10(%ebp),%esi
801090af:	8b 7d 0c             	mov    0xc(%ebp),%edi
801090b2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
801090b5:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801090bb:	77 49                	ja     80109106 <inituvm+0x66>
  mem = kalloc();
801090bd:	e8 3e ab ff ff       	call   80103c00 <kalloc>
  memset(mem, 0, PGSIZE);
801090c2:	83 ec 04             	sub    $0x4,%esp
801090c5:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
801090ca:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801090cc:	6a 00                	push   $0x0
801090ce:	50                   	push   %eax
801090cf:	e8 fc d4 ff ff       	call   801065d0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801090d4:	58                   	pop    %eax
801090d5:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801090db:	5a                   	pop    %edx
801090dc:	6a 06                	push   $0x6
801090de:	b9 00 10 00 00       	mov    $0x1000,%ecx
801090e3:	31 d2                	xor    %edx,%edx
801090e5:	50                   	push   %eax
801090e6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801090e9:	e8 12 fd ff ff       	call   80108e00 <mappages>
  memmove(mem, init, sz);
801090ee:	83 c4 10             	add    $0x10,%esp
801090f1:	89 75 10             	mov    %esi,0x10(%ebp)
801090f4:	89 7d 0c             	mov    %edi,0xc(%ebp)
801090f7:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
801090fa:	8d 65 f4             	lea    -0xc(%ebp),%esp
801090fd:	5b                   	pop    %ebx
801090fe:	5e                   	pop    %esi
801090ff:	5f                   	pop    %edi
80109100:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80109101:	e9 5a d5 ff ff       	jmp    80106660 <memmove>
    panic("inituvm: more than a page");
80109106:	83 ec 0c             	sub    $0xc,%esp
80109109:	68 24 9c 10 80       	push   $0x80109c24
8010910e:	e8 3d 74 ff ff       	call   80100550 <panic>
80109113:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010911a:	00 
8010911b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

80109120 <loaduvm>:
{
80109120:	55                   	push   %ebp
80109121:	89 e5                	mov    %esp,%ebp
80109123:	57                   	push   %edi
80109124:	56                   	push   %esi
80109125:	53                   	push   %ebx
80109126:	83 ec 0c             	sub    $0xc,%esp
  if((uint) addr % PGSIZE != 0)
80109129:	8b 75 0c             	mov    0xc(%ebp),%esi
{
8010912c:	8b 7d 18             	mov    0x18(%ebp),%edi
  if((uint) addr % PGSIZE != 0)
8010912f:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80109135:	0f 85 a2 00 00 00    	jne    801091dd <loaduvm+0xbd>
  for(i = 0; i < sz; i += PGSIZE){
8010913b:	85 ff                	test   %edi,%edi
8010913d:	74 7d                	je     801091bc <loaduvm+0x9c>
8010913f:	90                   	nop
  pde = &pgdir[PDX(va)];
80109140:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80109143:	8b 55 08             	mov    0x8(%ebp),%edx
80109146:	01 f0                	add    %esi,%eax
  pde = &pgdir[PDX(va)];
80109148:	89 c1                	mov    %eax,%ecx
8010914a:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
8010914d:	8b 0c 8a             	mov    (%edx,%ecx,4),%ecx
80109150:	f6 c1 01             	test   $0x1,%cl
80109153:	75 13                	jne    80109168 <loaduvm+0x48>
      panic("loaduvm: address should exist");
80109155:	83 ec 0c             	sub    $0xc,%esp
80109158:	68 3e 9c 10 80       	push   $0x80109c3e
8010915d:	e8 ee 73 ff ff       	call   80100550 <panic>
80109162:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80109168:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010916b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80109171:	25 fc 0f 00 00       	and    $0xffc,%eax
80109176:	8d 8c 01 00 00 00 80 	lea    -0x80000000(%ecx,%eax,1),%ecx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010917d:	85 c9                	test   %ecx,%ecx
8010917f:	74 d4                	je     80109155 <loaduvm+0x35>
    if(sz - i < PGSIZE)
80109181:	89 fb                	mov    %edi,%ebx
80109183:	b8 00 10 00 00       	mov    $0x1000,%eax
80109188:	29 f3                	sub    %esi,%ebx
8010918a:	39 c3                	cmp    %eax,%ebx
8010918c:	0f 47 d8             	cmova  %eax,%ebx
    if(readi(ip, P2V(pa), offset+i, n) != n)
8010918f:	53                   	push   %ebx
80109190:	8b 45 14             	mov    0x14(%ebp),%eax
80109193:	01 f0                	add    %esi,%eax
80109195:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80109196:	8b 01                	mov    (%ecx),%eax
80109198:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
8010919d:	05 00 00 00 80       	add    $0x80000000,%eax
801091a2:	50                   	push   %eax
801091a3:	ff 75 10             	push   0x10(%ebp)
801091a6:	e8 a5 9e ff ff       	call   80103050 <readi>
801091ab:	83 c4 10             	add    $0x10,%esp
801091ae:	39 d8                	cmp    %ebx,%eax
801091b0:	75 1e                	jne    801091d0 <loaduvm+0xb0>
  for(i = 0; i < sz; i += PGSIZE){
801091b2:	81 c6 00 10 00 00    	add    $0x1000,%esi
801091b8:	39 fe                	cmp    %edi,%esi
801091ba:	72 84                	jb     80109140 <loaduvm+0x20>
}
801091bc:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
801091bf:	31 c0                	xor    %eax,%eax
}
801091c1:	5b                   	pop    %ebx
801091c2:	5e                   	pop    %esi
801091c3:	5f                   	pop    %edi
801091c4:	5d                   	pop    %ebp
801091c5:	c3                   	ret
801091c6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801091cd:	00 
801091ce:	66 90                	xchg   %ax,%ax
801091d0:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
801091d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
801091d8:	5b                   	pop    %ebx
801091d9:	5e                   	pop    %esi
801091da:	5f                   	pop    %edi
...
801091e0:	68 90 9f 10 80       	push   $0x80109f90
801091e5:	e8 66 73 ff ff       	call   80100550 <panic>
801091ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
801091f9:	8b 75 10             	mov    0x10(%ebp),%esi
  if(newsz >= KERNBASE)
801091fc:	85 f6                	test   %esi,%esi
801091fe:	0f 88 98 00 00 00    	js     8010929c <allocuvm+0xac>
80109204:	89 f2                	mov    %esi,%edx
  if(newsz < oldsz)
80109206:	3b 75 0c             	cmp    0xc(%ebp),%esi
80109209:	0f 82 a1 00 00 00    	jb     801092b0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
8010920f:	8b 45 0c             	mov    0xc(%ebp),%eax
80109212:	05 ff 0f 00 00       	add    $0xfff,%eax
80109217:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010921c:	89 c7                	mov    %eax,%edi
  for(; a < newsz; a += PGSIZE){
8010921e:	39 f0                	cmp    %esi,%eax
80109220:	0f 83 8d 00 00 00    	jae    801092b3 <allocuvm+0xc3>
80109226:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80109229:	eb 44                	jmp    8010926f <allocuvm+0x7f>
8010922b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    memset(mem, 0, PGSIZE);
80109230:	83 ec 04             	sub    $0x4,%esp
80109233:	68 00 10 00 00       	push   $0x1000
80109238:	6a 00                	push   $0x0
8010923a:	50                   	push   %eax
8010923b:	e8 90 d3 ff ff       	call   801065d0 <memset>
...
8010924f:	89 fa                	mov    %edi,%edx
80109251:	50                   	push   %eax
80109252:	8b 45 08             	mov    0x8(%ebp),%eax
80109255:	e8 a6 fb ff ff       	call   80108e00 <mappages>
8010925a:	83 c4 10             	add    $0x10,%esp
8010925d:	85 c0                	test   %eax,%eax
8010925f:	78 5f                	js     801092c0 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
80109261:	81 c7 00 10 00 00    	add    $0x1000,%edi
80109267:	39 f7                	cmp    %esi,%edi
80109269:	0f 83 89 00 00 00    	jae    801092f8 <allocuvm+0x108>
    mem = kalloc();
8010926f:	e8 8c a9 ff ff       	call   80103c00 <kalloc>
80109274:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80109276:	85 c0                	test   %eax,%eax
80109278:	75 b6                	jne    80109230 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
8010927a:	83 ec 0c             	sub    $0xc,%esp
8010927d:	68 5c 9c 10 80       	push   $0x80109c5c
80109282:	e8 d9 7a ff ff       	call   80100d60 <cprintf>
  if(newsz >= oldsz)
80109287:	83 c4 10             	add    $0x10,%esp
8010928a:	3b 75 0c             	cmp    0xc(%ebp),%esi
8010928d:	74 0d                	je     8010929c <allocuvm+0xac>
8010928f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80109292:	8b 45 08             	mov    0x8(%ebp),%eax
80109295:	89 f2                	mov    %esi,%edx
80109297:	e8 a4 fa ff ff       	call   80108d40 <deallocuvm.part.0>
    return 0;
8010929c:	31 d2                	xor    %edx,%edx
}
8010929e:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
801092a6:	5d                   	pop    %ebp
801092a7:	c3                   	ret
801092a8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801092af:	00 
    return oldsz;
801092b0:	8b 55 0c             	mov    0xc(%ebp),%edx
}
801092b3:	8d 65 f4             	lea    -0xc(%ebp),%esp
801092b6:	89 d0                	mov    %edx,%eax
801092b8:	5b                   	pop    %ebx
801092b9:	5e                   	pop    %esi
801092ba:	5f                   	pop    %edi
801092bb:	5d                   	pop    %ebp
801092bc:	c3                   	ret
801092bd:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("allocuvm out of memory (2)\n");
801092c0:	83 ec 0c             	sub    $0xc,%esp
801092c3:	68 74 9c 10 80       	push   $0x80109c74
801092c8:	e8 93 7a ff ff       	call   80100d60 <cprintf>
  if(newsz >= oldsz)
801092cd:	83 c4 10             	add    $0x10,%esp
801092d0:	3b 75 0c             	cmp    0xc(%ebp),%esi
801092d3:	74 0d                	je     801092e2 <allocuvm+0xf2>
801092d5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801092d8:	8b 45 08             	mov    0x8(%ebp),%eax
801092db:	89 f2                	mov    %esi,%edx
801092dd:	e8 5e fa ff ff       	call   80108d40 <deallocuvm.part.0>
      kfree(mem);
801092e2:	83 ec 0c             	sub    $0xc,%esp
801092e5:	53                   	push   %ebx
801092e6:	e8 55 a7 ff ff       	call   80103a40 <kfree>
      return 0;
801092eb:	83 c4 10             	add    $0x10,%esp
    return 0;
801092ee:	31 d2                	xor    %edx,%edx
801092f0:	eb ac                	jmp    8010929e <allocuvm+0xae>
801092f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801092f8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
}
801092fb:	8d 65 f4             	lea    -0xc(%ebp),%esp
801092fe:	5b                   	pop    %ebx
801092ff:	5e                   	pop    %esi
...
80109303:	5d                   	pop    %ebp
80109304:	c3                   	ret
80109305:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010930c:	00 
8010930d:	8d 76 00             	lea    0x0(%esi),%esi

80109310 <deallocuvm>:
{
80109310:	55                   	push   %ebp
80109311:	89 e5                	mov    %esp,%ebp
80109313:	8b 55 0c             	mov    0xc(%ebp),%edx
80109316:	8b 4d 10             	mov    0x10(%ebp),%ecx
80109319:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
8010931c:	39 d1                	cmp    %edx,%ecx
8010931e:	73 10                	jae    80109330 <deallocuvm+0x20>
}
80109320:	5d                   	pop    %ebp
80109321:	e9 1a fa ff ff       	jmp    80108d40 <deallocuvm.part.0>
80109326:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010932d:	00 
8010932e:	66 90                	xchg   %ax,%ax
80109330:	89 d0                	mov    %edx,%eax
80109332:	5d                   	pop    %ebp
80109333:	c3                   	ret
80109334:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010933b:	00 
8010933c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80109343:	57                   	push   %edi
80109344:	56                   	push   %esi
80109345:	53                   	push   %ebx
80109346:	83 ec 0c             	sub    $0xc,%esp
80109349:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010934c:	85 f6                	test   %esi,%esi
8010934e:	74 59                	je     801093a9 <freevm+0x69>
  if(newsz >= oldsz)
80109350:	31 c9                	xor    %ecx,%ecx
80109352:	ba 00 00 00 80       	mov    $0x80000000,%edx
80109357:	89 f0                	mov    %esi,%eax
80109359:	89 f3                	mov    %esi,%ebx
8010935b:	e8 e0 f9 ff ff       	call   80108d40 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80109360:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80109366:	eb 0f                	jmp    80109377 <freevm+0x37>
80109368:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010936f:	00 
80109370:	83 c3 04             	add    $0x4,%ebx
80109373:	39 fb                	cmp    %edi,%ebx
80109375:	74 23                	je     8010939a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80109377:	8b 03                	mov    (%ebx),%eax
80109379:	a8 01                	test   $0x1,%al
8010937b:	74 f3                	je     80109370 <freevm+0x30>
      char * v = P2V(PTE_ADDR(pgdir[i]));
8010937d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
      kfree(v);
80109382:	83 ec 0c             	sub    $0xc,%esp
  for(i = 0; i < NPDENTRIES; i++){
80109385:	83 c3 04             	add    $0x4,%ebx
      char * v = P2V(PTE_ADDR(pgdir[i]));
80109388:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010938d:	50                   	push   %eax
8010938e:	e8 ad a6 ff ff       	call   80103a40 <kfree>
80109393:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
80109396:	39 fb                	cmp    %edi,%ebx
80109398:	75 dd                	jne    80109377 <freevm+0x37>
    }
  }
  kfree((char*)pgdir);
8010939a:	89 75 08             	mov    %esi,0x8(%ebp)
}
8010939d:	8d 65 f4             	lea    -0xc(%ebp),%esp
801093a0:	5b                   	pop    %ebx
801093a1:	5e                   	pop    %esi
801093a2:	5f                   	pop    %edi
801093a3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801093a4:	e9 97 a6 ff ff       	jmp    80103a40 <kfree>
    panic("freevm: no pgdir");
801093a9:	83 ec 0c             	sub    $0xc,%esp
801093ac:	68 90 9c 10 80       	push   $0x80109c90
801093b1:	e8 9a 71 ff ff       	call   80100550 <panic>
801093b6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801093bd:	00 
801093be:	66 90                	xchg   %ax,%ax

801093c0 <setupkvm>:
{
801093c0:	55                   	push   %ebp
801093c1:	89 e5                	mov    %esp,%ebp
801093c3:	56                   	push   %esi
801093c4:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
801093c5:	e8 36 a8 ff ff       	call   80103c00 <kalloc>
801093ca:	85 c0                	test   %eax,%eax
801093cc:	74 5e                	je     8010942c <setupkvm+0x6c>
  memset(pgdir, 0, PGSIZE);
801093ce:	83 ec 04             	sub    $0x4,%esp
801093d1:	89 c6                	mov    %eax,%esi
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801093d3:	bb 20 d4 10 80       	mov    $0x8010d420,%ebx
  memset(pgdir, 0, PGSIZE);
801093d8:	68 00 10 00 00       	push   $0x1000
801093dd:	6a 00                	push   $0x0
801093df:	50                   	push   %eax
801093e0:	e8 eb d1 ff ff       	call   801065d0 <memset>
801093e5:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
801093e8:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801093eb:	83 ec 08             	sub    $0x8,%esp
801093ee:	8b 4b 08             	mov    0x8(%ebx),%ecx
801093f1:	8b 13                	mov    (%ebx),%edx
801093f3:	ff 73 0c             	push   0xc(%ebx)
801093f6:	50                   	push   %eax
801093f7:	29 c1                	sub    %eax,%ecx
801093f9:	89 f0                	mov    %esi,%eax
801093fb:	e8 00 fa ff ff       	call   80108e00 <mappages>
80109400:	83 c4 10             	add    $0x10,%esp
80109403:	85 c0                	test   %eax,%eax
80109405:	78 19                	js     80109420 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80109407:	83 c3 10             	add    $0x10,%ebx
8010940a:	81 fb 60 d4 10 80    	cmp    $0x8010d460,%ebx
80109410:	75 d6                	jne    801093e8 <setupkvm+0x28>
}
80109412:	8d 65 f8             	lea    -0x8(%ebp),%esp
80109415:	89 f0                	mov    %esi,%eax
80109417:	5b                   	pop    %ebx
80109418:	5e                   	pop    %esi
80109419:	5d                   	pop    %ebp
8010941a:	c3                   	ret
8010941b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      freevm(pgdir);
80109420:	83 ec 0c             	sub    $0xc,%esp
80109423:	56                   	push   %esi
80109424:	e8 17 ff ff ff       	call   80109340 <freevm>
      return 0;
80109429:	83 c4 10             	add    $0x10,%esp
}
8010942c:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return 0;
8010942f:	31 f6                	xor    %esi,%esi
}
80109431:	89 f0                	mov    %esi,%eax
80109433:	5b                   	pop    %ebx
80109434:	5e                   	pop    %esi
80109435:	5d                   	pop    %ebp
80109436:	c3                   	ret
80109437:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010943e:	00 
8010943f:	90                   	nop

80109440 <kvmalloc>:
{
80109440:	55                   	push   %ebp
80109441:	89 e5                	mov    %esp,%ebp
80109443:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80109446:	e8 75 ff ff ff       	call   801093c0 <setupkvm>
8010944b:	a3 84 79 11 80       	mov    %eax,0x80117984
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80109450:	05 00 00 00 80       	add    $0x80000000,%eax
...
80109463:	83 ec 08             	sub    $0x8,%esp
80109466:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80109469:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
8010946c:	89 c1                	mov    %eax,%ecx
8010946e:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80109471:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80109474:	f6 c2 01             	test   $0x1,%dl
80109477:	75 17                	jne    80109490 <clearpteu+0x30>
  pte_t *pte;
...
8010947c:	68 a1 9c 10 80       	push   $0x80109ca1
80109481:	e8 ca 70 ff ff       	call   80100550 <panic>
80109486:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010948d:	00 
8010948e:	66 90                	xchg   %ax,%ax
  return &pgtab[PTX(va)];
80109490:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80109493:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80109499:	25 fc 0f 00 00       	and    $0xffc,%eax
8010949e:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
  if(pte == 0)
801094a5:	85 c0                	test   %eax,%eax
801094a7:	74 d0                	je     80109479 <clearpteu+0x19>
  *pte &= ~PTE_U;
801094a9:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801094ac:	c9                   	leave
801094ad:	c3                   	ret
801094ae:	66 90                	xchg   %ax,%ax
...
801094b3:	57                   	push   %edi
801094b4:	56                   	push   %esi
801094b5:	53                   	push   %ebx
801094b6:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801094b9:	e8 02 ff ff ff       	call   801093c0 <setupkvm>
801094be:	89 45 e0             	mov    %eax,-0x20(%ebp)
801094c1:	85 c0                	test   %eax,%eax
801094c3:	0f 84 e9 00 00 00    	je     801095b2 <copyuvm+0x102>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801094c9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801094cc:	85 c9                	test   %ecx,%ecx
801094ce:	0f 84 b2 00 00 00    	je     80109586 <copyuvm+0xd6>
801094d4:	31 f6                	xor    %esi,%esi
801094d6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801094dd:	00 
801094de:	66 90                	xchg   %ax,%ax
  if(*pde & PTE_P){
801094e0:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pde = &pgdir[PDX(va)];
801094e3:	89 f0                	mov    %esi,%eax
801094e5:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801094e8:	8b 04 81             	mov    (%ecx,%eax,4),%eax
801094eb:	a8 01                	test   $0x1,%al
801094ed:	75 11                	jne    80109500 <copyuvm+0x50>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
801094ef:	83 ec 0c             	sub    $0xc,%esp
801094f2:	68 ab 9c 10 80       	push   $0x80109cab
801094f7:	e8 54 70 ff ff       	call   80100550 <panic>
801094fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  return &pgtab[PTX(va)];
80109500:	89 f2                	mov    %esi,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80109502:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80109507:	c1 ea 0a             	shr    $0xa,%edx
8010950a:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80109510:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80109517:	85 c0                	test   %eax,%eax
80109519:	74 d4                	je     801094ef <copyuvm+0x3f>
    if(!(*pte & PTE_P))
8010951b:	8b 00                	mov    (%eax),%eax
8010951d:	a8 01                	test   $0x1,%al
8010951f:	0f 84 9f 00 00 00    	je     801095c4 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80109525:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80109527:	25 ff 0f 00 00       	and    $0xfff,%eax
8010952c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
8010952f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80109535:	e8 c6 a6 ff ff       	call   80103c00 <kalloc>
8010953a:	89 c3                	mov    %eax,%ebx
8010953c:	85 c0                	test   %eax,%eax
8010953e:	74 64                	je     801095a4 <copyuvm+0xf4>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80109540:	83 ec 04             	sub    $0x4,%esp
80109543:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80109549:	68 00 10 00 00       	push   $0x1000
8010954e:	57                   	push   %edi
8010954f:	50                   	push   %eax
80109550:	e8 0b d1 ff ff       	call   80106660 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80109555:	58                   	pop    %eax
80109556:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010955c:	5a                   	pop    %edx
8010955d:	ff 75 e4             	push   -0x1c(%ebp)
80109560:	b9 00 10 00 00       	mov    $0x1000,%ecx
80109565:	89 f2                	mov    %esi,%edx
80109567:	50                   	push   %eax
80109568:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010956b:	e8 90 f8 ff ff       	call   80108e00 <mappages>
80109570:	83 c4 10             	add    $0x10,%esp
80109573:	85 c0                	test   %eax,%eax
80109575:	78 21                	js     80109598 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
80109577:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010957d:	3b 75 0c             	cmp    0xc(%ebp),%esi
80109580:	0f 82 5a ff ff ff    	jb     801094e0 <copyuvm+0x30>
  return d;
...
80109586:	8b 45 e0             	mov    -0x20(%ebp),%eax
80109589:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010958c:	5b                   	pop    %ebx
8010958d:	5e                   	pop    %esi
8010958e:	5f                   	pop    %edi
8010958f:	5d                   	pop    %ebp
80109590:	c3                   	ret
80109591:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80109598:	83 ec 0c             	sub    $0xc,%esp
8010959b:	53                   	push   %ebx
8010959c:	e8 9f a4 ff ff       	call   80103a40 <kfree>
      goto bad;
801095a1:	83 c4 10             	add    $0x10,%esp
  freevm(d);
801095a4:	83 ec 0c             	sub    $0xc,%esp
801095a7:	ff 75 e0             	push   -0x20(%ebp)
801095aa:	e8 91 fd ff ff       	call   80109340 <freevm>
  return 0;
801095af:	83 c4 10             	add    $0x10,%esp
    return 0;
801095b2:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
801095b9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801095bc:	8d 65 f4             	lea    -0xc(%ebp),%esp
801095bf:	5b                   	pop    %ebx
801095c0:	5e                   	pop    %esi
801095c1:	5f                   	pop    %edi
801095c2:	5d                   	pop    %ebp
...
801095c7:	68 c5 9c 10 80       	push   $0x80109cc5
801095cc:	e8 7f 6f ff ff       	call   80100550 <panic>
801095d1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801095d8:	00 
801095d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801095e3:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
801095e6:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
801095e9:	89 c1                	mov    %eax,%ecx
801095eb:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
801095ee:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
801095f1:	f6 c2 01             	test   $0x1,%dl
801095f4:	0f 84 f8 00 00 00    	je     801096f2 <uva2ka.cold>
  return &pgtab[PTX(va)];
801095fa:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801095fd:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
80109603:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
80109604:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80109609:	8b 94 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%edx
  return (char*)P2V(PTE_ADDR(*pte));
80109610:	89 d0                	mov    %edx,%eax
80109612:	f7 d2                	not    %edx
80109614:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80109619:	05 00 00 00 80       	add    $0x80000000,%eax
8010961e:	83 e2 05             	and    $0x5,%edx
80109621:	ba 00 00 00 00       	mov    $0x0,%edx
80109626:	0f 45 c2             	cmovne %edx,%eax
}
80109629:	c3                   	ret
8010962a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
{
80109630:	55                   	push   %ebp
80109631:	89 e5                	mov    %esp,%ebp
80109633:	57                   	push   %edi
80109634:	56                   	push   %esi
80109635:	53                   	push   %ebx
80109636:	83 ec 0c             	sub    $0xc,%esp
80109639:	8b 75 14             	mov    0x14(%ebp),%esi
8010963c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010963f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80109642:	85 f6                	test   %esi,%esi
80109644:	75 51                	jne    80109697 <copyout+0x67>
80109646:	e9 9d 00 00 00       	jmp    801096e8 <copyout+0xb8>
8010964b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  return (char*)P2V(PTE_ADDR(*pte));
80109650:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80109656:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
8010965c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80109662:	74 74                	je     801096d8 <copyout+0xa8>
      return -1;
    n = PGSIZE - (va - va0);
80109664:	89 fb                	mov    %edi,%ebx
80109666:	29 c3                	sub    %eax,%ebx
80109668:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010966e:	39 f3                	cmp    %esi,%ebx
80109670:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80109673:	29 f8                	sub    %edi,%eax
80109675:	83 ec 04             	sub    $0x4,%esp
80109678:	01 c1                	add    %eax,%ecx
8010967a:	53                   	push   %ebx
8010967b:	52                   	push   %edx
8010967c:	89 55 10             	mov    %edx,0x10(%ebp)
8010967f:	51                   	push   %ecx
80109680:	e8 db cf ff ff       	call   80106660 <memmove>
    len -= n;
    buf += n;
80109685:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
80109688:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
8010968e:	83 c4 10             	add    $0x10,%esp
    buf += n;
80109691:	01 da                	add    %ebx,%edx
  while(len > 0){
80109693:	29 de                	sub    %ebx,%esi
80109695:	74 51                	je     801096e8 <copyout+0xb8>
  if(*pde & PTE_P){
80109697:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
8010969a:	89 c1                	mov    %eax,%ecx
    va0 = (uint)PGROUNDDOWN(va);
8010969c:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
8010969e:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
801096a1:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
801096a7:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
801096aa:	f6 c1 01             	test   $0x1,%cl
801096ad:	0f 84 46 00 00 00    	je     801096f9 <copyout.cold>
  return &pgtab[PTX(va)];
801096b3:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801096b5:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
801096bb:	c1 eb 0c             	shr    $0xc,%ebx
801096be:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
801096c4:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
801096cb:	89 d9                	mov    %ebx,%ecx
801096cd:	f7 d1                	not    %ecx
801096cf:	83 e1 05             	and    $0x5,%ecx
801096d2:	0f 84 78 ff ff ff    	je     80109650 <copyout+0x20>
  }
  return 0;
}
801096d8:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
801096db:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
801096e0:	5b                   	pop    %ebx
801096e1:	5e                   	pop    %esi
801096e2:	5f                   	pop    %edi
801096e3:	5d                   	pop    %ebp
801096e4:	c3                   	ret
801096e5:	8d 76 00             	lea    0x0(%esi),%esi
801096e8:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
801096eb:	31 c0                	xor    %eax,%eax
}
801096ed:	5b                   	pop    %ebx
801096ee:	5e                   	pop    %esi
801096ef:	5f                   	pop    %edi
...
801096f2 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801096f2:	a1 00 00 00 00       	mov    0x0,%eax
801096f7:	0f 0b                	ud2

801096f9 <copyout.cold>:
801096f9:	a1 00 00 00 00       	mov    0x0,%eax
801096fe:	0f 0b                	ud2
