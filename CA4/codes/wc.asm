 ...
 4e8:	89 d1                	mov    %edx,%ecx
{
 ...
 556:	50                   	push   %eax
 557:	56                   	push   %esi
 558:	e8 96 fe ff ff       	call   3f3 <write>
  while(--i >= 0)
 ...
 589:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5c0:	50                   	push   %eax
 5c1:	57                   	push   %edi
 5c2:	e8 2c fe ff ff       	call   3f3 <write>
 ...
 631:	52                   	push   %edx
 632:	57                   	push   %edi
 633:	e8 bb fd ff ff       	call   3f3 <write>
        putc(fd, c);
...
free(void *ap)
{
 ...
 711:	a1 00 0e 00 00       	mov    0xe00,%eax
{
 ...
 74f:	5b                   	pop    %ebx
  freep = p;
 750:	a3 00 0e 00 00       	mov    %eax,0xe00
}
 755:	5e                   	pop    %esi
 756:	5f                   	pop    %edi
 757:	5d                   	pop    %ebp
 ...
 766:	72 ce                	jb     736 <free+0x26>
{
 ...
 787:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 78a:	a3 00 0e 00 00       	mov    %eax,0xe00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 15 00 0e 00 00    	mov    0xe00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7eb:	3b 05 00 0e 00 00    	cmp    0xe00,%eax
 7f1:	75 ed                	jne    7e0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 7f3:	83 ec 0c             	sub    $0xc,%esp
 7f6:	56                   	push   %esi
 7f7:	e8 5f fc ff ff       	call   45b <sbrk>
  if(p == (char*)-1)
 ...
 80e:	e8 fd fe ff ff       	call   710 <free>
  return freep;
 813:	8b 15 00 0e 00 00    	mov    0xe00,%edx
 ...
 83c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 83f:	89 15 00 0e 00 00    	mov    %edx,0xe00
}
 ...
 84f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 00 0e 00 00 04 	movl   $0xe04,0xe00
 857:	0e 00 00 
    base.s.size = 0;
 85a:	b8 04 0e 00 00       	mov    $0xe04,%eax
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 04 0e 00 00 04 	movl   $0xe04,0xe04
 866:	0e 00 00 
    base.s.size = 0;
 869:	c7 05 08 0e 00 00 00 	movl   $0x0,0xe08
 870:	00 00 00 
    if(p->s.size >= nunits){
