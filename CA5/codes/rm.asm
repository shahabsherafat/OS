 ...
 418:	89 d1                	mov    %edx,%ecx
{
 ...
 44b:	0f b6 92 44 08 00 00 	movzbl 0x844(%edx),%edx
 ...
 4b9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 524:	ff 24 85 ec 07 00 00 	jmp    *0x7ec(,%eax,4)
 ...
 630:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 635:	bb e5 07 00 00       	mov    $0x7e5,%ebx
 ...
 641:	a1 f0 0a 00 00       	mov    0xaf0,%eax
{
 ...
 67f:	5b                   	pop    %ebx
  freep = p;
 680:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 687:	5d                   	pop    %ebp
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 f0 0a 00 00       	mov    %eax,0xaf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71b:	3b 05 f0 0a 00 00    	cmp    0xaf0,%eax
 ...
 73e:	e8 fd fe ff ff       	call   640 <free>
  return freep;
 743:	8b 15 f0 0a 00 00    	mov    0xaf0,%edx
 ...
 787:	0a 00 00 
    base.s.size = 0;
 78a:	b8 f4 0a 00 00       	mov    $0xaf4,%eax
    base.s.ptr = freep = prevp = &base;
