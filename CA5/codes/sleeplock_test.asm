...
_sleeplock_test:     file format elf32-i386
...
main(void)
{
  ...
  sleeplock_hold();
  1d:	e8 79 03 00 00       	call   39b <sleeplock_hold>
  ...
  2c:	78 37                	js     65 <main+0x65>
    printf(1, "locktest: fork failed\n");
    exit();
  }

  if(pid == 0){
  2e:	75 26                	jne    56 <main+0x56>
  ...
  30:	50                   	push   %eax
  31:	50                   	push   %eax
  32:	68 dc 07 00 00       	push   $0x7dc
  37:	6a 01                	push   $0x1
  39:	e8 72 04 00 00       	call   4b0 <printf>
    sleeplock_drop();
  3e:	e8 60 03 00 00       	call   3a3 <sleeplock_drop>

    // If execution reaches here, the lock ownership check failed.
    printf(1, "locktest: ERROR: child returned (panic expected)\n");
  43:	5a                   	pop    %edx
  44:	59                   	pop    %ecx
  45:	68 0c 08 00 00       	push   $0x80c
  4a:	6a 01                	push   $0x1
  4c:	e8 5f 04 00 00       	call   4b0 <printf>
    exit();
  51:	e8 7d 02 00 00       	call   2d3 <exit>
  }
  ...
  sleeplock_drop();
  5b:	e8 43 03 00 00       	call   3a3 <sleeplock_drop>
 ...
 418:	89 d1                	mov    %edx,%ecx
{
 ...
 44b:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
 ...
 4b9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 524:	ff 24 85 5c 08 00 00 	jmp    *0x85c(,%eax,4)
 ...
 630:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 635:	bb 55 08 00 00       	mov    $0x855,%ebx
 ...
 641:	a1 50 0b 00 00       	mov    0xb50,%eax
{
 ...
 67f:	5b                   	pop    %ebx
  freep = p;
 680:	a3 50 0b 00 00       	mov    %eax,0xb50
}
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 687:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 71b:	3b 05 50 0b 00 00    	cmp    0xb50,%eax
 ...
 73e:	e8 fd fe ff ff       	call   640 <free>
  return freep;
 743:	8b 15 50 0b 00 00    	mov    0xb50,%edx
 ...
 787:	0b 00 00 
    base.s.size = 0;
 78a:	b8 54 0b 00 00       	mov    $0xb54,%eax
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 54 0b 00 00 54 	movl   $0xb54,0xb54
 796:	0b 00 00 
    base.s.size = 0;
 799:	c7 05 58 0b 00 00 00 	movl   $0x0,0xb58
 7a0:	00 00 00 
    if(p->s.size >= nunits){
