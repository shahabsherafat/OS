...
main(void)
{
  ...
  43:	5a                   	pop    %edx
  44:	59                   	pop    %ecx
  45:	68 ec 07 00 00       	push   $0x7ec
  4a:	6a 01                	push   $0x1
  4c:	e8 3f 04 00 00       	call   490 <printf>
    exit();
 ...
 499:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 504:	ff 24 85 3c 08 00 00 	jmp    *0x83c(,%eax,4)
 ...
 610:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 615:	bb 35 08 00 00       	mov    $0x835,%ebx
