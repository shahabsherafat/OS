...
//    printf(fd, "%d\n", i);
  ...
  c8:	58                   	pop    %eax
  c9:	5a                   	pop    %edx
  ca:	68 55 08 00 00       	push   $0x855
  cf:	6a 01                	push   $0x1
  d1:	e8 5a 04 00 00       	call   530 <printf>
 ...
 498:	89 d1                	mov    %edx,%ecx
{
 ...
 4cb:	0f b6 92 bc 08 00 00 	movzbl 0x8bc(%edx),%edx
 ...
 506:	50                   	push   %eax
 507:	56                   	push   %esi
 508:	e8 86 fe ff ff       	call   393 <write>
  while(--i >= 0)
 ...
 539:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 570:	50                   	push   %eax
 571:	57                   	push   %edi
 572:	e8 1c fe ff ff       	call   393 <write>
 ...
 5a4:	ff 24 85 64 08 00 00 	jmp    *0x864(,%eax,4)
 ...
 5d0:	57                   	push   %edi
 5d1:	e8 bd fd ff ff       	call   393 <write>
 ...
 5e1:	52                   	push   %edx
 5e2:	57                   	push   %edi
 5e3:	e8 ab fd ff ff       	call   393 <write>
        putc(fd, c);
 ...
 64b:	53                   	push   %ebx
 64c:	57                   	push   %edi
 64d:	e8 41 fd ff ff       	call   393 <write>
        while(*s != 0){
 ...
 68a:	52                   	push   %edx
 68b:	57                   	push   %edi
 68c:	e8 02 fd ff ff       	call   393 <write>
        ap++;
 ...
 6b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6b5:	bb 5b 08 00 00       	mov    $0x85b,%ebx
...
free(void *ap)
{
 ...
 6c1:	a1 68 0b 00 00       	mov    0xb68,%eax
{
 ...
 6ff:	5b                   	pop    %ebx
  freep = p;
 700:	a3 68 0b 00 00       	mov    %eax,0xb68
}
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
 707:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 68 0b 00 00    	mov    0xb68,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79b:	3b 05 68 0b 00 00    	cmp    0xb68,%eax
 7a1:	75 ed                	jne    790 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 7a3:	83 ec 0c             	sub    $0xc,%esp
 7a6:	56                   	push   %esi
 7a7:	e8 4f fc ff ff       	call   3fb <sbrk>
  if(p == (char*)-1)
 ...
 7be:	e8 fd fe ff ff       	call   6c0 <free>
  return freep;
 7c3:	8b 15 68 0b 00 00    	mov    0xb68,%edx
 ...
 7ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 68 0b 00 00    	mov    %edx,0xb68
}
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 6c 0b 00 00       	mov    $0xb6c,%eax
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 6c 0b 00 00 6c 	movl   $0xb6c,0xb6c
 816:	0b 00 00 
    base.s.size = 0;
 819:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 820:	00 00 00 
    if(p->s.size >= nunits){
