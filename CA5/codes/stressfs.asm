...
SYSCALL(vread)
 483:	b8 24 00 00 00       	mov    $0x24,%eax
 488:	cd 40                	int    $0x40
 48a:	c3                   	ret

0000048b <vwrite>:
SYSCALL(vwrite)
 48b:	b8 25 00 00 00       	mov    $0x25,%eax
 490:	cd 40                	int    $0x40
 492:	c3                   	ret

00000493 <cptsetpolicy>:
SYSCALL(cptsetpolicy)
 493:	b8 26 00 00 00       	mov    $0x26,%eax
 498:	cd 40                	int    $0x40
 49a:	c3                   	ret

0000049b <cptresetstats>:
SYSCALL(cptresetstats)
 49b:	b8 27 00 00 00       	mov    $0x27,%eax
 4a0:	cd 40                	int    $0x40
 4a2:	c3                   	ret

000004a3 <cptgetstats>:
SYSCALL(cptgetstats)
 4a3:	b8 28 00 00 00       	mov    $0x28,%eax
 4a8:	cd 40                	int    $0x40
 4aa:	c3                   	ret
 ...
 4b8:	89 d1                	mov    %edx,%ecx
{
 ...
 4eb:	0f b6 92 dc 08 00 00 	movzbl 0x8dc(%edx),%edx
 ...
 526:	50                   	push   %eax
 527:	56                   	push   %esi
 528:	e8 66 fe ff ff       	call   393 <write>
  while(--i >= 0)
 ...
 559:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5c4:	ff 24 85 84 08 00 00 	jmp    *0x884(,%eax,4)
 ...
 5f0:	57                   	push   %edi
 5f1:	e8 9d fd ff ff       	call   393 <write>
 ...
 601:	52                   	push   %edx
 602:	57                   	push   %edi
 603:	e8 8b fd ff ff       	call   393 <write>
        putc(fd, c);
 ...
 6aa:	52                   	push   %edx
 6ab:	57                   	push   %edi
 6ac:	e8 e2 fc ff ff       	call   393 <write>
        ap++;
 ...
 6d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6d5:	bb 7b 08 00 00       	mov    $0x87b,%ebx
 ...
 6e1:	a1 88 0b 00 00       	mov    0xb88,%eax
{
 ...
 71f:	5b                   	pop    %ebx
  freep = p;
 720:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 725:	5e                   	pop    %esi
 726:	5f                   	pop    %edi
 727:	5d                   	pop    %ebp
 ...
 736:	72 ce                	jb     706 <free+0x26>
{
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 88 0b 00 00       	mov    %eax,0xb88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 88 0b 00 00    	mov    0xb88,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bb:	3b 05 88 0b 00 00    	cmp    0xb88,%eax
 7c1:	75 ed                	jne    7b0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 7c3:	83 ec 0c             	sub    $0xc,%esp
 7c6:	56                   	push   %esi
 7c7:	e8 2f fc ff ff       	call   3fb <sbrk>
  if(p == (char*)-1)
 ...
 7de:	e8 fd fe ff ff       	call   6e0 <free>
  return freep;
 7e3:	8b 15 88 0b 00 00    	mov    0xb88,%edx
 ...
 80c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 80f:	89 15 88 0b 00 00    	mov    %edx,0xb88
}
 ...
 81f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 827:	0b 00 00 
    base.s.size = 0;
 82a:	b8 8c 0b 00 00       	mov    $0xb8c,%eax
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 836:	0b 00 00 
    base.s.size = 0;
 839:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 840:	00 00 00 
    if(p->s.size >= nunits){
