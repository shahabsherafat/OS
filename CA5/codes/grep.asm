...
000006fb <getlockstat>:

SYSCALL(getlockstat)
 6fb:	b8 23 00 00 00       	mov    $0x23,%eax
 700:	cd 40                	int    $0x40
 702:	c3                   	ret
...
SYSCALL(vread)
 703:	b8 24 00 00 00       	mov    $0x24,%eax
 708:	cd 40                	int    $0x40
 70a:	c3                   	ret

0000070b <vwrite>:
SYSCALL(vwrite)
 70b:	b8 25 00 00 00       	mov    $0x25,%eax
 710:	cd 40                	int    $0x40
 712:	c3                   	ret

00000713 <cptsetpolicy>:
SYSCALL(cptsetpolicy)
 713:	b8 26 00 00 00       	mov    $0x26,%eax
 718:	cd 40                	int    $0x40
 71a:	c3                   	ret

0000071b <cptresetstats>:
SYSCALL(cptresetstats)
 71b:	b8 27 00 00 00       	mov    $0x27,%eax
 720:	cd 40                	int    $0x40
 722:	c3                   	ret

00000723 <cptgetstats>:
SYSCALL(cptgetstats)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 736:	89 cb                	mov    %ecx,%ebx
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
 738:	89 d1                	mov    %edx,%ecx
{
 73a:	83 ec 3c             	sub    $0x3c,%esp
 73d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
 740:	85 d2                	test   %edx,%edx
 742:	0f 89 80 00 00 00    	jns    7c8 <printint+0x98>
 748:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
 74c:	74 7a                	je     7c8 <printint+0x98>
    x = -xx;
 74e:	f7 d9                	neg    %ecx
    neg = 1;
 ...
 76b:	0f b6 92 70 0b 00 00 	movzbl 0xb70(%edx),%edx
 772:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
 776:	89 ca                	mov    %ecx,%edx
 778:	89 c1                	mov    %eax,%ecx
 77a:	39 da                	cmp    %ebx,%edx
 77c:	73 e2                	jae    760 <printint+0x30>
  if(neg)
 77e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 781:	85 c0                	test   %eax,%eax
 783:	74 07                	je     78c <printint+0x5c>
    buf[i++] = '-';
 ...
 78f:	8b 75 c0             	mov    -0x40(%ebp),%esi
 792:	01 df                	add    %ebx,%edi
 794:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
 798:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
 79b:	83 ec 04             	sub    $0x4,%esp
 79e:	88 45 d7             	mov    %al,-0x29(%ebp)
 7a1:	8d 45 d7             	lea    -0x29(%ebp),%eax
 7a4:	6a 01                	push   $0x1
 7a6:	50                   	push   %eax
 7a7:	56                   	push   %esi
 7a8:	e8 66 fe ff ff       	call   613 <write>
  while(--i >= 0)
 7ad:	89 f8                	mov    %edi,%eax
 7af:	83 c4 10             	add    $0x10,%esp
 7b2:	83 ef 01             	sub    $0x1,%edi
 7b5:	39 c3                	cmp    %eax,%ebx
 7b7:	75 df                	jne    798 <printint+0x68>
}
 ...
 7ca:	eb 89                	jmp    755 <printint+0x25>
 ...
 7d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 7dc:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
 7df:	0f b6 1e             	movzbl (%esi),%ebx
 7e2:	83 c6 01             	add    $0x1,%esi
 7e5:	84 db                	test   %bl,%bl
 7e7:	74 67                	je     850 <printf+0x80>
 7e9:	8d 4d 10             	lea    0x10(%ebp),%ecx
 7ec:	31 d2                	xor    %edx,%edx
 7ee:	89 4d d0             	mov    %ecx,-0x30(%ebp)
 7f1:	eb 34                	jmp    827 <printf+0x57>
 7f3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
 7f8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
 7fb:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
 800:	83 f8 25             	cmp    $0x25,%eax
 803:	74 18                	je     81d <printf+0x4d>
  write(fd, &c, 1);
 805:	83 ec 04             	sub    $0x4,%esp
 808:	8d 45 e7             	lea    -0x19(%ebp),%eax
 80b:	88 5d e7             	mov    %bl,-0x19(%ebp)
 80e:	6a 01                	push   $0x1
 810:	50                   	push   %eax
 811:	57                   	push   %edi
 812:	e8 fc fd ff ff       	call   613 <write>
 817:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
 81a:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
 81d:	0f b6 1e             	movzbl (%esi),%ebx
 820:	83 c6 01             	add    $0x1,%esi
 823:	84 db                	test   %bl,%bl
 825:	74 29                	je     850 <printf+0x80>
    c = fmt[i] & 0xff;
 827:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
 82a:	85 d2                	test   %edx,%edx
 82c:	74 ca                	je     7f8 <printf+0x28>
      }
    } else if(state == '%'){
 82e:	83 fa 25             	cmp    $0x25,%edx
 831:	75 ea                	jne    81d <printf+0x4d>
      if(c == 'd'){
 833:	83 f8 25             	cmp    $0x25,%eax
 836:	0f 84 04 01 00 00    	je     940 <printf+0x170>
 83c:	83 e8 63             	sub    $0x63,%eax
 83f:	83 f8 15             	cmp    $0x15,%eax
 842:	77 1c                	ja     860 <printf+0x90>
 844:	ff 24 85 18 0b 00 00 	jmp    *0xb18(,%eax,4)
 ...
 863:	8d 55 e7             	lea    -0x19(%ebp),%edx
 866:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
 86a:	6a 01                	push   $0x1
 86c:	52                   	push   %edx
 86d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
 870:	57                   	push   %edi
 871:	e8 9d fd ff ff       	call   613 <write>
 876:	83 c4 0c             	add    $0xc,%esp
 879:	88 5d e7             	mov    %bl,-0x19(%ebp)
 87c:	6a 01                	push   $0x1
 87e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
 881:	52                   	push   %edx
 882:	57                   	push   %edi
 883:	e8 8b fd ff ff       	call   613 <write>
        putc(fd, c);
 888:	83 c4 10             	add    $0x10,%esp
      state = 0;
 88b:	31 d2                	xor    %edx,%edx
 88d:	eb 8e                	jmp    81d <printf+0x4d>
 88f:	90                   	nop
        printint(fd, *ap, 16, 0);
 ...
 89f:	89 f8                	mov    %edi,%eax
        ap++;
 8a1:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
 8a4:	e8 87 fe ff ff       	call   730 <printint>
        ap++;
 8a9:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 8ac:	83 c4 10             	add    $0x10,%esp
      state = 0;
 8af:	31 d2                	xor    %edx,%edx
 8b1:	e9 67 ff ff ff       	jmp    81d <printf+0x4d>
        s = (char*)*ap;
 8b6:	8b 45 d0             	mov    -0x30(%ebp),%eax
 8b9:	8b 18                	mov    (%eax),%ebx
        ap++;
 8bb:	83 c0 04             	add    $0x4,%eax
 8be:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
 8c1:	85 db                	test   %ebx,%ebx
 8c3:	0f 84 87 00 00 00    	je     950 <printf+0x180>
        while(*s != 0){
 ...
 8d0:	0f 84 47 ff ff ff    	je     81d <printf+0x4d>
 8d6:	8d 55 e7             	lea    -0x19(%ebp),%edx
 8d9:	89 75 d4             	mov    %esi,-0x2c(%ebp)
 ...
 8eb:	53                   	push   %ebx
 8ec:	57                   	push   %edi
 8ed:	e8 21 fd ff ff       	call   613 <write>
        while(*s != 0){
 ...
 901:	e9 17 ff ff ff       	jmp    81d <printf+0x4d>
        printint(fd, *ap, 10, 1);
 906:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 909:	83 ec 0c             	sub    $0xc,%esp
 90c:	b9 0a 00 00 00       	mov    $0xa,%ecx
 911:	8b 13                	mov    (%ebx),%edx
 913:	6a 01                	push   $0x1
 915:	eb 88                	jmp    89f <printf+0xcf>
        putc(fd, *ap);
 917:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
 91a:	83 ec 04             	sub    $0x4,%esp
 91d:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
 920:	8b 03                	mov    (%ebx),%eax
        ap++;
 922:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
 925:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 928:	6a 01                	push   $0x1
 92a:	52                   	push   %edx
 92b:	57                   	push   %edi
 92c:	e8 e2 fc ff ff       	call   613 <write>
        ap++;
 931:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 934:	83 c4 10             	add    $0x10,%esp
      state = 0;
 937:	31 d2                	xor    %edx,%edx
 939:	e9 df fe ff ff       	jmp    81d <printf+0x4d>
 93e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
 940:	83 ec 04             	sub    $0x4,%esp
 943:	88 5d e7             	mov    %bl,-0x19(%ebp)
 946:	8d 55 e7             	lea    -0x19(%ebp),%edx
 949:	6a 01                	push   $0x1
 94b:	e9 31 ff ff ff       	jmp    881 <printf+0xb1>
 950:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 955:	bb 0e 0b 00 00       	mov    $0xb0e,%ebx
 95a:	e9 77 ff ff ff       	jmp    8d6 <printf+0x106>
 95f:	90                   	nop
 ...
 961:	a1 00 13 00 00       	mov    0x1300,%eax
{
 ...
 97c:	73 32                	jae    9b0 <free+0x50>
 97e:	39 d1                	cmp    %edx,%ecx
 980:	72 04                	jb     986 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 982:	39 d0                	cmp    %edx,%eax
 984:	72 32                	jb     9b8 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
 986:	8b 73 fc             	mov    -0x4(%ebx),%esi
 989:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 98c:	39 fa                	cmp    %edi,%edx
 98e:	74 30                	je     9c0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
 990:	89 53 f8             	mov    %edx,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
 993:	8b 50 04             	mov    0x4(%eax),%edx
 996:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 999:	39 f1                	cmp    %esi,%ecx
 99b:	74 3a                	je     9d7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
 99d:	89 08                	mov    %ecx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
 99f:	5b                   	pop    %ebx
  freep = p;
 9a0:	a3 00 13 00 00       	mov    %eax,0x1300
}
 9a5:	5e                   	pop    %esi
 9a6:	5f                   	pop    %edi
 9a7:	5d                   	pop    %ebp
 ...
 9b2:	72 04                	jb     9b8 <free+0x58>
 9b4:	39 d1                	cmp    %edx,%ecx
 9b6:	72 ce                	jb     986 <free+0x26>
{
 9b8:	89 d0                	mov    %edx,%eax
 9ba:	eb bc                	jmp    978 <free+0x18>
 9bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    bp->s.size += p->s.ptr->s.size;
 9c0:	03 72 04             	add    0x4(%edx),%esi
 ...
 9d5:	75 c6                	jne    99d <free+0x3d>
    p->s.size += bp->s.size;
 9d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 9da:	a3 00 13 00 00       	mov    %eax,0x1300
    p->s.size += bp->s.size;
 9df:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 9e2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
 9e5:	89 08                	mov    %ecx,(%eax)
}
 9e7:	5b                   	pop    %ebx
 9e8:	5e                   	pop    %esi
 9e9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 9f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9fc:	8b 15 00 13 00 00    	mov    0x1300,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a0d:	0f 84 8d 00 00 00    	je     aa0 <malloc+0xb0>
 ...
 a18:	39 f9                	cmp    %edi,%ecx
 a1a:	73 64                	jae    a80 <malloc+0x90>
  if(nu < 4096)
 a1c:	bb 00 10 00 00       	mov    $0x1000,%ebx
 a21:	39 df                	cmp    %ebx,%edi
 a23:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
 a26:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
 a2d:	eb 0a                	jmp    a39 <malloc+0x49>
 a2f:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ...
 a5d:	50                   	push   %eax
 a5e:	e8 fd fe ff ff       	call   960 <free>
  return freep;
 a63:	8b 15 00 13 00 00    	mov    0x1300,%edx
      if((p = morecore(nunits)) == 0)
 a69:	83 c4 10             	add    $0x10,%esp
 a6c:	85 d2                	test   %edx,%edx
 a6e:	75 c0                	jne    a30 <malloc+0x40>
        return 0;
  }
}
 ...
 a8c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a8f:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 ...
 a9f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 aa0:	c7 05 00 13 00 00 04 	movl   $0x1304,0x1300
 aa7:	13 00 00 
    base.s.size = 0;
 aaa:	b8 04 13 00 00       	mov    $0x1304,%eax
    base.s.ptr = freep = prevp = &base;
 aaf:	c7 05 04 13 00 00 04 	movl   $0x1304,0x1304
 ab6:	13 00 00 
    base.s.size = 0;
 ab9:	c7 05 08 13 00 00 00 	movl   $0x0,0x1308
 ac0:	00 00 00 
    if(p->s.size >= nunits){
 ac3:	e9 54 ff ff ff       	jmp    a1c <malloc+0x2c>
 ac8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 acf:	00 
        prevp->s.ptr = p->s.ptr;
 ad0:	8b 08                	mov    (%eax),%ecx
 ad2:	89 0a                	mov    %ecx,(%edx)
 ad4:	eb b9                	jmp    a8f <malloc+0x9f>
