...
{
 71a:	83 ec 3c             	sub    $0x3c,%esp
 71d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
 720:	85 d2                	test   %edx,%edx
 722:	0f 89 80 00 00 00    	jns    7a8 <printint+0x98>
 728:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
 72c:	74 7a                	je     7a8 <printint+0x98>
    x = -xx;
 72e:	f7 d9                	neg    %ecx
    neg = 1;
 ...
 744:	89 f7                	mov    %esi,%edi
 746:	f7 f3                	div    %ebx
 748:	8d 76 01             	lea    0x1(%esi),%esi
 74b:	0f b6 92 50 0b 00 00 	movzbl 0xb50(%edx),%edx
 752:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
 756:	89 ca                	mov    %ecx,%edx
 758:	89 c1                	mov    %eax,%ecx
 75a:	39 da                	cmp    %ebx,%edx
 75c:	73 e2                	jae    740 <printint+0x30>
  if(neg)
 75e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
 761:	85 c0                	test   %eax,%eax
 763:	74 07                	je     76c <printint+0x5c>
    buf[i++] = '-';
 765:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
 76a:	89 f7                	mov    %esi,%edi
 76c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
 76f:	8b 75 c0             	mov    -0x40(%ebp),%esi
 772:	01 df                	add    %ebx,%edi
 774:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
 778:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
 77b:	83 ec 04             	sub    $0x4,%esp
 77e:	88 45 d7             	mov    %al,-0x29(%ebp)
 781:	8d 45 d7             	lea    -0x29(%ebp),%eax
 784:	6a 01                	push   $0x1
 786:	50                   	push   %eax
 787:	56                   	push   %esi
 788:	e8 86 fe ff ff       	call   613 <write>
  while(--i >= 0)
 78d:	89 f8                	mov    %edi,%eax
 78f:	83 c4 10             	add    $0x10,%esp
 792:	83 ef 01             	sub    $0x1,%edi
 795:	39 c3                	cmp    %eax,%ebx
 797:	75 df                	jne    778 <printint+0x68>
}
 ...
 7aa:	eb 89                	jmp    735 <printint+0x25>
...
{
 7bc:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
 7bf:	0f b6 1e             	movzbl (%esi),%ebx
 7c2:	83 c6 01             	add    $0x1,%esi
 7c5:	84 db                	test   %bl,%bl
 7c7:	74 67                	je     830 <printf+0x80>
 7c9:	8d 4d 10             	lea    0x10(%ebp),%ecx
 7cc:	31 d2                	xor    %edx,%edx
 7ce:	89 4d d0             	mov    %ecx,-0x30(%ebp)
 7d1:	eb 34                	jmp    807 <printf+0x57>
 7d3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
 7d8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
 ...
 7e3:	74 18                	je     7fd <printf+0x4d>
  write(fd, &c, 1);
 7e5:	83 ec 04             	sub    $0x4,%esp
 7e8:	8d 45 e7             	lea    -0x19(%ebp),%eax
 7eb:	88 5d e7             	mov    %bl,-0x19(%ebp)
 7ee:	6a 01                	push   $0x1
 7f0:	50                   	push   %eax
 7f1:	57                   	push   %edi
 7f2:	e8 1c fe ff ff       	call   613 <write>
 7f7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
 7fa:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
 7fd:	0f b6 1e             	movzbl (%esi),%ebx
 800:	83 c6 01             	add    $0x1,%esi
 803:	84 db                	test   %bl,%bl
 805:	74 29                	je     830 <printf+0x80>
    c = fmt[i] & 0xff;
 807:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
 80a:	85 d2                	test   %edx,%edx
 80c:	74 ca                	je     7d8 <printf+0x28>
      }
    } else if(state == '%'){
 80e:	83 fa 25             	cmp    $0x25,%edx
 811:	75 ea                	jne    7fd <printf+0x4d>
      if(c == 'd'){
 813:	83 f8 25             	cmp    $0x25,%eax
 816:	0f 84 04 01 00 00    	je     920 <printf+0x170>
 81c:	83 e8 63             	sub    $0x63,%eax
 81f:	83 f8 15             	cmp    $0x15,%eax
 822:	77 1c                	ja     840 <printf+0x90>
 824:	ff 24 85 f8 0a 00 00 	jmp    *0xaf8(,%eax,4)
 ...
 843:	8d 55 e7             	lea    -0x19(%ebp),%edx
 846:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
 84a:	6a 01                	push   $0x1
 84c:	52                   	push   %edx
 84d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
 850:	57                   	push   %edi
 851:	e8 bd fd ff ff       	call   613 <write>
 856:	83 c4 0c             	add    $0xc,%esp
 859:	88 5d e7             	mov    %bl,-0x19(%ebp)
 85c:	6a 01                	push   $0x1
 85e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
 861:	52                   	push   %edx
 862:	57                   	push   %edi
 863:	e8 ab fd ff ff       	call   613 <write>
        putc(fd, c);
 868:	83 c4 10             	add    $0x10,%esp
      state = 0;
 86b:	31 d2                	xor    %edx,%edx
 86d:	eb 8e                	jmp    7fd <printf+0x4d>
 86f:	90                   	nop
        printint(fd, *ap, 16, 0);
 870:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 873:	83 ec 0c             	sub    $0xc,%esp
 876:	b9 10 00 00 00       	mov    $0x10,%ecx
 87b:	8b 13                	mov    (%ebx),%edx
 87d:	6a 00                	push   $0x0
 87f:	89 f8                	mov    %edi,%eax
        ap++;
 881:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
 884:	e8 87 fe ff ff       	call   710 <printint>
        ap++;
 889:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 88c:	83 c4 10             	add    $0x10,%esp
      state = 0;
 88f:	31 d2                	xor    %edx,%edx
 891:	e9 67 ff ff ff       	jmp    7fd <printf+0x4d>
        s = (char*)*ap;
 896:	8b 45 d0             	mov    -0x30(%ebp),%eax
 899:	8b 18                	mov    (%eax),%ebx
        ap++;
 89b:	83 c0 04             	add    $0x4,%eax
 89e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
 8a1:	85 db                	test   %ebx,%ebx
 8a3:	0f 84 87 00 00 00    	je     930 <printf+0x180>
        while(*s != 0){
 8a9:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
 8ac:	31 d2                	xor    %edx,%edx
        while(*s != 0){
 8ae:	84 c0                	test   %al,%al
 8b0:	0f 84 47 ff ff ff    	je     7fd <printf+0x4d>
 8b6:	8d 55 e7             	lea    -0x19(%ebp),%edx
 8b9:	89 75 d4             	mov    %esi,-0x2c(%ebp)
 8bc:	89 de                	mov    %ebx,%esi
 8be:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
 ...
 8cb:	53                   	push   %ebx
 8cc:	57                   	push   %edi
 8cd:	e8 41 fd ff ff       	call   613 <write>
        while(*s != 0){
 ...
 8e1:	e9 17 ff ff ff       	jmp    7fd <printf+0x4d>
        printint(fd, *ap, 10, 1);
 8e6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 8e9:	83 ec 0c             	sub    $0xc,%esp
 8ec:	b9 0a 00 00 00       	mov    $0xa,%ecx
 8f1:	8b 13                	mov    (%ebx),%edx
 8f3:	6a 01                	push   $0x1
 8f5:	eb 88                	jmp    87f <printf+0xcf>
        putc(fd, *ap);
 8f7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
 8fa:	83 ec 04             	sub    $0x4,%esp
 8fd:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
 900:	8b 03                	mov    (%ebx),%eax
        ap++;
 902:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
 905:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 908:	6a 01                	push   $0x1
 90a:	52                   	push   %edx
 90b:	57                   	push   %edi
 90c:	e8 02 fd ff ff       	call   613 <write>
        ap++;
 911:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 914:	83 c4 10             	add    $0x10,%esp
      state = 0;
 917:	31 d2                	xor    %edx,%edx
 919:	e9 df fe ff ff       	jmp    7fd <printf+0x4d>
 91e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
 920:	83 ec 04             	sub    $0x4,%esp
 923:	88 5d e7             	mov    %bl,-0x19(%ebp)
 926:	8d 55 e7             	lea    -0x19(%ebp),%edx
 929:	6a 01                	push   $0x1
 92b:	e9 31 ff ff ff       	jmp    861 <printf+0xb1>
 930:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 935:	bb ee 0a 00 00       	mov    $0xaee,%ebx
 93a:	e9 77 ff ff ff       	jmp    8b6 <printf+0x106>
 93f:	90                   	nop
...
free(void *ap)
{
 ...
 941:	a1 e0 12 00 00       	mov    0x12e0,%eax
{
 ...
 97f:	5b                   	pop    %ebx
  freep = p;
 980:	a3 e0 12 00 00       	mov    %eax,0x12e0
}
 985:	5e                   	pop    %esi
 986:	5f                   	pop    %edi
 987:	5d                   	pop    %ebp
 ...
 996:	72 ce                	jb     966 <free+0x26>
{
 ...
 9b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 9ba:	a3 e0 12 00 00       	mov    %eax,0x12e0
    p->s.size += bp->s.size;
 9bf:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 9c2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
...
malloc(uint nbytes)
{
 ...
 9d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9dc:	8b 15 e0 12 00 00    	mov    0x12e0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ed:	0f 84 8d 00 00 00    	je     a80 <malloc+0xb0>
 ...
 9f8:	39 f9                	cmp    %edi,%ecx
 9fa:	73 64                	jae    a60 <malloc+0x90>
  if(nu < 4096)
 9fc:	bb 00 10 00 00       	mov    $0x1000,%ebx
 a01:	39 df                	cmp    %ebx,%edi
 a03:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
 a06:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
 a0d:	eb 0a                	jmp    a19 <malloc+0x49>
 a0f:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a10:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
 a12:	8b 48 04             	mov    0x4(%eax),%ecx
 a15:	39 f9                	cmp    %edi,%ecx
 a17:	73 47                	jae    a60 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 a1b:	3b 05 e0 12 00 00    	cmp    0x12e0,%eax
 a21:	75 ed                	jne    a10 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 a23:	83 ec 0c             	sub    $0xc,%esp
 a26:	56                   	push   %esi
 a27:	e8 4f fc ff ff       	call   67b <sbrk>
  if(p == (char*)-1)
 a2c:	83 c4 10             	add    $0x10,%esp
 a2f:	83 f8 ff             	cmp    $0xffffffff,%eax
 a32:	74 1c                	je     a50 <malloc+0x80>
  hp->s.size = nu;
 a34:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
 a37:	83 ec 0c             	sub    $0xc,%esp
 a3a:	83 c0 08             	add    $0x8,%eax
 a3d:	50                   	push   %eax
 a3e:	e8 fd fe ff ff       	call   940 <free>
  return freep;
 a43:	8b 15 e0 12 00 00    	mov    0x12e0,%edx
      if((p = morecore(nunits)) == 0)
 a49:	83 c4 10             	add    $0x10,%esp
 a4c:	85 d2                	test   %edx,%edx
 a4e:	75 c0                	jne    a10 <malloc+0x40>
        return 0;
  }
}
 ...
 a6c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a6f:	89 15 e0 12 00 00    	mov    %edx,0x12e0
}
 ...
 a7f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 a80:	c7 05 e0 12 00 00 e4 	movl   $0x12e4,0x12e0
 a87:	12 00 00 
    base.s.size = 0;
 a8a:	b8 e4 12 00 00       	mov    $0x12e4,%eax
    base.s.ptr = freep = prevp = &base;
 a8f:	c7 05 e4 12 00 00 e4 	movl   $0x12e4,0x12e4
 a96:	12 00 00 
    base.s.size = 0;
 a99:	c7 05 e8 12 00 00 00 	movl   $0x0,0x12e8
 aa0:	00 00 00 
    if(p->s.size >= nunits){
 aa3:	e9 54 ff ff ff       	jmp    9fc <malloc+0x2c>
