...
main(void)
{
  ...
  while ((completion_flag = getcmd(buf, sizeof(buf))) >= 0) {
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
      5a:	80 3d 00 20 00 00 63 	cmpb   $0x63,0x2000
...
fork1(void)
{
  ...
  if (pid == -1)
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
      88:	80 3d 01 20 00 00 64 	cmpb   $0x64,0x2001
      8f:	75 d2                	jne    63 <main+0x63>
      91:	80 3d 02 20 00 00 20 	cmpb   $0x20,0x2002
      ...
      if (chdir(buf + 3) < 0)
      a7:	c7 04 24 03 20 00 00 	movl   $0x2003,(%esp)
      buf[strlen(buf) - 1] = 0; // chop \n
      ae:	c6 80 ff 1f 00 00 00 	movb   $0x0,0x1fff(%eax)
      if (chdir(buf + 3) < 0)
      ...
      bf:	0f 89 7b ff ff ff    	jns    40 <main+0x40>
        printf(2, "cannot cd %s\n", buf + 3);
      c5:	50                   	push   %eax
      c6:	68 03 20 00 00       	push   $0x2003
      cb:	68 8c 18 00 00       	push   $0x188c
      d0:	6a 02                	push   $0x2
      d2:	e8 f9 13 00 00       	call   14d0 <printf>
...
00000120 <auto_complete>:
{
  ...
  printf(2, "%s\t", instruction + buf_len);
     ...
     173:	51                   	push   %ecx
     174:	68 d8 17 00 00       	push   $0x17d8
     179:	6a 02                	push   $0x2
     17b:	e8 50 13 00 00       	call   14d0 <printf>
}
...
00000190 <print_instructions>:
{
  ...
  printf(2, "\n");
     1a5:	68 00 18 00 00       	push   $0x1800
     1aa:	6a 02                	push   $0x2
     1ac:	e8 1f 13 00 00       	call   14d0 <printf>
  for (int i = 0; i < count; i++) {
    ...
    if (instructions[i])
     ...
     1ca:	52                   	push   %edx
     1cb:	68 80 18 00 00       	push   $0x1880
     1d0:	6a 02                	push   $0x2
     1d2:	e8 f9 12 00 00       	call   14d0 <printf>
  ...
  printf(2, "\t");
     ...
     1e4:	68 da 17 00 00       	push   $0x17da
     1e9:	6a 02                	push   $0x2
     1eb:	e8 e0 12 00 00       	call   14d0 <printf>
  printf(2, "$ %s", prefix);
     1f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     1f3:	83 c4 10             	add    $0x10,%esp
     1f6:	c7 45 0c dc 17 00 00 	movl   $0x17dc,0xc(%ebp)
     ...
     20d:	5d                   	pop    %ebp
  printf(2, "$ %s", prefix);
     20e:	e9 bd 12 00 00       	jmp    14d0 <printf>
...
00000290 <get_matching_instructions>:
{
  ...
  fd = open(path, 0);
     29c:	6a 00                	push   $0x0
     29e:	68 e1 17 00 00       	push   $0x17e1
  ...
  char **instructions = malloc(sizeof(char *) * 16);
     ...
     2b2:	e8 39 14 00 00       	call   16f0 <malloc>
  ...
  while (read(fd, &de, sizeof(de)) == sizeof(de)) {
    ...
    for (int i = 0; i < prefix_len; i++) {
     ...
     340:	6a 0f                	push   $0xf
     342:	e8 a9 13 00 00       	call   16f0 <malloc>
  ...
  for (int i = 0; i < prefix_len; i++) {
    ...
    instructions[counter] = malloc(3);
     ...
     3fe:	6a 03                	push   $0x3
     400:	e8 eb 12 00 00       	call   16f0 <malloc>
...
00000440 <getcmd>:
{
  ...
  if (!temp_buf) {
     448:	a1 e0 1f 00 00       	mov    0x1fe0,%eax
{
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     45b:	a1 ec 1f 00 00       	mov    0x1fec,%eax
     460:	0b 05 e8 1f 00 00    	or     0x1fe8,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     48e:	a1 e0 1f 00 00       	mov    0x1fe0,%eax
    ...
    TAPPRESS = 0;
     4a4:	c7 05 ec 1f 00 00 00 	movl   $0x0,0x1fec
     4ab:	00 00 00 
    has_multiple_choice = 0;
     4ae:	c7 05 e8 1f 00 00 00 	movl   $0x0,0x1fe8
     4b5:	00 00 00 
  if (buf[0] == 0)
     4b8:	80 3b 00             	cmpb   $0x0,(%ebx)
     4bb:	0f 84 89 01 00 00    	je     64a <getcmd+0x20a>
  if (temp_buf)
     4c1:	a1 e0 1f 00 00       	mov    0x1fe0,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     4eb:	a1 e0 1f 00 00       	mov    0x1fe0,%eax
    ...
    has_multiple_choice = 0;
     505:	c7 05 e8 1f 00 00 00 	movl   $0x0,0x1fe8
     50c:	00 00 00 
    TAPPRESS = 0;
     50f:	c7 05 ec 1f 00 00 00 	movl   $0x0,0x1fec
     516:	00 00 00 
    ...
    if (instruction_num == 0) {
     ...
     540:	8b 0d e8 1f 00 00    	mov    0x1fe8,%ecx
     546:	85 c9                	test   %ecx,%ecx
     548:	0f 85 a2 00 00 00    	jne    5f0 <getcmd+0x1b0>
        if (temp_buf)
     54e:	a1 e0 1f 00 00       	mov    0x1fe0,%eax
        has_multiple_choice = 1; 
     553:	c7 05 e8 1f 00 00 01 	movl   $0x1,0x1fe8
     55a:	00 00 00 
        if (temp_buf)
     ...
     57b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      if (temp_buf)
     580:	a1 e0 1f 00 00       	mov    0x1fe0,%eax
      TAPPRESS = 1;
     585:	c7 05 ec 1f 00 00 01 	movl   $0x1,0x1fec
     58c:	00 00 00 
      if (temp_buf)
    ...
    temp_buf = malloc(nbuf);
     ...
     59b:	56                   	push   %esi
     59c:	e8 4f 11 00 00       	call   16f0 <malloc>
    if (temp_buf)
     5a1:	83 c4 10             	add    $0x10,%esp
    temp_buf = malloc(nbuf);
     5a4:	a3 e0 1f 00 00       	mov    %eax,0x1fe0
    if (temp_buf)
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     5b4:	a1 ec 1f 00 00       	mov    0x1fec,%eax
     5b9:	0b 05 e8 1f 00 00    	or     0x1fe8,%eax
     5bf:	0f 85 a7 fe ff ff    	jne    46c <getcmd+0x2c>
     5c5:	8d 76 00             	lea    0x0(%esi),%esi
    printf(2, "$ ");
     5c8:	83 ec 08             	sub    $0x8,%esp
     5cb:	68 e3 17 00 00       	push   $0x17e3
     5d0:	6a 02                	push   $0x2
     5d2:	e8 f9 0e 00 00       	call   14d0 <printf>
    memset(buf, 0, nbuf);
     ...
     5f6:	e8 95 fb ff ff       	call   190 <print_instructions>
        if (temp_buf)
     5fb:	a1 e0 1f 00 00       	mov    0x1fe0,%eax
     600:	83 c4 10             	add    $0x10,%esp
        done_printing = 1;
     603:	c7 05 e4 1f 00 00 01 	movl   $0x1,0x1fe4
     60a:	00 00 00 
        if (temp_buf)
     ...
     626:	e8 f5 fa ff ff       	call   120 <auto_complete>
      if (temp_buf)
     62b:	a1 e0 1f 00 00       	mov    0x1fe0,%eax
     630:	83 c4 10             	add    $0x10,%esp
      TAPPRESS = 1;
     633:	c7 05 ec 1f 00 00 01 	movl   $0x1,0x1fec
     63a:	00 00 00 
      if (temp_buf)
...
00000660 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     669:	68 80 18 00 00       	push   $0x1880
     66e:	6a 02                	push   $0x2
     670:	e8 5b 0e 00 00       	call   14d0 <printf>
  exit();
...
00000680 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     695:	68 e6 17 00 00       	push   $0x17e6
...
000006a0 <runcmd>:
{
  ...
  switch (cmd->type) {
     ...
     6b9:	ff 24 85 a4 18 00 00 	jmp    *0x18a4(,%eax,4)
    if (ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     6d9:	68 f2 17 00 00       	push   $0x17f2
     6de:	6a 02                	push   $0x2
     6e0:	e8 eb 0d 00 00       	call   14d0 <printf>
    break;
    ...
    panic("runcmd");
     ...
     79d:	68 eb 17 00 00       	push   $0x17eb
     7a2:	e8 b9 fe ff ff       	call   660 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     7a7:	51                   	push   %ecx
     7a8:	ff 73 08             	push   0x8(%ebx)
     7ab:	68 02 18 00 00       	push   $0x1802
     7b0:	6a 02                	push   $0x2
     7b2:	e8 19 0d 00 00       	call   14d0 <printf>
      exit();
     7b7:	e8 57 0b 00 00       	call   1313 <exit>
      panic("pipe");
     7bc:	83 ec 0c             	sub    $0xc,%esp
     7bf:	68 12 18 00 00       	push   $0x1812
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     837:	6a 54                	push   $0x54
     839:	e8 b2 0e 00 00       	call   16f0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     867:	6a 18                	push   $0x18
     869:	e8 82 0e 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8b7:	6a 0c                	push   $0xc
     8b9:	e8 32 0e 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8f7:	6a 0c                	push   $0xc
     8f9:	e8 f2 0d 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     937:	6a 08                	push   $0x8
     939:	e8 b2 0d 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     969:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     98d:	50                   	push   %eax
     98e:	68 c0 1f 00 00       	push   $0x1fc0
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     9dd:	50                   	push   %eax
     9de:	68 c0 1f 00 00       	push   $0x1fc0
  ...
  *ps = s;
  ...
  switch (*s) {
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a36:	50                   	push   %eax
     a37:	68 b8 1f 00 00       	push   $0x1fb8
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a55:	50                   	push   %eax
     a56:	68 c0 1f 00 00       	push   $0x1fc0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     afd:	50                   	push   %eax
     afe:	68 c0 1f 00 00       	push   $0x1fc0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while (peek(ps, es, "<>")) {
     ...
     b63:	68 34 18 00 00       	push   $0x1834
     b68:	53                   	push   %ebx
     b69:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     bc0:	6a 18                	push   $0x18
     bc2:	e8 29 0b 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     c1f:	6a 18                	push   $0x18
     c21:	e8 ca 0a 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     c7e:	68 17 18 00 00       	push   $0x1817
...
parseexec(char **ps, char *es)
{
  ...
  if (peek(ps, es, "("))
     c9f:	68 37 18 00 00       	push   $0x1837
     ca4:	56                   	push   %esi
     ca5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     cbb:	6a 54                	push   $0x54
     cbd:	e8 2e 0a 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (!peek(ps, es, "|)&;")) {
     ...
     d06:	68 4e 18 00 00       	push   $0x184e
     d0b:	56                   	push   %esi
     d0c:	53                   	push   %ebx
    ...
    if (argc >= MAXARGS)
     ...
     d50:	68 40 18 00 00       	push   $0x1840
  ...
  cmd->eargv[argc] = 0;
     ...
     d99:	68 39 18 00 00       	push   $0x1839
...
00000db0 <parsepipe>:
{
  ...
  if (peek(ps, es, "|")) {
     ...
     dc9:	68 53 18 00 00       	push   $0x1853
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     e0d:	e8 de 08 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000e40 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     e72:	e8 79 08 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (peek(ps, es, "&")) {
     ...
     e9b:	68 55 18 00 00       	push   $0x1855
     ea0:	57                   	push   %edi
     ea1:	56                   	push   %esi
  ...
  if (peek(ps, es, ";")) {
     ...
     eb1:	68 51 18 00 00       	push   $0x1851
     eb6:	57                   	push   %edi
     eb7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     eed:	e8 fe 07 00 00       	call   16f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000f20 <parseblock>:
{
  ...
  if (!peek(ps, es, "("))
     f2f:	68 37 18 00 00       	push   $0x1837
     f34:	56                   	push   %esi
     f35:	53                   	push   %ebx
  ...
  if (!peek(ps, es, ")"))
     ...
     f59:	68 73 18 00 00       	push   $0x1873
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch (cmd->type) {
     ...
     fc5:	ff 24 85 bc 18 00 00 	jmp    *0x18bc(,%eax,4)
    ...
    1055:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
    ...
    1073:	68 db 17 00 00       	push   $0x17db
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    109e:	52                   	push   %edx
    109f:	50                   	push   %eax
    10a0:	68 75 18 00 00       	push   $0x1875
    10a5:	6a 02                	push   $0x2
    10a7:	e8 24 04 00 00       	call   14d0 <printf>
    panic("syntax");
    10ac:	c7 04 24 39 18 00 00 	movl   $0x1839,(%esp)
...
SYSCALL(getlockstat)
    141b:	b8 1b 00 00 00       	mov    $0x1b,%eax
    1420:	cd 40                	int    $0x40
    1422:	c3                   	ret
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    1438:	89 d1                	mov    %edx,%ecx
{
    143a:	83 ec 3c             	sub    $0x3c,%esp
    143d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    1440:	85 d2                	test   %edx,%edx
    1442:	0f 89 80 00 00 00    	jns    14c8 <printint+0x98>
    1448:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    144c:	74 7a                	je     14c8 <printint+0x98>
    x = -xx;
    144e:	f7 d9                	neg    %ecx
    neg = 1;
  ...
  i = 0;
    1455:	89 45 c4             	mov    %eax,-0x3c(%ebp)
  ...
  do{
    ...
    1464:	89 f7                	mov    %esi,%edi
    1466:	f7 f3                	div    %ebx
    1468:	8d 76 01             	lea    0x1(%esi),%esi
    146b:	0f b6 92 2c 19 00 00 	movzbl 0x192c(%edx),%edx
    1472:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    1476:	89 ca                	mov    %ecx,%edx
    1478:	89 c1                	mov    %eax,%ecx
    147a:	39 da                	cmp    %ebx,%edx
    147c:	73 e2                	jae    1460 <printint+0x30>
  if(neg)
    147e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    1481:	85 c0                	test   %eax,%eax
    1483:	74 07                	je     148c <printint+0x5c>
    buf[i++] = '-';
    1485:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    148a:	89 f7                	mov    %esi,%edi
    148c:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    148f:	8b 75 c0             	mov    -0x40(%ebp),%esi
    1492:	01 df                	add    %ebx,%edi
    1494:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    1498:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    149b:	83 ec 04             	sub    $0x4,%esp
    149e:	88 45 d7             	mov    %al,-0x29(%ebp)
    14a1:	8d 45 d7             	lea    -0x29(%ebp),%eax
    14a4:	6a 01                	push   $0x1
    14a6:	50                   	push   %eax
    14a7:	56                   	push   %esi
    14a8:	e8 86 fe ff ff       	call   1333 <write>
  while(--i >= 0)
    14ad:	89 f8                	mov    %edi,%eax
    14af:	83 c4 10             	add    $0x10,%esp
    14b2:	83 ef 01             	sub    $0x1,%edi
    14b5:	39 c3                	cmp    %eax,%ebx
    14b7:	75 df                	jne    1498 <printint+0x68>
}
  ...
  neg = 0;
    ...
    14ca:	eb 89                	jmp    1455 <printint+0x25>
...
{
    14dc:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    14df:	0f b6 1e             	movzbl (%esi),%ebx
    14e2:	83 c6 01             	add    $0x1,%esi
    14e5:	84 db                	test   %bl,%bl
    14e7:	74 67                	je     1550 <printf+0x80>
    14e9:	8d 4d 10             	lea    0x10(%ebp),%ecx
    14ec:	31 d2                	xor    %edx,%edx
    14ee:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    14f1:	eb 34                	jmp    1527 <printf+0x57>
    14f3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    14f8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    14fb:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    1500:	83 f8 25             	cmp    $0x25,%eax
    1503:	74 18                	je     151d <printf+0x4d>
  write(fd, &c, 1);
    1505:	83 ec 04             	sub    $0x4,%esp
    1508:	8d 45 e7             	lea    -0x19(%ebp),%eax
    150b:	88 5d e7             	mov    %bl,-0x19(%ebp)
    150e:	6a 01                	push   $0x1
    1510:	50                   	push   %eax
    1511:	57                   	push   %edi
    1512:	e8 1c fe ff ff       	call   1333 <write>
    1517:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    151a:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    151d:	0f b6 1e             	movzbl (%esi),%ebx
    1520:	83 c6 01             	add    $0x1,%esi
    1523:	84 db                	test   %bl,%bl
    1525:	74 29                	je     1550 <printf+0x80>
    c = fmt[i] & 0xff;
    1527:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    152a:	85 d2                	test   %edx,%edx
    152c:	74 ca                	je     14f8 <printf+0x28>
      }
    } else if(state == '%'){
    152e:	83 fa 25             	cmp    $0x25,%edx
    1531:	75 ea                	jne    151d <printf+0x4d>
      if(c == 'd'){
    1533:	83 f8 25             	cmp    $0x25,%eax
    1536:	0f 84 04 01 00 00    	je     1640 <printf+0x170>
    153c:	83 e8 63             	sub    $0x63,%eax
    153f:	83 f8 15             	cmp    $0x15,%eax
    1542:	77 1c                	ja     1560 <printf+0x90>
    1544:	ff 24 85 d4 18 00 00 	jmp    *0x18d4(,%eax,4)
    154b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
    ...
    1556:	5d                   	pop    %ebp
    1557:	c3                   	ret
    1558:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    155f:	00 
  write(fd, &c, 1);
    1560:	83 ec 04             	sub    $0x4,%esp
    1563:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1566:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    156a:	6a 01                	push   $0x1
    156c:	52                   	push   %edx
    156d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    1570:	57                   	push   %edi
    1571:	e8 bd fd ff ff       	call   1333 <write>
    1576:	83 c4 0c             	add    $0xc,%esp
    1579:	88 5d e7             	mov    %bl,-0x19(%ebp)
    157c:	6a 01                	push   $0x1
    157e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    1581:	52                   	push   %edx
    1582:	57                   	push   %edi
    1583:	e8 ab fd ff ff       	call   1333 <write>
        putc(fd, c);
    1588:	83 c4 10             	add    $0x10,%esp
      state = 0;
    158b:	31 d2                	xor    %edx,%edx
    158d:	eb 8e                	jmp    151d <printf+0x4d>
    158f:	90                   	nop
        printint(fd, *ap, 16, 0);
    1590:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1593:	83 ec 0c             	sub    $0xc,%esp
    1596:	b9 10 00 00 00       	mov    $0x10,%ecx
    159b:	8b 13                	mov    (%ebx),%edx
    159d:	6a 00                	push   $0x0
    159f:	89 f8                	mov    %edi,%eax
        ap++;
    15a1:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    15a4:	e8 87 fe ff ff       	call   1430 <printint>
        ap++;
    15a9:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    15ac:	83 c4 10             	add    $0x10,%esp
      state = 0;
    15af:	31 d2                	xor    %edx,%edx
    15b1:	e9 67 ff ff ff       	jmp    151d <printf+0x4d>
        s = (char*)*ap;
    15b6:	8b 45 d0             	mov    -0x30(%ebp),%eax
    15b9:	8b 18                	mov    (%eax),%ebx
        ap++;
    15bb:	83 c0 04             	add    $0x4,%eax
    15be:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    15c1:	85 db                	test   %ebx,%ebx
    15c3:	0f 84 87 00 00 00    	je     1650 <printf+0x180>
        while(*s != 0){
    15c9:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    15cc:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    15ce:	84 c0                	test   %al,%al
    15d0:	0f 84 47 ff ff ff    	je     151d <printf+0x4d>
    15d6:	8d 55 e7             	lea    -0x19(%ebp),%edx
    15d9:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    15dc:	89 de                	mov    %ebx,%esi
    15de:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
    15e0:	83 ec 04             	sub    $0x4,%esp
    15e3:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
  ...
  write(fd, &c, 1);
    ...
    15eb:	53                   	push   %ebx
    15ec:	57                   	push   %edi
    15ed:	e8 41 fd ff ff       	call   1333 <write>
        while(*s != 0){
    ...
    1601:	e9 17 ff ff ff       	jmp    151d <printf+0x4d>
        printint(fd, *ap, 10, 1);
    1606:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1609:	83 ec 0c             	sub    $0xc,%esp
    160c:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1611:	8b 13                	mov    (%ebx),%edx
    1613:	6a 01                	push   $0x1
    1615:	eb 88                	jmp    159f <printf+0xcf>
        putc(fd, *ap);
    1617:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    161a:	83 ec 04             	sub    $0x4,%esp
    161d:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    1620:	8b 03                	mov    (%ebx),%eax
        ap++;
    1622:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    1625:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    1628:	6a 01                	push   $0x1
    162a:	52                   	push   %edx
    162b:	57                   	push   %edi
    162c:	e8 02 fd ff ff       	call   1333 <write>
        ap++;
    1631:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    1634:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1637:	31 d2                	xor    %edx,%edx
    1639:	e9 df fe ff ff       	jmp    151d <printf+0x4d>
    163e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    1640:	83 ec 04             	sub    $0x4,%esp
    1643:	88 5d e7             	mov    %bl,-0x19(%ebp)
    1646:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1649:	6a 01                	push   $0x1
    164b:	e9 31 ff ff ff       	jmp    1581 <printf+0xb1>
    1650:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1655:	bb 9a 18 00 00       	mov    $0x189a,%ebx
    165a:	e9 77 ff ff ff       	jmp    15d6 <printf+0x106>
    165f:	90                   	nop
    ...
    1661:	a1 64 20 00 00       	mov    0x2064,%eax
{
  ...
  freep = p;
    ...
    169f:	5b                   	pop    %ebx
  freep = p;
    16a0:	a3 64 20 00 00       	mov    %eax,0x2064
}
    16a5:	5e                   	pop    %esi
    16a6:	5f                   	pop    %edi
    16a7:	5d                   	pop    %ebp
    ...
    16b6:	72 ce                	jb     1686 <free+0x26>
{
  ...
  freep = p;
    16da:	a3 64 20 00 00       	mov    %eax,0x2064
    p->s.size += bp->s.size;
    16df:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    16e2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    16e5:	89 08                	mov    %ecx,(%eax)
}
    16e7:	5b                   	pop    %ebx
    16e8:	5e                   	pop    %esi
    16e9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16fc:	8b 15 64 20 00 00    	mov    0x2064,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    170d:	0f 84 8d 00 00 00    	je     17a0 <malloc+0xb0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1718:	39 f9                	cmp    %edi,%ecx
    171a:	73 64                	jae    1780 <malloc+0x90>
  if(nu < 4096)
    171c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1721:	39 df                	cmp    %ebx,%edi
    1723:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    1726:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    172d:	eb 0a                	jmp    1739 <malloc+0x49>
    172f:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1730:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1732:	8b 48 04             	mov    0x4(%eax),%ecx
    1735:	39 f9                	cmp    %edi,%ecx
    1737:	73 47                	jae    1780 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    173b:	3b 05 64 20 00 00    	cmp    0x2064,%eax
    1741:	75 ed                	jne    1730 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1743:	83 ec 0c             	sub    $0xc,%esp
    1746:	56                   	push   %esi
    1747:	e8 4f fc ff ff       	call   139b <sbrk>
  if(p == (char*)-1)
    174c:	83 c4 10             	add    $0x10,%esp
    174f:	83 f8 ff             	cmp    $0xffffffff,%eax
    1752:	74 1c                	je     1770 <malloc+0x80>
  hp->s.size = nu;
    1754:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1757:	83 ec 0c             	sub    $0xc,%esp
    175a:	83 c0 08             	add    $0x8,%eax
    175d:	50                   	push   %eax
    175e:	e8 fd fe ff ff       	call   1660 <free>
  return freep;
    1763:	8b 15 64 20 00 00    	mov    0x2064,%edx
      if((p = morecore(nunits)) == 0)
    1769:	83 c4 10             	add    $0x10,%esp
    176c:	85 d2                	test   %edx,%edx
    176e:	75 c0                	jne    1730 <malloc+0x40>
        return 0;
  }
}
    ...
    1782:	74 4c                	je     17d0 <malloc+0xe0>
        p->s.size -= nunits;
    ...
    178c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    178f:	89 15 64 20 00 00    	mov    %edx,0x2064
}
    ...
    179f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    17a0:	c7 05 64 20 00 00 68 	movl   $0x2068,0x2064
    17a7:	20 00 00 
    base.s.size = 0;
    17aa:	b8 68 20 00 00       	mov    $0x2068,%eax
    base.s.ptr = freep = prevp = &base;
    17af:	c7 05 68 20 00 00 68 	movl   $0x2068,0x2068
    17b6:	20 00 00 
    base.s.size = 0;
    17b9:	c7 05 6c 20 00 00 00 	movl   $0x0,0x206c
    17c0:	00 00 00 
    if(p->s.size >= nunits){
    17c3:	e9 54 ff ff ff       	jmp    171c <malloc+0x2c>
    17c8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    17cf:	00 
        prevp->s.ptr = p->s.ptr;
    17d0:	8b 08                	mov    (%eax),%ecx
    17d2:	89 0a                	mov    %ecx,(%edx)
    17d4:	eb b9                	jmp    178f <malloc+0x9f>
