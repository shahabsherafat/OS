...
fork1(void)
{
  ...
  if (pid == -1)
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
      88:	80 3d 21 20 00 00 64 	cmpb   $0x64,0x2021
      8f:	75 d2                	jne    63 <main+0x63>
      91:	80 3d 22 20 00 00 20 	cmpb   $0x20,0x2022
      98:	75 c9                	jne    63 <main+0x63>
      buf[strlen(buf) - 1] = 0; // chop \n
      9a:	83 ec 0c             	sub    $0xc,%esp
      9d:	68 20 20 00 00       	push   $0x2020
      a2:	e8 a9 10 00 00       	call   1150 <strlen>
      if (chdir(buf + 3) < 0)
      a7:	c7 04 24 23 20 00 00 	movl   $0x2023,(%esp)
      buf[strlen(buf) - 1] = 0; // chop \n
      ae:	c6 80 1f 20 00 00 00 	movb   $0x0,0x201f(%eax)
      if (chdir(buf + 3) < 0)
      ...
      bf:	0f 89 7b ff ff ff    	jns    40 <main+0x40>
        printf(2, "cannot cd %s\n", buf + 3);
      c5:	50                   	push   %eax
      c6:	68 23 20 00 00       	push   $0x2023
      cb:	68 ac 18 00 00       	push   $0x18ac
      d0:	6a 02                	push   $0x2
      d2:	e8 19 14 00 00       	call   14f0 <printf>
...
00000120 <auto_complete>:
{
  ...
  printf(2, "%s\t", instruction + buf_len);
     ...
     173:	51                   	push   %ecx
     174:	68 f8 17 00 00       	push   $0x17f8
     179:	6a 02                	push   $0x2
     17b:	e8 70 13 00 00       	call   14f0 <printf>
}
...
00000190 <print_instructions>:
{
  ...
  printf(2, "\n");
     1a5:	68 20 18 00 00       	push   $0x1820
     1aa:	6a 02                	push   $0x2
     1ac:	e8 3f 13 00 00       	call   14f0 <printf>
  for (int i = 0; i < count; i++) {
    ...
    if (instructions[i])
     ...
     1ca:	52                   	push   %edx
     1cb:	68 a0 18 00 00       	push   $0x18a0
     1d0:	6a 02                	push   $0x2
     1d2:	e8 19 13 00 00       	call   14f0 <printf>
  ...
  printf(2, "\t");
     ...
     1e4:	68 fa 17 00 00       	push   $0x17fa
     1e9:	6a 02                	push   $0x2
     1eb:	e8 00 13 00 00       	call   14f0 <printf>
  printf(2, "$ %s", prefix);
     1f0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     1f3:	83 c4 10             	add    $0x10,%esp
     1f6:	c7 45 0c fc 17 00 00 	movl   $0x17fc,0xc(%ebp)
     ...
     20d:	5d                   	pop    %ebp
  printf(2, "$ %s", prefix);
     20e:	e9 dd 12 00 00       	jmp    14f0 <printf>
...
00000290 <get_matching_instructions>:
{
  ...
  fd = open(path, 0);
     29c:	6a 00                	push   $0x0
     29e:	68 01 18 00 00       	push   $0x1801
  ...
  char **instructions = malloc(sizeof(char *) * 16);
     ...
     2b2:	e8 59 14 00 00       	call   1710 <malloc>
  ...
  while (read(fd, &de, sizeof(de)) == sizeof(de)) {
    ...
    for (int i = 0; i < prefix_len; i++) {
     ...
     340:	6a 0f                	push   $0xf
     342:	e8 c9 13 00 00       	call   1710 <malloc>
  ...
  for (int i = 0; i < prefix_len; i++) {
    ...
    instructions[counter] = malloc(3);
     ...
     3fe:	6a 03                	push   $0x3
     400:	e8 0b 13 00 00       	call   1710 <malloc>
...
00000440 <getcmd>:
{
  ...
  if (!temp_buf) {
     448:	a1 00 20 00 00       	mov    0x2000,%eax
{
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     45b:	a1 0c 20 00 00       	mov    0x200c,%eax
     460:	0b 05 08 20 00 00    	or     0x2008,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     48e:	a1 00 20 00 00       	mov    0x2000,%eax
    ...
    TAPPRESS = 0;
     4a4:	c7 05 0c 20 00 00 00 	movl   $0x0,0x200c
     4ab:	00 00 00 
    has_multiple_choice = 0;
     4ae:	c7 05 08 20 00 00 00 	movl   $0x0,0x2008
     4b5:	00 00 00 
  if (buf[0] == 0)
     4b8:	80 3b 00             	cmpb   $0x0,(%ebx)
     4bb:	0f 84 89 01 00 00    	je     64a <getcmd+0x20a>
  if (temp_buf)
     4c1:	a1 00 20 00 00       	mov    0x2000,%eax
  ...
  if (temp_buf && strcmp(buf, temp_buf) != 0) {
     4eb:	a1 00 20 00 00       	mov    0x2000,%eax
    ...
    has_multiple_choice = 0;
     505:	c7 05 08 20 00 00 00 	movl   $0x0,0x2008
     50c:	00 00 00 
    TAPPRESS = 0;
     50f:	c7 05 0c 20 00 00 00 	movl   $0x0,0x200c
     516:	00 00 00 
    ...
    if (instruction_num == 0) {
     ...
     540:	8b 0d 08 20 00 00    	mov    0x2008,%ecx
     546:	85 c9                	test   %ecx,%ecx
     548:	0f 85 a2 00 00 00    	jne    5f0 <getcmd+0x1b0>
        if (temp_buf)
     54e:	a1 00 20 00 00       	mov    0x2000,%eax
        has_multiple_choice = 1; 
     553:	c7 05 08 20 00 00 01 	movl   $0x1,0x2008
     55a:	00 00 00 
        if (temp_buf)
     ...
     57b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      if (temp_buf)
     580:	a1 00 20 00 00       	mov    0x2000,%eax
      TAPPRESS = 1;
     585:	c7 05 0c 20 00 00 01 	movl   $0x1,0x200c
     58c:	00 00 00 
      if (temp_buf)
    ...
    temp_buf = malloc(nbuf);
     ...
     59b:	56                   	push   %esi
     59c:	e8 6f 11 00 00       	call   1710 <malloc>
    if (temp_buf)
     5a1:	83 c4 10             	add    $0x10,%esp
    temp_buf = malloc(nbuf);
     5a4:	a3 00 20 00 00       	mov    %eax,0x2000
    if (temp_buf)
  ...
  if ((!TAPPRESS && !has_multiple_choice)) {
     5b4:	a1 0c 20 00 00       	mov    0x200c,%eax
     5b9:	0b 05 08 20 00 00    	or     0x2008,%eax
     5bf:	0f 85 a7 fe ff ff    	jne    46c <getcmd+0x2c>
     5c5:	8d 76 00             	lea    0x0(%esi),%esi
    printf(2, "$ ");
     5c8:	83 ec 08             	sub    $0x8,%esp
     5cb:	68 03 18 00 00       	push   $0x1803
     5d0:	6a 02                	push   $0x2
     5d2:	e8 19 0f 00 00       	call   14f0 <printf>
    memset(buf, 0, nbuf);
     ...
     5f6:	e8 95 fb ff ff       	call   190 <print_instructions>
        if (temp_buf)
     5fb:	a1 00 20 00 00       	mov    0x2000,%eax
     600:	83 c4 10             	add    $0x10,%esp
        done_printing = 1;
     603:	c7 05 04 20 00 00 01 	movl   $0x1,0x2004
     60a:	00 00 00 
        if (temp_buf)
     ...
     626:	e8 f5 fa ff ff       	call   120 <auto_complete>
      if (temp_buf)
     62b:	a1 00 20 00 00       	mov    0x2000,%eax
     630:	83 c4 10             	add    $0x10,%esp
      TAPPRESS = 1;
     633:	c7 05 0c 20 00 00 01 	movl   $0x1,0x200c
     63a:	00 00 00 
      if (temp_buf)
...
00000660 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     669:	68 a0 18 00 00       	push   $0x18a0
     66e:	6a 02                	push   $0x2
     670:	e8 7b 0e 00 00       	call   14f0 <printf>
  exit();
...
00000680 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     695:	68 06 18 00 00       	push   $0x1806
...
000006a0 <runcmd>:
{
  ...
  switch (cmd->type) {
     ...
     6b9:	ff 24 85 c4 18 00 00 	jmp    *0x18c4(,%eax,4)
    if (ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     6d9:	68 12 18 00 00       	push   $0x1812
     6de:	6a 02                	push   $0x2
     6e0:	e8 0b 0e 00 00       	call   14f0 <printf>
    break;
    ...
    panic("runcmd");
     ...
     79d:	68 0b 18 00 00       	push   $0x180b
     7a2:	e8 b9 fe ff ff       	call   660 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     7a7:	51                   	push   %ecx
     7a8:	ff 73 08             	push   0x8(%ebx)
     7ab:	68 22 18 00 00       	push   $0x1822
     7b0:	6a 02                	push   $0x2
     7b2:	e8 39 0d 00 00       	call   14f0 <printf>
      exit();
     7b7:	e8 57 0b 00 00       	call   1313 <exit>
      panic("pipe");
     7bc:	83 ec 0c             	sub    $0xc,%esp
     7bf:	68 32 18 00 00       	push   $0x1832
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     837:	6a 54                	push   $0x54
     839:	e8 d2 0e 00 00       	call   1710 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     867:	6a 18                	push   $0x18
     869:	e8 a2 0e 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8b7:	6a 0c                	push   $0xc
     8b9:	e8 52 0e 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     8f7:	6a 0c                	push   $0xc
     8f9:	e8 12 0e 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     937:	6a 08                	push   $0x8
     939:	e8 d2 0d 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     969:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     98d:	50                   	push   %eax
     98e:	68 e0 1f 00 00       	push   $0x1fe0
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     9dd:	50                   	push   %eax
     9de:	68 e0 1f 00 00       	push   $0x1fe0
  ...
  *ps = s;
  ...
  switch (*s) {
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a36:	50                   	push   %eax
     a37:	68 d8 1f 00 00       	push   $0x1fd8
    ...
    while (s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     a55:	50                   	push   %eax
     a56:	68 e0 1f 00 00       	push   $0x1fe0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while (s < es && strchr(whitespace, *s))
     ...
     afd:	50                   	push   %eax
     afe:	68 e0 1f 00 00       	push   $0x1fe0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while (peek(ps, es, "<>")) {
     ...
     b63:	68 54 18 00 00       	push   $0x1854
     b68:	53                   	push   %ebx
     b69:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     bc0:	6a 18                	push   $0x18
     bc2:	e8 49 0b 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     c1f:	6a 18                	push   $0x18
     c21:	e8 ea 0a 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     c7e:	68 37 18 00 00       	push   $0x1837
...
parseexec(char **ps, char *es)
{
  ...
  if (peek(ps, es, "("))
     c9f:	68 57 18 00 00       	push   $0x1857
     ca4:	56                   	push   %esi
     ca5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     cbb:	6a 54                	push   $0x54
     cbd:	e8 4e 0a 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (!peek(ps, es, "|)&;")) {
     ...
     d06:	68 6e 18 00 00       	push   $0x186e
     d0b:	56                   	push   %esi
     d0c:	53                   	push   %ebx
    ...
    if (argc >= MAXARGS)
     ...
     d50:	68 60 18 00 00       	push   $0x1860
  ...
  cmd->eargv[argc] = 0;
     ...
     d99:	68 59 18 00 00       	push   $0x1859
...
00000db0 <parsepipe>:
{
  ...
  if (peek(ps, es, "|")) {
     ...
     dc9:	68 73 18 00 00       	push   $0x1873
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     e0d:	e8 fe 08 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000e40 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     e72:	e8 99 08 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while (peek(ps, es, "&")) {
     ...
     e9b:	68 75 18 00 00       	push   $0x1875
     ea0:	57                   	push   %edi
     ea1:	56                   	push   %esi
  ...
  if (peek(ps, es, ";")) {
     ...
     eb1:	68 71 18 00 00       	push   $0x1871
     eb6:	57                   	push   %edi
     eb7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     eed:	e8 1e 08 00 00       	call   1710 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000f20 <parseblock>:
{
  ...
  if (!peek(ps, es, "("))
     f2f:	68 57 18 00 00       	push   $0x1857
     f34:	56                   	push   %esi
     f35:	53                   	push   %ebx
  ...
  if (!peek(ps, es, ")"))
     ...
     f59:	68 93 18 00 00       	push   $0x1893
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch (cmd->type) {
     ...
     fc5:	ff 24 85 dc 18 00 00 	jmp    *0x18dc(,%eax,4)
    ...
    1055:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
    ...
    1073:	68 fb 17 00 00       	push   $0x17fb
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    109e:	52                   	push   %edx
    109f:	50                   	push   %eax
    10a0:	68 95 18 00 00       	push   $0x1895
    10a5:	6a 02                	push   $0x2
    10a7:	e8 44 04 00 00       	call   14f0 <printf>
    panic("syntax");
    10ac:	c7 04 24 59 18 00 00 	movl   $0x1859,(%esp)
...
000013b3 <make_duplicate_file>:
SYSCALL(make_duplicate_file)
    13b3:	b8 17 00 00 00       	mov    $0x17,%eax
    13b8:	cd 40                	int    $0x40
    13ba:	c3                   	ret

000013bb <show_process_family>:
SYSCALL(show_process_family)
    13bb:	b8 18 00 00 00       	mov    $0x18,%eax
    13c0:	cd 40                	int    $0x40
    13c2:	c3                   	ret

000013c3 <simple_arithmetic_syscall>:
SYSCALL(simple_arithmetic_syscall)
    13c3:	b8 16 00 00 00       	mov    $0x16,%eax
    13c8:	cd 40                	int    $0x40
    13ca:	c3                   	ret

000013cb <grep_syscall>:
SYSCALL(grep_syscall)
    13cb:	b8 19 00 00 00       	mov    $0x19,%eax
    13d0:	cd 40                	int    $0x40
    13d2:	c3                   	ret

000013d3 <set_priority_syscall>:
SYSCALL(set_priority_syscall)
    13d3:	b8 1a 00 00 00       	mov    $0x1a,%eax
    13d8:	cd 40                	int    $0x40
    13da:	c3                   	ret

000013db <sleeplock_hold>:
SYSCALL(sleeplock_hold)
    13db:	b8 1b 00 00 00       	mov    $0x1b,%eax
    13e0:	cd 40                	int    $0x40
    13e2:	c3                   	ret

000013e3 <sleeplock_drop>:
SYSCALL(sleeplock_drop)
    13e3:	b8 1c 00 00 00       	mov    $0x1c,%eax
    13e8:	cd 40                	int    $0x40
    13ea:	c3                   	ret

000013eb <rwlock_rlock>:
SYSCALL(rwlock_rlock)
    13eb:	b8 1d 00 00 00       	mov    $0x1d,%eax
    13f0:	cd 40                	int    $0x40
    13f2:	c3                   	ret

000013f3 <rwlock_runlock>:
SYSCALL(rwlock_runlock)
    13f3:	b8 1e 00 00 00       	mov    $0x1e,%eax
    13f8:	cd 40                	int    $0x40
    13fa:	c3                   	ret

000013fb <rwlock_wlock>:
SYSCALL(rwlock_wlock)
    13fb:	b8 1f 00 00 00       	mov    $0x1f,%eax
    1400:	cd 40                	int    $0x40
    1402:	c3                   	ret

00001403 <rwlock_wunlock>:
SYSCALL(rwlock_wunlock)
    1403:	b8 20 00 00 00       	mov    $0x20,%eax
    1408:	cd 40                	int    $0x40
    140a:	c3                   	ret

0000140b <acquire_plock_sys>:
SYSCALL(acquire_plock_sys)
    140b:	b8 21 00 00 00       	mov    $0x21,%eax
    1410:	cd 40                	int    $0x40
    1412:	c3                   	ret

00001413 <release_plock_sys>:
SYSCALL(release_plock_sys)
    1413:	b8 22 00 00 00       	mov    $0x22,%eax
    1418:	cd 40                	int    $0x40
    141a:	c3                   	ret

0000141b <getlockstat>:

SYSCALL(getlockstat)
    141b:	b8 23 00 00 00       	mov    $0x23,%eax
    1420:	cd 40                	int    $0x40
    1422:	c3                   	ret
...
SYSCALL(vread)
    1423:	b8 24 00 00 00       	mov    $0x24,%eax
    1428:	cd 40                	int    $0x40
    142a:	c3                   	ret

0000142b <vwrite>:
SYSCALL(vwrite)
    142b:	b8 25 00 00 00       	mov    $0x25,%eax
    1430:	cd 40                	int    $0x40
    1432:	c3                   	ret

00001433 <cptsetpolicy>:
SYSCALL(cptsetpolicy)
    1433:	b8 26 00 00 00       	mov    $0x26,%eax
    1438:	cd 40                	int    $0x40
    143a:	c3                   	ret

0000143b <cptresetstats>:
SYSCALL(cptresetstats)
    143b:	b8 27 00 00 00       	mov    $0x27,%eax
    1440:	cd 40                	int    $0x40
    1442:	c3                   	ret

00001443 <cptgetstats>:
SYSCALL(cptgetstats)
    1443:	b8 28 00 00 00       	mov    $0x28,%eax
    1448:	cd 40                	int    $0x40
    144a:	c3                   	ret
...
{
    145a:	83 ec 3c             	sub    $0x3c,%esp
    145d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    1460:	85 d2                	test   %edx,%edx
    1462:	0f 89 80 00 00 00    	jns    14e8 <printint+0x98>
    1468:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    146c:	74 7a                	je     14e8 <printint+0x98>
    x = -xx;
    146e:	f7 d9                	neg    %ecx
    neg = 1;
  ...
  i = 0;
    1475:	89 45 c4             	mov    %eax,-0x3c(%ebp)
  ...
  do{
    ...
    1484:	89 f7                	mov    %esi,%edi
    1486:	f7 f3                	div    %ebx
    1488:	8d 76 01             	lea    0x1(%esi),%esi
    148b:	0f b6 92 4c 19 00 00 	movzbl 0x194c(%edx),%edx
    1492:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    1496:	89 ca                	mov    %ecx,%edx
    1498:	89 c1                	mov    %eax,%ecx
    149a:	39 da                	cmp    %ebx,%edx
    149c:	73 e2                	jae    1480 <printint+0x30>
  if(neg)
    149e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    14a1:	85 c0                	test   %eax,%eax
    14a3:	74 07                	je     14ac <printint+0x5c>
    buf[i++] = '-';
    14a5:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    14aa:	89 f7                	mov    %esi,%edi
    14ac:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    14af:	8b 75 c0             	mov    -0x40(%ebp),%esi
    14b2:	01 df                	add    %ebx,%edi
    14b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    14b8:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    14bb:	83 ec 04             	sub    $0x4,%esp
    14be:	88 45 d7             	mov    %al,-0x29(%ebp)
    14c1:	8d 45 d7             	lea    -0x29(%ebp),%eax
    14c4:	6a 01                	push   $0x1
    14c6:	50                   	push   %eax
    14c7:	56                   	push   %esi
    14c8:	e8 66 fe ff ff       	call   1333 <write>
  while(--i >= 0)
    14cd:	89 f8                	mov    %edi,%eax
    14cf:	83 c4 10             	add    $0x10,%esp
    14d2:	83 ef 01             	sub    $0x1,%edi
    14d5:	39 c3                	cmp    %eax,%ebx
    14d7:	75 df                	jne    14b8 <printint+0x68>
}
  ...
  neg = 0;
    ...
    14ea:	eb 89                	jmp    1475 <printint+0x25>
...
{
    14fc:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    14ff:	0f b6 1e             	movzbl (%esi),%ebx
    1502:	83 c6 01             	add    $0x1,%esi
    1505:	84 db                	test   %bl,%bl
    1507:	74 67                	je     1570 <printf+0x80>
    1509:	8d 4d 10             	lea    0x10(%ebp),%ecx
    150c:	31 d2                	xor    %edx,%edx
    150e:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    1511:	eb 34                	jmp    1547 <printf+0x57>
    ...
    if(state == 0){
      if(c == '%'){
        state = '%';
    151b:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    1520:	83 f8 25             	cmp    $0x25,%eax
    1523:	74 18                	je     153d <printf+0x4d>
  write(fd, &c, 1);
    1525:	83 ec 04             	sub    $0x4,%esp
    1528:	8d 45 e7             	lea    -0x19(%ebp),%eax
    152b:	88 5d e7             	mov    %bl,-0x19(%ebp)
    152e:	6a 01                	push   $0x1
    1530:	50                   	push   %eax
    1531:	57                   	push   %edi
    1532:	e8 fc fd ff ff       	call   1333 <write>
    1537:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    153a:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    153d:	0f b6 1e             	movzbl (%esi),%ebx
    1540:	83 c6 01             	add    $0x1,%esi
    1543:	84 db                	test   %bl,%bl
    1545:	74 29                	je     1570 <printf+0x80>
    c = fmt[i] & 0xff;
    1547:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    154a:	85 d2                	test   %edx,%edx
    154c:	74 ca                	je     1518 <printf+0x28>
      }
    } else if(state == '%'){
    154e:	83 fa 25             	cmp    $0x25,%edx
    1551:	75 ea                	jne    153d <printf+0x4d>
      if(c == 'd'){
    1553:	83 f8 25             	cmp    $0x25,%eax
    1556:	0f 84 04 01 00 00    	je     1660 <printf+0x170>
    155c:	83 e8 63             	sub    $0x63,%eax
    155f:	83 f8 15             	cmp    $0x15,%eax
    1562:	77 1c                	ja     1580 <printf+0x90>
    1564:	ff 24 85 f4 18 00 00 	jmp    *0x18f4(,%eax,4)
    156b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
    ...
    1576:	5d                   	pop    %ebp
    1577:	c3                   	ret
    1578:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    157f:	00 
  write(fd, &c, 1);
    1580:	83 ec 04             	sub    $0x4,%esp
    1583:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1586:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    158a:	6a 01                	push   $0x1
    158c:	52                   	push   %edx
    158d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    1590:	57                   	push   %edi
    1591:	e8 9d fd ff ff       	call   1333 <write>
    1596:	83 c4 0c             	add    $0xc,%esp
    1599:	88 5d e7             	mov    %bl,-0x19(%ebp)
    159c:	6a 01                	push   $0x1
    159e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    15a1:	52                   	push   %edx
    15a2:	57                   	push   %edi
    15a3:	e8 8b fd ff ff       	call   1333 <write>
        putc(fd, c);
    15a8:	83 c4 10             	add    $0x10,%esp
      state = 0;
    15ab:	31 d2                	xor    %edx,%edx
    15ad:	eb 8e                	jmp    153d <printf+0x4d>
    15af:	90                   	nop
        printint(fd, *ap, 16, 0);
    15b0:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    15b3:	83 ec 0c             	sub    $0xc,%esp
    15b6:	b9 10 00 00 00       	mov    $0x10,%ecx
    15bb:	8b 13                	mov    (%ebx),%edx
    15bd:	6a 00                	push   $0x0
    15bf:	89 f8                	mov    %edi,%eax
        ap++;
    15c1:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    15c4:	e8 87 fe ff ff       	call   1450 <printint>
        ap++;
    15c9:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    15cc:	83 c4 10             	add    $0x10,%esp
      state = 0;
    15cf:	31 d2                	xor    %edx,%edx
    15d1:	e9 67 ff ff ff       	jmp    153d <printf+0x4d>
        s = (char*)*ap;
    15d6:	8b 45 d0             	mov    -0x30(%ebp),%eax
    15d9:	8b 18                	mov    (%eax),%ebx
        ap++;
    15db:	83 c0 04             	add    $0x4,%eax
    15de:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    15e1:	85 db                	test   %ebx,%ebx
    15e3:	0f 84 87 00 00 00    	je     1670 <printf+0x180>
        while(*s != 0){
    15e9:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    15ec:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    15ee:	84 c0                	test   %al,%al
    15f0:	0f 84 47 ff ff ff    	je     153d <printf+0x4d>
    15f6:	8d 55 e7             	lea    -0x19(%ebp),%edx
    15f9:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    15fc:	89 de                	mov    %ebx,%esi
    15fe:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
    1600:	83 ec 04             	sub    $0x4,%esp
    1603:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
  ...
  write(fd, &c, 1);
    ...
    160b:	53                   	push   %ebx
    160c:	57                   	push   %edi
    160d:	e8 21 fd ff ff       	call   1333 <write>
        while(*s != 0){
    ...
    1621:	e9 17 ff ff ff       	jmp    153d <printf+0x4d>
        printint(fd, *ap, 10, 1);
    1626:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1629:	83 ec 0c             	sub    $0xc,%esp
    162c:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1631:	8b 13                	mov    (%ebx),%edx
    1633:	6a 01                	push   $0x1
    1635:	eb 88                	jmp    15bf <printf+0xcf>
        putc(fd, *ap);
    1637:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    163a:	83 ec 04             	sub    $0x4,%esp
    163d:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    1640:	8b 03                	mov    (%ebx),%eax
        ap++;
    1642:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    1645:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    1648:	6a 01                	push   $0x1
    164a:	52                   	push   %edx
    164b:	57                   	push   %edi
    164c:	e8 e2 fc ff ff       	call   1333 <write>
        ap++;
    1651:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    1654:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1657:	31 d2                	xor    %edx,%edx
    1659:	e9 df fe ff ff       	jmp    153d <printf+0x4d>
    165e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    1660:	83 ec 04             	sub    $0x4,%esp
    1663:	88 5d e7             	mov    %bl,-0x19(%ebp)
    1666:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1669:	6a 01                	push   $0x1
    166b:	e9 31 ff ff ff       	jmp    15a1 <printf+0xb1>
    1670:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1675:	bb ba 18 00 00       	mov    $0x18ba,%ebx
    167a:	e9 77 ff ff ff       	jmp    15f6 <printf+0x106>
    167f:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1681:	a1 84 20 00 00       	mov    0x2084,%eax
{
  ...
  freep = p;
    ...
    16bf:	5b                   	pop    %ebx
  freep = p;
    16c0:	a3 84 20 00 00       	mov    %eax,0x2084
}
    16c5:	5e                   	pop    %esi
    16c6:	5f                   	pop    %edi
    16c7:	5d                   	pop    %ebp
    ...
    16d6:	72 ce                	jb     16a6 <free+0x26>
{
  ...
  freep = p;
    16fa:	a3 84 20 00 00       	mov    %eax,0x2084
    p->s.size += bp->s.size;
    16ff:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    1702:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    1705:	89 08                	mov    %ecx,(%eax)
}
    1707:	5b                   	pop    %ebx
    1708:	5e                   	pop    %esi
    1709:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    171c:	8b 15 84 20 00 00    	mov    0x2084,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    172d:	0f 84 8d 00 00 00    	je     17c0 <malloc+0xb0>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1738:	39 f9                	cmp    %edi,%ecx
    173a:	73 64                	jae    17a0 <malloc+0x90>
  if(nu < 4096)
    173c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1741:	39 df                	cmp    %ebx,%edi
    1743:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    1746:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    174d:	eb 0a                	jmp    1759 <malloc+0x49>
    174f:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1750:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    1752:	8b 48 04             	mov    0x4(%eax),%ecx
    1755:	39 f9                	cmp    %edi,%ecx
    1757:	73 47                	jae    17a0 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    175b:	3b 05 84 20 00 00    	cmp    0x2084,%eax
    1761:	75 ed                	jne    1750 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1763:	83 ec 0c             	sub    $0xc,%esp
    1766:	56                   	push   %esi
    1767:	e8 2f fc ff ff       	call   139b <sbrk>
  if(p == (char*)-1)
    176c:	83 c4 10             	add    $0x10,%esp
    176f:	83 f8 ff             	cmp    $0xffffffff,%eax
    1772:	74 1c                	je     1790 <malloc+0x80>
  hp->s.size = nu;
    1774:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1777:	83 ec 0c             	sub    $0xc,%esp
    177a:	83 c0 08             	add    $0x8,%eax
    177d:	50                   	push   %eax
    177e:	e8 fd fe ff ff       	call   1680 <free>
  return freep;
    1783:	8b 15 84 20 00 00    	mov    0x2084,%edx
      if((p = morecore(nunits)) == 0)
    1789:	83 c4 10             	add    $0x10,%esp
    178c:	85 d2                	test   %edx,%edx
    178e:	75 c0                	jne    1750 <malloc+0x40>
        return 0;
  }
}
    ...
    17a2:	74 4c                	je     17f0 <malloc+0xe0>
        p->s.size -= nunits;
    ...
    17ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    17af:	89 15 84 20 00 00    	mov    %edx,0x2084
}
    ...
    17bf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    17c0:	c7 05 84 20 00 00 88 	movl   $0x2088,0x2084
    17c7:	20 00 00 
    base.s.size = 0;
    17ca:	b8 88 20 00 00       	mov    $0x2088,%eax
    base.s.ptr = freep = prevp = &base;
    17cf:	c7 05 88 20 00 00 88 	movl   $0x2088,0x2088
    17d6:	20 00 00 
    base.s.size = 0;
    17d9:	c7 05 8c 20 00 00 00 	movl   $0x0,0x208c
    17e0:	00 00 00 
    if(p->s.size >= nunits){
    17e3:	e9 54 ff ff ff       	jmp    173c <malloc+0x2c>
    17e8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    17ef:	00 
        prevp->s.ptr = p->s.ptr;
    17f0:	8b 08                	mov    (%eax),%ecx
    17f2:	89 0a                	mov    %ecx,(%edx)
    17f4:	eb b9                	jmp    17af <malloc+0x9f>
