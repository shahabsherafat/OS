   ...
   f:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  34:	68 2c 09 00 00       	push   $0x92c
  39:	e8 a2 01 00 00       	call   1e0 <strlen>
  3e:	83 c4 0c             	add    $0xc,%esp
  41:	50                   	push   %eax
  42:	68 2c 09 00 00       	push   $0x92c
  47:	53                   	push   %ebx
  ...
  55:	58                   	pop    %eax
  56:	5a                   	pop    %edx
  57:	68 97 08 00 00       	push   $0x897
  5c:	6a 01                	push   $0x1
  5e:	e8 fd 04 00 00       	call   560 <printf>
  run_one("KEYWORD", fname);
  63:	ba 7e 08 00 00       	mov    $0x87e,%edx
  68:	b8 a9 08 00 00       	mov    $0x8a9,%eax
  6d:	e8 4e 00 00 00       	call   c0 <run_one>
  run_one("NOPE", fname);
  72:	ba 7e 08 00 00       	mov    $0x87e,%edx
  77:	b8 b1 08 00 00       	mov    $0x8b1,%eax
  7c:	e8 3f 00 00 00       	call   c0 <run_one>
  run_one("anything", "no_such_file.txt");
  81:	ba b6 08 00 00       	mov    $0x8b6,%edx
  86:	b8 c7 08 00 00       	mov    $0x8c7,%eax
  ...
  a5:	51                   	push   %ecx
  a6:	68 7e 08 00 00       	push   $0x87e
  ab:	68 85 08 00 00       	push   $0x885
  b0:	6a 02                	push   $0x2
...
static void run_one(const char *key, const char *path){
  ...
  ef:	b9 68 08 00 00       	mov    $0x868,%ecx
  f4:	ba 7d 08 00 00       	mov    $0x87d,%edx
 ...
 12e:	57                   	push   %edi
 12f:	53                   	push   %ebx
 130:	68 d8 08 00 00       	push   $0x8d8
 135:	6a 01                	push   $0x1
 137:	e8 24 04 00 00       	call   560 <printf>
 ...
 4c8:	89 d1                	mov    %edx,%ecx
{
 ...
 4fb:	0f b6 92 cc 09 00 00 	movzbl 0x9cc(%edx),%edx
 ...
 536:	50                   	push   %eax
 537:	56                   	push   %esi
 538:	e8 86 fe ff ff       	call   3c3 <write>
  while(--i >= 0)
 ...
 569:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	50                   	push   %eax
 5a1:	57                   	push   %edi
 5a2:	e8 1c fe ff ff       	call   3c3 <write>
 ...
 5d4:	ff 24 85 74 09 00 00 	jmp    *0x974(,%eax,4)
 ...
 600:	57                   	push   %edi
 601:	e8 bd fd ff ff       	call   3c3 <write>
 ...
 611:	52                   	push   %edx
 612:	57                   	push   %edi
 613:	e8 ab fd ff ff       	call   3c3 <write>
        putc(fd, c);
 ...
 67b:	53                   	push   %ebx
 67c:	57                   	push   %edi
 67d:	e8 41 fd ff ff       	call   3c3 <write>
        while(*s != 0){
 ...
 6ba:	52                   	push   %edx
 6bb:	57                   	push   %edi
 6bc:	e8 02 fd ff ff       	call   3c3 <write>
        ap++;
 ...
 6e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6e5:	bb d0 08 00 00       	mov    $0x8d0,%ebx
...
free(void *ap)
{
 ...
 6f1:	a1 a0 0c 00 00       	mov    0xca0,%eax
{
 ...
 72f:	5b                   	pop    %ebx
  freep = p;
 730:	a3 a0 0c 00 00       	mov    %eax,0xca0
}
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 737:	5d                   	pop    %ebp
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 a0 0c 00 00       	mov    %eax,0xca0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 a0 0c 00 00    	mov    0xca0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cb:	3b 05 a0 0c 00 00    	cmp    0xca0,%eax
 7d1:	75 ed                	jne    7c0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 7d3:	83 ec 0c             	sub    $0xc,%esp
 7d6:	56                   	push   %esi
 7d7:	e8 4f fc ff ff       	call   42b <sbrk>
  if(p == (char*)-1)
 ...
 7ee:	e8 fd fe ff ff       	call   6f0 <free>
  return freep;
 7f3:	8b 15 a0 0c 00 00    	mov    0xca0,%edx
 ...
 81c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 81f:	89 15 a0 0c 00 00    	mov    %edx,0xca0
}
 ...
 82f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 a0 0c 00 00 a4 	movl   $0xca4,0xca0
 837:	0c 00 00 
    base.s.size = 0;
 83a:	b8 a4 0c 00 00       	mov    $0xca4,%eax
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 a4 0c 00 00 a4 	movl   $0xca4,0xca4
 846:	0c 00 00 
    base.s.size = 0;
 849:	c7 05 a8 0c 00 00 00 	movl   $0x0,0xca8
 850:	00 00 00 
    if(p->s.size >= nunits){
