 ...
 3f8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 0c 08 00 00 	movzbl 0x80c(%edx),%edx
 ...
 499:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 504:	ff 24 85 b4 07 00 00 	jmp    *0x7b4(,%eax,4)
 ...
 610:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 615:	bb ac 07 00 00       	mov    $0x7ac,%ebx
 ...
 621:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 65f:	5b                   	pop    %ebx
  freep = p;
 660:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 667:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fb:	3b 05 b8 0a 00 00    	cmp    0xab8,%eax
 ...
 71e:	e8 fd fe ff ff       	call   620 <free>
  return freep;
 723:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 74f:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 bc 0a 00 00       	mov    $0xabc,%eax
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 776:	0a 00 00 
    base.s.size = 0;
