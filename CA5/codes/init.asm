...
main(void)
{
  ...
  8d:	6a 01                	push   $0x1
  8f:	e8 7c 04 00 00       	call   510 <printf>
 ...
 478:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 14 09 00 00 	movzbl 0x914(%edx),%edx
 ...
 4e6:	50                   	push   %eax
 4e7:	56                   	push   %esi
 4e8:	e8 86 fe ff ff       	call   373 <write>
  while(--i >= 0)
 ...
 519:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 584:	ff 24 85 bc 08 00 00 	jmp    *0x8bc(,%eax,4)
 ...
 5c1:	52                   	push   %edx
 5c2:	57                   	push   %edi
 5c3:	e8 ab fd ff ff       	call   373 <write>
        putc(fd, c);
 ...
 66a:	52                   	push   %edx
 66b:	57                   	push   %edi
 66c:	e8 02 fd ff ff       	call   373 <write>
        ap++;
 ...
 6a1:	a1 bc 0b 00 00       	mov    0xbbc,%eax
{
 ...
 6df:	5b                   	pop    %ebx
  freep = p;
 6e0:	a3 bc 0b 00 00       	mov    %eax,0xbbc
}
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 bc 0b 00 00       	mov    %eax,0xbbc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 bc 0b 00 00    	mov    0xbbc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77b:	3b 05 bc 0b 00 00    	cmp    0xbbc,%eax
 781:	75 ed                	jne    770 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 783:	83 ec 0c             	sub    $0xc,%esp
 786:	56                   	push   %esi
 787:	e8 4f fc ff ff       	call   3db <sbrk>
  if(p == (char*)-1)
 ...
 79e:	e8 fd fe ff ff       	call   6a0 <free>
  return freep;
 7a3:	8b 15 bc 0b 00 00    	mov    0xbbc,%edx
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 bc 0b 00 00    	mov    %edx,0xbbc
}
 ...
 7df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 bc 0b 00 00 c0 	movl   $0xbc0,0xbbc
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	b8 c0 0b 00 00       	mov    $0xbc0,%eax
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 c0 0b 00 00 c0 	movl   $0xbc0,0xbc0
 7f6:	0b 00 00 
    base.s.size = 0;
 7f9:	c7 05 c4 0b 00 00 00 	movl   $0x0,0xbc4
 800:	00 00 00 
    if(p->s.size >= nunits){
