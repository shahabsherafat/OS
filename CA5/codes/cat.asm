 ...
 488:	89 d1                	mov    %edx,%ecx
{
 ...
 4f6:	50                   	push   %eax
 4f7:	56                   	push   %esi
 4f8:	e8 86 fe ff ff       	call   383 <write>
  while(--i >= 0)
 ...
 529:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 560:	50                   	push   %eax
 561:	57                   	push   %edi
 562:	e8 1c fe ff ff       	call   383 <write>
 ...
 5d1:	52                   	push   %edx
 5d2:	57                   	push   %edi
 5d3:	e8 ab fd ff ff       	call   383 <write>
        putc(fd, c);
 ...
 67a:	52                   	push   %edx
 67b:	57                   	push   %edi
 67c:	e8 02 fd ff ff       	call   383 <write>
        ap++;
 ...
 6a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6a5:	bb 60 08 00 00       	mov    $0x860,%ebx
...
malloc(uint nbytes)
{
 ...
 796:	56                   	push   %esi
 797:	e8 4f fc ff ff       	call   3eb <sbrk>
  if(p == (char*)-1)
