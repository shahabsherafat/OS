 ...
 3e8:	89 d1                	mov    %edx,%ecx
{
 ...
 41b:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
 ...
 489:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4f4:	ff 24 85 98 07 00 00 	jmp    *0x798(,%eax,4)
 ...
 600:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 605:	bb 91 07 00 00       	mov    $0x791,%ebx
 ...
 611:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 64f:	5b                   	pop    %ebx
  freep = p;
 650:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6eb:	3b 05 98 0a 00 00    	cmp    0xa98,%eax
 ...
 70e:	e8 fd fe ff ff       	call   610 <free>
  return freep;
 713:	8b 15 98 0a 00 00    	mov    0xa98,%edx
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 9c 0a 00 00       	mov    $0xa9c,%eax
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 766:	0a 00 00 
    base.s.size = 0;
 769:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 770:	00 00 00 
    if(p->s.size >= nunits){
