 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 10 08 00 00 	movzbl 0x810(%edx),%edx
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 514:	ff 24 85 b8 07 00 00 	jmp    *0x7b8(,%eax,4)
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb b1 07 00 00       	mov    $0x7b1,%ebx
 ...
 631:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 66f:	5b                   	pop    %ebx
  freep = p;
 670:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 677:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 70b:	3b 05 b8 0a 00 00    	cmp    0xab8,%eax
