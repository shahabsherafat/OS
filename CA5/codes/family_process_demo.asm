...
main(void)
{
  ...
  printf(1, "\n[famdemo] parent PID = %d\n", me);
  1f:	68 b8 08 00 00       	push   $0x8b8
  24:	6a 01                	push   $0x1
  26:	e8 85 05 00 00       	call   5b0 <printf>
  ...
  9f:	56                   	push   %esi
  a0:	53                   	push   %ebx
  a1:	68 0c 09 00 00       	push   $0x90c
  a6:	6a 01                	push   $0x1
  a8:	e8 03 05 00 00       	call   5b0 <printf>
 ...
 518:	89 d1                	mov    %edx,%ecx
{
 ...
 54b:	0f b6 92 a0 09 00 00 	movzbl 0x9a0(%edx),%edx
 ...
 586:	50                   	push   %eax
 587:	56                   	push   %esi
 588:	e8 86 fe ff ff       	call   413 <write>
  while(--i >= 0)
 ...
 5b9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5f0:	50                   	push   %eax
 5f1:	57                   	push   %edi
 5f2:	e8 1c fe ff ff       	call   413 <write>
 ...
 624:	ff 24 85 48 09 00 00 	jmp    *0x948(,%eax,4)
 ...
 661:	52                   	push   %edx
 662:	57                   	push   %edi
 663:	e8 ab fd ff ff       	call   413 <write>
        putc(fd, c);
 ...
 6cb:	53                   	push   %ebx
 6cc:	57                   	push   %edi
 6cd:	e8 41 fd ff ff       	call   413 <write>
        while(*s != 0){
 ...
 70a:	52                   	push   %edx
 70b:	57                   	push   %edi
 70c:	e8 02 fd ff ff       	call   413 <write>
        ap++;
 ...
 730:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 735:	bb 03 09 00 00       	mov    $0x903,%ebx
 ...
 741:	a1 48 0c 00 00       	mov    0xc48,%eax
{
 ...
 77f:	5b                   	pop    %ebx
  freep = p;
 780:	a3 48 0c 00 00       	mov    %eax,0xc48
}
 785:	5e                   	pop    %esi
 786:	5f                   	pop    %edi
 787:	5d                   	pop    %ebp
 ...
 796:	72 ce                	jb     766 <free+0x26>
{
 ...
 7b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7ba:	a3 48 0c 00 00       	mov    %eax,0xc48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7dc:	8b 15 48 0c 00 00    	mov    0xc48,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 81b:	3b 05 48 0c 00 00    	cmp    0xc48,%eax
 821:	75 ed                	jne    810 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 823:	83 ec 0c             	sub    $0xc,%esp
 826:	56                   	push   %esi
 827:	e8 4f fc ff ff       	call   47b <sbrk>
  if(p == (char*)-1)
 ...
 83e:	e8 fd fe ff ff       	call   740 <free>
  return freep;
 843:	8b 15 48 0c 00 00    	mov    0xc48,%edx
 ...
 86c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 86f:	89 15 48 0c 00 00    	mov    %edx,0xc48
}
 ...
 87f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 880:	c7 05 48 0c 00 00 4c 	movl   $0xc4c,0xc48
 887:	0c 00 00 
    base.s.size = 0;
 88a:	b8 4c 0c 00 00       	mov    $0xc4c,%eax
    base.s.ptr = freep = prevp = &base;
 88f:	c7 05 4c 0c 00 00 4c 	movl   $0xc4c,0xc4c
 896:	0c 00 00 
    base.s.size = 0;
 899:	c7 05 50 0c 00 00 00 	movl   $0x0,0xc50
 8a0:	00 00 00 
    if(p->s.size >= nunits){
