   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  63:	50                   	push   %eax
  64:	53                   	push   %ebx
  65:	68 28 08 00 00       	push   $0x828
  6a:	6a 01                	push   $0x1
  6c:	e8 af 04 00 00       	call   520 <printf>
  ...
  82:	50                   	push   %eax
  83:	53                   	push   %ebx
  84:	68 58 08 00 00       	push   $0x858
  89:	6a 01                	push   $0x1
  8b:	e8 90 04 00 00       	call   520 <printf>
  rwlock_runlock();
  ...
  ac:	50                   	push   %eax
  ad:	53                   	push   %ebx
  ae:	68 88 08 00 00       	push   $0x888
  b3:	6a 01                	push   $0x1
  b5:	e8 66 04 00 00       	call   520 <printf>
  sleep(120);
...
SYSCALL(vread)
 453:	b8 24 00 00 00       	mov    $0x24,%eax
 458:	cd 40                	int    $0x40
 45a:	c3                   	ret

0000045b <vwrite>:
SYSCALL(vwrite)
 45b:	b8 25 00 00 00       	mov    $0x25,%eax
 460:	cd 40                	int    $0x40
 462:	c3                   	ret

00000463 <cptsetpolicy>:
SYSCALL(cptsetpolicy)
 463:	b8 26 00 00 00       	mov    $0x26,%eax
 468:	cd 40                	int    $0x40
 46a:	c3                   	ret

0000046b <cptresetstats>:
SYSCALL(cptresetstats)
 46b:	b8 27 00 00 00       	mov    $0x27,%eax
 470:	cd 40                	int    $0x40
 472:	c3                   	ret

00000473 <cptgetstats>:
SYSCALL(cptgetstats)
 ...
 488:	89 d1                	mov    %edx,%ecx
{
 ...
 4bb:	0f b6 92 54 09 00 00 	movzbl 0x954(%edx),%edx
 ...
 4f6:	50                   	push   %eax
 4f7:	56                   	push   %esi
 4f8:	e8 66 fe ff ff       	call   363 <write>
  while(--i >= 0)
 ...
 529:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 560:	50                   	push   %eax
 561:	57                   	push   %edi
 562:	e8 fc fd ff ff       	call   363 <write>
 ...
 594:	ff 24 85 fc 08 00 00 	jmp    *0x8fc(,%eax,4)
 ...
 5d1:	52                   	push   %edx
 5d2:	57                   	push   %edi
 5d3:	e8 8b fd ff ff       	call   363 <write>
        putc(fd, c);
 ...
 63b:	53                   	push   %ebx
 63c:	57                   	push   %edi
 63d:	e8 21 fd ff ff       	call   363 <write>
        while(*s != 0){
 ...
 67a:	52                   	push   %edx
 67b:	57                   	push   %edi
 67c:	e8 e2 fc ff ff       	call   363 <write>
        ap++;
 ...
 6a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 6a5:	bb f2 08 00 00       	mov    $0x8f2,%ebx
...
free(void *ap)
{
 ...
 6b1:	a1 f4 0b 00 00       	mov    0xbf4,%eax
{
 ...
 6ef:	5b                   	pop    %ebx
  freep = p;
 6f0:	a3 f4 0b 00 00       	mov    %eax,0xbf4
}
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 6f7:	5d                   	pop    %ebp
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78b:	3b 05 f4 0b 00 00    	cmp    0xbf4,%eax
 791:	75 ed                	jne    780 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 793:	83 ec 0c             	sub    $0xc,%esp
 796:	56                   	push   %esi
 797:	e8 2f fc ff ff       	call   3cb <sbrk>
  if(p == (char*)-1)
 ...
 7ae:	e8 fd fe ff ff       	call   6b0 <free>
  return freep;
 7b3:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7df:	89 15 f4 0b 00 00    	mov    %edx,0xbf4
}
 ...
 7ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 f4 0b 00 00 f8 	movl   $0xbf8,0xbf4
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	b8 f8 0b 00 00       	mov    $0xbf8,%eax
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 f8 0b 00 00 f8 	movl   $0xbf8,0xbf8
 806:	0b 00 00 
    base.s.size = 0;
 809:	c7 05 fc 0b 00 00 00 	movl   $0x0,0xbfc
 810:	00 00 00 
    if(p->s.size >= nunits){
