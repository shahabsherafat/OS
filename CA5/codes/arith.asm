...
SYSCALL(vread)
 393:	b8 24 00 00 00       	mov    $0x24,%eax
 398:	cd 40                	int    $0x40
 39a:	c3                   	ret

0000039b <vwrite>:
SYSCALL(vwrite)
 39b:	b8 25 00 00 00       	mov    $0x25,%eax
 3a0:	cd 40                	int    $0x40
 3a2:	c3                   	ret

000003a3 <cptsetpolicy>:
SYSCALL(cptsetpolicy)
 3a3:	b8 26 00 00 00       	mov    $0x26,%eax
 3a8:	cd 40                	int    $0x40
 3aa:	c3                   	ret

000003ab <cptresetstats>:
SYSCALL(cptresetstats)
 3ab:	b8 27 00 00 00       	mov    $0x27,%eax
 3b0:	cd 40                	int    $0x40
 3b2:	c3                   	ret

000003b3 <cptgetstats>:
SYSCALL(cptgetstats)
 3b3:	b8 28 00 00 00       	mov    $0x28,%eax
 3b8:	cd 40                	int    $0x40
 3ba:	c3                   	ret
 ...
 3c8:	89 d1                	mov    %edx,%ecx
{
 ...
 436:	50                   	push   %eax
 437:	56                   	push   %esi
 438:	e8 66 fe ff ff       	call   2a3 <write>
  while(--i >= 0)
 ...
 469:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4a0:	50                   	push   %eax
 4a1:	57                   	push   %edi
 4a2:	e8 fc fd ff ff       	call   2a3 <write>
 ...
 511:	52                   	push   %edx
 512:	57                   	push   %edi
 513:	e8 8b fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 5ba:	52                   	push   %edx
 5bb:	57                   	push   %edi
 5bc:	e8 e2 fc ff ff       	call   2a3 <write>
        ap++;
 ...
 5f1:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 62f:	5b                   	pop    %ebx
  freep = p;
 630:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 637:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6cb:	3b 05 68 0a 00 00    	cmp    0xa68,%eax
 6d1:	75 ed                	jne    6c0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 6d3:	83 ec 0c             	sub    $0xc,%esp
 6d6:	56                   	push   %esi
 6d7:	e8 2f fc ff ff       	call   30b <sbrk>
  if(p == (char*)-1)
