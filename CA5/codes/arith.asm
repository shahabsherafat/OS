...
main(void)
{
  ...
  asm volatile(
   7:	b8 05 00 00 00       	mov    $0x5,%eax
   c:	ba 03 00 00 00       	mov    $0x3,%edx
{
 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 416:	50                   	push   %eax
 417:	56                   	push   %esi
 418:	e8 86 fe ff ff       	call   2a3 <write>
  while(--i >= 0)
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 480:	50                   	push   %eax
 481:	57                   	push   %edi
 482:	e8 1c fe ff ff       	call   2a3 <write>
 ...
 4f1:	52                   	push   %edx
 4f2:	57                   	push   %edi
 4f3:	e8 ab fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 59a:	52                   	push   %edx
 59b:	57                   	push   %edi
 59c:	e8 02 fd ff ff       	call   2a3 <write>
        ap++;
 ...
 5d1:	a1 48 0a 00 00       	mov    0xa48,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 48 0a 00 00       	mov    %eax,0xa48
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 48 0a 00 00       	mov    %eax,0xa48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ab:	3b 05 48 0a 00 00    	cmp    0xa48,%eax
 6b1:	75 ed                	jne    6a0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 6b3:	83 ec 0c             	sub    $0xc,%esp
 6b6:	56                   	push   %esi
 6b7:	e8 4f fc ff ff       	call   30b <sbrk>
  if(p == (char*)-1)
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 48 0a 00 00    	mov    0xa48,%edx
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 4c 0a 00 00       	mov    $0xa4c,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 4c 0a 00 00 4c 	movl   $0xa4c,0xa4c
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 50 0a 00 00 00 	movl   $0x0,0xa50
 730:	00 00 00 
    if(p->s.size >= nunits){
