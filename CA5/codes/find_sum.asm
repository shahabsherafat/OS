 ...
 5e8:	89 d1                	mov    %edx,%ecx
{
 ...
 61b:	0f b6 92 f4 09 00 00 	movzbl 0x9f4(%edx),%edx
 ...
 656:	50                   	push   %eax
 657:	56                   	push   %esi
 658:	e8 86 fe ff ff       	call   4e3 <write>
  while(--i >= 0)
 ...
 689:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 6c0:	50                   	push   %eax
 6c1:	57                   	push   %edi
 6c2:	e8 1c fe ff ff       	call   4e3 <write>
 ...
 6f4:	ff 24 85 9c 09 00 00 	jmp    *0x99c(,%eax,4)
 ...
 731:	52                   	push   %edx
 732:	57                   	push   %edi
 733:	e8 ab fd ff ff       	call   4e3 <write>
        putc(fd, c);
 ...
 79b:	53                   	push   %ebx
 79c:	57                   	push   %edi
 79d:	e8 41 fd ff ff       	call   4e3 <write>
        while(*s != 0){
 ...
 7da:	52                   	push   %edx
 7db:	57                   	push   %edi
 7dc:	e8 02 fd ff ff       	call   4e3 <write>
        ap++;
 ...
 800:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 805:	bb 93 09 00 00       	mov    $0x993,%ebx
 ...
 811:	a1 9c 0c 00 00       	mov    0xc9c,%eax
{
 ...
 84f:	5b                   	pop    %ebx
  freep = p;
 850:	a3 9c 0c 00 00       	mov    %eax,0xc9c
}
 855:	5e                   	pop    %esi
 856:	5f                   	pop    %edi
 857:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 8eb:	3b 05 9c 0c 00 00    	cmp    0xc9c,%eax
 8f1:	75 ed                	jne    8e0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 8f3:	83 ec 0c             	sub    $0xc,%esp
 8f6:	56                   	push   %esi
 8f7:	e8 4f fc ff ff       	call   54b <sbrk>
  if(p == (char*)-1)
 ...
 90e:	e8 fd fe ff ff       	call   810 <free>
  return freep;
 913:	8b 15 9c 0c 00 00    	mov    0xc9c,%edx
 ...
 93c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 93f:	89 15 9c 0c 00 00    	mov    %edx,0xc9c
}
 ...
 94f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 950:	c7 05 9c 0c 00 00 a0 	movl   $0xca0,0xc9c
 957:	0c 00 00 
    base.s.size = 0;
 95a:	b8 a0 0c 00 00       	mov    $0xca0,%eax
    base.s.ptr = freep = prevp = &base;
 95f:	c7 05 a0 0c 00 00 a0 	movl   $0xca0,0xca0
 966:	0c 00 00 
    base.s.size = 0;
 969:	c7 05 a4 0c 00 00 00 	movl   $0x0,0xca4
 970:	00 00 00 
    if(p->s.size >= nunits){
