...
000005cb <getlockstat>:

SYSCALL(getlockstat)
 5cb:	b8 23 00 00 00       	mov    $0x23,%eax
 5d0:	cd 40                	int    $0x40
 5d2:	c3                   	ret
...
SYSCALL(vread)
 5d3:	b8 24 00 00 00       	mov    $0x24,%eax
 5d8:	cd 40                	int    $0x40
 5da:	c3                   	ret

000005db <vwrite>:
SYSCALL(vwrite)
 5db:	b8 25 00 00 00       	mov    $0x25,%eax
 5e0:	cd 40                	int    $0x40
 5e2:	c3                   	ret

000005e3 <cptsetpolicy>:
SYSCALL(cptsetpolicy)
 5e3:	b8 26 00 00 00       	mov    $0x26,%eax
 5e8:	cd 40                	int    $0x40
 5ea:	c3                   	ret

000005eb <cptresetstats>:
SYSCALL(cptresetstats)
 5eb:	b8 27 00 00 00       	mov    $0x27,%eax
 5f0:	cd 40                	int    $0x40
 5f2:	c3                   	ret

000005f3 <cptgetstats>:
SYSCALL(cptgetstats)
 5f3:	b8 28 00 00 00       	mov    $0x28,%eax
 5f8:	cd 40                	int    $0x40
 5fa:	c3                   	ret
 ...
 608:	89 d1                	mov    %edx,%ecx
{
 ...
 63b:	0f b6 92 14 0a 00 00 	movzbl 0xa14(%edx),%edx
 ...
 676:	50                   	push   %eax
 677:	56                   	push   %esi
 678:	e8 66 fe ff ff       	call   4e3 <write>
  while(--i >= 0)
 67d:	89 f8                	mov    %edi,%eax
 67f:	83 c4 10             	add    $0x10,%esp
 682:	83 ef 01             	sub    $0x1,%edi
 685:	39 c3                	cmp    %eax,%ebx
 ...
 6a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 6e0:	50                   	push   %eax
 6e1:	57                   	push   %edi
 6e2:	e8 fc fd ff ff       	call   4e3 <write>
 ...
 706:	0f 84 04 01 00 00    	je     810 <printf+0x170>
 70c:	83 e8 63             	sub    $0x63,%eax
 70f:	83 f8 15             	cmp    $0x15,%eax
 712:	77 1c                	ja     730 <printf+0x90>
 714:	ff 24 85 bc 09 00 00 	jmp    *0x9bc(,%eax,4)
 ...
 740:	57                   	push   %edi
 741:	e8 9d fd ff ff       	call   4e3 <write>
 ...
 751:	52                   	push   %edx
 752:	57                   	push   %edi
 753:	e8 8b fd ff ff       	call   4e3 <write>
        putc(fd, c);
 ...
 781:	e9 67 ff ff ff       	jmp    6ed <printf+0x4d>
        s = (char*)*ap;
 786:	8b 45 d0             	mov    -0x30(%ebp),%eax
 789:	8b 18                	mov    (%eax),%ebx
        ap++;
 78b:	83 c0 04             	add    $0x4,%eax
 78e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
 791:	85 db                	test   %ebx,%ebx
 793:	0f 84 87 00 00 00    	je     820 <printf+0x180>
        while(*s != 0){
 799:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
 79c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
 79e:	84 c0                	test   %al,%al
 7a0:	0f 84 47 ff ff ff    	je     6ed <printf+0x4d>
 7a6:	8d 55 e7             	lea    -0x19(%ebp),%edx
 7a9:	89 75 d4             	mov    %esi,-0x2c(%ebp)
 7ac:	89 de                	mov    %ebx,%esi
 7ae:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
 ...
 7bb:	53                   	push   %ebx
 7bc:	57                   	push   %edi
 7bd:	e8 21 fd ff ff       	call   4e3 <write>
        while(*s != 0){
 ...
 7d1:	e9 17 ff ff ff       	jmp    6ed <printf+0x4d>
        printint(fd, *ap, 10, 1);
 7d6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
 7d9:	83 ec 0c             	sub    $0xc,%esp
 7dc:	b9 0a 00 00 00       	mov    $0xa,%ecx
 7e1:	8b 13                	mov    (%ebx),%edx
 7e3:	6a 01                	push   $0x1
 7e5:	eb 88                	jmp    76f <printf+0xcf>
        putc(fd, *ap);
 7e7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
 7ea:	83 ec 04             	sub    $0x4,%esp
 7ed:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
 7f0:	8b 03                	mov    (%ebx),%eax
        ap++;
 7f2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
 7f5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 7f8:	6a 01                	push   $0x1
 7fa:	52                   	push   %edx
 7fb:	57                   	push   %edi
 7fc:	e8 e2 fc ff ff       	call   4e3 <write>
        ap++;
 801:	89 5d d0             	mov    %ebx,-0x30(%ebp)
 804:	83 c4 10             	add    $0x10,%esp
      state = 0;
 807:	31 d2                	xor    %edx,%edx
 809:	e9 df fe ff ff       	jmp    6ed <printf+0x4d>
 80e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
 810:	83 ec 04             	sub    $0x4,%esp
 813:	88 5d e7             	mov    %bl,-0x19(%ebp)
 816:	8d 55 e7             	lea    -0x19(%ebp),%edx
 819:	6a 01                	push   $0x1
 81b:	e9 31 ff ff ff       	jmp    751 <printf+0xb1>
 820:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 825:	bb b3 09 00 00       	mov    $0x9b3,%ebx
 82a:	e9 77 ff ff ff       	jmp    7a6 <printf+0x106>
 82f:	90                   	nop
...
free(void *ap)
{
 ...
 831:	a1 bc 0c 00 00       	mov    0xcbc,%eax
{
 ...
 86f:	5b                   	pop    %ebx
  freep = p;
 870:	a3 bc 0c 00 00       	mov    %eax,0xcbc
}
 875:	5e                   	pop    %esi
 876:	5f                   	pop    %edi
 877:	5d                   	pop    %ebp
 ...
 886:	72 ce                	jb     856 <free+0x26>
{
 ...
 8a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 8aa:	a3 bc 0c 00 00       	mov    %eax,0xcbc
    p->s.size += bp->s.size;
 8af:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 8b2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
 8b5:	89 08                	mov    %ecx,(%eax)
}
 8b7:	5b                   	pop    %ebx
 8b8:	5e                   	pop    %esi
 8b9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 8c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8cc:	8b 15 bc 0c 00 00    	mov    0xcbc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8dd:	0f 84 8d 00 00 00    	je     970 <malloc+0xb0>
 ...
 8e8:	39 f9                	cmp    %edi,%ecx
 8ea:	73 64                	jae    950 <malloc+0x90>
  if(nu < 4096)
 8ec:	bb 00 10 00 00       	mov    $0x1000,%ebx
 8f1:	39 df                	cmp    %ebx,%edi
 8f3:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
 8f6:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
 8fd:	eb 0a                	jmp    909 <malloc+0x49>
 8ff:	90                   	nop
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 900:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
 902:	8b 48 04             	mov    0x4(%eax),%ecx
 905:	39 f9                	cmp    %edi,%ecx
 907:	73 47                	jae    950 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 90b:	3b 05 bc 0c 00 00    	cmp    0xcbc,%eax
 911:	75 ed                	jne    900 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 913:	83 ec 0c             	sub    $0xc,%esp
 916:	56                   	push   %esi
 917:	e8 2f fc ff ff       	call   54b <sbrk>
  if(p == (char*)-1)
 91c:	83 c4 10             	add    $0x10,%esp
 91f:	83 f8 ff             	cmp    $0xffffffff,%eax
 922:	74 1c                	je     940 <malloc+0x80>
  hp->s.size = nu;
 924:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
 927:	83 ec 0c             	sub    $0xc,%esp
 92a:	83 c0 08             	add    $0x8,%eax
 92d:	50                   	push   %eax
 92e:	e8 fd fe ff ff       	call   830 <free>
  return freep;
 933:	8b 15 bc 0c 00 00    	mov    0xcbc,%edx
      if((p = morecore(nunits)) == 0)
 939:	83 c4 10             	add    $0x10,%esp
 93c:	85 d2                	test   %edx,%edx
 93e:	75 c0                	jne    900 <malloc+0x40>
        return 0;
  }
}
 ...
 95c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 95f:	89 15 bc 0c 00 00    	mov    %edx,0xcbc
}
 ...
 96f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 970:	c7 05 bc 0c 00 00 c0 	movl   $0xcc0,0xcbc
 977:	0c 00 00 
    base.s.size = 0;
 97a:	b8 c0 0c 00 00       	mov    $0xcc0,%eax
    base.s.ptr = freep = prevp = &base;
 97f:	c7 05 c0 0c 00 00 c0 	movl   $0xcc0,0xcc0
 986:	0c 00 00 
    base.s.size = 0;
 989:	c7 05 c4 0c 00 00 00 	movl   $0x0,0xcc4
 990:	00 00 00 
    if(p->s.size >= nunits){
 993:	e9 54 ff ff ff       	jmp    8ec <malloc+0x2c>
 998:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 99f:	00 
        prevp->s.ptr = p->s.ptr;
 9a0:	8b 08                	mov    (%eax),%ecx
 9a2:	89 0a                	mov    %ecx,(%edx)
 9a4:	eb b9                	jmp    95f <malloc+0x9f>
