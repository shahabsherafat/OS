 ...
 6a8:	89 d1                	mov    %edx,%ecx
{
 ...
 6db:	0f b6 92 f4 0a 00 00 	movzbl 0xaf4(%edx),%edx
 ...
 716:	50                   	push   %eax
 717:	56                   	push   %esi
 718:	e8 86 fe ff ff       	call   5a3 <write>
  while(--i >= 0)
 ...
 749:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 780:	50                   	push   %eax
 781:	57                   	push   %edi
 782:	e8 1c fe ff ff       	call   5a3 <write>
 ...
 7b4:	ff 24 85 9c 0a 00 00 	jmp    *0xa9c(,%eax,4)
 ...
 7e0:	57                   	push   %edi
 7e1:	e8 bd fd ff ff       	call   5a3 <write>
 ...
 7f1:	52                   	push   %edx
 7f2:	57                   	push   %edi
 7f3:	e8 ab fd ff ff       	call   5a3 <write>
        putc(fd, c);
 ...
 89a:	52                   	push   %edx
 89b:	57                   	push   %edi
 89c:	e8 02 fd ff ff       	call   5a3 <write>
        ap++;
 ...
 8c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 8c5:	bb 92 0a 00 00       	mov    $0xa92,%ebx
...
free(void *ap)
{
 ...
 8d1:	a1 28 0e 00 00       	mov    0xe28,%eax
{
 ...
 90f:	5b                   	pop    %ebx
  freep = p;
 910:	a3 28 0e 00 00       	mov    %eax,0xe28
}
 915:	5e                   	pop    %esi
 916:	5f                   	pop    %edi
 917:	5d                   	pop    %ebp
 ...
 926:	72 ce                	jb     8f6 <free+0x26>
{
 ...
 947:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 94a:	a3 28 0e 00 00       	mov    %eax,0xe28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 96c:	8b 15 28 0e 00 00    	mov    0xe28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ab:	3b 05 28 0e 00 00    	cmp    0xe28,%eax
 9b1:	75 ed                	jne    9a0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 9b3:	83 ec 0c             	sub    $0xc,%esp
 9b6:	56                   	push   %esi
 9b7:	e8 4f fc ff ff       	call   60b <sbrk>
  if(p == (char*)-1)
 ...
 9ce:	e8 fd fe ff ff       	call   8d0 <free>
  return freep;
 9d3:	8b 15 28 0e 00 00    	mov    0xe28,%edx
 ...
 9fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9ff:	89 15 28 0e 00 00    	mov    %edx,0xe28
}
 ...
 a0f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 a10:	c7 05 28 0e 00 00 2c 	movl   $0xe2c,0xe28
 a17:	0e 00 00 
    base.s.size = 0;
 a1a:	b8 2c 0e 00 00       	mov    $0xe2c,%eax
    base.s.ptr = freep = prevp = &base;
 a1f:	c7 05 2c 0e 00 00 2c 	movl   $0xe2c,0xe2c
 a26:	0e 00 00 
    base.s.size = 0;
 a29:	c7 05 30 0e 00 00 00 	movl   $0x0,0xe30
 a30:	00 00 00 
    if(p->s.size >= nunits){
