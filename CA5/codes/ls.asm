...
000006a3 <cptsetpolicy>:
SYSCALL(cptsetpolicy)
 6a3:	b8 26 00 00 00       	mov    $0x26,%eax
 6a8:	cd 40                	int    $0x40
 6aa:	c3                   	ret

000006ab <cptresetstats>:
SYSCALL(cptresetstats)
 6ab:	b8 27 00 00 00       	mov    $0x27,%eax
 6b0:	cd 40                	int    $0x40
 6b2:	c3                   	ret

000006b3 <cptgetstats>:
SYSCALL(cptgetstats)
 6b3:	b8 28 00 00 00       	mov    $0x28,%eax
 6b8:	cd 40                	int    $0x40
 6ba:	c3                   	ret
 ...
 6c8:	89 d1                	mov    %edx,%ecx
{
 ...
 6fb:	0f b6 92 14 0b 00 00 	movzbl 0xb14(%edx),%edx
 ...
 736:	50                   	push   %eax
 737:	56                   	push   %esi
 738:	e8 66 fe ff ff       	call   5a3 <write>
  while(--i >= 0)
 ...
 769:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 7a0:	50                   	push   %eax
 7a1:	57                   	push   %edi
 7a2:	e8 fc fd ff ff       	call   5a3 <write>
 ...
 7d4:	ff 24 85 bc 0a 00 00 	jmp    *0xabc(,%eax,4)
 ...
 800:	57                   	push   %edi
 801:	e8 9d fd ff ff       	call   5a3 <write>
 ...
 811:	52                   	push   %edx
 812:	57                   	push   %edi
 813:	e8 8b fd ff ff       	call   5a3 <write>
        putc(fd, c);
 ...
 8ba:	52                   	push   %edx
 8bb:	57                   	push   %edi
 8bc:	e8 e2 fc ff ff       	call   5a3 <write>
        ap++;
 ...
 8e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 8e5:	bb b2 0a 00 00       	mov    $0xab2,%ebx
...
free(void *ap)
{
 ...
 8f1:	a1 48 0e 00 00       	mov    0xe48,%eax
{
 ...
 92f:	5b                   	pop    %ebx
  freep = p;
 930:	a3 48 0e 00 00       	mov    %eax,0xe48
}
 935:	5e                   	pop    %esi
 936:	5f                   	pop    %edi
 937:	5d                   	pop    %ebp
 ...
 946:	72 ce                	jb     916 <free+0x26>
{
 ...
 967:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 96a:	a3 48 0e 00 00       	mov    %eax,0xe48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9cb:	3b 05 48 0e 00 00    	cmp    0xe48,%eax
 9d1:	75 ed                	jne    9c0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 9d3:	83 ec 0c             	sub    $0xc,%esp
 9d6:	56                   	push   %esi
 9d7:	e8 2f fc ff ff       	call   60b <sbrk>
  if(p == (char*)-1)
