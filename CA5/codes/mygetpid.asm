 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 a8 07 00 00 	movzbl 0x7a8(%edx),%edx
 ...
 416:	50                   	push   %eax
 417:	56                   	push   %esi
 418:	e8 66 fe ff ff       	call   283 <write>
  while(--i >= 0)
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 480:	50                   	push   %eax
 481:	57                   	push   %edi
 482:	e8 fc fd ff ff       	call   283 <write>
 ...
 4b4:	ff 24 85 50 07 00 00 	jmp    *0x750(,%eax,4)
 ...
 4f1:	52                   	push   %edx
 4f2:	57                   	push   %edi
 4f3:	e8 8b fd ff ff       	call   283 <write>
        putc(fd, c);
 ...
 55b:	53                   	push   %ebx
 55c:	57                   	push   %edi
 55d:	e8 21 fd ff ff       	call   283 <write>
        while(*s != 0){
 ...
 59a:	52                   	push   %edx
 59b:	57                   	push   %edi
 59c:	e8 e2 fc ff ff       	call   283 <write>
        ap++;
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb 48 07 00 00       	mov    $0x748,%ebx
...
free(void *ap)
{
 ...
 5d1:	a1 3c 0a 00 00       	mov    0xa3c,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 3c 0a 00 00       	mov    %eax,0xa3c
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 3c 0a 00 00       	mov    %eax,0xa3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ab:	3b 05 3c 0a 00 00    	cmp    0xa3c,%eax
 6b1:	75 ed                	jne    6a0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 6b3:	83 ec 0c             	sub    $0xc,%esp
 6b6:	56                   	push   %esi
 6b7:	e8 2f fc ff ff       	call   2eb <sbrk>
  if(p == (char*)-1)
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
}
 ...
 70f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 3c 0a 00 00 40 	movl   $0xa40,0xa3c
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 40 0a 00 00       	mov    $0xa40,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 730:	00 00 00 
    if(p->s.size >= nunits){
