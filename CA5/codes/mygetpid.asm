 ...
 388:	89 d1                	mov    %edx,%ecx
{
 ...
 3f6:	50                   	push   %eax
 3f7:	56                   	push   %esi
 3f8:	e8 86 fe ff ff       	call   283 <write>
  while(--i >= 0)
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 460:	50                   	push   %eax
 461:	57                   	push   %edi
 462:	e8 1c fe ff ff       	call   283 <write>
 ...
 4d1:	52                   	push   %edx
 4d2:	57                   	push   %edi
 4d3:	e8 ab fd ff ff       	call   283 <write>
        putc(fd, c);
 ...
 57a:	52                   	push   %edx
 57b:	57                   	push   %edi
 57c:	e8 02 fd ff ff       	call   283 <write>
        ap++;
...
free(void *ap)
{
 ...
 5b1:	a1 1c 0a 00 00       	mov    0xa1c,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 1c 0a 00 00       	mov    %eax,0xa1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 1c 0a 00 00    	cmp    0xa1c,%eax
 691:	75 ed                	jne    680 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 693:	83 ec 0c             	sub    $0xc,%esp
 696:	56                   	push   %esi
 697:	e8 4f fc ff ff       	call   2eb <sbrk>
  if(p == (char*)-1)
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 1c 0a 00 00 20 	movl   $0xa20,0xa1c
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 20 0a 00 00       	mov    $0xa20,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 710:	00 00 00 
    if(p->s.size >= nunits){
