 ...
 3f8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 2c 08 00 00 	movzbl 0x82c(%edx),%edx
 ...
 499:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 504:	ff 24 85 d4 07 00 00 	jmp    *0x7d4(,%eax,4)
 ...
 610:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 615:	bb cb 07 00 00       	mov    $0x7cb,%ebx
 ...
 621:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 65f:	5b                   	pop    %ebx
  freep = p;
 660:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 667:	5d                   	pop    %ebp
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 d8 0a 00 00       	mov    %eax,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6fb:	3b 05 d8 0a 00 00    	cmp    0xad8,%eax
 ...
 71e:	e8 fd fe ff ff       	call   620 <free>
  return freep;
 723:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 dc 0a 00 00       	mov    $0xadc,%eax
    base.s.ptr = freep = prevp = &base;
