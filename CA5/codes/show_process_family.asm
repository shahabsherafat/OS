 ...
 3d8:	89 d1                	mov    %edx,%ecx
{
 ...
 40b:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
 ...
 479:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4e4:	ff 24 85 a8 07 00 00 	jmp    *0x7a8(,%eax,4)
 ...
 5f0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5f5:	bb a0 07 00 00       	mov    $0x7a0,%ebx
 ...
 601:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 63f:	5b                   	pop    %ebx
  freep = p;
 640:	a3 a0 0a 00 00       	mov    %eax,0xaa0
}
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 647:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6db:	3b 05 a0 0a 00 00    	cmp    0xaa0,%eax
 ...
 6fe:	e8 fd fe ff ff       	call   600 <free>
  return freep;
 703:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 72f:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
}
 ...
 73f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 a0 0a 00 00 a4 	movl   $0xaa4,0xaa0
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 a4 0a 00 00       	mov    $0xaa4,%eax
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 a4 0a 00 00 a4 	movl   $0xaa4,0xaa4
 756:	0a 00 00 
    base.s.size = 0;
 759:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 760:	00 00 00 
    if(p->s.size >= nunits){
