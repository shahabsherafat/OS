...
main(int argc, char **argv)
{
  ...
  37:	75 0f                	jne    48 <main+0x48>
    cpu_intensive("HIGH");
  39:	b8 0f 08 00 00       	mov    $0x80f,%eax
 ...
 458:	89 d1                	mov    %edx,%ecx
{
 ...
 4c6:	50                   	push   %eax
 4c7:	56                   	push   %esi
 4c8:	e8 86 fe ff ff       	call   353 <write>
  while(--i >= 0)
 ...
 4f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 530:	50                   	push   %eax
 531:	57                   	push   %edi
 532:	e8 1c fe ff ff       	call   353 <write>
 ...
 5a1:	52                   	push   %edx
 5a2:	57                   	push   %edi
 5a3:	e8 ab fd ff ff       	call   353 <write>
        putc(fd, c);
 ...
 64a:	52                   	push   %edx
 64b:	57                   	push   %edi
 64c:	e8 02 fd ff ff       	call   353 <write>
        ap++;
 ...
 670:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 675:	bb 14 08 00 00       	mov    $0x814,%ebx
 ...
 681:	a1 7c 0b 00 00       	mov    0xb7c,%eax
{
 ...
 6bf:	5b                   	pop    %ebx
  freep = p;
 6c0:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 6c7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75b:	3b 05 7c 0b 00 00    	cmp    0xb7c,%eax
 761:	75 ed                	jne    750 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 763:	83 ec 0c             	sub    $0xc,%esp
 766:	56                   	push   %esi
 767:	e8 4f fc ff ff       	call   3bb <sbrk>
  if(p == (char*)-1)
 ...
 77e:	e8 fd fe ff ff       	call   680 <free>
  return freep;
 783:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 80 0b 00 00       	mov    $0xb80,%eax
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 80 0b 00 00 80 	movl   $0xb80,0xb80
 7d6:	0b 00 00 
    base.s.size = 0;
 7d9:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 7e0:	00 00 00 
    if(p->s.size >= nunits){
